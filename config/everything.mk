...
AUX_RULES:=clean distclean help run-unit-test run-integration-test cov-report dist-cov-report seccomp-policies frontend frontend-generated frontend-clean env objdir
...
make-bin-rust  = $(eval $(call _make-exe,$(1),$(2),$(3),rust,bin,$(4) $(filter-out -static -static-pie,$(LDFLAGS_EXE)) -pie))$(eval $(call _publish-bin,$(1),rust))
...
make-integration-test-rust = $(eval $(call _make-exe,$(1),$(2),$(3),integration-test,integration-test,$(4) $(filter-out -static -static-pie,$(LDFLAGS_EXE)) -pie))
...
# Regenerates generated/http_import_dist.c from the committed dist/ tree.
# Hermetic (no npm), so CI can diff it; C collation keeps the order
# stable across developer locales.
define frontend-generated-recipe
	...
	counter=0; \
	for file in $$($(FIND) $(FRONTEND_DIR)/dist -type f | LC_ALL=C sort); do \
