...
frontend:
	...
	rm -rf src/disco/gui/dist
	mkdir -p src/disco/gui/dist
	cp -r frontend/dist/* src/disco/gui/dist
	...
	counter=0; \
	for file in $$(find src/disco/gui/dist -type f | sort); do \
		echo "FD_IMPORT_BINARY( file$$counter, \"$$file\" );" >> src/disco/gui/generated/http_import_dist.c; \
		counter=$$((counter + 1)); \
	done; \
	echo "" >> src/disco/gui/generated/http_import_dist.c; \
	echo "fd_http_static_file_t STATIC_FILES[] = {" >> src/disco/gui/generated/http_import_dist.c; \
	counter=0; \
	for file in $$(find src/disco/gui/dist -type f | sort); do \
		stripped_file=$$(echo $$file | sed 's|^src/disco/gui/dist/||'); \
		echo "    {" >> src/disco/gui/generated/http_import_dist.c; \
		echo "        .name = \"/$$stripped_file\"," >> src/disco/gui/generated/http_import_dist.c; \
		echo "        .data = file$$counter," >> src/disco/gui/generated/http_import_dist.c; \
		echo "        .data_len = &file$${counter}_sz," >> src/disco/gui/generated/http_import_dist.c; \
		echo "    }," >> src/disco/gui/generated/http_import_dist.c; \
		counter=$$((counter + 1)); \
	done; \
