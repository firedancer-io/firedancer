...
CPPFLAGS+=-march=armv8.4-a+crypto+sha3 -mtune=neoverse-n2
CPPFLAGS+=-DFD_HAS_ARM=1 -DFD_HAS_NEON=1 -DFD_HAS_ARM_CRYPTO=1 -DFD_HAS_ARM_SHA256=1 -DFD_HAS_ARM_SHA512=1 -DFD_HAS_ARM_AES=1
FD_HAS_ARM:=1
FD_HAS_NEON:=1
FD_HAS_ARM_CRYPTO:=1
FD_HAS_ARM_SHA256:=1
