#ifndef HEADER_fd_src_ballet_zksdk_instructions_fd_zksdk_batched_grouped_ciphertext_validity_h
#define HEADER_fd_src_ballet_zksdk_instructions_fd_zksdk_batched_grouped_ciphertext_validity_h
...
struct __attribute__((packed)) fd_zksdk_grp_ciph_2h_val_context {
  ...
  grp_ciph_2h_t grouped_ciphertext[1]; // 3x points
};
...
struct __attribute__((packed)) fd_zksdk_batched_grp_ciph_2h_val_context {
  uchar pubkey1 [ 32 ]; // point
  uchar pubkey2 [ 32 ]; // point
  grp_ciph_2h_t grouped_ciphertext_lo[1]; // 3x points
  grp_ciph_2h_t grouped_ciphertext_hi[1]; // 3x points
};
...
#endif /* HEADER_fd_src_ballet_zksdk_instructions_fd_zksdk_batched_grouped_ciphertext_validity_h */
