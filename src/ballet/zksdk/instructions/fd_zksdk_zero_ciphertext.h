#ifndef HEADER_fd_src_ballet_zksdk_instructions_fd_zksdk_zero_ciphertext_h
#define HEADER_fd_src_ballet_zksdk_instructions_fd_zksdk_zero_ciphertext_h
...
#endif /* HEADER_fd_src_ballet_zksdk_instructions_fd_zksdk_zero_ciphertext_h */
