#ifndef HEADER_fd_src_ballet_zksdk_instructions_fd_zksdk_percentage_with_cap_h
#define HEADER_fd_src_ballet_zksdk_instructions_fd_zksdk_percentage_with_cap_h
...
#endif /* HEADER_fd_src_ballet_zksdk_instructions_fd_zksdk_percentage_with_cap_h */
