...
fd_sha512_core_riscv( ulong *       state,
                      uchar const * block,
                      ulong         block_cnt ) {
  vuint32m1_t const idx = __riscv_vle32_v_u32m1( fd_sha512_riscv_state_idx, FD_SHA512_RISCV_VL );
  ...
  do {
    vuint64m2_t w0 = __riscv_vreinterpret_v_u8m2_u64m2( __riscv_vle8_v_u8m2( block,      32UL ) );
    vuint64m2_t w1 = __riscv_vreinterpret_v_u8m2_u64m2( __riscv_vle8_v_u8m2( block+32UL, 32UL ) );
    vuint64m2_t w2 = __riscv_vreinterpret_v_u8m2_u64m2( __riscv_vle8_v_u8m2( block+64UL, 32UL ) );
    vuint64m2_t w3 = __riscv_vreinterpret_v_u8m2_u64m2( __riscv_vle8_v_u8m2( block+96UL, 32UL ) );
