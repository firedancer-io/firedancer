# This file was autogenerated by the sha512 ASM code generator
# sha512-x86_64.pl and x86_64-xlate.pl from OpenSSL circa 2022-Oct (open
# source Apache 2.0 license).  The generated code was lightly modified
# to extract only the version needed and named appropriately for
# interfacing the existing API and exposing for library use.

.text	
.globl	fd_sha512_core_avx2
.type	fd_sha512_core_avx2,@function
.align	64
fd_sha512_core_avx2:
.cfi_startproc	
	movq	%rsp,%rax
...
.Loop_avx2:
	...
	leaq	fd_sha512_core_avx2_k+128(%rip),%rbp
...
.Lepilogue_avx2:
	.byte	0xf3,0xc3
.cfi_endproc	
.size	fd_sha512_core_avx2,.-fd_sha512_core_avx2

.align	64
.type	fd_sha512_core_avx2_k,@object
fd_sha512_core_avx2_k:
