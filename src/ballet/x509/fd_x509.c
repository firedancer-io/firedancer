...
fd_x509_serial_valid( uchar const * p,
  ...
  /* RFC 5280 requires a positive serial number no longer than 20 octets.
     ...
     Exception: serial 0 is allowed.  It is in the Mozilla root store:
       Hellenic Academic and Research Institutions ECC RootCA 2015
       sha256 44b545aa8a25e65a73ca15dc27fc36d24c1cb9953a066539b11582dc487b4833 */
  ...
  while( FD_DER_HAS_MORE( *c ) ) {
    ...
    if( fd_der_oid_match( oid_raw, oid_raw_len,
      ...
      /* DER zeroes the unused bits and trims trailing zero bits, so the
         ...
         Exception: a trailing zero octet is allowed.  Two Mozilla roots
         encode keyUsage as 07 06 00 instead of 01 06:
           Trustwave Global ECC P256 Certification Authority
           sha256 945bbc825ea554f489d1fd51a73ddf2ea624ac7019a05205225c22a78ccfa8b4
           Trustwave Global ECC P384 Certification Authority
           sha256 55903859c8c0c3ebb8759ece4e2557225ff5758bbd38ebd48276601e1bd58097 */
      ...
      } else if( FD_UNLIKELY( bs_len<3UL || !bs[1] ) ) {
        return -1;
      }
...
fd_x509_san_matches( fd_x509_cert_info_t const * info,
  ...
  /* An IPv4 literal is matched byte-for-byte against iPAddress SANs
     ...
     by fd_x509_dns_name_valid above; the HTTP clients are IPv4-only. */
