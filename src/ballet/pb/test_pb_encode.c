...
test_pb_encode_int64( void ) {
  ...
  fd_pb_encoder_t enc[1];
  FD_TEST( fd_pb_encoder_init( enc, buf, sizeof(buf) ) );
  FD_TEST( fd_pb_push_uint64( enc,  1, 0                    ) );
  FD_TEST( fd_pb_push_uint64( enc,  2, 0x000000000000007fUL ) ); /*  7 bits */
  FD_TEST( fd_pb_push_uint64( enc,  3, 0x0000000000000080UL ) );
  FD_TEST( fd_pb_push_uint64( enc,  4, 0x0000000000003fffUL ) ); /* 14 bits */
  FD_TEST( fd_pb_push_uint64( enc,  5, 0x0000000000004000UL ) );
  FD_TEST( fd_pb_push_uint64( enc,  6, 0x00000000001fffffUL ) ); /* 21 bits */
  FD_TEST( fd_pb_push_uint64( enc,  7, 0x0000000000200000UL ) );
  FD_TEST( fd_pb_push_uint64( enc,  8, 0x000000000fffffffUL ) ); /* 28 bits */
  FD_TEST( fd_pb_push_uint64( enc,  9, 0x0000000010000000UL ) );
  FD_TEST( fd_pb_push_uint64( enc, 10, INT_MAX              ) );
  FD_TEST( fd_pb_push_uint64( enc, 11, 0x00000007ffffffffUL ) ); /* 35 bits */
  FD_TEST( fd_pb_push_uint64( enc, 12, 0x0000000800000000UL ) );
  FD_TEST( fd_pb_push_uint64( enc, 13, 0x000003ffffffffffUL ) ); /* 42 bits */
  FD_TEST( fd_pb_push_uint64( enc, 14, 0x0000040000000000UL ) );
  FD_TEST( fd_pb_push_uint64( enc, 15, 0x0001ffffffffffffUL ) ); /* 49 bits */
  FD_TEST( fd_pb_push_uint64( enc, 16, 0x0002000000000000UL ) );
  FD_TEST( fd_pb_push_uint64( enc, 17, 0x00ffffffffffffffUL ) ); /* 56 bits */
  FD_TEST( fd_pb_push_uint64( enc, 18, 0x0100000000000000UL ) );
  FD_TEST( fd_pb_push_uint64( enc, 19, 0x7fffffffffffffffUL ) ); /* 63 bits */
  FD_TEST( fd_pb_push_uint64( enc, 20, 0x8000000000000000UL ) );
  FD_TEST( fd_pb_push_uint64( enc, 21, 0xffffffffffffffffUL ) ); /* 64 bits */
  uchar const expected[] = {
    0x08,       0x00,
    0x10,       0x7f,
    0x18,       0x80, 0x01,
