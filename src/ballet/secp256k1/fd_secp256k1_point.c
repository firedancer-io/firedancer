/* secp256k1 square root and group arithmetic, shared by both backends.
   Included by fd_secp256k1_private.h after the backend (fd_secp256k1_s2n.c
   or fd_secp256k1_ref.c) has defined the fd_secp256k1_fp_* and
   fd_secp256k1_scalar_* primitives. */
