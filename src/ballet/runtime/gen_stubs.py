...
fields_body_decode = {
    ...
    "int64_t" : lambda n, f: print("fd_bincode_uint64_decode((unsigned long *) &self->" + f["name"] + ", data, dataend);", file=body),
...
fields_body_encode = {
    ...
    "int64_t" : lambda n, f: print("fd_bincode_uint64_encode((unsigned long *) &self->" + f["name"] + ", data);", file=body),
