...
int test_1482(fd_executor_test_suite_t *suite) {
  ...
  test.disable_cnt = 47;
  uchar disabled_features[] = { 76,26,83,33,89,126,128,77,121,2,98,105,125,61,92,113,111,108,114,75,127,103,112,87,27,118,30,29,82,80,110,122,116,90,15,78,124,79,24,56,120,123,62,106,117,55,109 };
