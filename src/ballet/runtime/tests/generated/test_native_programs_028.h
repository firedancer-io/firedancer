...
int test_28(fd_executor_test_suite_t *suite) {
  ...
  test.disable_cnt = 47;
  uchar disabled_features[] = { 90,55,116,123,56,87,105,112,106,120,113,26,61,118,80,82,92,114,126,109,127,124,89,108,128,30,2,111,103,62,125,78,75,110,76,79,122,24,83,29,98,15,121,33,27,117,77 };
