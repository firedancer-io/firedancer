...
int test_1404(fd_executor_test_suite_t *suite) {
  ...
  static uchar const fd_flamenco_native_prog_test_1404_acc_0_data[] = { 0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00 };
  test_acc->data            = fd_flamenco_native_prog_test_1404_acc_0_data;
  test_acc->data_len        = 8UL;
  static uchar const fd_flamenco_native_prog_test_1404_acc_0_post_data[] = { 0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00 };
