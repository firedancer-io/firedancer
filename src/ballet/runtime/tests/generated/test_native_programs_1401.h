...
int test_1401(fd_executor_test_suite_t *suite) {
  ...
  static uchar const fd_flamenco_native_prog_test_1401_acc_0_data[] = { 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00 };
  test_acc->data            = fd_flamenco_native_prog_test_1401_acc_0_data;
  test_acc->data_len        = 8UL;
  static uchar const fd_flamenco_native_prog_test_1401_acc_0_post_data[] = { 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00 };
