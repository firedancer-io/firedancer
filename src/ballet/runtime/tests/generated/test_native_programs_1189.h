...
int test_1189(fd_executor_test_suite_t *suite) {
  ...
  test.disable_cnt = 47;
  uchar disabled_features[] = { 83,80,126,116,87,108,110,75,24,122,76,128,123,15,26,121,33,92,124,61,105,90,56,27,2,114,62,103,79,82,98,55,109,77,113,29,106,78,89,117,111,125,30,112,118,127,120 };
