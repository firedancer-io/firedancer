...
fd_bincode_uint32_decode(&self->units, data, dataend);
fd_bincode_uint32_decode(&self->additional_fee, data, dataend);
}
...
fd_bincode_uint32_encode(&self->units, data);
fd_bincode_uint32_encode(&self->additional_fee, data);
}
...
void fd_compute_budget_program_instruction_inner_decode(fd_compute_budget_program_instruction_inner_t* self, uint discriminant, void const** data, void const* dataend, fd_alloc_fun_t allocf, void* allocf_arg) {
  switch (discriminant) {
  case 0: {
  fd_compute_budget_program_instruction_request_units_deprecated_decode(&self->request_units_deprecated, data, dataend, allocf, allocf_arg);
   break;
   }
  case 1: {
fd_bincode_uint32_decode(&self->request_heap_frame, data, dataend);
   break;
   }
  case 2: {
fd_bincode_uint32_decode(&self->set_compute_unit_limit, data, dataend);
   break;
   }
  case 3: {
fd_bincode_uint64_decode(&self->set_compute_unit_price, data, dataend);
   break;
   }
default: FD_LOG_ERR(( "unhandled type"));
}}
void fd_compute_budget_program_instruction_decode(fd_compute_budget_program_instruction_t* self, void const** data, void const* dataend, fd_alloc_fun_t allocf, void* allocf_arg) {
  fd_bincode_uint32_decode(&self->discriminant, data, dataend);
  fd_compute_budget_program_instruction_inner_decode(&self->inner, self->discriminant, data, dataend, allocf, allocf_arg);
}
void fd_compute_budget_program_instruction_inner_destroy(fd_compute_budget_program_instruction_inner_t* self, uint discriminant, fd_free_fun_t freef, void* freef_arg) {
  switch (discriminant) {
  case 0: {
  fd_compute_budget_program_instruction_request_units_deprecated_destroy(&self->request_units_deprecated, freef, freef_arg);
   break;
   }
  case 1: {
   break;
...
void fd_compute_budget_program_instruction_destroy(fd_compute_budget_program_instruction_t* self, fd_free_fun_t freef, void* freef_arg) {
  fd_compute_budget_program_instruction_inner_destroy(&self->inner, self->discriminant, freef, freef_arg);
}
...
void fd_compute_budget_program_instruction_inner_encode(fd_compute_budget_program_instruction_inner_t* self, uint discriminant, void const** data) {
  switch (discriminant) {
  case 0: {
  fd_compute_budget_program_instruction_request_units_deprecated_encode(&self->request_units_deprecated, data);
  break; }
  case 1: {
fd_bincode_uint32_encode(&self->request_heap_frame, data);
  break; }
  case 2: {
fd_bincode_uint32_encode(&self->set_compute_unit_limit, data);
  break; }
  case 3: {
fd_bincode_uint64_encode(&self->set_compute_unit_price, data);
  break; }
}
}
void fd_compute_budget_program_instruction_encode(fd_compute_budget_program_instruction_t* self, void const** data) {
  fd_bincode_uint32_encode(&self->discriminant, data);
  fd_compute_budget_program_instruction_inner_encode(&self->inner, self->discriminant, data);
}
