...
$(call add-hdrs,fd_banks_solana.h fd_rocksdb.h fd_executor.h fd_acc_mgr.h fd_hashes.h fd_types.h fd_types_custom.h fd_runtime.h fd_features.h)
...
$(call add-objs,fd_features fd_banks_solana fd_rocksdb fd_executor fd_acc_mgr fd_hashes fd_types fd_runtime tests/fd_tests,fd_ballet)
