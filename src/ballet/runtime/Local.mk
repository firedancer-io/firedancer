...
$(call add-hdrs,program/fd_system_program.h program/fd_vote_program.h program/fd_builtin_programs.h program/fd_stake_program.h program/fd_compute_budget_program.h)
...
$(call add-objs,program/fd_system_program program/fd_nonce_program program/fd_vote_program program/fd_builtin_programs program/fd_stake_program program/fd_compute_budget_program,fd_ballet)

$(call make-unit-test,tests/test_native_programs,tests/test_native_programs,fd_ballet fd_funk fd_util tests/fd_tests)
