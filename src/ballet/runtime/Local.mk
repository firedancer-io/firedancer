...
$(call add-hdrs,program/fd_system_program.h program/fd_vote_program.h program/fd_builtin_programs.h)
...
$(call add-objs,program/fd_system_program program/fd_vote_program program/fd_builtin_programs,fd_ballet)
