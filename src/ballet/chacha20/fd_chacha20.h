...
/*
  This method generates a cryptographically secure random number, it expects a key (32 bytes) param, as well as a buffer
  to store the generated number, passed as 'random_number' param (fd_chacha20_rng_t)
*/
void fd_chacha20_generate_random_number(const uchar *key, fd_chacha20_rng_t *random_number);
