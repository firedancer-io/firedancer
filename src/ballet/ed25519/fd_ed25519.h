...
/* fd_ed25519_sign_batch8 signs n independent messages, n in [1,8]
   ...
   fd_ed25519_sign of the same (msg, key) pair.  For n>=2 the
   ...
   public_key and private_key are assumed to point to the first byte of
   n*32-byte memory regions holding the n public / private keys (key i
   at offset 32*i).
