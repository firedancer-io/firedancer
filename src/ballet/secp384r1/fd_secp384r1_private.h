...
/* 1 in Montgomery form: R mod p  (verified by gen_consts) */
...
/* a = -3 in Montgomery form  (verified by gen_consts) */
...
/* b in Montgomery form  (verified by gen_consts) */
...
static const fd_secp384r1_scalar_t fd_secp384r1_const_n_m1_half[1] = {{{
  0x76760CB566629CB9UL, 0xAC0D06D924585BBDUL, 0xE3B1A6C0FA1B96EFUL,
...
/* Generator G in Jacobian Montgomery form (Gx_mont, Gy_mont, 1_mont).
   18 ulongs = 3 coords * 6 limbs.  (verified by gen_consts) */
