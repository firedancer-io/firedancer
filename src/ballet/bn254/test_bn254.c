...
int main( int     argc,
  ...
  {
    static const fd_bn254_point_g1_t g1_1 = { .v={ 28, 118, 71, 111,
        77, 239, 75, 185, 69, 65, 213, 126, 187, 161, 25, 51, 129, 255,
        167, 170, 118, 173, 166, 100, 221, 49, 193, 96, 36, 196, 63, 89,
        48, 52, 221, 41, 32, 246, 115, 226, 4, 254, 226, 129, 28, 103,
        135, 69, 252, 129, 155, 85, 211, 233, 210, 148, 228, 92, 155, 3,
        167, 106, 239, 65 } };
    static const fd_bn254_point_g2_t g2_1 = { .v={ 32, 157, 209, 94,
        191, 245, 212, 108, 75, 216, 136, 229, 26, 147, 207, 153, 167, 50,
        150, 54, 198, 53, 20, 57, 107, 74, 69, 32, 3, 163, 91, 247, 4,
        191, 17, 202, 1, 72, 59, 250, 139, 52, 180, 53, 97, 132, 141, 40,
        144, 89, 96, 17, 76, 138, 192, 64, 73, 175, 75, 99, 21, 164, 22,
        120, 43, 184, 50, 74, 246, 207, 201, 53, 55, 162, 173, 26, 68, 92,
        253, 12, 162, 167, 26, 205, 122, 196, 31, 173, 191, 147, 60, 42,
        81, 190, 52, 77, 18, 10, 42, 76, 243, 12, 27, 249, 132, 95, 32,
        198, 254, 57, 224, 126, 162, 204, 230, 31, 12, 155, 176, 72, 22,
        95, 229, 228, 222, 135, 117, 80 } };
    static const fd_bn254_point_g1_t g1_2 = { .v={ 17, 30, 18, 159,
        28, 241, 9, 119, 16, 212, 28, 74, 199, 15, 205, 250, 91, 162, 2,
        60, 111, 241, 203, 234, 195, 34, 222, 73, 209, 182, 223, 124, 32,
        50, 198, 26, 131, 14, 60, 23, 40, 109, 233, 70, 43, 242, 66, 252,
        162, 136, 53, 133, 185, 56, 112, 167, 56, 83, 250, 206, 106, 107,
        244, 17 } };
    static const fd_bn254_point_g2_t g2_2 = { .v={ 25, 142, 147, 147,
        146, 13, 72, 58, 114, 96, 191, 183, 49, 251, 93, 37, 241, 170, 73,
        51, 53, 169, 231, 18, 151, 228, 133, 183, 174, 243, 18, 194, 24,
        0, 222, 239, 18, 31, 30, 118, 66, 106, 0, 102, 94, 92, 68, 121,
        103, 67, 34, 212, 247, 94, 218, 221, 70, 222, 189, 92, 217, 146,
        246, 237, 9, 6, 137, 208, 88, 95, 240, 117, 236, 158, 153, 173,
        105, 12, 51, 149, 188, 75, 49, 51, 112, 179, 142, 243, 85, 172,
        218, 220, 209, 34, 151, 91, 18, 200, 94, 165, 219, 140, 109, 235,
        74, 171, 113, 128, 141, 203, 64, 143, 227, 209, 231, 105, 12, 67,
        211, 123, 76, 230, 204, 1, 102, 250, 125, 170 } };
    FD_TEST(fd_bn254_pairing(&g1_1, &g2_1, &g1_2, &g2_2));
  }
