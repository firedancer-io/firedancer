...
static const uchar FD_SBPF_OP_JEQ32_IMM =   FD_SBPF_DEFINE_NORM_INSTR(FD_SBPF_OPCODE_CLASS_JMP32, FD_SBPF_OPCODE_JMP_OP_MODE_JEQ,  FD_SBPF_OPCODE_SOURCE_MODE_IMM);
static const uchar FD_SBPF_OP_JEQ32_REG =   FD_SBPF_DEFINE_NORM_INSTR(FD_SBPF_OPCODE_CLASS_JMP32, FD_SBPF_OPCODE_JMP_OP_MODE_JEQ,  FD_SBPF_OPCODE_SOURCE_MODE_REG);
static const uchar FD_SBPF_OP_JGT32_IMM =   FD_SBPF_DEFINE_NORM_INSTR(FD_SBPF_OPCODE_CLASS_JMP32, FD_SBPF_OPCODE_JMP_OP_MODE_JGT,  FD_SBPF_OPCODE_SOURCE_MODE_IMM);
static const uchar FD_SBPF_OP_JGT32_REG =   FD_SBPF_DEFINE_NORM_INSTR(FD_SBPF_OPCODE_CLASS_JMP32, FD_SBPF_OPCODE_JMP_OP_MODE_JGT,  FD_SBPF_OPCODE_SOURCE_MODE_REG);
static const uchar FD_SBPF_OP_JGE32_IMM =   FD_SBPF_DEFINE_NORM_INSTR(FD_SBPF_OPCODE_CLASS_JMP32, FD_SBPF_OPCODE_JMP_OP_MODE_JGE,  FD_SBPF_OPCODE_SOURCE_MODE_IMM);
static const uchar FD_SBPF_OP_JGE32_REG =   FD_SBPF_DEFINE_NORM_INSTR(FD_SBPF_OPCODE_CLASS_JMP32, FD_SBPF_OPCODE_JMP_OP_MODE_JGE,  FD_SBPF_OPCODE_SOURCE_MODE_REG);
static const uchar FD_SBPF_OP_JSET32_IMM =  FD_SBPF_DEFINE_NORM_INSTR(FD_SBPF_OPCODE_CLASS_JMP32, FD_SBPF_OPCODE_JMP_OP_MODE_JSET, FD_SBPF_OPCODE_SOURCE_MODE_IMM);
static const uchar FD_SBPF_OP_JSET32_REG =  FD_SBPF_DEFINE_NORM_INSTR(FD_SBPF_OPCODE_CLASS_JMP32, FD_SBPF_OPCODE_JMP_OP_MODE_JSET, FD_SBPF_OPCODE_SOURCE_MODE_REG);
static const uchar FD_SBPF_OP_JNE32_IMM =   FD_SBPF_DEFINE_NORM_INSTR(FD_SBPF_OPCODE_CLASS_JMP32, FD_SBPF_OPCODE_JMP_OP_MODE_JNE,  FD_SBPF_OPCODE_SOURCE_MODE_IMM);
static const uchar FD_SBPF_OP_JNE32_REG =   FD_SBPF_DEFINE_NORM_INSTR(FD_SBPF_OPCODE_CLASS_JMP32, FD_SBPF_OPCODE_JMP_OP_MODE_JNE,  FD_SBPF_OPCODE_SOURCE_MODE_REG);
static const uchar FD_SBPF_OP_JSGT32_IMM =  FD_SBPF_DEFINE_NORM_INSTR(FD_SBPF_OPCODE_CLASS_JMP32, FD_SBPF_OPCODE_JMP_OP_MODE_JSGT, FD_SBPF_OPCODE_SOURCE_MODE_IMM);
static const uchar FD_SBPF_OP_JSGT32_REG =  FD_SBPF_DEFINE_NORM_INSTR(FD_SBPF_OPCODE_CLASS_JMP32, FD_SBPF_OPCODE_JMP_OP_MODE_JSGT, FD_SBPF_OPCODE_SOURCE_MODE_REG);
static const uchar FD_SBPF_OP_JSGE32_IMM =  FD_SBPF_DEFINE_NORM_INSTR(FD_SBPF_OPCODE_CLASS_JMP32, FD_SBPF_OPCODE_JMP_OP_MODE_JSGE, FD_SBPF_OPCODE_SOURCE_MODE_IMM);
static const uchar FD_SBPF_OP_JSGE32_REG =  FD_SBPF_DEFINE_NORM_INSTR(FD_SBPF_OPCODE_CLASS_JMP32, FD_SBPF_OPCODE_JMP_OP_MODE_JSGE, FD_SBPF_OPCODE_SOURCE_MODE_REG);
static const uchar FD_SBPF_OP_JLT32_IMM =   FD_SBPF_DEFINE_NORM_INSTR(FD_SBPF_OPCODE_CLASS_JMP32, FD_SBPF_OPCODE_JMP_OP_MODE_JLT,  FD_SBPF_OPCODE_SOURCE_MODE_IMM);
static const uchar FD_SBPF_OP_JLT32_REG =   FD_SBPF_DEFINE_NORM_INSTR(FD_SBPF_OPCODE_CLASS_JMP32, FD_SBPF_OPCODE_JMP_OP_MODE_JLT,  FD_SBPF_OPCODE_SOURCE_MODE_REG);
static const uchar FD_SBPF_OP_JLE32_IMM =   FD_SBPF_DEFINE_NORM_INSTR(FD_SBPF_OPCODE_CLASS_JMP32, FD_SBPF_OPCODE_JMP_OP_MODE_JLE,  FD_SBPF_OPCODE_SOURCE_MODE_IMM);
static const uchar FD_SBPF_OP_JLE32_REG =   FD_SBPF_DEFINE_NORM_INSTR(FD_SBPF_OPCODE_CLASS_JMP32, FD_SBPF_OPCODE_JMP_OP_MODE_JLE,  FD_SBPF_OPCODE_SOURCE_MODE_REG);
static const uchar FD_SBPF_OP_JSLT32_IMM =  FD_SBPF_DEFINE_NORM_INSTR(FD_SBPF_OPCODE_CLASS_JMP32, FD_SBPF_OPCODE_JMP_OP_MODE_JSLT, FD_SBPF_OPCODE_SOURCE_MODE_IMM);
static const uchar FD_SBPF_OP_JSLT32_REG =  FD_SBPF_DEFINE_NORM_INSTR(FD_SBPF_OPCODE_CLASS_JMP32, FD_SBPF_OPCODE_JMP_OP_MODE_JSLT, FD_SBPF_OPCODE_SOURCE_MODE_REG);
static const uchar FD_SBPF_OP_JSLE32_IMM =  FD_SBPF_DEFINE_NORM_INSTR(FD_SBPF_OPCODE_CLASS_JMP32, FD_SBPF_OPCODE_JMP_OP_MODE_JSLE, FD_SBPF_OPCODE_SOURCE_MODE_IMM);
static const uchar FD_SBPF_OP_JSLE32_REG =  FD_SBPF_DEFINE_NORM_INSTR(FD_SBPF_OPCODE_CLASS_JMP32, FD_SBPF_OPCODE_JMP_OP_MODE_JSLE, FD_SBPF_OPCODE_SOURCE_MODE_REG);
