#ifndef HEADER_fd_src_ballet_sbpf_fd_opcodes_h
#define HEADER_fd_src_ballet_sbpf_fd_opcodes_h
...
#define FD_SBPF_OPCODE_SIZE_MODE_QUAD (0x3) /* (0b11) */ /* eBPF only */
...
/* FIXME This should be FD_SBPF_OP_LDDW */
static const uchar FD_SBPF_OP_LDQ =   FD_SBPF_DEFINE_MEM_INSTR(FD_SBPF_OPCODE_CLASS_LD,   FD_SBPF_OPCODE_ADDR_MODE_IMM,  FD_SBPF_OPCODE_SIZE_MODE_QUAD);
...
static const uchar FD_SBPF_OP_LDXQ =  FD_SBPF_DEFINE_MEM_INSTR(FD_SBPF_OPCODE_CLASS_LDX,  FD_SBPF_OPCODE_ADDR_MODE_MEM,  FD_SBPF_OPCODE_SIZE_MODE_QUAD);
...
static const uchar FD_SBPF_OP_STQ =   FD_SBPF_DEFINE_MEM_INSTR(FD_SBPF_OPCODE_CLASS_ST,  FD_SBPF_OPCODE_ADDR_MODE_MEM,  FD_SBPF_OPCODE_SIZE_MODE_QUAD);
...
static const uchar FD_SBPF_OP_STXQ =  FD_SBPF_DEFINE_MEM_INSTR(FD_SBPF_OPCODE_CLASS_STX,  FD_SBPF_OPCODE_ADDR_MODE_MEM,  FD_SBPF_OPCODE_SIZE_MODE_QUAD);

static const uchar FD_SBPF_OP_ADDL_IMM = (0x00); /* (0b00000000) */

#endif // HEADER_fd_src_ballet_sbpf_fd_opcodes_h
