#include "../fd_ballet.h"
<<<<<<< PATCH SET (f52b67 sha256: add test program and CAVP test vectors)
...
#include "cavp/sha256_short.inc"
#include "cavp/sha256_long.inc"
#endif

static void
test_sha256_vectors( fd_sha256_test_vector_t const * vec,
                     fd_sha256_t *                   sha,
                     fd_rng_t *                      rng ) {
...
# ifdef HAS_CAVP_TEST_VECTORS
  ...
  test_sha256_vectors( cavp_sha256_short, sha, rng );
  FD_LOG_NOTICE(( "OK: CAVP SHA256ShortMsg.rsp" ));
  test_sha256_vectors( cavp_sha256_long,  sha, rng );
  FD_LOG_NOTICE(( "OK: CAVP SHA256LongMsg.rsp" ));
# endif
