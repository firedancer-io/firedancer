...
main( int     argc,
  ...
  do {
    ulong  batch_data [ 8 ]; for( uint i=0; i<8; i++ ) batch_data [i] = (ulong)( block_in + 1024*i );
  ...
  do {
    ulong  batch_data [ 16 ]; for( uint i=0; i<16; i++ ) batch_data [i] = (ulong)( block_in + 1024*i );
