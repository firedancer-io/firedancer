...
static uchar const base58_inverse_full[ 256 ];
...
/* Direct byte lookup used by the fixed-width decoder.  The 256-entry
   table folds range checking and alphabet conversion into one load. */
static uchar const base58_inverse_full[ 256 ] = {
