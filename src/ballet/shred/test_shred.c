...
FD_STATIC_ASSERT( fd_offsetof( fd_shred_t, signature       )==0x00, unit_test );
FD_STATIC_ASSERT( fd_offsetof( fd_shred_t, variant         )==0x40, unit_test );
FD_STATIC_ASSERT( fd_offsetof( fd_shred_t, slot            )==0x41, unit_test );
FD_STATIC_ASSERT( fd_offsetof( fd_shred_t, idx             )==0x49, unit_test );
FD_STATIC_ASSERT( fd_offsetof( fd_shred_t, version         )==0x4d, unit_test );
FD_STATIC_ASSERT( fd_offsetof( fd_shred_t, fec_set_idx     )==0x4f, unit_test );

FD_STATIC_ASSERT( fd_offsetof( fd_shred_t, code.data_cnt   )==0x53, unit_test );
FD_STATIC_ASSERT( fd_offsetof( fd_shred_t, code.code_cnt   )==0x55, unit_test );
FD_STATIC_ASSERT( fd_offsetof( fd_shred_t, code.idx        )==0x57, unit_test );

FD_STATIC_ASSERT( fd_offsetof( fd_shred_t, data.parent_off )==0x53, unit_test );
FD_STATIC_ASSERT( fd_offsetof( fd_shred_t, data.flags      )==0x55, unit_test );
FD_STATIC_ASSERT( fd_offsetof( fd_shred_t, data.size       )==0x56, unit_test );
