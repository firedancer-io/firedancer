...
test_secp256r1_verify( FD_FN_UNUSED fd_rng_t * rng ) {
  ...
  fd_hex_decode( pub, "02d8c82b3791c8b51cfe44aa50226217159596ca26e6075aaf8bf8be2d351b96ae", 33 );
  {
    ...
    FD_TEST( fd_secp256r1_verify_allow_high_s( msg, msg_sz, sig, pub, sha )==FD_SECP256R1_SUCCESS );
  }
  ...
  memset( sig, 0, 32UL );
  FD_TEST( fd_secp256r1_verify_allow_high_s( msg, msg_sz, sig, pub, sha )==FD_SECP256R1_FAILURE );
