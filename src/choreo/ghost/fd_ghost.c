...
fd_ghost_new( void * shmem,
  ...
  ghost->blk_pool = blk_pool_join( blk_pool_new( blk_pool, blk_max             ) );
  ghost->blk_map  = blk_map_join ( blk_map_new ( blk_map,  blk_chain_cnt, seed ) );
  ghost->vtr_pool = vtr_pool_join( vtr_pool_new( vtr_pool, vtr_max             ) );
  ghost->vtr_map  = vtr_map_join ( vtr_map_new ( vtr_map,  vtr_chain_cnt, seed ) );
