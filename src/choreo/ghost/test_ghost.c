...
test_ghost_simple( fd_wksp_t * wksp ) {
  ...
  fd_voter_t voter[1]  = { { .key = {{1}}, .stake = 1 } };
...
test_ghost_head( fd_wksp_t * wksp ){
  ...
  fd_voter_t v1[1]  = { { .key = {{1}}, .stake = 50 } };
  fd_voter_t v2[1]  = { { .key = {{2}}, .stake = 100 } };
...
test_rooted_vote( fd_wksp_t * wksp ){
  ...
  fd_voter_t v1[1]  = { { .key = {{1}}, .stake = 20 } };
  fd_voter_t v2[1]  = { { .key = {{2}}, .stake = 10 } };
