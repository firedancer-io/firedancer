...
void
fd_epoch_init( fd_epoch_t * epoch, fd_vote_accounts_t const * vote_accounts ) {
  fd_epoch_update( epoch, vote_accounts );
}

void
fd_epoch_update( fd_epoch_t * epoch, fd_vote_accounts_t const * vote_accounts ) {
