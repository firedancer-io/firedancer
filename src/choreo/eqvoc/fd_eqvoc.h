...
#define FD_EQVOC_ERR_SZ        (-1) /* wrong serialized size vs. expected for shred type */
#define FD_EQVOC_ERR_SLOT      (-2) /* different slot */
#define FD_EQVOC_ERR_VERSION   (-3) /* different shred version */
#define FD_EQVOC_ERR_TYPE      (-4) /* wrong shred type (must be chained {resigned} merkle) */
#define FD_EQVOC_ERR_MERKLE    (-5) /* merkle root failed */
#define FD_EQVOC_ERR_SIGNATURE (-6) /* sigverify of leader failed */
