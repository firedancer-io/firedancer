...
test_vote_simple( fd_wksp_t * wksp ) {
  ...
  fd_funk_t funk_mem[1];
  fd_funk_t * funk = fd_funk_open_file( funk_mem, "", 1, 0, 1000, 100, 1*(1UL<<30), FD_FUNK_OVERWRITE, &funk_close_args );
  FD_TEST( funk );
...
test_vote_switch_check_testnet_forks( fd_wksp_t * wksp ) {
  ...
  fd_funk_close_file_args_t funk_close_args;
  fd_funk_t funk_mem[1];
  fd_funk_t * funk = fd_funk_open_file( funk_mem, "", 1, 0, 1000, 1000, 1*(1UL<<30), FD_FUNK_OVERWRITE, &funk_close_args );
  FD_TEST( funk );
...
#define THRESHOLD_DEPTH         (8)
...

  {
    ...
    FD_TEST( 1==fd_tower_threshold_check( tower, epoch1, funk, query->ele, THRESHOLD_DEPTH, scratch ) );
    ...
    //FD_TEST( 0==fd_tower_threshold_check( tower, epoch1, funk, query->ele, THRESHOLD_DEPTH, scratch ) );
