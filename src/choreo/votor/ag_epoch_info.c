...
FD_FN_PURE int
ag_epoch_info_is_genesis_quorum( ag_epoch_info_t const * self, ulong stake ) {
  return fraction_is_met( stake, self->total_stake, AG_GENESIS_QUORUM_THRESHOLD_NUMER, AG_GENESIS_QUORUM_THRESHOLD_DENOM );
}
