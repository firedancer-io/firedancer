...
struct ag_slot_voted_stake_hash {
  ...
  ag_bls_pub_t    pub;
  ag_bls_sig_t    agg;
  ag_bls_set_t    set[ ag_bls_set_word_cnt ];
};
...
struct ag_slot_voted_stake {
  ...
  ag_bls_set_t               skip_set[ ag_bls_set_word_cnt ];
  ulong                      skip_fallback;
  ag_bls_pub_t               skip_fallback_pub;
  ag_bls_sig_t               skip_fallback_agg;
  ag_bls_set_t               skip_fallback_set[ ag_bls_set_word_cnt ];
  ulong                      finalize;
  ag_bls_pub_t               finalize_pub;
  ag_bls_sig_t               finalize_agg;
  ag_bls_set_t               finalize_set[ ag_bls_set_word_cnt ];
  ulong                      notar_or_skip;
  ulong                      top_notar;
};
