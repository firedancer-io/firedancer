$(call add-hdrs,ag_votor_base.h ag_bls_serde.h ag_vote.h ag_vote_serde.h ag_epoch_info.h ag_cert.h ag_cert_serde.h ag_hist.h ag_hist_file.h ag_event.h ag_pool.h ag_slot_state.h ag_finality_tracker.h ag_parent_ready_tracker.h ag_votor.h)
$(call add-objs,ag_bls_serde ag_vote ag_vote_serde ag_epoch_info ag_cert ag_cert_serde ag_hist ag_hist_file ag_pool ag_slot_state ag_finality_tracker ag_parent_ready_tracker ag_votor,fd_choreo)
...
$(call make-unit-test,test_ag_hist,test_ag_hist,fd_choreo fd_ballet fd_util)
$(call make-unit-test,test_ag_hist_file,test_ag_hist_file,fd_choreo fd_ballet fd_util)
$(call make-fuzz-test,fuzz_ag_hist_file,fuzz_ag_hist_file,fd_choreo fd_ballet fd_util)
...
$(call make-unit-test,test_ag_votor_failover,test_ag_votor_failover,fd_choreo fd_ballet fd_util)
...
$(call run-unit-test,test_ag_hist)
$(call run-unit-test,test_ag_hist_file)
...
$(call run-unit-test,test_ag_votor_failover)
endif
