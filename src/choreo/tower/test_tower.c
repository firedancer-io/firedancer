...
test_switch_check_simple( fd_wksp_t * wksp ) {
  ...
  */
  ...
  make_vote_account( &(fd_hash_t){.ul = {1}}, 20, 5, 1, &acct );
  fd_forks_add_lockouts( forks, 5, &acct.addr, &acct );
  ulong prev = fd_epoch_stakes_slot_stakes_add( epoch_stakes, 5, &acct.addr, acct.stake, ULONG_MAX );

  make_vote_account( &(fd_hash_t){.ul = {2}}, 20, 5, 1, &acct );
  fd_forks_add_lockouts( forks, 5, &acct.addr, &acct );
  prev = fd_epoch_stakes_slot_stakes_add( epoch_stakes, 5, &acct.addr, acct.stake, prev );

  make_vote_account( &(fd_hash_t){.ul = {3}}, 20, 5, 1, &acct );
  fd_forks_add_lockouts( forks, 5, &acct.addr, &acct );
  prev = fd_epoch_stakes_slot_stakes_add( epoch_stakes, 5, &acct.addr, acct.stake, prev );

  make_vote_account( &(fd_hash_t){.ul = {4}}, 20, 5, 1, &acct );
  fd_forks_add_lockouts( forks, 5, &acct.addr, &acct );
  prev = fd_epoch_stakes_slot_stakes_add( epoch_stakes, 5, &acct.addr, acct.stake, prev );
...
test_switch_threshold( fd_wksp_t * wksp ) {
  ...
  */
  ...
  fd_forks_add_lockouts( forks, 50, &acct.addr, &acct );
  ...
  fd_forks_add_lockouts( forks, 14, &acct.addr, &acct );
  ...
  fd_forks_add_lockouts( forks, 13, &acct.addr, &acct );
...
test_switch_threshold_common_ancestor( fd_wksp_t * wksp ) {
  ...
  fd_forks_add_lockouts( forks, 51, &acct.addr, &acct );
  ...
  fd_forks_clear_lockouts( forks, 51 );

  fd_forks_add_lockouts( forks, 112, &acct.addr, &acct );
  fd_epoch_stakes_slot_stakes_add( epoch_stakes, 112, &acct.addr, acct.stake, ULONG_MAX );
  FD_TEST( switch_check( tower, forks, epoch_stakes, total_stake, 111 ) == 1 );
  fd_forks_clear_lockouts( forks, 112 );

  fd_forks_add_lockouts( forks, 113, &acct.addr, &acct );
  fd_epoch_stakes_slot_stakes_add( epoch_stakes, 113, &acct.addr, acct.stake, ULONG_MAX );
  FD_TEST( switch_check( tower, forks, epoch_stakes, total_stake, 111 ) == 1 );
  fd_forks_clear_lockouts( forks, 113 );
}
