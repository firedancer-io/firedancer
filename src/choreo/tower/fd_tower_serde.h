...
/* fd_compact_tower_sync_de deserializes at most buf_sz of buf into
   ...
   not whether the resulting tower is semantically valid (e.g. slots and
   confirmations are monotonically increasing).  Callers must validate
   the deserialized tower contents separately. */
