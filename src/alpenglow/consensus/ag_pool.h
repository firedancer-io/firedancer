...
/* AddCertError (pool.rs). */

#define AG_ADD_CERT_ERR_SLOT_OUT_OF_BOUNDS (-1)
#define AG_ADD_CERT_ERR_THRESHOLD_NOT_MET  (-2)
#define AG_ADD_CERT_ERR_INVALID_SIGNATURE  (-3)
#define AG_ADD_CERT_ERR_DUPLICATE          (-4)
