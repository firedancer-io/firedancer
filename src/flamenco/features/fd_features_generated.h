...
#define FD_FEATURE_ID_CNT (297UL)

/* Feature set ID calculated from all feature names */
#define FD_FEATURE_SET_ID (1438446620U)
...
union fd_features {
  ...
  struct {
    ...
    /* 0x3d030a2e7e893d06 */ ulong remove_inactive_stakes;
    ...
    /* 0x5dcee0d9dcbaa456 */ ulong enable_get_leader_syscall;
  };
};
