...
#define FD_FEATURE_SET_ID (4242254245U)
...
union fd_features {
  ...
  struct {
    ...
    /* 0x8321f88bec76cb0e */ ulong reenable_zk_elgamal_proof_program;
    ...
    /* 0x1d0a91b3be4013c5 */ ulong bls_pubkey_management_in_vote_account;
  };
};
