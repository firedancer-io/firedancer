...
#define FD_FEATURE_JUST_ACTIVATED(_bank, _feature_name)                   FD_FEATURE_JUST_ACTIVATED_( _bank->slot, fd_bank_features_get(_bank), _feature_name )
#define FD_FEATURE_ACTIVE_OFFSET(_slot, _features, _offset)               FD_FEATURE_ACTIVE_OFFSET_( _slot, _features, _offset )
#define FD_FEATURE_JUST_ACTIVATED_OFFSET(_bank, _offset)                  FD_FEATURE_JUST_ACTIVATED_OFFSET_( _bank->slot, fd_bank_features_get(_bank), _offset )
