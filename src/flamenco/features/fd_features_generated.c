...
#define MAP_PERFECT_297 0x0aa7b29de47f96cbUL, .val = &ids[297]
...
FD_STATIC_ASSERT( offsetof( fd_features_t, loader_v3_set_program_data_to_elf_length                )>>3==297UL, layout );
