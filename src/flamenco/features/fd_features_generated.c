...
fd_feature_id_query( ulong prefix ) {
  ...
  case 0x2f5861dc0250fba3: return &ids[ 242 ];
  case 0xa641f5942ffa690c: return &ids[ 243 ];
  default: break;
  }
  return NULL;
}
...
FD_STATIC_ASSERT( offsetof( fd_features_t, stricter_abi_and_runtime_constraints                    )>>3==242UL, layout );
FD_STATIC_ASSERT( offsetof( fd_features_t, direct_mapping_2                                        )>>3==243UL, layout );
