...
fd_feature_id_t const ids[] = {
  ...
  { .index                     = offsetof(fd_features_t, stricter_abi_and_runtime_constraints)>>3,
    .id                        = {"\xa3\xfb\x50\x02\xdc\x61\x58\x2f\xd6\x48\x60\x65\xfe\xd6\x2c\x80\x58\x9a\xe4\x0b\x2e\xab\x5c\x6a\xa2\xcd\xc9\xe9\x66\xbd\x7a\xec"},
                                 /* C37iaPi6VE4CZDueU1vL8y6pGp5i8amAbEsF31xzz723 */
    .name                      = "stricter_abi_and_runtime_constraints",
    .cleaned_up                = {UINT_MAX, UINT_MAX, UINT_MAX} },

  { .index                     = offsetof(fd_features_t, direct_mapping_2)>>3,
    .id                        = {"\x0c\x69\xfa\x2f\x94\xf5\x41\xa6\x11\x20\xf3\x08\xd0\x6d\x8a\xb6\xdb\x94\xbd\xef\xfb\x53\x48\x8f\xa3\xf2\x1f\x10\x0a\x37\x4a\x8f"},
                                 /* qTcv56zqjacegAfYXCciP1TAz7J4w6G43263C1ugD4S */
    .name                      = "direct_mapping_2",
    .cleaned_up                = {UINT_MAX, UINT_MAX, UINT_MAX} },
...
fd_feature_id_query( ulong prefix ) {
  ...
  case 0x2f5861dc0250fba3: return &ids[ 240 ];
  case 0xa641f5942ffa690c: return &ids[ 241 ];
  default: break;
  }
  return NULL;
}
...
FD_STATIC_ASSERT( offsetof( fd_features_t, stricter_abi_and_runtime_constraints                    )>>3==240UL, layout );
FD_STATIC_ASSERT( offsetof( fd_features_t, direct_mapping_2                                        )>>3==241UL, layout );
