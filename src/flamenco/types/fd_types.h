...
FD_FN_UNUSED static fd_slot_pair_t *fd_hard_forks_hard_forks_join(fd_hard_forks_global_t const *struct_mem)
{ // vector
...
FD_FN_UNUSED static uchar *fd_solana_account_data_join(fd_solana_account_global_t const *struct_mem)
{ // vector
...
FD_FN_UNUSED static uchar *fd_string_pubkey_pair_string_join(fd_string_pubkey_pair_global_t const *struct_mem)
{ // vector
...
FD_FN_UNUSED static fd_pubkey_account_pair_global_t *fd_genesis_solana_accounts_join(fd_genesis_solana_global_t const *struct_mem)
{ // vector
...
FD_FN_UNUSED static fd_string_pubkey_pair_global_t *fd_genesis_solana_native_instruction_processors_join(fd_genesis_solana_global_t const *struct_mem)
{ // vector
...
FD_FN_UNUSED static fd_pubkey_account_pair_global_t *fd_genesis_solana_rewards_pools_join(fd_genesis_solana_global_t const *struct_mem)
{ // vector
...
{
  if (FD_UNLIKELY(0 == max))
    max = 1; // prevent underflow
...
{
  if (FD_UNLIKELY(0 == num))
    num = 1; // prevent underflow
...
static FD_FN_UNUSED fd_slot_hash_t *fd_slot_hashes_hashes_join(fd_slot_hashes_global_t *type)
{ // deque
...
static FD_FN_UNUSED fd_block_block_hash_entry_t *fd_recent_block_hashes_hashes_join(fd_recent_block_hashes_global_t *type)
{ // deque
...
static inline ulong fd_fee_calculator_size(fd_fee_calculator_t const *self)
{
  (void)self;
  return 8UL;
}
...
static inline int fd_fee_calculator_decode_footprint(fd_bincode_decode_ctx_t *ctx, ulong *total_sz)
{
  *total_sz += sizeof(fd_fee_calculator_t);
  if ((ulong)ctx->data + 8UL > (ulong)ctx->dataend)
  {
...
static inline ulong fd_fee_rate_governor_size(fd_fee_rate_governor_t const *self)
{
  (void)self;
  return 33UL;
}
...
static inline int fd_fee_rate_governor_decode_footprint(fd_bincode_decode_ctx_t *ctx, ulong *total_sz)
{
  *total_sz += sizeof(fd_fee_rate_governor_t);
  if ((ulong)ctx->data + 33UL > (ulong)ctx->dataend)
  {
    return FD_BINCODE_ERR_OVERFLOW;
  };
  return 0;
...
static inline ulong fd_slot_pair_size(fd_slot_pair_t const *self)
{
  (void)self;
  return 16UL;
}
...
static inline int fd_slot_pair_decode_footprint(fd_bincode_decode_ctx_t *ctx, ulong *total_sz)
{
  *total_sz += sizeof(fd_slot_pair_t);
  if ((ulong)ctx->data + 16UL > (ulong)ctx->dataend)
  {
    return FD_BINCODE_ERR_OVERFLOW;
  };
  return 0;
...
static inline ulong fd_inflation_size(fd_inflation_t const *self)
{
  (void)self;
  return 48UL;
}
...
static inline int fd_inflation_decode_footprint(fd_bincode_decode_ctx_t *ctx, ulong *total_sz)
{
  *total_sz += sizeof(fd_inflation_t);
  if ((ulong)ctx->data + 48UL > (ulong)ctx->dataend)
  {
    return FD_BINCODE_ERR_OVERFLOW;
  };
  return 0;
...
static inline ulong fd_rent_size(fd_rent_t const *self)
{
  (void)self;
  return 17UL;
}
...
static inline int fd_rent_decode_footprint(fd_bincode_decode_ctx_t *ctx, ulong *total_sz)
{
  *total_sz += sizeof(fd_rent_t);
  if ((ulong)ctx->data + 17UL > (ulong)ctx->dataend)
  {
    return FD_BINCODE_ERR_OVERFLOW;
  };
  return 0;
...
static inline ulong fd_epoch_schedule_size(fd_epoch_schedule_t const *self)
{
  (void)self;
  return 33UL;
}
...
static inline ulong fd_stake_history_entry_size(fd_stake_history_entry_t const *self)
{
  (void)self;
  return 24UL;
}
...
static inline int fd_stake_history_entry_decode_footprint(fd_bincode_decode_ctx_t *ctx, ulong *total_sz)
{
  *total_sz += sizeof(fd_stake_history_entry_t);
  if ((ulong)ctx->data + 24UL > (ulong)ctx->dataend)
  {
    return FD_BINCODE_ERR_OVERFLOW;
  };
  return 0;
...
static inline ulong fd_epoch_stake_history_entry_pair_size(fd_epoch_stake_history_entry_pair_t const *self)
{
  (void)self;
  return 32UL;
}
...
static inline int fd_epoch_stake_history_entry_pair_decode_footprint(fd_bincode_decode_ctx_t *ctx, ulong *total_sz)
{
  *total_sz += sizeof(fd_epoch_stake_history_entry_pair_t);
  if ((ulong)ctx->data + 32UL > (ulong)ctx->dataend)
  {
    return FD_BINCODE_ERR_OVERFLOW;
  };
  return 0;
...
static inline ulong fd_stake_history_size(fd_stake_history_t const *self)
{
  (void)self;
  return 16392UL;
}
...
static inline ulong fd_delegation_size(fd_delegation_t const *self)
{
  (void)self;
  return 64UL;
}
...
static inline int fd_delegation_decode_footprint(fd_bincode_decode_ctx_t *ctx, ulong *total_sz)
{
  *total_sz += sizeof(fd_delegation_t);
  if ((ulong)ctx->data + 64UL > (ulong)ctx->dataend)
  {
    return FD_BINCODE_ERR_OVERFLOW;
  };
  return 0;
...
static inline ulong fd_stake_size(fd_stake_t const *self)
{
  (void)self;
  return 72UL;
}
...
static inline int fd_stake_decode_footprint(fd_bincode_decode_ctx_t *ctx, ulong *total_sz)
{
  *total_sz += sizeof(fd_stake_t);
  if ((ulong)ctx->data + 72UL > (ulong)ctx->dataend)
  {
    return FD_BINCODE_ERR_OVERFLOW;
  };
  return 0;
...
static inline ulong fd_rust_duration_size(fd_rust_duration_t const *self)
{
  (void)self;
  return 12UL;
}
...
static inline int fd_rust_duration_decode_footprint(fd_bincode_decode_ctx_t *ctx, ulong *total_sz)
{
  *total_sz += sizeof(fd_rust_duration_t);
  if ((ulong)ctx->data + 12UL > (ulong)ctx->dataend)
  {
    return FD_BINCODE_ERR_OVERFLOW;
  };
  return 0;
...
static inline ulong fd_sol_sysvar_clock_size(fd_sol_sysvar_clock_t const *self)
{
  (void)self;
  return 40UL;
}
...
static inline int fd_sol_sysvar_clock_decode_footprint(fd_bincode_decode_ctx_t *ctx, ulong *total_sz)
{
  *total_sz += sizeof(fd_sol_sysvar_clock_t);
  if ((ulong)ctx->data + 40UL > (ulong)ctx->dataend)
  {
    return FD_BINCODE_ERR_OVERFLOW;
  };
  return 0;
...
static inline ulong fd_sol_sysvar_last_restart_slot_size(fd_sol_sysvar_last_restart_slot_t const *self)
{
  (void)self;
  return 8UL;
}
...
static inline ulong fd_vote_lockout_size(fd_vote_lockout_t const *self)
{
  (void)self;
  return 12UL;
}
...
static inline ulong fd_vote_authorized_voter_size(fd_vote_authorized_voter_t const *self)
{
  (void)self;
  return 40UL;
}
...
static inline ulong fd_vote_prior_voter_size(fd_vote_prior_voter_t const *self)
{
  (void)self;
  return 48UL;
}
...
static inline ulong fd_vote_prior_voter_0_23_5_size(fd_vote_prior_voter_0_23_5_t const *self)
{
  (void)self;
  return 56UL;
}
...
static inline int fd_vote_prior_voter_0_23_5_decode_footprint(fd_bincode_decode_ctx_t *ctx, ulong *total_sz)
{
  *total_sz += sizeof(fd_vote_prior_voter_0_23_5_t);
  if ((ulong)ctx->data + 56UL > (ulong)ctx->dataend)
  {
    return FD_BINCODE_ERR_OVERFLOW;
  };
  return 0;
...
static inline ulong fd_vote_epoch_credits_size(fd_vote_epoch_credits_t const *self)
{
  (void)self;
  return 24UL;
}
...
static inline ulong fd_vote_block_timestamp_size(fd_vote_block_timestamp_t const *self)
{
  (void)self;
  return 16UL;
}
...
static inline ulong fd_vote_prior_voters_size(fd_vote_prior_voters_t const *self)
{
  (void)self;
  return 1545UL;
}
...
static inline ulong fd_vote_prior_voters_0_23_5_size(fd_vote_prior_voters_0_23_5_t const *self)
{
  (void)self;
  return 1800UL;
}
...
static inline int fd_vote_prior_voters_0_23_5_decode_footprint(fd_bincode_decode_ctx_t *ctx, ulong *total_sz)
{
  *total_sz += sizeof(fd_vote_prior_voters_0_23_5_t);
  if ((ulong)ctx->data + 1800UL > (ulong)ctx->dataend)
  {
    return FD_BINCODE_ERR_OVERFLOW;
  };
  return 0;
...
static inline ulong fd_landed_vote_size(fd_landed_vote_t const *self)
{
  (void)self;
  return 13UL;
}
...
static inline int fd_landed_vote_decode_footprint(fd_bincode_decode_ctx_t *ctx, ulong *total_sz)
{
  *total_sz += sizeof(fd_landed_vote_t);
  if ((ulong)ctx->data + 13UL > (ulong)ctx->dataend)
  {
    return FD_BINCODE_ERR_OVERFLOW;
  };
  return 0;
...
static inline ulong fd_bls_pubkey_compressed_size(fd_bls_pubkey_compressed_t const *self)
{
  (void)self;
  return 48UL;
}
...
static inline ulong fd_slot_hash_size(fd_slot_hash_t const *self)
{
  (void)self;
  return 40UL;
}
...
static inline ulong fd_block_block_hash_entry_size(fd_block_block_hash_entry_t const *self)
{
  (void)self;
  return 40UL;
}
...
static inline ulong fd_sysvar_fees_size(fd_sysvar_fees_t const *self)
{
  (void)self;
  return 8UL;
}
...
static inline ulong fd_sysvar_epoch_rewards_size(fd_sysvar_epoch_rewards_t const *self)
{
  (void)self;
  return 81UL;
}
...
static inline ulong fd_config_keys_pair_size(fd_config_keys_pair_t const *self)
{
  (void)self;
  return 33UL;
}
...
static inline ulong fd_cluster_version_size(fd_cluster_version_t const *self)
{
  (void)self;
  return 12UL;
}
...
static inline ulong fd_vote_init_size(fd_vote_init_t const *self)
{
  (void)self;
  return 97UL;
}
...
static inline int fd_vote_init_decode_footprint(fd_bincode_decode_ctx_t *ctx, ulong *total_sz)
{
  *total_sz += sizeof(fd_vote_init_t);
  if ((ulong)ctx->data + 97UL > (ulong)ctx->dataend)
  {
    return FD_BINCODE_ERR_OVERFLOW;
  };
  return 0;
...
static inline ulong fd_vote_authorize_pubkey_size(fd_vote_authorize_pubkey_t const *self)
{
  (void)self;
  return 36UL;
}
...
static inline ulong fd_system_program_instruction_create_account_size(fd_system_program_instruction_create_account_t const *self)
{
  (void)self;
  return 48UL;
}
...
static inline ulong fd_stake_authorized_size(fd_stake_authorized_t const *self)
{
  (void)self;
  return 64UL;
}
...
static inline ulong fd_stake_lockup_size(fd_stake_lockup_t const *self)
{
  (void)self;
  return 48UL;
}
...
static inline ulong fd_stake_instruction_initialize_size(fd_stake_instruction_initialize_t const *self)
{
  (void)self;
  return 112UL;
}
...
static inline int fd_stake_instruction_initialize_decode_footprint(fd_bincode_decode_ctx_t *ctx, ulong *total_sz)
{
  *total_sz += sizeof(fd_stake_instruction_initialize_t);
  if ((ulong)ctx->data + 112UL > (ulong)ctx->dataend)
  {
    return FD_BINCODE_ERR_OVERFLOW;
  };
  return 0;
...
static inline ulong fd_stake_instruction_authorize_size(fd_stake_instruction_authorize_t const *self)
{
  (void)self;
  return 36UL;
}
...
static inline ulong fd_stake_meta_size(fd_stake_meta_t const *self)
{
  (void)self;
  return 120UL;
}
...
static inline int fd_stake_meta_decode_footprint(fd_bincode_decode_ctx_t *ctx, ulong *total_sz)
{
  *total_sz += sizeof(fd_stake_meta_t);
  if ((ulong)ctx->data + 120UL > (ulong)ctx->dataend)
  {
    return FD_BINCODE_ERR_OVERFLOW;
  };
  return 0;
...
static inline ulong fd_stake_flags_size(fd_stake_flags_t const *self)
{
  (void)self;
  return 1UL;
}
...
static inline int fd_stake_flags_decode_footprint(fd_bincode_decode_ctx_t *ctx, ulong *total_sz)
{
  *total_sz += sizeof(fd_stake_flags_t);
  if ((ulong)ctx->data + 1UL > (ulong)ctx->dataend)
  {
    return FD_BINCODE_ERR_OVERFLOW;
  };
  return 0;
...
static inline ulong fd_stake_state_v2_initialized_size(fd_stake_state_v2_initialized_t const *self)
{
  (void)self;
  return 120UL;
}
...
static inline ulong fd_stake_state_v2_stake_size(fd_stake_state_v2_stake_t const *self)
{
  (void)self;
  return 193UL;
}
...
static inline int fd_stake_state_v2_stake_decode_footprint(fd_bincode_decode_ctx_t *ctx, ulong *total_sz)
{
  *total_sz += sizeof(fd_stake_state_v2_stake_t);
  if ((ulong)ctx->data + 193UL > (ulong)ctx->dataend)
  {
    return FD_BINCODE_ERR_OVERFLOW;
  };
  return 0;
...
static inline ulong fd_nonce_data_size(fd_nonce_data_t const *self)
{
  (void)self;
  return 72UL;
}
...
static inline ulong fd_compute_budget_program_instruction_request_units_deprecated_size(fd_compute_budget_program_instruction_request_units_deprecated_t const *self)
{
  (void)self;
  return 8UL;
}
...
static inline ulong fd_loader_v4_program_instruction_copy_size(fd_loader_v4_program_instruction_copy_t const *self)
{
  (void)self;
  return 12UL;
}
...
static inline ulong fd_loader_v4_program_instruction_set_program_length_size(fd_loader_v4_program_instruction_set_program_length_t const *self)
{
  (void)self;
  return 4UL;
}
...
static inline int fd_loader_v4_program_instruction_set_program_length_decode_footprint(fd_bincode_decode_ctx_t *ctx, ulong *total_sz)
{
  *total_sz += sizeof(fd_loader_v4_program_instruction_set_program_length_t);
  if ((ulong)ctx->data + 4UL > (ulong)ctx->dataend)
  {
    return FD_BINCODE_ERR_OVERFLOW;
  };
  return 0;
...
static inline ulong fd_bpf_upgradeable_loader_program_instruction_deploy_with_max_data_len_size(fd_bpf_upgradeable_loader_program_instruction_deploy_with_max_data_len_t const *self)
{
  (void)self;
  return 8UL;
}
...
static inline ulong fd_bpf_upgradeable_loader_program_instruction_extend_program_size(fd_bpf_upgradeable_loader_program_instruction_extend_program_t const *self)
{
  (void)self;
  return 4UL;
}
...
static inline ulong fd_bpf_upgradeable_loader_program_instruction_extend_program_checked_size(fd_bpf_upgradeable_loader_program_instruction_extend_program_checked_t const *self)
{
  (void)self;
  return 4UL;
}
...
static inline ulong fd_bpf_upgradeable_loader_state_program_size(fd_bpf_upgradeable_loader_state_program_t const *self)
{
  (void)self;
  return 32UL;
}
...
static inline ulong fd_loader_v4_state_size(fd_loader_v4_state_t const *self)
{
  (void)self;
  return 48UL;
}
...
static inline ulong fd_frozen_hash_status_size(fd_frozen_hash_status_t const *self)
{
  (void)self;
  return 33UL;
}
...
static inline ulong fd_addrlut_create_size(fd_addrlut_create_t const *self)
{
  (void)self;
  return 9UL;
}
...
static inline int fd_addrlut_create_decode_footprint(fd_bincode_decode_ctx_t *ctx, ulong *total_sz)
{
  *total_sz += sizeof(fd_addrlut_create_t);
  if ((ulong)ctx->data + 9UL > (ulong)ctx->dataend)
  {
    return FD_BINCODE_ERR_OVERFLOW;
  };
  return 0;
