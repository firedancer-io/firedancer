...
struct __attribute__((aligned(8UL))) fd_vote_accounts_pair_serializable_global {
  fd_pubkey_t key;
  ulong stake;
  fd_solana_account_global_t value;
};
typedef struct fd_vote_accounts_pair_serializable_global fd_vote_accounts_pair_serializable_global_t;
#define FD_VOTE_ACCOUNTS_PAIR_SERIALIZABLE_GLOBAL_FOOTPRINT sizeof(fd_vote_accounts_pair_serializable_global_t)
#define FD_VOTE_ACCOUNTS_PAIR_SERIALIZABLE_GLOBAL_ALIGN (8UL)
...
struct __attribute__((aligned(8UL))) fd_vote_accounts_serializable_global {
  ulong vote_accounts_pool_gaddr;
  ulong vote_accounts_root_gaddr;
};
typedef struct fd_vote_accounts_serializable_global fd_vote_accounts_serializable_global_t;
#define FD_VOTE_ACCOUNTS_SERIALIZABLE_GLOBAL_FOOTPRINT sizeof(fd_vote_accounts_serializable_global_t)
#define FD_VOTE_ACCOUNTS_SERIALIZABLE_GLOBAL_ALIGN (8UL)
...
struct __attribute__((aligned(8UL))) fd_stakes_serializable_global {
  fd_vote_accounts_serializable_global_t vote_accounts;
  ulong stake_delegations_pool_gaddr;
  ulong stake_delegations_root_gaddr;
  ulong unused;
  ulong epoch;
...
typedef struct fd_stakes_serializable_global fd_stakes_serializable_global_t;
#define FD_STAKES_SERIALIZABLE_GLOBAL_FOOTPRINT sizeof(fd_stakes_serializable_global_t)
#define FD_STAKES_SERIALIZABLE_GLOBAL_ALIGN (8UL)
...
struct __attribute__((aligned(16UL))) fd_deserializable_versioned_bank_global {
...
typedef struct fd_deserializable_versioned_bank_global fd_deserializable_versioned_bank_global_t;
#define FD_DESERIALIZABLE_VERSIONED_BANK_GLOBAL_FOOTPRINT sizeof(fd_deserializable_versioned_bank_global_t)
#define FD_DESERIALIZABLE_VERSIONED_BANK_GLOBAL_ALIGN (16UL)
...
struct __attribute__((aligned(16UL))) fd_serializable_versioned_bank_global {
  fd_block_hash_vec_global_t blockhash_queue;
  ulong ancestors_len;
  ulong ancestors_gaddr;
  fd_hash_t hash;
  ...
  fd_epoch_schedule_t epoch_schedule;
  fd_inflation_t inflation;
  fd_stakes_serializable_global_t stakes;
  fd_unused_accounts_global_t unused_accounts;
  ulong epoch_stakes_len;
  ulong epoch_stakes_gaddr;
  uchar is_delta;
};
typedef struct fd_serializable_versioned_bank_global fd_serializable_versioned_bank_global_t;
#define FD_SERIALIZABLE_VERSIONED_BANK_GLOBAL_FOOTPRINT sizeof(fd_serializable_versioned_bank_global_t)
#define FD_SERIALIZABLE_VERSIONED_BANK_GLOBAL_ALIGN (16UL)
...
struct __attribute__((aligned(16UL))) fd_solana_manifest_global {
  fd_deserializable_versioned_bank_global_t bank;
...
struct __attribute__((aligned(16UL))) fd_solana_manifest_serializable_global {
  fd_serializable_versioned_bank_global_t bank;
  fd_solana_accounts_db_fields_global_t accounts_db;
  ulong lamports_per_signature;
  ulong bank_incremental_snapshot_persistence_gaddr;
  ulong epoch_account_hash_gaddr;
...
typedef struct fd_solana_manifest_serializable_global fd_solana_manifest_serializable_global_t;
#define FD_SOLANA_MANIFEST_SERIALIZABLE_GLOBAL_FOOTPRINT sizeof(fd_solana_manifest_serializable_global_t)
#define FD_SOLANA_MANIFEST_SERIALIZABLE_GLOBAL_ALIGN (16UL)
...
void fd_vote_accounts_pair_serializable_destroy( fd_vote_accounts_pair_serializable_t * self );
...
void * fd_vote_accounts_pair_serializable_decode( void * mem, fd_bincode_decode_ctx_t * ctx );
void fd_vote_accounts_pair_serializable_decode_inner( void * struct_mem, void * * alloc_mem, fd_bincode_decode_ctx_t * ctx );
void * fd_vote_accounts_pair_serializable_decode_global( void * mem, fd_bincode_decode_ctx_t * ctx );
void fd_vote_accounts_pair_serializable_decode_inner_global( void * struct_mem, void * * alloc_mem, fd_bincode_decode_ctx_t * ctx );
int fd_vote_accounts_pair_serializable_convert_global_to_local( void const * global_self, fd_vote_accounts_pair_serializable_t * self, fd_bincode_decode_ctx_t * ctx );
...
void fd_vote_accounts_serializable_destroy( fd_vote_accounts_serializable_t * self );
...
void * fd_vote_accounts_serializable_decode( void * mem, fd_bincode_decode_ctx_t * ctx );
void fd_vote_accounts_serializable_decode_inner( void * struct_mem, void * * alloc_mem, fd_bincode_decode_ctx_t * ctx );
void * fd_vote_accounts_serializable_decode_global( void * mem, fd_bincode_decode_ctx_t * ctx );
void fd_vote_accounts_serializable_decode_inner_global( void * struct_mem, void * * alloc_mem, fd_bincode_decode_ctx_t * ctx );
int fd_vote_accounts_serializable_convert_global_to_local( void const * global_self, fd_vote_accounts_serializable_t * self, fd_bincode_decode_ctx_t * ctx );
...
void fd_stakes_serializable_destroy( fd_stakes_serializable_t * self );
...
void * fd_stakes_serializable_decode( void * mem, fd_bincode_decode_ctx_t * ctx );
void fd_stakes_serializable_decode_inner( void * struct_mem, void * * alloc_mem, fd_bincode_decode_ctx_t * ctx );
void * fd_stakes_serializable_decode_global( void * mem, fd_bincode_decode_ctx_t * ctx );
void fd_stakes_serializable_decode_inner_global( void * struct_mem, void * * alloc_mem, fd_bincode_decode_ctx_t * ctx );
int fd_stakes_serializable_convert_global_to_local( void const * global_self, fd_stakes_serializable_t * self, fd_bincode_decode_ctx_t * ctx );
...
void fd_deserializable_versioned_bank_destroy( fd_deserializable_versioned_bank_t * self );
...
void * fd_deserializable_versioned_bank_decode( void * mem, fd_bincode_decode_ctx_t * ctx );
void fd_deserializable_versioned_bank_decode_inner( void * struct_mem, void * * alloc_mem, fd_bincode_decode_ctx_t * ctx );
void * fd_deserializable_versioned_bank_decode_global( void * mem, fd_bincode_decode_ctx_t * ctx );
void fd_deserializable_versioned_bank_decode_inner_global( void * struct_mem, void * * alloc_mem, fd_bincode_decode_ctx_t * ctx );
int fd_deserializable_versioned_bank_convert_global_to_local( void const * global_self, fd_deserializable_versioned_bank_t * self, fd_bincode_decode_ctx_t * ctx );
...
void fd_serializable_versioned_bank_destroy( fd_serializable_versioned_bank_t * self );
...
void * fd_serializable_versioned_bank_decode( void * mem, fd_bincode_decode_ctx_t * ctx );
void fd_serializable_versioned_bank_decode_inner( void * struct_mem, void * * alloc_mem, fd_bincode_decode_ctx_t * ctx );
void * fd_serializable_versioned_bank_decode_global( void * mem, fd_bincode_decode_ctx_t * ctx );
void fd_serializable_versioned_bank_decode_inner_global( void * struct_mem, void * * alloc_mem, fd_bincode_decode_ctx_t * ctx );
int fd_serializable_versioned_bank_convert_global_to_local( void const * global_self, fd_serializable_versioned_bank_t * self, fd_bincode_decode_ctx_t * ctx );
...
void fd_solana_manifest_serializable_destroy( fd_solana_manifest_serializable_t * self );
...
void * fd_solana_manifest_serializable_decode( void * mem, fd_bincode_decode_ctx_t * ctx );
void fd_solana_manifest_serializable_decode_inner( void * struct_mem, void * * alloc_mem, fd_bincode_decode_ctx_t * ctx );
void * fd_solana_manifest_serializable_decode_global( void * mem, fd_bincode_decode_ctx_t * ctx );
void fd_solana_manifest_serializable_decode_inner_global( void * struct_mem, void * * alloc_mem, fd_bincode_decode_ctx_t * ctx );
int fd_solana_manifest_serializable_convert_global_to_local( void const * global_self, fd_solana_manifest_serializable_t * self, fd_bincode_decode_ctx_t * ctx );
