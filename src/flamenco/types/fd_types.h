...
struct __attribute__((aligned(8UL))) fd_stake_reward_calculation_partitioned_off {
  uint partitioned_stake_rewards_off;
...
struct __attribute__((aligned(8UL))) fd_fd_epoch_reward_status_inner_off {
  uint Active_off;
};
typedef struct fd_fd_epoch_reward_status_inner_off fd_fd_epoch_reward_status_inner_off_t;
#define FD_FD_EPOCH_REWARD_STATUS_INNER_OFF_FOOTPRINT sizeof(fd_fd_epoch_reward_status_inner_off_t)
#define FD_FD_EPOCH_REWARD_STATUS_INNER_OFF_ALIGN (8UL)
