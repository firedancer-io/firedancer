...
static FD_FN_UNUSED fd_stake_weight_t_mapnode_t * fd_stake_weights_stake_weights_pool_join( void const * struct_mem, ulong offset ) { // deque
  return (fd_stake_weight_t_mapnode_t *)fd_stake_weight_t_map_join( fd_type_pun( (uchar *)struct_mem + offset ) );
}
static FD_FN_UNUSED fd_stake_weight_t_mapnode_t * fd_stake_weights_stake_weights_root_join( void const * struct_mem, ulong offset ) { // deque
...
static FD_FN_UNUSED fd_stake_pair_t_mapnode_t * fd_stakes_stake_stake_delegations_pool_join( void const * struct_mem, ulong offset ) { // deque
  return (fd_stake_pair_t_mapnode_t *)fd_stake_pair_t_map_join( fd_type_pun( (uchar *)struct_mem + offset ) );
}
static FD_FN_UNUSED fd_stake_pair_t_mapnode_t * fd_stakes_stake_stake_delegations_root_join( void const * struct_mem, ulong offset ) { // deque
...
static FD_FN_UNUSED fd_vote_lockout_t * fd_vote_state_0_23_5_votes_join( void const * struct_mem, ulong offset ) { // deque
  return (fd_vote_lockout_t *)deq_fd_vote_lockout_t_join( fd_type_pun( (uchar *)struct_mem + offset ) );
}
static FD_FN_UNUSED fd_vote_epoch_credits_t * fd_vote_state_0_23_5_epoch_credits_join( void const * struct_mem, ulong offset ) { // deque
...
static FD_FN_UNUSED fd_vote_lockout_t * fd_vote_state_1_14_11_votes_join( void const * struct_mem, ulong offset ) { // deque
  return (fd_vote_lockout_t *)deq_fd_vote_lockout_t_join( fd_type_pun( (uchar *)struct_mem + offset ) );
}
static FD_FN_UNUSED fd_vote_epoch_credits_t * fd_vote_state_1_14_11_epoch_credits_join( void const * struct_mem, ulong offset ) { // deque
  return (fd_vote_epoch_credits_t *)deq_fd_vote_epoch_credits_t_join( fd_type_pun( (uchar *)struct_mem + offset ) );
}
...
static FD_FN_UNUSED fd_landed_vote_t * fd_vote_state_votes_join( void const * struct_mem, ulong offset ) { // deque
  return (fd_landed_vote_t *)deq_fd_landed_vote_t_join( fd_type_pun( (uchar *)struct_mem + offset ) );
}
static FD_FN_UNUSED fd_vote_epoch_credits_t * fd_vote_state_epoch_credits_join( void const * struct_mem, ulong offset ) { // deque
  return (fd_vote_epoch_credits_t *)deq_fd_vote_epoch_credits_t_join( fd_type_pun( (uchar *)struct_mem + offset ) );
}
...
static FD_FN_UNUSED fd_vote_lockout_t * fd_vote_state_update_lockouts_join( void const * struct_mem, ulong offset ) { // deque
  return (fd_vote_lockout_t *)deq_fd_vote_lockout_t_join( fd_type_pun( (uchar *)struct_mem + offset ) );
}
/* Encoded Size: Dynamic */
...
FD_FN_UNUSED static fd_lockout_offset_t * fd_compact_vote_state_update_lockouts_join( fd_compact_vote_state_update_global_t const * struct_mem ) { // vector
...
static FD_FN_UNUSED fd_lockout_offset_t * fd_compact_tower_sync_lockout_offsets_join( void const * struct_mem, ulong offset ) { // deque
...
static FD_FN_UNUSED fd_vote_lockout_t * fd_tower_sync_lockouts_join( void const * struct_mem, ulong offset ) { // deque
  return (fd_vote_lockout_t *)deq_fd_vote_lockout_t_join( fd_type_pun( (uchar *)struct_mem + offset ) );
}
...
FD_FN_UNUSED static ulong * fd_slot_history_inner_blocks_join( fd_slot_history_inner_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static ulong * fd_slot_meta_next_slot_join( fd_slot_meta_global_t const * struct_mem ) { // vector
  return (ulong *)fd_type_pun( (uchar *)struct_mem + struct_mem->next_slot_offset );
}
FD_FN_UNUSED static uint * fd_slot_meta_entry_end_indexes_join( fd_slot_meta_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static fd_config_keys_pair_t * fd_stake_config_config_keys_join( fd_stake_config_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static uchar * fd_feature_entry_description_join( fd_feature_entry_global_t const * struct_mem ) { // vector
...
static FD_FN_UNUSED fd_vote_reward_t_mapnode_t * fd_calculate_stake_vote_rewards_result_vote_reward_map_pool_join( void const * struct_mem, ulong offset ) { // deque
  return (fd_vote_reward_t_mapnode_t *)fd_vote_reward_t_map_join( fd_type_pun( (uchar *)struct_mem + offset ) );
}
static FD_FN_UNUSED fd_vote_reward_t_mapnode_t * fd_calculate_stake_vote_rewards_result_vote_reward_map_root_join( void const * struct_mem, ulong offset ) { // deque
...
static FD_FN_UNUSED fd_vote_reward_t_mapnode_t * fd_partitioned_rewards_calculation_vote_reward_map_pool_join( void const * struct_mem, ulong offset ) { // deque
  return (fd_vote_reward_t_mapnode_t *)fd_vote_reward_t_map_join( fd_type_pun( (uchar *)struct_mem + offset ) );
}
static FD_FN_UNUSED fd_vote_reward_t_mapnode_t * fd_partitioned_rewards_calculation_vote_reward_map_root_join( void const * struct_mem, ulong offset ) { // deque
  return !!offset ? (fd_vote_reward_t_mapnode_t *)fd_type_pun( (uchar *)struct_mem + offset ) : NULL;
}
...
static FD_FN_UNUSED ulong * fd_vote_slots_join( void const * struct_mem, ulong offset ) { // deque
...
FD_FN_UNUSED static uchar * fd_vote_authorize_with_seed_args_current_authority_derived_key_seed_join( fd_vote_authorize_with_seed_args_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static uchar * fd_vote_authorize_checked_with_seed_args_current_authority_derived_key_seed_join( fd_vote_authorize_checked_with_seed_args_global_t const * struct_mem ) { // vector
  return (uchar *)fd_type_pun( (uchar *)struct_mem + struct_mem->current_authority_derived_key_seed_offset );
}
...
FD_FN_UNUSED static uchar * fd_system_program_instruction_create_account_with_seed_seed_join( fd_system_program_instruction_create_account_with_seed_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static uchar * fd_system_program_instruction_allocate_with_seed_seed_join( fd_system_program_instruction_allocate_with_seed_global_t const * struct_mem ) { // vector
  return (uchar *)fd_type_pun( (uchar *)struct_mem + struct_mem->seed_offset );
}
...
FD_FN_UNUSED static uchar * fd_system_program_instruction_assign_with_seed_seed_join( fd_system_program_instruction_assign_with_seed_global_t const * struct_mem ) { // vector
  return (uchar *)fd_type_pun( (uchar *)struct_mem + struct_mem->seed_offset );
}
/* https://github.com/solana-labs/solana/blob/8f2c8b8388a495d2728909e30460aa40dcc5d733/sdk/program/src/system_instruction.rs#L288 */
/* Encoded Size: Dynamic */
...
FD_FN_UNUSED static uchar * fd_system_program_instruction_transfer_with_seed_from_seed_join( fd_system_program_instruction_transfer_with_seed_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static uchar * fd_authorize_with_seed_args_authority_seed_join( fd_authorize_with_seed_args_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static uchar * fd_authorize_checked_with_seed_args_authority_seed_join( fd_authorize_checked_with_seed_args_global_t const * struct_mem ) { // vector
  return (uchar *)fd_type_pun( (uchar *)struct_mem + struct_mem->authority_seed_offset );
}
...
FD_FN_UNUSED static fd_config_keys_pair_t * fd_config_keys_keys_join( fd_config_keys_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static uchar * fd_bpf_loader_program_instruction_write_bytes_join( fd_bpf_loader_program_instruction_write_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static uchar * fd_loader_v4_program_instruction_write_bytes_join( fd_loader_v4_program_instruction_write_global_t const * struct_mem ) { // vector
  return (uchar *)fd_type_pun( (uchar *)struct_mem + struct_mem->bytes_offset );
}
...
FD_FN_UNUSED static uchar * fd_bpf_upgradeable_loader_program_instruction_write_bytes_join( fd_bpf_upgradeable_loader_program_instruction_write_global_t const * struct_mem ) { // vector
  return (uchar *)fd_type_pun( (uchar *)struct_mem + struct_mem->bytes_offset );
}
/* Encoded Size: Fixed (8 bytes) */
...
FD_FN_UNUSED static uchar * fd_gossip_bitvec_u8_inner_vec_join( fd_gossip_bitvec_u8_inner_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static ulong * fd_gossip_bitvec_u64_inner_vec_join( fd_gossip_bitvec_u64_inner_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static fd_pubkey_t * fd_gossip_prune_data_prunes_join( fd_gossip_prune_data_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static fd_pubkey_t * fd_gossip_prune_sign_data_prunes_join( fd_gossip_prune_sign_data_global_t const * struct_mem ) { // vector
  return (fd_pubkey_t *)fd_type_pun( (uchar *)struct_mem + struct_mem->prunes_offset );
}
/* Encoded Size: Dynamic */
...
FD_FN_UNUSED static uchar * fd_gossip_prune_sign_data_with_prefix_prefix_join( fd_gossip_prune_sign_data_with_prefix_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static ulong * fd_gossip_lowest_slot_slots_join( fd_gossip_lowest_slot_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static fd_slot_hash_t * fd_gossip_slot_hashes_hashes_join( fd_gossip_slot_hashes_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static uchar * fd_gossip_flate2_slots_compressed_join( fd_gossip_flate2_slots_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static fd_gossip_slots_enum_global_t * fd_gossip_epoch_slots_slots_join( fd_gossip_epoch_slots_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static uchar * fd_gossip_duplicate_shred_chunk_join( fd_gossip_duplicate_shred_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static fd_slot_hash_t * fd_gossip_incremental_snapshot_hashes_hashes_join( fd_gossip_incremental_snapshot_hashes_global_t const * struct_mem ) { // vector
  return (fd_slot_hash_t *)fd_type_pun( (uchar *)struct_mem + struct_mem->hashes_offset );
}
/* Encoded Size: Dynamic */
...
FD_FN_UNUSED static fd_gossip_ip_addr_t * fd_gossip_contact_info_v2_addrs_join( fd_gossip_contact_info_v2_global_t const * struct_mem ) { // vector
  return (fd_gossip_ip_addr_t *)fd_type_pun( (uchar *)struct_mem + struct_mem->addrs_offset );
}
FD_FN_UNUSED static fd_gossip_socket_entry_t * fd_gossip_contact_info_v2_sockets_join( fd_gossip_contact_info_v2_global_t const * struct_mem ) { // vector
  return (fd_gossip_socket_entry_t *)fd_type_pun( (uchar *)struct_mem + struct_mem->sockets_offset );
}
FD_FN_UNUSED static uint * fd_gossip_contact_info_v2_extensions_join( fd_gossip_contact_info_v2_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static fd_restart_run_length_encoding_inner_t * fd_restart_run_length_encoding_offsets_join( fd_restart_run_length_encoding_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static uchar * fd_restart_raw_offsets_bitvec_u8_inner_bits_join( fd_restart_raw_offsets_bitvec_u8_inner_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static ulong * fd_crds_bloom_keys_join( fd_crds_bloom_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static fd_crds_value_global_t * fd_gossip_pull_resp_crds_join( fd_gossip_pull_resp_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static fd_crds_value_global_t * fd_gossip_push_msg_crds_join( fd_gossip_push_msg_global_t const * struct_mem ) { // vector
  return (fd_crds_value_global_t *)fd_type_pun( (uchar *)struct_mem + struct_mem->crds_offset );
}
/* Encoded Size: Dynamic */
...
FD_FN_UNUSED static fd_pubkey_t * fd_addrlut_extend_new_addrs_join( fd_addrlut_extend_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static fd_cache_status_global_t * fd_status_value_statuses_join( fd_status_value_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static fd_status_pair_global_t * fd_slot_delta_slot_delta_vec_join( fd_slot_delta_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static fd_slot_delta_global_t * fd_bank_slot_deltas_slot_deltas_join( fd_bank_slot_deltas_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static uchar * fd_duplicate_slot_proof_shred1_join( fd_duplicate_slot_proof_global_t const * struct_mem ) { // vector
  return (uchar *)fd_type_pun( (uchar *)struct_mem + struct_mem->shred1_offset );
}
FD_FN_UNUSED static uchar * fd_duplicate_slot_proof_shred2_join( fd_duplicate_slot_proof_global_t const * struct_mem ) { // vector
...
FD_FN_UNUSED static fd_epoch_info_pair_t * fd_epoch_info_stake_infos_join( fd_epoch_info_global_t const * struct_mem ) { // vector
  return (fd_epoch_info_pair_t *)fd_type_pun( (uchar *)struct_mem + struct_mem->stake_infos_offset );
}
static FD_FN_UNUSED fd_vote_info_pair_global_t_mapnode_t * fd_epoch_info_vote_states_pool_join( void const * struct_mem, ulong offset ) { // deque
  return (fd_vote_info_pair_global_t_mapnode_t *)fd_vote_info_pair_global_t_map_join( fd_type_pun( (uchar *)struct_mem + offset ) );
}
static FD_FN_UNUSED fd_vote_info_pair_global_t_mapnode_t * fd_epoch_info_vote_states_root_join( void const * struct_mem, ulong offset ) { // deque
...
static FD_FN_UNUSED fd_account_costs_pair_t_mapnode_t * fd_account_costs_account_costs_pool_join( void const * struct_mem, ulong offset ) { // deque
  return (fd_account_costs_pair_t_mapnode_t *)fd_account_costs_pair_t_map_join( fd_type_pun( (uchar *)struct_mem + offset ) );
}
static FD_FN_UNUSED fd_account_costs_pair_t_mapnode_t * fd_account_costs_account_costs_root_join( void const * struct_mem, ulong offset ) { // deque
