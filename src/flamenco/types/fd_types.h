...
struct __attribute__((aligned(8UL))) fd_stake_reward_global {
  ulong prev;
  ulong next;
  ulong parent;
  fd_pubkey_t stake_pubkey;
...
typedef struct fd_stake_reward_global fd_stake_reward_global_t;
#define FD_STAKE_REWARD_GLOBAL_FOOTPRINT sizeof(fd_stake_reward_global_t)
#define FD_STAKE_REWARD_GLOBAL_ALIGN (8UL)
...
struct __attribute__((aligned(8UL))) fd_vote_reward_global {
  fd_pubkey_t pubkey;
  ulong vote_rewards;
  uchar commission;
  uchar needs_store;
};
typedef struct fd_vote_reward_global fd_vote_reward_global_t;
#define FD_VOTE_REWARD_GLOBAL_FOOTPRINT sizeof(fd_vote_reward_global_t)
#define FD_VOTE_REWARD_GLOBAL_ALIGN (8UL)
...
struct __attribute__((aligned(8UL))) fd_point_value_global {
  ulong rewards;
  uint128 points;
};
typedef struct fd_point_value_global fd_point_value_global_t;
#define FD_POINT_VALUE_GLOBAL_FOOTPRINT sizeof(fd_point_value_global_t)
#define FD_POINT_VALUE_GLOBAL_ALIGN (8UL)
...
void * fd_stake_reward_decode_global( void * mem, fd_bincode_decode_ctx_t * ctx );
void fd_stake_reward_decode_inner_global( void * struct_mem, void * * alloc_mem, fd_bincode_decode_ctx_t * ctx );
int fd_stake_reward_convert_global_to_local( void const * global_self, fd_stake_reward_t * self, fd_bincode_decode_ctx_t * ctx );
...
void * fd_vote_reward_decode_global( void * mem, fd_bincode_decode_ctx_t * ctx );
void fd_vote_reward_decode_inner_global( void * struct_mem, void * * alloc_mem, fd_bincode_decode_ctx_t * ctx );
int fd_vote_reward_convert_global_to_local( void const * global_self, fd_vote_reward_t * self, fd_bincode_decode_ctx_t * ctx );
...
void * fd_point_value_decode_global( void * mem, fd_bincode_decode_ctx_t * ctx );
void fd_point_value_decode_inner_global( void * struct_mem, void * * alloc_mem, fd_bincode_decode_ctx_t * ctx );
int fd_point_value_convert_global_to_local( void const * global_self, fd_point_value_t * self, fd_bincode_decode_ctx_t * ctx );
...
int fd_stake_reward_calculation_partitioned_convert_global_to_local( void const * global_self, fd_stake_reward_calculation_partitioned_t * self, fd_bincode_decode_ctx_t * ctx );
...
int fd_calculate_stake_vote_rewards_result_convert_global_to_local( void const * global_self, fd_calculate_stake_vote_rewards_result_t * self, fd_bincode_decode_ctx_t * ctx );
...
int fd_calculate_validator_rewards_result_convert_global_to_local( void const * global_self, fd_calculate_validator_rewards_result_t * self, fd_bincode_decode_ctx_t * ctx );
...
int fd_calculate_rewards_and_distribute_vote_rewards_result_convert_global_to_local( void const * global_self, fd_calculate_rewards_and_distribute_vote_rewards_result_t * self, fd_bincode_decode_ctx_t * ctx );
...
int fd_partitioned_rewards_calculation_convert_global_to_local( void const * global_self, fd_partitioned_rewards_calculation_t * self, fd_bincode_decode_ctx_t * ctx );
...
int fd_start_block_height_and_rewards_convert_global_to_local( void const * global_self, fd_start_block_height_and_rewards_t * self, fd_bincode_decode_ctx_t * ctx );
...
int fd_fd_epoch_reward_status_inner_convert_global_to_local( void const * global_self, fd_fd_epoch_reward_status_inner_t * self, fd_bincode_decode_ctx_t * ctx );
...
int fd_epoch_reward_status_convert_global_to_local( void const * global_self, fd_epoch_reward_status_t * self, fd_bincode_decode_ctx_t * ctx );
