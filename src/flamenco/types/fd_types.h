...
/* |token| >= 8. https://github.com/anza-xyz/agave/blob/v2.3.0/gossip/src/ping_pong.rs#L30 */
/* Encoded Size: Dynamic */
...
void fd_pingpong_ping_new( fd_pingpong_ping_t * self );
int fd_pingpong_ping_encode( fd_pingpong_ping_t const * self, fd_bincode_encode_ctx_t * ctx );
void fd_pingpong_ping_walk( void * w, fd_pingpong_ping_t const * self, fd_types_walk_fn_t fun, const char *name, uint level );
...
int fd_pingpong_ping_decode_footprint( fd_bincode_decode_ctx_t * ctx, ulong * total_sz );
...
void fd_pingpong_pong_walk( void * w, fd_pingpong_pong_t const * self, fd_types_walk_fn_t fun, const char *name, uint level );
