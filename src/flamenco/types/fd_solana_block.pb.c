...
PB_BIND(fd_solblock_ConfirmedBlock, fd_solblock_ConfirmedBlock, AUTO)
...
PB_BIND(fd_solblock_CompiledInstruction, fd_solblock_CompiledInstruction, AUTO)
...
PB_BIND(fd_solblock_Rewards, fd_solblock_Rewards, AUTO)


PB_BIND(fd_solblock_UnixTimestamp, fd_solblock_UnixTimestamp, AUTO)


PB_BIND(fd_solblock_BlockHeight, fd_solblock_BlockHeight, AUTO)


PB_BIND(fd_solblock_NumPartitions, fd_solblock_NumPartitions, AUTO)
