...
/* min_reserved is the minimum number of lines per class so that a
   ...
   = 3 lines in the worst-case class (class 7, an account that is
   already 1-10 MiB and stays there), 2 in any other.

   So worst case (all 64 accounts writable, all in the same class)
   gives 64 * 3 = 192 lines per class per transaction.
