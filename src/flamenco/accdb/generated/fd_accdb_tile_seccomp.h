...
#ifndef HEADER_fd_src_discof_accdb_generated_fd_accdb_tile_seccomp_h
#define HEADER_fd_src_discof_accdb_generated_fd_accdb_tile_seccomp_h
...
static void populate_sock_filter_policy_fd_accdb_tile( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd, unsigned int accounts_fd ) {
  ...
  struct sock_filter filter[34] = {
    ...
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_pwrite64, /* check_pwrite64 */ 11, 0 ),
...
#endif /* HEADER_fd_src_discof_accdb_generated_fd_accdb_tile_seccomp_h */
