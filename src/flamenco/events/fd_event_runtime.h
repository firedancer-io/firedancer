...
/* Build a runtime_stake_delegation event from a snapshot for a baseline
   stake delegation cache entry loaded at boot (snapshot manifest or genesis)
   and publish it on the calling tile's event link. */
