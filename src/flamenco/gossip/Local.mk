$(call add-hdrs,fd_gossip.h fd_gossip_message.h fd_gossip_out.h fd_gossip_txbuild.h)
ifdef FD_HAS_ALLOCA
$(call add-objs,fd_gossip fd_gossip_message fd_gossip_out fd_gossip_txbuild,fd_flamenco)
endif
