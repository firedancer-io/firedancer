...
fd_contact_info_gossip_socket( fd_contact_info_t const * ci ){
  return ci->sockets[ FD_GOSSIP_SOCKET_TAG_GOSSIP ];
}
...
fd_contact_info_convert_sockets( fd_contact_info_t const *             contact_info,
                                 fd_gossip_contact_info_socket_entry_t out_sockets_entries[static FD_GOSSIP_SOCKET_TAG_MAX],
                                 uchar *                               out_socket_entries_cnt,
                                 uint                                  out_addrs[static FD_GOSSIP_SOCKET_TAG_MAX],
                                 uchar *                               out_addrs_cnt ) {
  ...
  socket_ctx_t filled_up[ FD_GOSSIP_SOCKET_TAG_MAX ];
  ...
  socket_ctx_t sorted[ FD_GOSSIP_SOCKET_TAG_MAX ];
  ...
  out_sockets_entries[socket_entries_cnt].addr_index  = 0U; /* First address */
