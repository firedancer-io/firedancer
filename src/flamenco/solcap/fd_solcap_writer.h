...
#define FD_SOLCAP_MSG_STAKE_INFLATION       12
#define FD_SOLCAP_MSG_STAKE_REWARD          13
#define FD_SOLCAP_MSG_STAKE_REWARD_PAYOUT   14
...
fd_solcap_bank_create( fd_pkt_writer_t * pw,
  ...
  fd_pkt_writer_post( pw, fd_pb_encoder_out_sz( enc ), FD_SOLCAP_MSG_BANK_CREATE );
}
...
fd_solcap_bank_clone( fd_pkt_writer_t * pw,
  ...
  fd_pb_submsg_close( enc );
  fd_pkt_writer_post( pw, fd_pb_encoder_out_sz( enc ), FD_SOLCAP_MSG_BANK_CLONE );
}
...
fd_solcap_bank_destroy( fd_pkt_writer_t * pw,
  ...
  fd_pb_push_uint64 ( enc, 1U, bank_id );
  fd_pb_submsg_close( enc );
  fd_pkt_writer_post( pw, fd_pb_encoder_out_sz( enc ), FD_SOLCAP_MSG_BANK_DESTROY );
}
...
fd_solcap_txn_exec_start( fd_pkt_writer_t *                  pw,
  ...
  fd_pb_submsg_close( enc );
  fd_pkt_writer_post( pw, fd_pb_encoder_out_sz( enc ), FD_SOLCAP_MSG_TXN_EXEC_START );
}
...
fd_solcap_txn_exec_preflight( fd_pkt_writer_t *                      pw,
  ...
  fd_pb_submsg_close( enc );
  fd_pkt_writer_post( pw, fd_pb_encoder_out_sz( enc ), FD_SOLCAP_MSG_TXN_EXEC_PREFLIGHT );
}
...
fd_solcap_txn_exec_end( fd_pkt_writer_t *                pw,
  ...
  fd_pb_encoder_t enc[1];
  fd_pb_encoder_init( enc, frame, pw->mtu );
  fd_pb_submsg_open ( enc, FD_SOLCAP_MSG_TXN_EXEC_END );
  fd_pb_push_uint64 ( enc, 1U, end->bank_id       );
  fd_pb_push_bytes  ( enc, 1U, end->signature, 64 );
  fd_pb_push_int32  ( enc, 2U, end->error_code    );
  fd_pb_submsg_close( enc );
  fd_pkt_writer_post( pw, fd_pb_encoder_out_sz( enc ), FD_SOLCAP_MSG_TXN_EXEC_END );
}
...
fd_solcap_instr_exec_start( fd_pkt_writer_t *                    pw,
  ...
  fd_pb_encoder_t enc[1];
  fd_pb_encoder_init( enc, frame, pw->mtu );
  fd_pb_submsg_open ( enc, FD_SOLCAP_MSG_INSTR_EXEC_START );
  fd_pb_push_uint64 ( enc, 1U, start->bank_id       );
  ...
  fd_pb_submsg_close( enc );
  fd_pkt_writer_post( pw, fd_pb_encoder_out_sz( enc ), FD_SOLCAP_MSG_INSTR_EXEC_START );
}
...
fd_solcap_instr_exec_end( fd_pkt_writer_t *                  pw,
  ...
  fd_pb_encoder_t enc[1];
  fd_pb_encoder_init( enc, frame, pw->mtu );
  fd_pb_submsg_open ( enc, FD_SOLCAP_MSG_INSTR_EXEC_END );
  fd_pb_push_uint64 ( enc, 1U, end->bank_id       );
  ...
  fd_pb_submsg_close( enc );
  fd_pkt_writer_post( pw, fd_pb_encoder_out_sz( enc ), FD_SOLCAP_MSG_INSTR_EXEC_END );
}
...
fd_solcap_lthash_init( fd_pkt_writer_t * pw,
  ...
  fd_pb_encoder_t enc[1];
  fd_pb_encoder_init( enc, frame, pw->mtu );
  fd_pb_submsg_open ( enc, FD_SOLCAP_MSG_LTHASH_UPDATE );
  fd_pb_push_uint64 ( enc, 1U, bank_id );
  fd_pb_push_int32  ( enc, 2U, 2 ); /* LthashDeltaType SET */
  fd_pb_push_bytes  ( enc, 3U, lthash_post, 2048 );
  fd_pkt_writer_post( pw, fd_pb_encoder_out_sz( enc ), FD_SOLCAP_MSG_LTHASH_UPDATE );
}
...
fd_solcap_bank_hash( fd_pkt_writer_t *             pw,
  ...
  fd_pb_encoder_t enc[1];
  fd_pb_encoder_init( enc, frame, pw->mtu );
  fd_pb_submsg_open ( enc, FD_SOLCAP_MSG_BANK_HASH );
  ...
  fd_pb_submsg_close( enc );
  fd_pkt_writer_post( pw, fd_pb_encoder_out_sz( enc ), FD_SOLCAP_MSG_BANK_HASH );
}
...
fd_solcap_stake_inflation( fd_pkt_writer_t *                   pw,
  ...
  fd_pb_encoder_t enc[1];
  fd_pb_encoder_init( enc, frame, pw->mtu );
  fd_pb_submsg_open ( enc, FD_SOLCAP_MSG_STAKE_INFLATION );
  ...
  fd_pb_submsg_close( enc );
  fd_pkt_writer_post( pw, fd_pb_encoder_out_sz( enc ), FD_SOLCAP_MSG_STAKE_INFLATION );
}
...
fd_solcap_stake_reward( fd_pkt_writer_t *                pw,
  ...
  fd_pb_encoder_t enc[1];
  fd_pb_encoder_init( enc, frame, pw->mtu );
  fd_pb_submsg_open ( enc, FD_SOLCAP_MSG_STAKE_REWARD );
  ...
  fd_pb_submsg_close( enc );
  fd_pkt_writer_post( pw, fd_pb_encoder_out_sz( enc ), FD_SOLCAP_MSG_STAKE_REWARD );
}
...
fd_solcap_stake_reward_payout( fd_pkt_writer_t *                       pw,
  ...
  fd_pb_encoder_t enc[1];
  fd_pb_encoder_init( enc, frame, pw->mtu );
  fd_pb_submsg_open ( enc, FD_SOLCAP_MSG_STAKE_REWARD_PAYOUT );
  ...
  fd_pb_submsg_close( enc );
  fd_pkt_writer_post( pw, fd_pb_encoder_out_sz( enc ), FD_SOLCAP_MSG_STAKE_REWARD_PAYOUT );
}
