...
fd_txn_account_set_mutable( fd_txn_account_t * acct ) {
  acct->meta = (void *)acct->const_meta;
  acct->data = (void *)acct->const_data;
  acct->rec  = (void *)acct->const_rec;
  acct->vt   = &fd_txn_account_writable_vtable;
}
