...
fd_sysvar_slot_history_write_history( fd_bank_t *                bank,
  ...
  uchar __attribute__((aligned(alignof(fd_slot_history_global_t)))) slot_history_mem[ FD_SLOT_HISTORY_MIN_ACCOUNT_SIZE ] = {0};
...
fd_sysvar_slot_history_init( fd_bank_t *               bank,
  ...
  uchar __attribute__((aligned(alignof(fd_slot_history_global_t)))) slot_history_mem[ FD_SLOT_HISTORY_DECODED_SIZE ] = {0};
