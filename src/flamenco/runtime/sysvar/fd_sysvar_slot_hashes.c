...
fd_sysvar_slot_hashes_write( fd_bank_t *               bank,
  ...
  fd_sysvar_set( bank, funk, funk_txn, &fd_sysvar_owner_id, &fd_sysvar_slot_hashes_id, enc, slot_hashes_account_size, bank->slot );
}
...
fd_sysvar_slot_hashes_init( fd_bank_t *     bank,
  ...
  FD_SPAD_FRAME_BEGIN( runtime_spad ) {
    ...
    fd_sysvar_slot_hashes_write( bank, funk, funk_txn, slot_hashes_global);
...
fd_sysvar_slot_hashes_update( fd_bank_t *     bank,
                              ...
                              fd_spad_t *     runtime_spad ) {
FD_SPAD_FRAME_BEGIN( runtime_spad ) {
  fd_slot_hashes_global_t * slot_hashes_global = fd_sysvar_slot_hashes_read( funk, funk_txn, runtime_spad );
  ...
  if( !found ) {
    ...
    fd_slot_hash_t slot_hash = {
      ...
      .slot = fd_bank_prev_slot_get( bank ), // parent_slot
    };
