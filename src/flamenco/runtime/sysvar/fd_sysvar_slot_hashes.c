...
fd_sysvar_slot_hashes_update( fd_exec_slot_ctx_t * slot_ctx, fd_spad_t * runtime_spad ) {
  ...
  if( !slot_hashes_global ) {
    ...
    hashes = deq_fd_slot_hash_t_join( (uchar*)slot_hashes_global + slot_hashes_global->hashes_gaddr_off );
  }
...
fd_sysvar_slot_hashes_read( fd_exec_slot_ctx_t *  slot_ctx,
  ...
  fd_slot_hashes_global_t * slot_hashes_global = fd_sysvar_cache_slot_hashes( slot_ctx->sysvar_cache, slot_ctx->runtime_wksp );
  if( !!slot_hashes_global ) {
