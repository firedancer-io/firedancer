...
#define FD_SYSVAR_CLOCK_SZ_MAX              (40UL) /* fixed */
#define FD_SYSVAR_EPOCH_REWARDS_SZ_MAX      (81UL) /* fixed */
#define FD_SYSVAR_EPOCH_SCHEDULE_SZ_MAX     (33UL) /* fixed */
#define FD_SYSVAR_LAST_RESTART_SLOT_SZ_MAX   (8UL) /* fixed */
#define FD_SYSVAR_RECENT_BLOCK_HASHES_SZ_MAX (1UL) /* TODO */
#define FD_SYSVAR_RENT_SZ_MAX               (17UL) /* fixed */
#define FD_SYSVAR_SLOT_HASHES_SZ_MAX         (1UL) /* TODO */
#define FD_SYSVAR_STAKE_HISTORY_SZ_MAX       (1UL) /* TODO */
...
/* fd_sysvar_cache_data_query returns a pointer to raw/serialized sysvar
   ...
   *psz is set to the serialized data size (0 if account does not exist). */
...
fd_sysvar_clock_is_valid( fd_sysvar_cache_t const * sysvar_cache ) {
  return !!fd_sysvar_cache_flags_valid( sysvar_cache->clock.flags );
}
...
fd_sysvar_epoch_rewards_is_valid( fd_sysvar_cache_t const * sysvar_cache ) {
  return !!fd_sysvar_cache_flags_valid( sysvar_cache->epoch_rewards.flags );
}
...
fd_sysvar_last_restart_slot_is_valid( fd_sysvar_cache_t const * sysvar_cache ) {
  return !!fd_sysvar_cache_flags_valid( sysvar_cache->last_restart_slot.flags );
}
...
fd_sysvar_rent_is_valid( fd_sysvar_cache_t const * sysvar_cache ) {
  return !!fd_sysvar_cache_flags_valid( sysvar_cache->rent.flags );
}
...
fd_sysvar_slot_hashes_is_valid( fd_sysvar_cache_t const * sysvar_cache ) {
  return !!fd_sysvar_cache_flags_valid( sysvar_cache->slot_hashes.flags );
}
...
fd_sysvar_slot_history_is_valid( fd_sysvar_cache_t const * sysvar_cache ) {
  return !!fd_sysvar_cache_flags_valid( sysvar_cache->slot_history.flags );
}
...
fd_sysvar_stake_history_is_valid( fd_sysvar_cache_t const * sysvar_cache ) {
  return !!fd_sysvar_cache_flags_valid( sysvar_cache->stake_history.flags );
}
