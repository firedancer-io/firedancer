...
/* FD_SYSVAR_SLOT_HISTORY_BINCODE_SZ is the serialized size of the slot
   history sysvar account.  (static/hardcoded)

   Agave v2.2.1: https://github.com/anza-xyz/solana-sdk/blob/slot-history%40v2.2.1/sysvar/src/slot_history.rs#L65 */

#define FD_SYSVAR_SLOT_HISTORY_BINCODE_SZ 131097UL
