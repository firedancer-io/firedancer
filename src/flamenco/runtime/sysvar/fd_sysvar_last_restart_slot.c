...
fd_sysvar_last_restart_slot_init( fd_bank_t *     bank,
  ...
  ulong sz = fd_sol_sysvar_last_restart_slot_size( fd_bank_last_restart_slot_query( bank ) );
  uchar enc[ sz ];
  fd_memset( enc, 0, sz );
  ...
  int err = fd_sol_sysvar_last_restart_slot_encode( fd_bank_last_restart_slot_query( bank ), &encode );
...
fd_sysvar_last_restart_slot_update( fd_bank_t *     bank,
  ...
  fd_sol_sysvar_last_restart_slot_t * old_account = fd_sysvar_last_restart_slot_read( funk, funk_txn, runtime_spad );
  ...
  ulong last_restart_slot = fd_bank_last_restart_slot_get( bank ).slot;
