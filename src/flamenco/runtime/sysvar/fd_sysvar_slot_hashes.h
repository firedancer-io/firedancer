...
/* FD_SYSVAR_SLOT_HASHES_BINCODE_SZ is the serialized size of the slot
   hashes sysvar account.  (static/hardcoded)

   Agave v2.2.1: https://github.com/anza-xyz/solana-sdk/blob/slot-history%40v2.2.1/sysvar/src/slot_hashes.rs#L69 */

#define FD_SYSVAR_SLOT_HASHES_BINCODE_SZ (20488UL)
