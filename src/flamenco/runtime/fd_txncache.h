...
/* fd_txncache_set_txnhash_offset sets the txnhash offset in the
   blockcache.  This is used solely for snapshot restore since in
   Firedancer we always use an offset of 0 after snapshot restore.
