...
fd_source_buffer_account_new( fd_exec_slot_ctx_t *    slot_ctx,
                              ...
                              fd_funk_rec_prepare_t * out_source_buffer_prepare ) {
  ...
  if( FD_UNLIKELY( fd_txn_account_init_from_funk_mutable( buffer_account, buffer_address, slot_ctx->funk, slot_ctx->funk_txn, 0, 0UL, out_source_buffer_prepare )!=FD_ACC_MGR_SUCCESS ) ) {
...
fd_source_buffer_account_new_with_hash( fd_exec_slot_ctx_t *    slot_ctx,
  ...
  int err = fd_source_buffer_account_new( slot_ctx, buffer_account, buffer_address, out_source_buffer_prepare );
  if( FD_UNLIKELY( err ) ) {
    return err;
  }
