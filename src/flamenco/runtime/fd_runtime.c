...
fd_runtime_freeze( fd_bank_t *               bank,
  ...
  fd_cost_tracker_t * cost_tracker_mod = fd_bank_cost_tracker_locking_modify( bank );
  FD_LOG_INFO(("SLOT %lu, BLOCK COST %lu", fd_bank_slot_get( bank ), cost_tracker_mod->block_cost));
