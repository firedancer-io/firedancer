...
SOL_COMPAT_FLAGS:=-Wl,--undefined=fd_types_vt_by_name,--undefined=fd_stat_robust_norm_fit_double -Wl,--version-script=src/flamenco/runtime/tests/libfd_exec_sol_compat.map
$(call make-unit-test,test_sol_compat,test_sol_compat,fd_flamenco_test fd_flamenco fd_discof fd_tango fd_funk fd_ballet fd_util fd_disco,$(SECP256K1_LIBS))
$(call make-shared,libfd_exec_sol_compat.so,fd_sol_compat,fd_flamenco_test fd_flamenco fd_discof fd_funk fd_ballet fd_util fd_disco fd_tango,$(SECP256K1_LIBS) $(SOL_COMPAT_FLAGS))
