...
# $(call make-unit-test,test_sol_compat,test_sol_compat,fd_flamenco_test fd_flamenco fd_tango fd_ballet fd_util fd_disco,$(FLATCC_LIBS))
# $(call make-shared,libfd_exec_sol_compat.so,fd_sol_compat,fd_flamenco_test fd_flamenco fd_ballet fd_util fd_disco,$(FLATCC_LIBS) $(SOL_COMPAT_FLAGS))
