...
$(call make-unit-test,test_sol_compat,test_sol_compat,fd_flamenco_test fd_discof fd_choreo fd_flamenco fd_disco fd_reedsol fd_tango fd_ballet fd_util_test fd_util)
$(call make-shared,libfd_exec_sol_compat.so,fd_sol_compat,fd_flamenco_test fd_discof fd_choreo fd_flamenco fd_disco fd_reedsol fd_ballet fd_util_test fd_util,$(SOL_COMPAT_FLAGS))
