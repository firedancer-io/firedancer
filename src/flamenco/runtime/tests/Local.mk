...
SOL_COMPAT_FLAGS:=-Wl,--undefined=fd_types_vt_by_name -Wl,--undefined=fd_stat_robust_norm_fit_double -Wl,--version-script=src/flamenco/runtime/tests/libfd_exec_sol_compat.map
...
$(call make-shared,libfd_exec_sol_compat.so,fd_sol_compat,fd_flamenco_test fd_flamenco fd_funk fd_ballet fd_util fd_disco fd_tango,$(SECP256K1_LIBS) $(SOL_COMPAT_FLAGS))
