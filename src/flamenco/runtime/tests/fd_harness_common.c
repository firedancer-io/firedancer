...
fd_solfuzz_pb_restore_fee_rate_governor( fd_bank_t *                              bank,
  ...
  fd_fee_rate_governor_t * frg = &bank->data->fields.fee_rate_governor;
...
fd_solfuzz_pb_restore_epoch_schedule( fd_bank_t *                           bank,
  ...
  fd_epoch_schedule_t * es = &bank->data->fields.epoch_schedule;
...
fd_solfuzz_pb_restore_blockhash_queue( fd_bank_t *                                    bank,
  ...
  fd_blockhashes_t * blockhashes = fd_blockhashes_init( &bank->data->fields.block_hash_queue, blockhash_seed );
