...
static void
dump_blockhash_queue( fd_exec_slot_ctx_t const * slot_ctx,
                      fd_spad_t *                spad,
...
create_block_context_protobuf_from_block( fd_exec_test_block_context_t * block_context,
  ...
  dump_vote_accounts( &epoch_ctx->epoch_bank.stakes.vote_accounts,
                      spad,
  ...
  dump_vote_accounts( &epoch_ctx->epoch_bank.next_epoch_stakes,
                      spad,
  ...
  dump_vote_accounts( &slot_ctx->slot_bank.epoch_stakes,
                      spad,
...
create_txn_context_protobuf_from_txn( fd_exec_test_txn_context_t * txn_context_msg,
  ...
  */
  ...
  dump_sanitized_transaction( slot_ctx, txn_descriptor, txn_payload, spad, sanitized_transaction );
  ...
  dump_blockhash_queue( slot_ctx, spad, output_blockhash_queue, &txn_context_msg->blockhash_queue_count );
