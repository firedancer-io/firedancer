...
fd_solfuzz_block_ctx_exec( fd_solfuzz_runner_t * runner,
  ...
  FD_SPAD_FRAME_BEGIN( runner->spad ) {
    fd_rewards_recalculate_partitioned_rewards( runner->banks, runner->bank, runner->accdb, runner->runtime_stack );
    ...
    fd_runtime_block_execute_prepare( runner->banks, runner->bank, runner->accdb, runner->runtime_stack, &is_epoch_boundary );
    ...
    /* Finalize the block */
    fd_runtime_block_execute_finalize( runner->bank, runner->accdb, NULL, (ushort)0 );
