...
int test_1172(fd_executor_test_suite_t *suite) {
  ...
  test.disable_cnt = 0;
  test.bt = "   2: solana_stake_program::stake_instruction::tests::test_stake_process_instruction_error_ordering             at ./src/stake_instruction.rs:7127:13   3: solana_stake_program::stake_instruction::tests::test_stake_process_instruction_error_ordering::all_enabled             at ./src/stake_instruction.rs:7068:5   4: solana_stake_program::stake_instruction::tests::test_stake_process_instruction_error_ordering::all_enabled::{{closure}}             at ./src/stake_instruction.rs:7068:5   5: core::ops::function::FnOnce::call_once             at /rustc/cc66ad468955717ab92600c770da8c1601a4ff33/library/core/src/ops/function.rs:250:5";
