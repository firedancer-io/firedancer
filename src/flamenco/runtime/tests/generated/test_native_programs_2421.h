...
int test_2421(fd_executor_test_suite_t *suite) {
  ...
  test.disable_cnt = 2;
  test.bt = "   2: solana_stake_program::stake_instruction::tests::test_stake_process_instruction_error_ordering             at ./src/stake_instruction.rs:6571:13   3: solana_stake_program::stake_instruction::tests::test_stake_process_instruction_error_ordering::old_warmup_cooldown_no_min_delegation             at ./src/stake_instruction.rs:6512:5   4: solana_stake_program::stake_instruction::tests::test_stake_process_instruction_error_ordering::old_warmup_cooldown_no_min_delegation::{{closure}}             at ./src/stake_instruction.rs:6512:5   5: core::ops::function::FnOnce::call_once             at /rustc/83964c156db1f444050a38b2498dbd0da6d5d503/library/core/src/ops/function.rs:250:5";
