...
#ifndef PB_ORG_SOLANA_SEALEVEL_V1_INSTR_PB_H_INCLUDED
#define PB_ORG_SOLANA_SEALEVEL_V1_INSTR_PB_H_INCLUDED
...
#define FD_EXEC_TEST_INSTR_CONTEXT_INIT_DEFAULT  {{0}, 0, NULL, 0, NULL, NULL, 0, false, FD_EXEC_TEST_FEATURE_SET_INIT_DEFAULT}
#define FD_EXEC_TEST_INSTR_EFFECTS_INIT_DEFAULT  {0, 0, 0, NULL, 0, 0}
...
#define FD_EXEC_TEST_INSTR_CONTEXT_INIT_ZERO     {{0}, 0, NULL, 0, NULL, NULL, 0, false, FD_EXEC_TEST_FEATURE_SET_INIT_ZERO}
#define FD_EXEC_TEST_INSTR_EFFECTS_INIT_ZERO     {0, 0, 0, NULL, 0, 0}
...
#define FD_EXEC_TEST_INSTR_CONTEXT_FEATURES_TAG  10
...
#define FD_EXEC_TEST_INSTR_EFFECTS_RETURN_DATA_HASH_TAG 6
...
X(a, STATIC,   OPTIONAL, MESSAGE,  features,         10)
...
#define fd_exec_test_instr_context_t_features_MSGTYPE fd_exec_test_feature_set_t
...
X(a, STATIC,   SINGULAR, FIXED64,  return_data_hash,   6)
...
#define ORG_SOLANA_SEALEVEL_V1_INSTR_PB_H_MAX_SIZE FD_EXEC_TEST_INSTR_ACCT_SIZE
