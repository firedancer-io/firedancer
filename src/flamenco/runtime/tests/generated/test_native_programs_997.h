...
int test_997(fd_executor_test_suite_t *suite) {
  ...
  test.disable_cnt = 2;
  test.bt = "   2: solana_stake_program::stake_instruction::tests::process_instruction_as_one_arg             at ./src/stake_instruction.rs:625:9   3: solana_stake_program::stake_instruction::tests::test_spoofed_stake_accounts             at ./src/stake_instruction.rs:789:9   4: solana_stake_program::stake_instruction::tests::test_spoofed_stake_accounts::old_warmup_cooldown_no_min_delegation             at ./src/stake_instruction.rs:785:5   5: solana_stake_program::stake_instruction::tests::test_spoofed_stake_accounts::old_warmup_cooldown_no_min_delegation::{{closure}}             at ./src/stake_instruction.rs:785:5";
 ...
 // {'clock': 'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA==', 'epoch_schedule': 'gJcGAAAAAACAlwYAAAAAAAEOAAAAAAAAAOD/BwAAAAAA', 'epoch_rewards': '', 'fees': '', 'rent': 'mA0AAAAAAAAAAAAAAAAAQDI=', 'slot_hashes': '', 'recent_blockhashes': '', 'stake_history': '', 'last_restart_slot': ''}
  ...
  static uchar const fd_flamenco_native_prog_test_997_acc_0_data[] = { 0x80,0x97,0x06,0x00,0x00,0x00,0x00,0x00,0x80,0x97,0x06,0x00,0x00,0x00,0x00,0x00,0x01,0x0e,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xe0,0xff,0x07,0x00,0x00,0x00,0x00,0x00 };
  test_acc->data            = fd_flamenco_native_prog_test_997_acc_0_data;
  test_acc->data_len        = 33UL;
  static uchar const fd_flamenco_native_prog_test_997_acc_0_post_data[] = { 0x80,0x97,0x06,0x00,0x00,0x00,0x00,0x00,0x80,0x97,0x06,0x00,0x00,0x00,0x00,0x00,0x01,0x0e,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xe0,0xff,0x07,0x00,0x00,0x00,0x00,0x00 };
  ...
  test_acc->rent_epoch      = 0;
  test_acc->result_rent_epoch      = 0;
  static uchar const fd_flamenco_native_prog_test_997_acc_1_data[] = { 0x98,0x0d,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x40,0x32 };
  test_acc->data            = fd_flamenco_native_prog_test_997_acc_1_data;
  test_acc->data_len        = 17UL;
  static uchar const fd_flamenco_native_prog_test_997_acc_1_post_data[] = { 0x98,0x0d,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x40,0x32 };
  ...
  test_acc->rent_epoch      = 0;
  test_acc->result_rent_epoch      = 0;
  static uchar const fd_flamenco_native_prog_test_997_acc_2_data[] = { 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00 };
  test_acc->data            = fd_flamenco_native_prog_test_997_acc_2_data;
  test_acc->data_len        = 40UL;
  static uchar const fd_flamenco_native_prog_test_997_acc_2_post_data[] = { 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00 };
