...
int test_1690(fd_executor_test_suite_t *suite) {
  ...
  test.disable_cnt = 1;
  test.bt = "   2: solana_stake_program::stake_instruction::tests::process_instruction_as_one_arg             at ./src/stake_instruction.rs:595:9   3: solana_stake_program::stake_instruction::tests::test_spoofed_stake_accounts             at ./src/stake_instruction.rs:738:9   4: solana_stake_program::stake_instruction::tests::test_spoofed_stake_accounts::old_behavior             at ./src/stake_instruction.rs:735:5   5: solana_stake_program::stake_instruction::tests::test_spoofed_stake_accounts::old_behavior::{{closure}}             at ./src/stake_instruction.rs:735:5";
 ...
 // {'clock': '1111111111111111111111111111111111111111', 'epoch_schedule': '', 'epoch_rewards': '', 'fees': '', 'rent': '2RsdFKVyfoKRJwMEPcvasdsF', 'slot_hashes': '', 'recent_blockhashes': '', 'stake_history': '', 'last_restart_slot': ''}
  ...
  static uchar const fd_flamenco_native_prog_test_1690_acc_0_data[] = { 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00 };
  test_acc->data            = fd_flamenco_native_prog_test_1690_acc_0_data;
  test_acc->data_len        = 40UL;
  static uchar const fd_flamenco_native_prog_test_1690_acc_0_post_data[] = { 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00 };
