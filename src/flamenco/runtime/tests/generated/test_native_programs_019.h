...
int test_19(fd_executor_test_suite_t *suite) {
 ...
 // {'clock': '', 'epoch_schedule': '', 'epoch_rewards': '', 'fees': '', 'rent': '', 'slot_hashes': '', 'recent_blockhashes': '', 'stake_history': '', 'last_restart_slot': ''}
  ...
  static uchar const fd_flamenco_native_prog_test_19_acc_0_data[] = { 0x00,0x00,0x00,0x00 };
  test_acc->data            = fd_flamenco_native_prog_test_19_acc_0_data;
  test_acc->data_len        = 4UL;
  static uchar const fd_flamenco_native_prog_test_19_acc_0_post_data[] = { 0x00,0x00,0x00,0x00 };
  ...
  test_acc->rent_epoch      = 0;
  test_acc->result_rent_epoch      = 0;
  static uchar const fd_flamenco_native_prog_test_19_acc_1_data[] = { 0x02,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x56,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00 };
  test_acc->data            = fd_flamenco_native_prog_test_19_acc_1_data;
  test_acc->data_len        = 36UL;
  static uchar const fd_flamenco_native_prog_test_19_acc_1_post_data[] = { 0x02,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x56,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00 };
  test_acc->result_data     = fd_flamenco_native_prog_test_19_acc_1_post_data;
