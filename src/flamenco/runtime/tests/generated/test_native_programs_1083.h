...
int test_1083(fd_executor_test_suite_t *suite) {
  ...
  test.disable_cnt = 0;
  test.bt = "   2: solana_stake_program::stake_instruction::tests::test_stake_initialize             at ./src/stake_instruction.rs:1643:9   3: solana_stake_program::stake_instruction::tests::test_stake_initialize::all_enabled             at ./src/stake_instruction.rs:1546:5   4: solana_stake_program::stake_instruction::tests::test_stake_initialize::all_enabled::{{closure}}             at ./src/stake_instruction.rs:1546:5   5: core::ops::function::FnOnce::call_once             at /rustc/cc66ad468955717ab92600c770da8c1601a4ff33/library/core/src/ops/function.rs:250:5";
 ...
 // {'clock': '', 'epoch_schedule': '', 'epoch_rewards': '', 'fees': '', 'rent': 'mQ0AAAAAAAAAAAAAAAAAQDI=', 'slot_hashes': '', 'recent_blockhashes': '', 'stake_history': '', 'last_restart_slot': ''}
  ...
  test_acc->rent_epoch      = 0;
  test_acc->result_rent_epoch      = 0;
  static uchar const fd_flamenco_native_prog_test_1083_acc_1_data[] = { 0x99,0x0d,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x40,0x32 };
  test_acc->data            = fd_flamenco_native_prog_test_1083_acc_1_data;
  test_acc->data_len        = 17UL;
  static uchar const fd_flamenco_native_prog_test_1083_acc_1_post_data[] = { 0x99,0x0d,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x40,0x32 };
