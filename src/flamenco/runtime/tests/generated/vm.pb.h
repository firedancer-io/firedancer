...
#define FD_EXEC_TEST_SYSCALL_EFFECTS_INIT_DEFAULT {0, 0, 0, NULL, NULL, NULL, NULL, 0, NULL}
...
#define FD_EXEC_TEST_SYSCALL_EFFECTS_INIT_ZERO   {0, 0, 0, NULL, NULL, NULL, NULL, 0, NULL}
...
#define FD_EXEC_TEST_SYSCALL_EFFECTS_RODATA_TAG  7
#define FD_EXEC_TEST_SYSCALL_EFFECTS_FRAME_COUNT_TAG 8
#define FD_EXEC_TEST_SYSCALL_EFFECTS_LOG_TAG     9
...
X(a, POINTER,  SINGULAR, BYTES,    rodata,            7) \
X(a, STATIC,   SINGULAR, UINT64,   frame_count,       8) \
X(a, POINTER,  SINGULAR, BYTES,    log,               9)
