...
typedef struct fd_exec_test_type_compute_budget_fixture {
    bool has_metadata;
...
} fd_exec_test_type_compute_budget_fixture_t;
...
#define FD_EXEC_TEST_TYPE_EFFECTS_INIT_DEFAULT   {0, NULL}
#define FD_EXEC_TEST_TYPE_COMPUTE_BUDGET_FIXTURE_INIT_DEFAULT {false, FD_EXEC_TEST_FIXTURE_METADATA_INIT_DEFAULT, false, FD_EXEC_TEST_TYPE_CONTEXT_INIT_DEFAULT, false, FD_EXEC_TEST_TYPE_EFFECTS_INIT_DEFAULT}
#define FD_EXEC_TEST_TYPE_CONTEXT_INIT_ZERO      {NULL}
#define FD_EXEC_TEST_TYPE_EFFECTS_INIT_ZERO      {0, NULL}
#define FD_EXEC_TEST_TYPE_COMPUTE_BUDGET_FIXTURE_INIT_ZERO {false, FD_EXEC_TEST_FIXTURE_METADATA_INIT_ZERO, false, FD_EXEC_TEST_TYPE_CONTEXT_INIT_ZERO, false, FD_EXEC_TEST_TYPE_EFFECTS_INIT_ZERO}

/* Field tags (for use in manual encoding/decoding) */
#define FD_EXEC_TEST_TYPE_CONTEXT_CONTENT_TAG    1
#define FD_EXEC_TEST_TYPE_EFFECTS_RESULT_TAG     1
#define FD_EXEC_TEST_TYPE_EFFECTS_CONTENT_TAG    2
#define FD_EXEC_TEST_TYPE_COMPUTE_BUDGET_FIXTURE_METADATA_TAG 1
#define FD_EXEC_TEST_TYPE_COMPUTE_BUDGET_FIXTURE_INPUT_TAG 2
#define FD_EXEC_TEST_TYPE_COMPUTE_BUDGET_FIXTURE_OUTPUT_TAG 3
...
#define FD_EXEC_TEST_TYPE_COMPUTE_BUDGET_FIXTURE_FIELDLIST(X, a) \
X(a, STATIC,   OPTIONAL, MESSAGE,  metadata,          1) \
X(a, STATIC,   OPTIONAL, MESSAGE,  input,             2) \
X(a, STATIC,   OPTIONAL, MESSAGE,  output,            3)
#define FD_EXEC_TEST_TYPE_COMPUTE_BUDGET_FIXTURE_CALLBACK NULL
#define FD_EXEC_TEST_TYPE_COMPUTE_BUDGET_FIXTURE_DEFAULT NULL
#define fd_exec_test_type_compute_budget_fixture_t_metadata_MSGTYPE fd_exec_test_fixture_metadata_t
#define fd_exec_test_type_compute_budget_fixture_t_input_MSGTYPE fd_exec_test_type_context_t
#define fd_exec_test_type_compute_budget_fixture_t_output_MSGTYPE fd_exec_test_type_effects_t

extern const pb_msgdesc_t fd_exec_test_type_context_t_msg;
extern const pb_msgdesc_t fd_exec_test_type_effects_t_msg;
extern const pb_msgdesc_t fd_exec_test_type_compute_budget_fixture_t_msg;
...
#define FD_EXEC_TEST_TYPE_COMPUTE_BUDGET_FIXTURE_FIELDS &fd_exec_test_type_compute_budget_fixture_t_msg
...
/* fd_exec_test_TypeComputeBudgetFixture_size depends on runtime parameters */
...
#define org_solana_sealevel_v1_TypeComputeBudgetFixture fd_exec_test_TypeComputeBudgetFixture
...
#define ORG_SOLANA_SEALEVEL_V1_TYPE_COMPUTE_BUDGET_FIXTURE_INIT_DEFAULT FD_EXEC_TEST_TYPE_COMPUTE_BUDGET_FIXTURE_INIT_DEFAULT
...
#define ORG_SOLANA_SEALEVEL_V1_TYPE_COMPUTE_BUDGET_FIXTURE_INIT_ZERO FD_EXEC_TEST_TYPE_COMPUTE_BUDGET_FIXTURE_INIT_ZERO
