...
sol_compat_wksp_init( void ) {
  ...
  // FD_LOG_WARNING(( "footprint min %lu max %lu default %lu fuzz %lu",
  //                   FD_RUNTIME_TRANSACTION_EXECUTION_FOOTPRINT(64UL,1),
  //                   FD_RUNTIME_TRANSACTION_EXECUTION_FOOTPRINT(MAX_TX_ACCOUNT_LOCKS,0),
  //                   FD_RUNTIME_TRANSACTION_EXECUTION_FOOTPRINT_DEFAULT,
  //                   FD_RUNTIME_TRANSACTION_EXECUTION_FOOTPRINT_FUZZ ));
