...
$(call add-hdrs,fd_banks_solana.h fd_rocksdb.h fd_executor.h fd_acc_mgr.h fd_hashes.h fd_runtime.h fd_rent_lists.h)
$(call add-hdrs,sysvar/fd_sysvar.h sysvar/fd_sysvar_clock.h sysvar/fd_sysvar_slot_history.h sysvar/fd_sysvar_slot_hashes.h sysvar/fd_sysvar_epoch_schedule.h sysvar/fd_sysvar_fees.h sysvar/fd_sysvar_rent.h sysvar/fd_sysvar_stake_history.h sysvar/fd_sysvar_last_restart_slot.h)
...
$(call add-objs,fd_rocksdb fd_executor fd_acc_mgr fd_hashes fd_runtime fd_rent_lists tests/fd_tests,fd_flamenco)
$(call add-objs,sysvar/fd_sysvar sysvar/fd_sysvar_clock sysvar/fd_sysvar_recent_hashes sysvar/fd_sysvar_slot_history sysvar/fd_sysvar_slot_hashes sysvar/fd_sysvar_epoch_schedule sysvar/fd_sysvar_fees sysvar/fd_sysvar_rent sysvar/fd_sysvar_stake_history sysvar/fd_sysvar_last_restart_slot,fd_flamenco)
$(call add-objs,program/fd_system_program program/fd_nonce_program program/fd_vote_program program/fd_builtin_programs program/fd_compute_budget_program program/fd_config_program program/fd_bpf_loader_program program/fd_bpf_upgradeable_loader_program program/fd_bpf_deprecated_loader_program program/fd_ed25519_program program/fd_secp256k1_program program/fd_bpf_loader_serialization,fd_flamenco)
