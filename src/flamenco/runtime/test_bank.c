...
main( int argc, char ** argv ) {
  ...
  keys->account_keys.pool_offset = 100UL;
  keys->account_keys.root_offset = 100UL;
  ...
  keys2->account_keys.pool_offset = 101UL;
  keys2->account_keys.root_offset = 101UL;
  ...
  FD_TEST( keys3->account_keys.pool_offset == 100UL );
  FD_TEST( keys3->account_keys.root_offset == 100UL );
  ...
  FD_TEST( keys4->account_keys.pool_offset == 101UL );
  FD_TEST( keys4->account_keys.root_offset == 101UL );
  fd_bank_stake_account_keys_end_locking_query( bank11 );

  keys = fd_bank_vote_account_keys_locking_modify( bank11 );
  keys->account_keys.pool_offset = 200UL;
  keys->account_keys.root_offset = 200UL;
  ...
  votes->votes.pool_offset = 102UL;
  votes->votes.root_offset = 102UL;
  ...
  FD_TEST( keys3->account_keys.pool_offset == 200UL );
  FD_TEST( keys3->account_keys.root_offset == 200UL );
  fd_bank_vote_account_keys_end_locking_query( bank11 );
  ...
  FD_TEST( votes->votes.pool_offset == 102UL );
  FD_TEST( votes->votes.root_offset == 102UL );
  fd_bank_clock_timestamp_votes_end_locking_query( bank11 );
