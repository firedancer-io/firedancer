...
main( int argc, char ** argv ) {
  ...
  FD_TEST( !fd_banks_rekey_root_bank( banks, &block_id_1 ) );
  ...
  fd_bank_t * rekeyed_root = fd_banks_rekey_root_bank( banks, &block_id_999 );
  ...
  rekeyed_root = fd_banks_rekey_root_bank( banks, &block_id_1 );
  FD_TEST( rekeyed_root );
  ...
  rekeyed_root = fd_banks_rekey_root_bank( banks, &block_id_1234 );
  FD_TEST( rekeyed_root );
