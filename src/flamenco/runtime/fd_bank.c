...
fd_banks_new( void * shmem,
  ...
  fd_stake_delegations_t * stake_delegations = fd_stake_delegations_join( fd_stake_delegations_new( stake_delegations_mem, seed, max_stake_accounts, max_disk_records, max_total_banks ) );
