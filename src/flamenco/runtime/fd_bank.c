...
fd_banks_footprint( ulong max_total_banks,
  ...
  l = FD_LAYOUT_APPEND( l, fd_vote_stakes_align(),             fd_vote_stakes_footprint( 1000000UL, max_fork_width, 2048UL ) ); /* TODO:FIXME: setup params for this correctly */
...
fd_banks_new( void * shmem,
  ...
  void *            vote_stakes_mem        = FD_SCRATCH_ALLOC_APPEND( l, fd_vote_stakes_align(),             fd_vote_stakes_footprint( 1000000UL, max_fork_width, 2048UL ) ); /* TODO:FIXME: setup params for this correctly */
