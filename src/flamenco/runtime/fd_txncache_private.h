...
/* Packed to 30 bytes to save memory.  Fields must not be accessed
   atomically (unaligned).  No CAS targets this struct: entries are
   published via the heads[] CAS in the containing blockcache. */
