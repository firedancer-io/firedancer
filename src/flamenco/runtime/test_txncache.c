...
test_page_sizing( void ) {
  ...
  FD_TEST( fd_txncache_shmem_footprint( 2048UL, max_txn_per_slot )==8251646976UL ); /* production, ushort page indices */
  ...
  FD_TEST( fd_txncache_shmem_footprint( 2048UL, bench_txn_per_slot )==42854135296UL );
