...
build/linux/gcc/x86_64/bin/fd_frank_ledger --rocksdb test-ledger-4/rocksdb --genesis test-ledger-4/genesis.bin --cmd ingest --indexmax 10000 --txnmax 100 --backup test_ledger_backup
