...
typedef ulong                     (* fd_txn_account_get_starting_lamports_fn_t) ( fd_txn_account_t const * acct );
typedef ulong                     (* fd_txn_account_get_starting_data_len_fn_t) ( fd_txn_account_t const * acct );
...
typedef void                      (* fd_txn_account_set_starting_lamports_fn_t) ( fd_txn_account_t * acct, ulong starting_lamports );
typedef void                      (* fd_txn_account_set_starting_data_len_fn_t) ( fd_txn_account_t * acct, ulong starting_data_len );
...
struct fd_txn_account_vtable {
  ...
  fd_txn_account_get_starting_lamports_fn_t get_starting_lamports;
  fd_txn_account_get_starting_data_len_fn_t get_starting_data_len;
  /* setters */
  ...
  fd_txn_account_set_starting_lamports_fn_t set_starting_lamports;
  fd_txn_account_set_starting_data_len_fn_t set_starting_data_len;
