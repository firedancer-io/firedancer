...
target_core_bpf_new_checked( target_core_bpf_t *  target_core_bpf,
  ...
  if( FD_UNLIKELY( !fd_bincode_decode_static( bpf_upgradeable_loader_state, program_state, program_account->data, program_account->data_sz ) ) ) {
    return NULL;
  }
  ...
  if( FD_UNLIKELY( !fd_bincode_decode_static( bpf_upgradeable_loader_state, programdata_state, program_data_account->data, program_data_account->data_sz ) ) ) {
    return NULL;
  }
