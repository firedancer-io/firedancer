...
/* fd_hashes_update_lthash_from_funk is a convenience wrapper that looks
   up the previous account state from funk before updating the lthash.
   This is the typical usage pattern during transaction execution.
...
void
fd_hashes_update_lthash_from_funk( fd_funk_t *         funk,
