...
void fd_enable_testnet(struct fd_features *f) {
  ...
  f->disable_bpf_deprecated_load_instructions = 124508260; // disable ldabs* and ldind* BPF instructions
  f->disable_bpf_unresolved_symbols_at_runtime = 124508260; // disable reporting of unresolved BPF symbols at runtime
...
void fd_enable_devnet(struct fd_features *f) {
  ...
  f->disable_bpf_deprecated_load_instructions = 128304000; // disable ldabs* and ldind* BPF instructions
  f->prevent_calling_precompiles_as_programs = 128304000; // prevent calling precompiles as programs
  f->disable_bpf_unresolved_symbols_at_runtime = 128304000; // disable reporting of unresolved BPF symbols at runtime
...
void fd_enable_mainnet(struct fd_features *f) {
  ...
  f->disable_bpf_deprecated_load_instructions = 139104000; // disable ldabs* and ldind* BPF instructions
  f->disable_bpf_unresolved_symbols_at_runtime = 139104000; // disable reporting of unresolved BPF symbols at runtime
...
void fd_enable_everything(struct fd_features *f) {
  ...
  f->disable_bpf_deprecated_load_instructions = 1; // disable ldabs* and ldind* BPF instructions
  f->disable_bpf_unresolved_symbols_at_runtime = 1; // disable reporting of unresolved BPF symbols at runtime
