...
fd_program_cache_validate_sbpf_program( fd_bank_t *                bank,
  ...
  int direct_mapping                       = FD_FEATURE_ACTIVE( fd_bank_slot_get( bank ), fd_bank_features_query( bank ), account_data_direct_mapping );
  int stricter_abi_and_runtime_constraints = FD_FEATURE_ACTIVE( fd_bank_slot_get( bank ), fd_bank_features_query( bank ), stricter_abi_and_runtime_constraints );
