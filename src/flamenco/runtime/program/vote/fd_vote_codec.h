...
/* fd_vote_account_collectors returns SIMD-0232 commission
   collectors.  Older vote states use the vote account for inflation
   rewards and the node identity for block revenue.  Returns 0 on
   success, 1 on error. */
