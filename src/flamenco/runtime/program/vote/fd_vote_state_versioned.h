...
/* Decodes the vote account data and stores the decoded state in
   versioned.  Returns FD_EXECUTOR_INSTR_ERR_INVALID_ACC_DATA if
   decoding fails.
...
/* Sets the authorized voter for the appropriate vote state version.
   Only supported for v3 and v4 vote states.
...
/* https://github.com/anza-xyz/agave/blob/v4.2.0-beta.1/programs/vote/src/vote_state/handler.rs#L178-L182 */
void
