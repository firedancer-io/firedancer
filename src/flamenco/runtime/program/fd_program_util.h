...
static inline int
fd_borrowed_account_checked_add_lamports( fd_account_meta_t * meta,
                                          ulong               lamports ) {
  ulong temp;
  int   rc = fd_int_if( __builtin_uaddl_overflow( meta->info.lamports, lamports, &temp ),
