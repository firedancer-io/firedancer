...
// https://github.com/firedancer-io/solana/blob/debug-master/programs/vote/src/vote_processor.rs#L21
static int
...
// https://github.com/firedancer-io/solana/blob/debug-master/programs/vote/src/vote_state/mod.rs#L546
static int
...
// https://github.com/firedancer-io/solana/blob/debug-master/programs/vote/src/vote_state/mod.rs#L996
static int
...
// https://github.com/firedancer-io/solana/blob/debug-master/programs/vote/src/vote_state/mod.rs#L1017
static int
...
// https://github.com/firedancer-io/solana/blob/debug-master/programs/vote/src/vote_state/mod.rs#L1036
static int
...
// https://github.com/firedancer-io/solana/blob/debug-master/sdk/program/src/vote/state/mod.rs#L447
static void
...
// https://github.com/firedancer-io/solana/blob/debug-master/sdk/program/src/vote/state/mod.rs#L614
static void
...
// https://github.com/firedancer-io/solana/blob/da470eef4652b3b22598a1f379cacfe82bd5928d/sdk/program/src/vote/state/mod.rs#L94
static bool
...
// https://github.com/firedancer-io/solana/blob/da470eef4652b3b22598a1f379cacfe82bd5928d/sdk/program/src/vote/authorized_voters.rs#L64-L66
static fd_vote_authorized_voter_t *
authorized_voters_first( fd_vote_authorized_voters_t * self );
...
fd_executor_vote_program_execute_instruction( instruction_ctx_t ctx ) {
  ...
  if ( FD_UNLIKELY( 0 != memcmp( &me->meta->info.owner, ctx.global->solana_vote_program, 32UL ) ) )
  ...
  if ( FD_UNLIKELY( FD_EXECUTOR_INSTR_SUCCESS !=
                    fd_vote_instruction_decode( &instruction, &decode ) ) ) {
...
// https://github.com/firedancer-io/solana/blob/da470eef4652b3b22598a1f379cacfe82bd5928d/sdk/program/src/vote/authorized_voters.rs#L64-L66
static inline fd_vote_authorized_voter_t * __attribute__((unused))
authorized_voters_first( fd_vote_authorized_voters_t * self ) {
  fd_vote_authorized_voters_treap_fwd_iter_t iter =
      fd_vote_authorized_voters_treap_fwd_iter_init( self->treap, self->pool );
  return fd_vote_authorized_voters_treap_fwd_iter_ele( iter, self->pool );
}
