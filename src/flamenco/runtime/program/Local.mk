...
ifdef FD_HAS_ATOMIC
ifdef FD_HAS_HOSTED
$(call make-unit-test,test_bpf_loader_serialization,test_bpf_loader_serialization,fd_flamenco_test fd_flamenco fd_choreo fd_ballet fd_util)
$(call run-unit-test,test_bpf_loader_serialization)

$(call make-unit-test,test_bpf_loader_program,test_bpf_loader_program,fd_flamenco fd_choreo fd_ballet fd_util)
$(call run-unit-test,test_bpf_loader_program)

$(call make-unit-test,test_vote_program,test_vote_program,fd_flamenco_test fd_flamenco fd_choreo fd_ballet fd_util)
$(call run-unit-test,test_vote_program)

$(call make-unit-test,test_create_account_allow_prefund,test_create_account_allow_prefund,fd_flamenco_test fd_flamenco fd_choreo fd_ballet fd_util)
