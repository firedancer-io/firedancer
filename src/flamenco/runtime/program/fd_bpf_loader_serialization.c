...
fd_bpf_loader_input_serialize_aligned( fd_exec_instr_ctx_t *     ctx,
   ...
   */
  uchar * serialized_params            = ctx->runtime->exec_stack->bpf_loader_serialization.serialization_mem[ ctx->runtime->instr.stack_sz-1UL ];
  ...
  *sz = (ulong)(serialized_params - serialized_params_start);
