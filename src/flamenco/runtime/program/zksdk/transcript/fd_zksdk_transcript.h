...
static inline void
fd_zksdk_transcript_domsep_equality_proof( fd_zksdk_transcript_t * transcript ) {
  fd_merlin_transcript_append_message( transcript, FD_TRANSCRIPT_LITERAL("dom-sep"), (uchar *)FD_TRANSCRIPT_LITERAL("equality-proof") );
}

static inline void
fd_zksdk_transcript_domsep_zero_balance_proof( fd_zksdk_transcript_t * transcript ) {
...
static inline void
fd_zksdk_transcript_domsep_grp_ciph_val_proof( fd_zksdk_transcript_t * transcript ) {
  fd_merlin_transcript_append_message( transcript, FD_TRANSCRIPT_LITERAL("dom-sep"), (uchar *)FD_TRANSCRIPT_LITERAL("validity-proof") );
}

static inline void
fd_zksdk_transcript_domsep_batched_grp_ciph_val_proof( fd_zksdk_transcript_t * transcript ) {
