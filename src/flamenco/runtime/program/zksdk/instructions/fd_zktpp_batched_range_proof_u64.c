...
int
fd_zktpp_instr_verify_proof_batched_range_proof_u64( void const * _context, void const * _proof ) {
  ...
  FD_LOG_DEBUG(( "fd_zktpp_instr_verify_proof_batched_range_proof_u64" ));
  ...
  return fd_zktpp_verify_proof_range_u64( proof, context->commitments, context->bit_lengths, len, transcript );
}
