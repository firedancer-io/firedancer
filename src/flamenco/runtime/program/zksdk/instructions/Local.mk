...
# $(call add-objs,fd_zksdk_grouped_ciphertext_2_handles,fd_flamenco)
# $(call add-objs,fd_zksdk_batched_grouped_ciphertext_2_handles,fd_flamenco)
# $(call add-objs,fd_zksdk_grouped_ciphertext_3_handles,fd_flamenco)
# $(call add-objs,fd_zksdk_batched_grouped_ciphertext_3_handles,fd_flamenco)
endif
