...
test_env_create( test_env_t * env, fd_wksp_t * wksp ) {
  ...
  ulong accdb_shmem_sz = fd_accdb_shmem_footprint( accdb_max_accounts, 0UL, accdb_max_live_slots,
  ...
  fd_accdb_shmem_t * shmem = fd_accdb_shmem_join(
      fd_accdb_shmem_new( env->accdb_shmem, accdb_max_accounts, 0UL, accdb_max_live_slots,
  ...
  FD_TEST( shmem );
  env->accdb = fd_accdb_join( fd_accdb_new( env->accdb_join, shmem, env->accdb_fd, -1, 0UL, NULL ) );
  FD_TEST( env->accdb );
