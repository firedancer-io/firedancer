...
main( int argc, char * argv[] ) {
  ...
  fd_top_votes_insert( top_votes, &vote_E, &node_E, 50UL, 1 );
  ...
  fd_top_votes_insert( top_votes, &vote_G, &node_G, 9UL, 1 );
  ...
  fd_top_votes_insert( top_votes, &vote_J, &node_J, 11UL, 1 ); /* ties current min */
  ...
  fd_top_votes_insert( top_votes, &vote_K, &node_K, 11UL, 1 );
  assert_vote_absent( top_votes, &vote_K );

  fd_top_votes_insert( top_votes, &vote_L, &node_L, 12UL, 1 );
