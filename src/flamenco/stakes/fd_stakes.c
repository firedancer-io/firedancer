...
fd_refresh_vote_accounts( fd_bank_t *                    bank,
  ...
  fd_top_votes_t * top_votes_t_2 = fd_bank_top_votes_t_1_modify( bank );
  fd_top_votes_t * top_votes_t_3 = fd_bank_top_votes_t_2_modify( bank );

  int delay_commission = FD_FEATURE_ACTIVE_BANK( bank, validator_admission_ticket );
  ...
  fd_memcpy( top_votes_t_3, top_votes_t_2, FD_TOP_VOTES_MAX_FOOTPRINT );
  fd_top_votes_t * top_votes_t_1 = top_votes_t_2;
