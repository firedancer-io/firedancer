...
int main( int argc, char * argv[] ) {
  ...
  fd_vote_stakes_insert_key( vote_stakes, dedup_idx, &pubkey_A, &node_account_t_1, &node_account_t_2, 888UL, 0UL );
  ...
  fd_vote_stakes_insert_key( vote_stakes, reuse_idx, &pubkey_B, &node_account_t_1_fork_1, &node_account_t_2, 999UL, 0UL );
