...
int main( int argc, char * argv[] ) {
  ...
  fd_vote_stakes_insert_key( vote_stakes, idx_1, &pubkey_A, &node_account_t_1_fork_1, &node_account_t_2, 200UL, 0UL, 1 ); fd_vote_stakes_insert_update( vote_stakes, idx_1, &pubkey_A, 301UL );
  fd_vote_stakes_insert_key( vote_stakes, idx_1, &pubkey_B, &node_account_t_1_fork_1, &node_account_t_2, 200UL, 0UL, 1 ); fd_vote_stakes_insert_update( vote_stakes, idx_1, &pubkey_B, 301UL );
  fd_vote_stakes_insert_key( vote_stakes, idx_1, &pubkey_C, &node_account_t_1_fork_1, &node_account_t_2, 200UL, 0UL, 1 ); fd_vote_stakes_insert_update( vote_stakes, idx_1, &pubkey_C, 301UL );
  fd_vote_stakes_insert_key( vote_stakes, idx_1, &pubkey_D, &node_account_t_1_fork_1, &node_account_t_2, 200UL, 0UL, 1 ); fd_vote_stakes_insert_update( vote_stakes, idx_1, &pubkey_D, 301UL );
  fd_vote_stakes_insert_key( vote_stakes, idx_1, &pubkey_E, &node_account_t_1_fork_1, &node_account_t_2, 200UL, 0UL, 1 ); fd_vote_stakes_insert_update( vote_stakes, idx_1, &pubkey_E, 301UL );
  ...
  fd_vote_stakes_insert_key( vote_stakes, idx_2, &pubkey_A, &node_account_t_1_fork_2, &node_account_t_2, 200UL, 0UL, 1 ); fd_vote_stakes_insert_update( vote_stakes, idx_2, &pubkey_A, 301UL );
  fd_vote_stakes_insert_key( vote_stakes, idx_2, &pubkey_B, &node_account_t_1_fork_2, &node_account_t_2, 200UL, 0UL, 1 ); fd_vote_stakes_insert_update( vote_stakes, idx_2, &pubkey_B, 301UL );
  fd_vote_stakes_insert_key( vote_stakes, idx_2, &pubkey_C, &node_account_t_1_fork_2, &node_account_t_2, 200UL, 0UL, 1 ); fd_vote_stakes_insert_update( vote_stakes, idx_2, &pubkey_C, 301UL );
  fd_vote_stakes_insert_key( vote_stakes, idx_2, &pubkey_D, &node_account_t_1_fork_2, &node_account_t_2, 200UL, 0UL, 1 ); fd_vote_stakes_insert_update( vote_stakes, idx_2, &pubkey_D, 301UL );
  fd_vote_stakes_insert_key( vote_stakes, idx_2, &pubkey_E, &node_account_t_1_fork_2, &node_account_t_2, 200UL, 0UL, 1 ); fd_vote_stakes_insert_update( vote_stakes, idx_2, &pubkey_E, 302UL );
  ...
  fd_vote_stakes_insert_key( vote_stakes, idx_3, &pubkey_A, &node_account_t_1_fork_3, &node_account_t_2, 200UL, 0UL, 1 ); fd_vote_stakes_insert_update( vote_stakes, idx_3, &pubkey_A, 301UL );
  fd_vote_stakes_insert_key( vote_stakes, idx_3, &pubkey_B, &node_account_t_1_fork_3, &node_account_t_2, 200UL, 0UL, 1 ); fd_vote_stakes_insert_update( vote_stakes, idx_3, &pubkey_B, 301UL );
  fd_vote_stakes_insert_key( vote_stakes, idx_3, &pubkey_C, &node_account_t_1_fork_3, &node_account_t_2, 200UL, 0UL, 1 ); fd_vote_stakes_insert_update( vote_stakes, idx_3, &pubkey_C, 301UL );
  fd_vote_stakes_insert_key( vote_stakes, idx_3, &pubkey_D, &node_account_t_1_fork_3, &node_account_t_2, 200UL, 0UL, 1 ); fd_vote_stakes_insert_update( vote_stakes, idx_3, &pubkey_D, 301UL );
  fd_vote_stakes_insert_key( vote_stakes, idx_3, &pubkey_E, &node_account_t_1_fork_3, &node_account_t_2, 200UL, 0UL, 1 ); fd_vote_stakes_insert_update( vote_stakes, idx_3, &pubkey_E, 302UL );
  fd_vote_stakes_insert_key( vote_stakes, idx_3, &pubkey_F, &node_account_t_1_fork_3, &node_account_t_2, 200UL, 0UL, 1 ); fd_vote_stakes_insert_update( vote_stakes, idx_3, &pubkey_F, 302UL );
  ...
  fd_vote_stakes_root_insert_key( vote_stakes, &pubkey_A, &node_account_t_1, 777UL, 0UL );
  fd_vote_stakes_root_update_meta( vote_stakes, &pubkey_A, &node_account_t_2, 888UL, 0UL );
  FD_TEST( 1U==index_pool_used( index_pool ) );

  ushort dedup_idx = fd_vote_stakes_new_child( vote_stakes );
  fd_vote_stakes_insert_key( vote_stakes, dedup_idx, &pubkey_A, &node_account_t_1, &node_account_t_2, 888UL, 0UL, 1 );
  ...
  FD_TEST( fd_vote_stakes_query( vote_stakes, dedup_idx, &pubkey_A, &stake_t_1, &stake_t_2, &node_account_t_1_out, &node_account_t_2_out ) );
  ...
  fd_vote_stakes_insert_key( vote_stakes, reuse_idx, &pubkey_B, &node_account_t_1_fork_1, &node_account_t_2, 999UL, 0UL, 1 );
