...
test_vm_minimal_exec_instr_ctx( fd_exec_instr_ctx_t * instr_ctx,
  ...
  /* Setup feature flags */
  fd_features_disable_all( &bank->data->fields.features );
  fd_features_set( &bank->data->fields.features, fd_feature_id_query( TEST_VM_REJECT_CALLX_R10_FEATURE_PREFIX ), 0UL );
