...
fd_vm_syscall_sol_get_epoch_schedule_sysvar( /**/            void *  _vm,
  ...
  fd_epoch_schedule_t * schedule = fd_sysvar_epoch_schedule_read( instr_ctx->txn_ctx->sysvar_cache,
                                                                  instr_ctx->txn_ctx->funk,
                                                                  instr_ctx->txn_ctx->funk_txn,
                                                                  instr_ctx->txn_ctx->spad,
                                                                  instr_ctx->txn_ctx->runtime_pub_wksp );
...
fd_vm_syscall_sol_get_fees_sysvar( /**/            void *  _vm,
  ...
  fd_sysvar_fees_t * fees = fd_sysvar_fees_read( instr_ctx->txn_ctx->sysvar_cache,
                                                 instr_ctx->txn_ctx->funk,
                                                 instr_ctx->txn_ctx->funk_txn,
                                                 instr_ctx->txn_ctx->spad,
                                                 instr_ctx->txn_ctx->runtime_pub_wksp );
...
fd_vm_syscall_sol_get_last_restart_slot_sysvar( /**/            void *  _vm,
  ...
  fd_sol_sysvar_last_restart_slot_t * last_restart_slot = fd_sysvar_last_restart_slot_read( vm->instr_ctx->txn_ctx->sysvar_cache,
...
fd_vm_syscall_sol_get_epoch_rewards_sysvar( /**/            void *  _vm,
  ...
  fd_sysvar_epoch_rewards_t * epoch_rewards = fd_sysvar_epoch_rewards_read( instr_ctx->txn_ctx->sysvar_cache,
                                                                            instr_ctx->txn_ctx->funk,
                                                                            instr_ctx->txn_ctx->funk_txn,
                                                                            instr_ctx->txn_ctx->spad,
                                                                            instr_ctx->txn_ctx->runtime_pub_wksp );
