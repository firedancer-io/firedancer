...
fd_vm_memmove( fd_vm_t * vm,
  ...
  if( !vm->direct_mapping ) {
    ...
    FD_VM_TRANSLATE_MUT_N( vm, 1UL, &dst_ref_mut_query, NULL, NULL, NULL, NULL );
...
fd_vm_syscall_sol_memcmp( /**/            void *  _vm,
  ...
  *_ret = 0;
  ...
  if( !vm->direct_mapping ) {
    ...
    FD_VM_TRANSLATE_MUT_N( vm, 1UL, &cmp_result_ref_mut_query, NULL, NULL, NULL, NULL );
    ...
    /* TODO: Refactor to use `FD_VM_TRANSLATE_MUT_N` macro when direct mapping is rewritten */
...
fd_vm_syscall_sol_memset( /**/            void *  _vm,
  ...
  *_ret = 0;
  ...
  if( !vm->direct_mapping ) {
    ...
    FD_VM_TRANSLATE_MUT_N( vm, 1UL, &haddr_query, NULL, NULL, NULL, NULL );
