...
#define FD_VM_SYSCALL_SOL_ALT_BN128_ADD_BE              (  0UL) /* add */
#define FD_VM_SYSCALL_SOL_ALT_BN128_SUB_BE              (  1UL) /* add inverse */
#define FD_VM_SYSCALL_SOL_ALT_BN128_MUL_BE              (  2UL) /* scalar mult */
...
#define FD_VM_SYSCALL_SOL_ALT_BN128_ADD_LE              ( FD_VM_SYSCALL_SOL_ALT_BN128_ADD_BE     | FD_VM_SYSCALL_SOL_ALT_BN128_LITTLE_ENDIAN_FLAG )
#define FD_VM_SYSCALL_SOL_ALT_BN128_SUB_LE              ( FD_VM_SYSCALL_SOL_ALT_BN128_SUB_BE     | FD_VM_SYSCALL_SOL_ALT_BN128_LITTLE_ENDIAN_FLAG )
#define FD_VM_SYSCALL_SOL_ALT_BN128_MUL_LE              ( FD_VM_SYSCALL_SOL_ALT_BN128_MUL_BE     | FD_VM_SYSCALL_SOL_ALT_BN128_LITTLE_ENDIAN_FLAG )
