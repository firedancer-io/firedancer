...
$(call add-objs,test_vm_util,fd_flamenco_test)

$(call make-unit-test,test_vm_interp,test_vm_interp,fd_flamenco_test fd_flamenco fd_ballet fd_util fd_disco,$(BLST_LIBS))
