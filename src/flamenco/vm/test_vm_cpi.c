...
FD_STATIC_ASSERT( offsetof( fd_vm_c_instruction_t, accounts_cnt    )==16UL, layout );
FD_STATIC_ASSERT( offsetof( fd_vm_c_instruction_t, data_addr       )==24UL, layout );
FD_STATIC_ASSERT( offsetof( fd_vm_c_instruction_t, data_sz         )==32UL, layout );
...
FD_STATIC_ASSERT( offsetof( fd_vm_c_vec_t, addr )== 0UL, layout );
FD_STATIC_ASSERT( offsetof( fd_vm_c_vec_t, len  )== 8UL, layout );
FD_STATIC_ASSERT( sizeof  ( fd_vm_c_vec_t       )==16UL, layout );
