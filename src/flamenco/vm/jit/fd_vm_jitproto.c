...
#line 271 "fd_vm_jitproto.dasc"
  ...
  //| jmp ->leave
  dasm_put(Dst, 2);
#line 278 "fd_vm_jitproto.dasc"

  /* Start translating user code */

  //|->main:
  dasm_put(Dst, 16);
#line 282 "fd_vm_jitproto.dasc"
...
#line 574 "fd_vm_jitproto.dasc"
    ...
    case 0x63:  /* FD_SBPF_OP_STXW */
      //| lea rdi, [dst64+offset]
      dasm_put(Dst, 456, (x86_dst), offset);
#line 578 "fd_vm_jitproto.dasc"
      // TODO translate
      // TODO check align
      //| mov [rdi], src32
      dasm_put(Dst, 473, (x86_src));
#line 581 "fd_vm_jitproto.dasc"
      break;

    case 0x64:  /* FD_SBPF_OP_LSH_IMM */
      //| shl dst32, imm
      dasm_put(Dst, 478, (x86_dst), imm);
#line 585 "fd_vm_jitproto.dasc"
      break;
...
#line 640 "fd_vm_jitproto.dasc"
      break;

    case 0x72:  /* FD_SBPF_OP_STB */
      //| lea rdi, [src64+offset]
      dasm_put(Dst, 456, (x86_src), offset);
#line 644 "fd_vm_jitproto.dasc"
      // TODO translate
      // TODO check align
      //| mov byte [rdi], imm
...
#line 654 "fd_vm_jitproto.dasc"
      break;

    case 0x74:  /* FD_SBPF_OP_RSH_IMM */
      //| shr dst32, imm
      dasm_put(Dst, 557, (x86_dst), imm);
#line 658 "fd_vm_jitproto.dasc"
      break;
...
#line 663 "fd_vm_jitproto.dasc"
      break;

    case 0x77:  /* FD_SBPF_OP_RSH64_IMM */
      //| shr dst64, imm
      dasm_put(Dst, 574, (x86_dst), imm);
#line 667 "fd_vm_jitproto.dasc"
      break;

    case 0x79:  /* FD_SBPF_OP_LDXQ */
      //| lea rdi, [src64+offset]
      dasm_put(Dst, 456, (x86_src), offset);
#line 671 "fd_vm_jitproto.dasc"
      // TODO translate
      // TODO check align
      //| mov dst64, [rdi]
...
#line 683 "fd_vm_jitproto.dasc"
    ...
    case 0x7b:  /* FD_SBPF_OP_STXQ */
      //| lea rdi, [dst64+offset]
      dasm_put(Dst, 456, (x86_dst), offset);
#line 687 "fd_vm_jitproto.dasc"
      // TODO translate
      // TODO check align
      //| mov [rdi], src64
      dasm_put(Dst, 595, (x86_src));
#line 690 "fd_vm_jitproto.dasc"
      break;
...
#line 819 "fd_vm_jitproto.dasc"
      break;

    case 0xb7:  /* FD_SBPF_OP_MOV64_IMM */
      //| mov dst64, imm
      dasm_put(Dst, 141, (x86_dst), imm);
#line 823 "fd_vm_jitproto.dasc"
      break;
...
#line 887 "fd_vm_jitproto.dasc"
        break;
      case 64U:
        //| bswap dst64
        dasm_put(Dst, 885, (x86_dst));
#line 890 "fd_vm_jitproto.dasc"
        break;
      default:
        break;
        // TODO sigill
