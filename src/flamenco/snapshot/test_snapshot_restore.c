...
# define NEW_RESTORE() \
    fd_snapshot_restore_new( restore_mem, _spad, _dummy_ctx, cb_manifest, cb_status_cache, NULL, NULL, NULL )
...
# define NEW_RESTORE_POST_MANIFEST() __extension__({ \
    fd_snapshot_restore_t * restore = fd_snapshot_restore_new( restore_mem, _spad, _dummy_ctx, cb_manifest, cb_status_cache, NULL, NULL, NULL ); \
  ...
  /* Test invalid params */
  fd_spad_push( _spad );
  FD_TEST( !fd_snapshot_restore_new( NULL,        _spad, NULL, cb_manifest, cb_status_cache, NULL, NULL, NULL ) );  /* NULL mem */
  FD_TEST( !fd_snapshot_restore_new( restore_mem, _spad, NULL, cb_manifest, cb_status_cache, NULL, NULL, NULL ) );  /* NULL funk */
  fd_spad_pop( _spad );
  ...
  do {
    fd_spad_push( _spad );
    fd_snapshot_restore_t * restore = fd_snapshot_restore_new( restore_mem, _spad, NULL, cb_manifest, cb_status_cache, NULL, NULL, NULL );
    FD_TEST( restore );
