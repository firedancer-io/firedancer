...
int
fd_mux_tile( char const *  _cnc,        /* Workspace gaddr for mux's command-and-control communications */
             ...
             char const *  _mcache,     /* Workspace gaddr for mcache of the multiplexed frag streams */
