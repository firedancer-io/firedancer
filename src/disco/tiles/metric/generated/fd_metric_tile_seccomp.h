...
#ifndef HEADER_fd_src_disco_tiles_metric_generated_fd_metric_tile_seccomp_h
#define HEADER_fd_src_disco_tiles_metric_generated_fd_metric_tile_seccomp_h
...
#endif
static const unsigned int sock_filter_policy_fd_metric_tile_instr_cnt = 20;

static void populate_sock_filter_policy_fd_metric_tile( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd, unsigned int socket_fd) {
  FD_TEST( out_cnt >= 20 );
