...
#ifndef HEADER_fd_src_disco_tiles_quic_generated_fd_quic_tile_seccomp_h
#define HEADER_fd_src_disco_tiles_quic_generated_fd_quic_tile_seccomp_h
...
#endif
static const unsigned int sock_filter_policy_fd_quic_tile_instr_cnt = 15;

static void populate_sock_filter_policy_fd_quic_tile( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd) {
  FD_TEST( out_cnt >= 15 );
