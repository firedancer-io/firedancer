...
fd_gui_txn_waterfall_snap( fd_gui_t *               gui,
  ...
  for( ulong i=0UL; i<gui->summary.bank_tile_cnt; i++ ) {
    ...
    cur->out.block_success += bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_SUCCESS ) ];

    cur->out.block_fail +=
        bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_ACCOUNT_IN_USE ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_ACCOUNT_LOADED_TWICE ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_ACCOUNT_NOT_FOUND ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_PROGRAM_ACCOUNT_NOT_FOUND ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_INSUFFICIENT_FUNDS_FOR_FEE ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_INVALID_ACCOUNT_FOR_FEE ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_ALREADY_PROCESSED ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_BLOCKHASH_NOT_FOUND ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_INSTRUCTION_ERROR ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_CALL_CHAIN_TOO_DEEP ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_MISSING_SIGNATURE_FOR_FEE ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_INVALID_ACCOUNT_INDEX ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_SIGNATURE_FAILURE ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_INVALID_PROGRAM_FOR_EXECUTION ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_SANITIZE_FAILURE ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_CLUSTER_MAINTENANCE ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_ACCOUNT_BORROW_OUTSTANDING ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_WOULD_EXCEED_MAX_BLOCK_COST_LIMIT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_UNSUPPORTED_VERSION ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_INVALID_WRITABLE_ACCOUNT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_WOULD_EXCEED_MAX_ACCOUNT_COST_LIMIT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_WOULD_EXCEED_ACCOUNT_DATA_BLOCK_LIMIT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_TOO_MANY_ACCOUNT_LOCKS ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_ADDRESS_LOOKUP_TABLE_NOT_FOUND ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_INVALID_ADDRESS_LOOKUP_TABLE_OWNER ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_INVALID_ADDRESS_LOOKUP_TABLE_DATA ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_INVALID_ADDRESS_LOOKUP_TABLE_INDEX ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_INVALID_RENT_PAYING_ACCOUNT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_WOULD_EXCEED_MAX_VOTE_COST_LIMIT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_WOULD_EXCEED_ACCOUNT_DATA_TOTAL_LIMIT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_DUPLICATE_INSTRUCTION ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_INSUFFICIENT_FUNDS_FOR_RENT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_MAX_LOADED_ACCOUNTS_DATA_SIZE_EXCEEDED ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_INVALID_LOADED_ACCOUNTS_DATA_SIZE_LIMIT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_RESANITIZATION_NEEDED ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_PROGRAM_EXECUTION_TEMPORARILY_RESTRICTED ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_UNBALANCED_TRANSACTION ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTED_PROGRAM_CACHE_HIT_MAX_LIMIT ) ];
    ...
    cur->out.bank_invalid +=
        bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_ACCOUNT_IN_USE ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_ACCOUNT_LOADED_TWICE ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_ACCOUNT_NOT_FOUND ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_PROGRAM_ACCOUNT_NOT_FOUND ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_INSUFFICIENT_FUNDS_FOR_FEE ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_INVALID_ACCOUNT_FOR_FEE ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_ALREADY_PROCESSED ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_BLOCKHASH_NOT_FOUND ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_INSTRUCTION_ERROR ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_CALL_CHAIN_TOO_DEEP ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_MISSING_SIGNATURE_FOR_FEE ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_INVALID_ACCOUNT_INDEX ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_SIGNATURE_FAILURE ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_INVALID_PROGRAM_FOR_EXECUTION ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_SANITIZE_FAILURE ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_CLUSTER_MAINTENANCE ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_ACCOUNT_BORROW_OUTSTANDING ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_WOULD_EXCEED_MAX_BLOCK_COST_LIMIT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_UNSUPPORTED_VERSION ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_INVALID_WRITABLE_ACCOUNT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_WOULD_EXCEED_MAX_ACCOUNT_COST_LIMIT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_WOULD_EXCEED_ACCOUNT_DATA_BLOCK_LIMIT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_TOO_MANY_ACCOUNT_LOCKS ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_ADDRESS_LOOKUP_TABLE_NOT_FOUND ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_INVALID_ADDRESS_LOOKUP_TABLE_OWNER ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_INVALID_ADDRESS_LOOKUP_TABLE_DATA ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_INVALID_ADDRESS_LOOKUP_TABLE_INDEX ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_INVALID_RENT_PAYING_ACCOUNT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_WOULD_EXCEED_MAX_VOTE_COST_LIMIT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_WOULD_EXCEED_ACCOUNT_DATA_TOTAL_LIMIT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_DUPLICATE_INSTRUCTION ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_INSUFFICIENT_FUNDS_FOR_RENT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_MAX_LOADED_ACCOUNTS_DATA_SIZE_EXCEEDED ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_INVALID_LOADED_ACCOUNTS_DATA_SIZE_LIMIT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_RESANITIZATION_NEEDED ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_PROGRAM_EXECUTION_TEMPORARILY_RESTRICTED ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_UNBALANCED_TRANSACTION ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_LOAD_PROGRAM_CACHE_HIT_MAX_LIMIT ) ];

    cur->out.bank_invalid +=
        bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_ACCOUNT_IN_USE ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_ACCOUNT_LOADED_TWICE ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_ACCOUNT_NOT_FOUND ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_PROGRAM_ACCOUNT_NOT_FOUND ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_INSUFFICIENT_FUNDS_FOR_FEE ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_INVALID_ACCOUNT_FOR_FEE ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_ALREADY_PROCESSED ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_BLOCKHASH_NOT_FOUND ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_INSTRUCTION_ERROR ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_CALL_CHAIN_TOO_DEEP ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_MISSING_SIGNATURE_FOR_FEE ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_INVALID_ACCOUNT_INDEX ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_SIGNATURE_FAILURE ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_INVALID_PROGRAM_FOR_EXECUTION ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_SANITIZE_FAILURE ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_CLUSTER_MAINTENANCE ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_ACCOUNT_BORROW_OUTSTANDING ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_WOULD_EXCEED_MAX_BLOCK_COST_LIMIT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_UNSUPPORTED_VERSION ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_INVALID_WRITABLE_ACCOUNT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_WOULD_EXCEED_MAX_ACCOUNT_COST_LIMIT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_WOULD_EXCEED_ACCOUNT_DATA_BLOCK_LIMIT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_TOO_MANY_ACCOUNT_LOCKS ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_ADDRESS_LOOKUP_TABLE_NOT_FOUND ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_INVALID_ADDRESS_LOOKUP_TABLE_OWNER ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_INVALID_ADDRESS_LOOKUP_TABLE_DATA ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_INVALID_ADDRESS_LOOKUP_TABLE_INDEX ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_INVALID_RENT_PAYING_ACCOUNT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_WOULD_EXCEED_MAX_VOTE_COST_LIMIT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_WOULD_EXCEED_ACCOUNT_DATA_TOTAL_LIMIT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_DUPLICATE_INSTRUCTION ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_INSUFFICIENT_FUNDS_FOR_RENT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_MAX_LOADED_ACCOUNTS_DATA_SIZE_EXCEEDED ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_INVALID_LOADED_ACCOUNTS_DATA_SIZE_LIMIT ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_RESANITIZATION_NEEDED ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_PROGRAM_EXECUTION_TEMPORARILY_RESTRICTED ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_UNBALANCED_TRANSACTION ) ]
      + bank_metrics[ MIDX( COUNTER, BANK, TRANSACTION_EXECUTING_PROGRAM_CACHE_HIT_MAX_LIMIT ) ];
  }
