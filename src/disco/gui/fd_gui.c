...
fd_gui_tile_timers_snap( fd_gui_t * gui ) {
  ...
  gui->summary.tile_timers_snap_idx = (gui->summary.tile_timers_snap_idx+1)%FD_GUI_TILE_TIMER_SNAP_CNT;
...
fd_gui_handle_slot_end( fd_gui_t * gui,
  ...
  gui->summary.tile_timers_history_idx = (gui->summary.tile_timers_history_idx+1)%FD_GUI_TILE_TIMER_LEADER_CNT;
