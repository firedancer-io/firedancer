...
main( int argc, char ** argv ) {
  ...
  test_live_table_sort_key_t const key0 = { .col = { 0, 1 }, .dir =  { 0,   1 } };
  test_live_table_sort_key_t const key1 = { .col = { 0, 1 }, .dir =  { 0,  -1 } };
  test_live_table_sort_key_t const key2 = { .col = { 0, 1 }, .dir =  { -1, -1 } };
