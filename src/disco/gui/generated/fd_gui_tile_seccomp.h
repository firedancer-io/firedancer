...
static const uint sock_filter_policy_fd_gui_tile_instr_cnt = 62;

static void populate_sock_filter_policy_fd_gui_tile( ulong out_cnt, struct sock_filter out[ static 62 ], uint logfile_fd, uint gui_socket_fd ) {
  FD_TEST( out_cnt >= 62 );
