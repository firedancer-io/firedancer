...
FD_IMPORT_BINARY( file2, "src/disco/gui/dist/assets/index-7DrCplxz.js" );
FD_IMPORT_BINARY( file3, "src/disco/gui/dist/assets/index-B1Rj-3ce.js" );
FD_IMPORT_BINARY( file4, "src/disco/gui/dist/assets/index-DAxOld-c.css" );
...
fd_http_static_file_t STATIC_FILES[] = {
    ...
    {
        .name = "/assets/index-7DrCplxz.js",
        .data = file2,
        .data_len = &file2_sz,
    },
    {
        .name = "/assets/index-B1Rj-3ce.js",
        .data = file3,
        .data_len = &file3_sz,
    },
    {
        .name = "/assets/index-DAxOld-c.css",
        .data = file4,
        .data_len = &file4_sz,
    },
    {
