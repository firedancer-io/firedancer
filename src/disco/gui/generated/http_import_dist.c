...
FD_IMPORT_BINARY( file2, "src/disco/gui/dist/assets/index-Bi2VmjCU.js" );
FD_IMPORT_BINARY( file3, "src/disco/gui/dist/assets/index-H-FcyHrg.css" );
FD_IMPORT_BINARY( file4, "src/disco/gui/dist/assets/index-hRnAfMMw.js" );
...
fd_http_static_file_t STATIC_FILES[] = {
    ...
    {
        .name = "/assets/index-Bi2VmjCU.js",
        .data = file2,
        .data_len = &file2_sz,
    },
    {
        .name = "/assets/index-H-FcyHrg.css",
        .data = file3,
        .data_len = &file3_sz,
    },
    {
        .name = "/assets/index-hRnAfMMw.js",
        .data = file4,
        .data_len = &file4_sz,
    },
    {
