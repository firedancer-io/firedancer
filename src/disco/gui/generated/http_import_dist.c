...
FD_IMPORT_BINARY( file2, "src/disco/gui/dist/assets/index-9ISQTOZK.css" );
FD_IMPORT_BINARY( file3, "src/disco/gui/dist/assets/index-D48BJ3cP.js" );
FD_IMPORT_BINARY( file4, "src/disco/gui/dist/assets/index-DRw8p3Sw.js" );
...
fd_http_static_file_t STATIC_FILES[] = {
    ...
    {
        .name = "/assets/index-9ISQTOZK.css",
        .data = file2,
        .data_len = &file2_sz,
    },
    {
        .name = "/assets/index-D48BJ3cP.js",
        .data = file3,
        .data_len = &file3_sz,
    },
    {
        .name = "/assets/index-DRw8p3Sw.js",
        .data = file4,
        .data_len = &file4_sz,
    },
    {
