...
FD_IMPORT_BINARY( file2, "src/disco/gui/dist/assets/index-Bj-2ozr1.css" );
FD_IMPORT_BINARY( file3, "src/disco/gui/dist/assets/index-D68CXzdf.js" );
FD_IMPORT_BINARY( file4, "src/disco/gui/dist/assets/index-Dobne4Xk.css" );
FD_IMPORT_BINARY( file5, "src/disco/gui/dist/assets/index-naCxCck8.js" );
...
fd_http_static_file_t STATIC_FILES[] = {
    ...
    {
        .name = "/assets/index-Bj-2ozr1.css",
        .data = file2,
        .data_len = &file2_sz,
    },
    {
        .name = "/assets/index-D68CXzdf.js",
        .data = file3,
        .data_len = &file3_sz,
    },
    {
