...
FD_IMPORT_BINARY( file2, "src/disco/gui/dist/assets/index-CeMmwSX_.css" );
FD_IMPORT_BINARY( file3, "src/disco/gui/dist/assets/index-CXR6J9xZ.js" );
FD_IMPORT_BINARY( file4, "src/disco/gui/dist/assets/index-DEoU3Mlp.js" );
...
fd_http_static_file_t STATIC_FILES[] = {
    ...
    {
        .name = "/assets/index-CeMmwSX_.css",
        .data = file2,
        .data_len = &file2_sz,
    },
    {
        .name = "/assets/index-CXR6J9xZ.js",
        .data = file3,
        .data_len = &file3_sz,
    },
    {
        .name = "/assets/index-DEoU3Mlp.js",
        .data = file4,
        .data_len = &file4_sz,
    },
    {
