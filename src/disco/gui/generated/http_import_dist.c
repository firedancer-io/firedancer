...
FD_IMPORT_BINARY( file2, "src/disco/gui/dist/assets/index-CD9euXz_.js" );
FD_IMPORT_BINARY( file3, "src/disco/gui/dist/assets/index-CjBkPt9y.js" );
...
fd_http_static_file_t STATIC_FILES[] = {
    ...
    {
        .name = "/assets/index-CD9euXz_.js",
        .data = file2,
        .data_len = &file2_sz,
    },
    {
        .name = "/assets/index-CjBkPt9y.js",
        .data = file3,
        .data_len = &file3_sz,
    },
    {
