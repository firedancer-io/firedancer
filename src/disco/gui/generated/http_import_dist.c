...
FD_IMPORT_BINARY( file2, "src/disco/gui/dist/assets/index-D9G9NFun.css" );
FD_IMPORT_BINARY( file3, "src/disco/gui/dist/assets/index-Dobne4Xk.css" );
FD_IMPORT_BINARY( file4, "src/disco/gui/dist/assets/index-gVCGxJWn.js" );
FD_IMPORT_BINARY( file5, "src/disco/gui/dist/assets/index-Wn-R608Y.js" );
...
fd_http_static_file_t STATIC_FILES[] = {
    ...
    {
        .name = "/assets/index-gVCGxJWn.js",
        .data = file4,
        .data_len = &file4_sz,
    },
    {
        .name = "/assets/index-Wn-R608Y.js",
        .data = file5,
        .data_len = &file5_sz,
    },
    {
