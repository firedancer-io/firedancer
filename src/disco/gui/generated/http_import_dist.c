...
FD_IMPORT_BINARY( file2, "src/disco/gui/dist/assets/index-BOM3Hkl7.css" );
FD_IMPORT_BINARY( file3, "src/disco/gui/dist/assets/index-DGByOnDO.js" );
FD_IMPORT_BINARY( file4, "src/disco/gui/dist/assets/index-DHAeX47o.js" );
...
fd_http_static_file_t STATIC_FILES[] = {
    ...
    {
        .name = "/assets/index-BOM3Hkl7.css",
        .data = file2,
        .data_len = &file2_sz,
    },
    {
        .name = "/assets/index-DGByOnDO.js",
        .data = file3,
        .data_len = &file3_sz,
    },
    {
        .name = "/assets/index-DHAeX47o.js",
        .data = file4,
        .data_len = &file4_sz,
    },
    {
