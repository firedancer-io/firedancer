...
FD_IMPORT_BINARY( file2, "src/disco/gui/dist/assets/index-BAzx36nf.css" );
FD_IMPORT_BINARY( file3, "src/disco/gui/dist/assets/index-BjGjIF08.js" );
FD_IMPORT_BINARY( file4, "src/disco/gui/dist/assets/index-BQf-1TSW.js" );
FD_IMPORT_BINARY( file5, "src/disco/gui/dist/assets/index-_St8gGTN.css" );
...
fd_http_static_file_t STATIC_FILES[] = {
    ...
    {
        .name = "/assets/index-BAzx36nf.css",
        .data = file2,
        .data_len = &file2_sz,
    },
    {
        .name = "/assets/index-BjGjIF08.js",
        .data = file3,
        .data_len = &file3_sz,
    },
    {
        .name = "/assets/index-BQf-1TSW.js",
        .data = file4,
        .data_len = &file4_sz,
    },
    {
