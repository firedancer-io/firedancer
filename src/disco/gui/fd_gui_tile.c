...
populate_allowed_seccomp( fd_topo_t const *      topo,
  ...
  #if defined(__aarch64__)
  populate_sock_filter_policy_fd_gui_tile_arm64( out_cnt, out, (uint)fd_log_private_logfile_fd(), (uint)fd_http_server_fd( ctx->gui_server ) );
  return sock_filter_policy_fd_gui_tile_arm64_instr_cnt;
  #else
