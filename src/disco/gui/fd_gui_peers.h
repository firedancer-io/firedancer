...
#define LIVE_TABLE_COLUMN_CNT (8UL)
...
#define FD_GUI_PEERS_LIVE_TABLE_DEFAULT_SORT_KEY ((fd_gui_peers_live_table_sort_key_t){ .col = { 0, 1, 2, 3, 4, 5, 6, 7 }, .dir = { -1, -1, -1, -1, -1, -1, -1, -1 } })
