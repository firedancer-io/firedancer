...
struct fd_gui_peers_ctx {
  ...
  union {
    ...
    struct {
      ulong wfs_peers[ FD_SNAPSHOT_MAX_VOTE_ACCOUNTS ];
    };
    struct {
      fd_stake_weight_t      manifest_id_weights  [ FD_SNAPSHOT_MAX_VOTE_ACCOUNTS ];
      fd_vote_stake_weight_t manifest_vote_weights[ FD_SNAPSHOT_MAX_VOTE_ACCOUNTS ];
    };
  ...
  int                       wfs_enabled;
  fd_gui_wfs_peer_t         wfs_peers[ FD_SNAPSHOT_MAX_VOTE_ACCOUNTS ];
  ulong                     wfs_peers_cnt;
  int                       wfs_peers_valid;
  int                       wfs_stakes_sent;
