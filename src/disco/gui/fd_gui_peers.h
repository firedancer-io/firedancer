...
#define LIVE_TABLE_COLUMNS LIVE_TABLE_COL_ARRAY( \
  LIVE_TABLE_COL_ENTRY( "Ingress Push", gossvf_rx[ FD_METRICS_ENUM_GOSSIP_MESSAGE_V_PUSH_IDX ].rate,                live_table_col_double_lt ), \
  LIVE_TABLE_COL_ENTRY( "Ingress Pull", gossvf_rx[ FD_METRICS_ENUM_GOSSIP_MESSAGE_V_PULL_RESPONSE_IDX ].rate,       live_table_col_double_lt ), \
  LIVE_TABLE_COL_ENTRY( "Egress Push",  gossip_tx[ FD_METRICS_ENUM_GOSSIP_MESSAGE_V_PUSH_IDX ].rate,                live_table_col_double_lt ), \
  LIVE_TABLE_COL_ENTRY( "Egress Pull",  gossip_tx[ FD_METRICS_ENUM_GOSSIP_MESSAGE_V_PULL_RESPONSE_IDX ].rate,       live_table_col_double_lt ), \
...
#define LIVE_TABLE_COLUMNS LIVE_TABLE_COL_ARRAY( \
  LIVE_TABLE_COL_ENTRY( "Ingress Total", gossvf_rx[ FD_METRICS_ENUM_GOSSIP_MESSAGE_V_PUSH_IDX ].rate,                live_table_col_double_lt ), \
  LIVE_TABLE_COL_ENTRY( "Egress Total",  gossvf_rx[ FD_METRICS_ENUM_GOSSIP_MESSAGE_V_PULL_RESPONSE_IDX ].rate,       live_table_col_double_lt )  )
#define LIVE_TABLE_ROW_T fd_gui_peers_node_t
#include "fd_gui_live_table_tmpl.c"
