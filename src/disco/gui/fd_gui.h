...
struct __attribute__((packed)) fd_gui_slot {
  ...
  uchar     vote_latency_exact;/* our vote latency minus skipped slots on the landed fork (UCHAR_MAX if did not vote) */
...
#define FD_GUI_VOTE_LATENCY_UNKNOWN   ((uchar)(UCHAR_MAX-1UL)) /* above frontier; treated as not-late */
#define FD_GUI_VOTE_LATENCY_NOT_VOTED ((uchar)(UCHAR_MAX))     /* vote missing */
#define FD_GUI_VOTE_LATENCY_MAX       ((uchar)(UCHAR_MAX-2UL)) /* largest observable vote latency */
...
fd_gui_slot_get_or_create( fd_gui_t * gui,
  ...
  meta->vote_latency_exact = UCHAR_MAX;
