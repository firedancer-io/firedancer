...
#define FD_GUI_TXN_FLAGS_STARTED        (1)
#define FD_GUI_TXN_FLAGS_ENDED          (2)
#define FD_GUI_TXN_FLAGS_IS_SIMPLE_VOTE (4)
#define FD_GUI_TXN_FLAGS_FROM_BUNDLE    (8)
...
struct __attribute__((packed)) fd_gui_txn {
  ...
  uint flags                       :  4; /* assigned with the FD_GUI_TXN_FLAGS_* macros */
