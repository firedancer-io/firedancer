    ...
    union {
      ...
      struct { /* used in the full client */
        ...
        struct {
          ...
          long  read_throughput_compressed;       /* bytes compressed / sec */
          ...
          long  decompress_throughput_compressed; /* bytes compressed / sec */

          ulong insert_bytes_decompressed;
          long  insert_throughput_decompressed;   /* bytes decompressed / sec */
          char  insert_path[ PATH_MAX ];
          ulong insert_accounts_current;
          long  insert_accounts_throughput;       /* accounts per sec */
