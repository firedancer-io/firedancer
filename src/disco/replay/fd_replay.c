...
//       FD_LOG_WARNING(( "[%s] block_info %lu not found in blockstore. shred tile should have already inserted.", __func__, slot ));
//       return FD_SHRED_IDX_NULL;
//     }

//     fd_block_meta_t * block_info = fd_block_map_query_ele( query );
