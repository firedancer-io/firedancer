...
main( int     argc,
  ...
  ulong const fib4_lock_cnt = 2UL;
  void * fib4_local_mem     = fd_wksp_alloc_laddr( wksp, fd_fib4_align(), fd_fib4_footprint( fib4_max,fib4_max, fib4_lock_cnt  ), WKSP_TAG );
  void * fib4_main_mem      = fd_wksp_alloc_laddr( wksp, fd_fib4_align(), fd_fib4_footprint( fib4_max, fib4_max, fib4_lock_cnt ), WKSP_TAG );
  FD_TEST( fd_fib4_new( fib4_local_mem, fib4_max, fib4_max, fib4_lock_cnt, 12345UL ) );
  FD_TEST( fd_fib4_new( fib4_main_mem,  fib4_max, fib4_max, fib4_lock_cnt, 12345UL ) );
  ...
  FD_TEST( fd_fib4_insert( fib_main,  gre_dst_ip, 32, 0, &hop4 ) );
