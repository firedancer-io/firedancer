...
main( int     argc,
  ...
  int   const neigh4_lg_slots = fd_neigh4_hmap_est_lg_slot_cnt( neigh4_ele_max ); FD_TEST( neigh4_lg_slots > 0 );
  void      * neigh4_hmap_mem = fd_wksp_alloc_laddr( wksp, fd_neigh4_hmap_align(), fd_neigh4_hmap_footprint( neigh4_lg_slots ), WKSP_TAG );
  FD_TEST( fd_neigh4_hmap_new( neigh4_hmap_mem, neigh4_lg_slots, 1UL ) );
  ...
  fd_neigh4_hmap_t * neigh4_hmap   = fd_neigh4_hmap_join( neigh4_hmap_mem );
  FD_TEST( neigh4_hmap );
  ...
  ctx->neigh4 = fd_neigh4_hmap_join( fd_topo_obj_laddr( topo, topo_tile->xdp.neigh4_obj_id ) );
  FD_TEST( ctx->neigh4 );
