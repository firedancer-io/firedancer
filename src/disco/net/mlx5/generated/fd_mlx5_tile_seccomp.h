...
static const uint sock_filter_policy_fd_mlx5_tile_instr_cnt = 22;

static void populate_sock_filter_policy_fd_mlx5_tile( ulong out_cnt, struct sock_filter out[ static 22 ], uint logfile_fd, uint async_fd ) {
  FD_TEST( out_cnt >= 22 );
  struct sock_filter filter[22] = {
    ...
    /* check read */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_read, /* check_read */ 4, 0 ),
    /* check write */
