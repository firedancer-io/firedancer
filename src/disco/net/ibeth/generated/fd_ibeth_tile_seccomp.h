...
#ifndef HEADER_fd_src_disco_net_ibeth_generated_fd_ibeth_tile_seccomp_h
#define HEADER_fd_src_disco_net_ibeth_generated_fd_ibeth_tile_seccomp_h
...
static const uint sock_filter_policy_fd_ibeth_tile_instr_cnt = 22;

static void populate_sock_filter_policy_fd_ibeth_tile( ulong out_cnt, struct sock_filter out[ static 22 ], uint logfile_fd, uint async_fd ) {
  FD_TEST( out_cnt >= 22 );
...
#endif /* HEADER_fd_src_disco_net_ibeth_generated_fd_ibeth_tile_seccomp_h */
