...
fd_topos_net_tiles( fd_topo_t *             topo,
                    ...
                    ulong                   netlnk_lock_cnt_peer_routes,
  ...
  if( 0==strcmp( net_cfg->provider, "xdp" ) ) {
    ...
    fd_netlink_topo_create( netlink_tile, topo, netlnk_max_routes, netlnk_max_peer_routes, netlnk_lock_cnt_peer_routes, netlnk_max_neighbors, net_cfg->interface );
