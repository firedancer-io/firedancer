...
#ifndef HEADER_fd_src_disco_net_iavf_generated_fd_iavf_tile_seccomp_h
#define HEADER_fd_src_disco_net_iavf_generated_fd_iavf_tile_seccomp_h
...
static const uint sock_filter_policy_fd_iavf_tile_instr_cnt = 18;

static void populate_sock_filter_policy_fd_iavf_tile( ulong out_cnt, struct sock_filter out[ static 18 ], uint logfile_fd ) {
  FD_TEST( out_cnt >= 18 );
...
#endif /* HEADER_fd_src_disco_net_iavf_generated_fd_iavf_tile_seccomp_h */
