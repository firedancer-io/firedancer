...
static const uint sock_filter_policy_quic_instr_cnt = 18;

static void populate_sock_filter_policy_quic( ulong out_cnt, struct sock_filter out[ static 18 ], uint logfile_fd, uint keylog_fd ) {
  FD_TEST( out_cnt >= 18 );
...
//  or_eq_next_lo_2:
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, ((uint)(keylog_fd)), /* write_ALLOW */ 1, /* write_KILL */ 0 ),
//  write_KILL:
    BPF_STMT( BPF_RET | BPF_K, SECCOMP_RET_KILL_PROCESS ),
//  write_ALLOW:
    BPF_STMT( BPF_RET | BPF_K, SECCOMP_RET_ALLOW ),
