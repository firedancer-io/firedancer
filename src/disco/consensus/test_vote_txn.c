...
ushort
dummy_vote_instr_fun( uchar * out_buf, uchar * FD_PARAM_UNUSED opt_args, ulong FD_PARAM_UNUSED opt_args_len ) {
  (void) opt_args;
  (void) opt_args_len;
...
main( int argc, char ** argv ) {
  ...
  ulong size = fd_txn_add_instr(txn_meta_buf, txn_buf, 2, instr_accounts, 2, dummy_vote_instr_fun, NULL, 0);
