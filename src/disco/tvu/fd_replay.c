...
//   // fd_slot_meta_t * slot_meta = fd_blockstore_block_map_query( replay->blockstore, slot );
...
//   //     fd_blockstore_block_map_query( replay->blockstore, parent_slot );
...
//   block->flags = fd_uchar_set_bit( block->flags, FD_BLOCK_FLAG_PREPARING );
