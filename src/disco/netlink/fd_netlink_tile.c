...
fd_netlink_topo_create( fd_topo_tile_t * netlink_tile,
  ...
  FD_TEST( fd_pod_insertf_ulong( topo->props, netlnk_lock_cnt_peer_routes, "obj.%lu.route_peer_lock_cnt", fib4_main_obj->id  ) );
  FD_TEST( fd_pod_insertf_ulong( topo->props, netlnk_lock_cnt_peer_routes, "obj.%lu.route_peer_lock_cnt", fib4_local_obj->id ) );
  ulong fib4_seed;
