...
#ifndef HEADER_fd_src_disco_waker_generated_fd_waker_tile_seccomp_h
#define HEADER_fd_src_disco_waker_generated_fd_waker_tile_seccomp_h
...
static const uint sock_filter_policy_fd_waker_tile_instr_cnt = 26;

static void populate_sock_filter_policy_fd_waker_tile( ulong out_cnt, struct sock_filter out[ static 26 ], uint logfile_fd, uint waker_outer_fd ) {
  FD_TEST( out_cnt >= 26 );
  struct sock_filter filter[26] = {
    ...
    /* check epoll_pwait */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_epoll_pwait, /* check_epoll_pwait */ 12, 0 ),
//  RET_KILL_PROCESS:
    /* default deny */
...
//  check_epoll_pwait:
    /* arg 0 low 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_LO_OFFSET(0)),
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, ((uint)(waker_outer_fd)), /* and_2 */ 0, /* epoll_pwait_KILL */ 4 ),
//  and_2:
    /* arg 4 high 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_HI_OFFSET(4)),
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, 0x00000000U, /* arg_hi_eq_3 */ 0, /* epoll_pwait_KILL */ 2 ),
//  arg_hi_eq_3:
    /* arg 4 low 32 bits */
...
#endif /* HEADER_fd_src_disco_waker_generated_fd_waker_tile_seccomp_h */
