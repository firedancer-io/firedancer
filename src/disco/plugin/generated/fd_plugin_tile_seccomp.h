...
#endif
static const unsigned int sock_filter_policy_fd_plugin_tile_instr_cnt = 16;
...
static void populate_sock_filter_policy_fd_plugin_tile( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd) {
  ...
  struct sock_filter filter[16] = {
    ...
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_sched_yield, /* RET_ALLOW */ 9, 0 ),
    /* simply allow clock_nanosleep */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_clock_nanosleep, /* RET_ALLOW */ 8, 0 ),
