...
struct __attribute__((aligned(64))) fd_stem_tile_in {
  ...
  ushort                 idx;      /* index of this in in the list of providers, [0, in_cnt) */
  ushort                 stride;   /* seq advances by this much per frag; frags at other seqs are never
                                      polled (see STEM_CALLBACK_IN_SHARD) */
