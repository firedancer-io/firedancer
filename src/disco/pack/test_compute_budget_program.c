...
test_txn( uchar const * payload,
  ...
  fd_compute_budget_program_finalize( &state, non_builtin_instr_cnt, builtin_instr_cost, &rewards, &compute, &loaded_accounts_data_cost);
...
main( int     argc,
  ...
  test_txn( txn1, txn1_sz, 0UL, 3000UL*1UL, 1400000UL,  280000UL, 16384UL );
  test_txn( txn2, txn2_sz, 0UL, 3000UL*2UL,  500000UL,   7501ULL, 16384UL );
  test_txn( txn3, txn3_sz, 0UL, 3000UL*1UL, 1000000UL,      0ULL, 16384UL );
  test_txn( txn4, txn4_sz, 0UL, 3000UL*2UL,   75000UL,   1501ULL, 16384UL );
  test_txn( txn5, txn5_sz, 0UL, 3000UL*1UL, 1400000UL,  28000ULL, 16384UL );
  test_txn( txn6, txn6_sz, 0UL, 3000UL*1UL,   60000UL,   5400ULL,   248UL );
  test_txn( txn7, txn7_sz, 0UL, 3000UL*1UL, 1400000UL,      0ULL, 16384UL );
