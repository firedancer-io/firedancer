...
#define FD_STORE_SHACQ_TIMED(store, shacq_start, shacq_end) shacq_start = fd_stem_now( stem ); fd_store_shacq( store ); shacq_end = fd_stem_now( stem );
#define FD_STORE_SHREL_TIMED(store, shrel_end)              shrel_end   = fd_stem_now( stem ); fd_store_shrel( store );
#define FD_STORE_EXACQ_TIMED(store, exacq_start, exacq_end) exacq_start = fd_stem_now( stem ); fd_store_exacq( store ); exacq_end = fd_stem_now( stem );
#define FD_STORE_EXREL_TIMED(store, exrel_end)              exrel_end   = fd_stem_now( stem ); fd_store_exrel( store );
