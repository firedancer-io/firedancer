...
#define FD_METRICS_HISTOGRAM_REPAIR_STORE_LINK_WAIT_OFF  (32UL)
...
#define FD_METRICS_HISTOGRAM_REPAIR_STORE_LINK_WORK_OFF  (49UL)
...
#define FD_METRICS_HISTOGRAM_REPAIR_SIGN_DURATION_SECONDS_OFF  (66UL)
