...
enum {
  FD_METRICS_COUNTER_NET_RX_PKT_CNT_OFF = 23,
  FD_METRICS_COUNTER_NET_RX_BYTES_TOTAL_OFF,
  FD_METRICS_COUNTER_NET_RX_UNDERSZ_CNT_OFF,
  FD_METRICS_COUNTER_NET_RX_FILL_BLOCKED_CNT_OFF,
  FD_METRICS_COUNTER_NET_RX_BACKPRESSURE_CNT_OFF,
  ...
  FD_METRICS_COUNTER_NET_TX_ROUTE_FAIL_CNT_OFF,
  FD_METRICS_COUNTER_NET_TX_NEIGHBOR_FAIL_CNT_OFF,
  FD_METRICS_COUNTER_NET_TX_FULL_FAIL_CNT_OFF,
  ...
  FD_METRICS_COUNTER_NET_RX_GRE_INVALID_CNT_OFF,
  FD_METRICS_COUNTER_NET_RX_GRE_IGNORED_CNT_OFF,
  FD_METRICS_COUNTER_NET_TX_GRE_CNT_OFF,
  FD_METRICS_COUNTER_NET_TX_GRE_ROUTE_FAIL_CNT_OFF,
  FD_METRICS_COUNTER_NET_RX_SRC_ADDR_INVALID_CNT_OFF,
  FD_METRICS_COUNTER_NET_RX_DST_ADDR_INVALID_CNT_OFF,
  FD_METRICS_COUNTER_NET_RX_RP_FILTER_CNT_OFF,
};
...
#define FD_METRICS_COUNTER_NET_RX_DST_ADDR_INVALID_CNT_NAME "net_rx_dst_addr_invalid_cnt"
#define FD_METRICS_COUNTER_NET_RX_DST_ADDR_INVALID_CNT_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_NET_RX_DST_ADDR_INVALID_CNT_DESC "Number of incoming packets dropped because destination IP is not a local address"
#define FD_METRICS_COUNTER_NET_RX_DST_ADDR_INVALID_CNT_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_NET_RX_RP_FILTER_CNT_NAME "net_rx_rp_filter_cnt"
#define FD_METRICS_COUNTER_NET_RX_RP_FILTER_CNT_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_NET_RX_RP_FILTER_CNT_DESC "Number of incoming packets dropped by reverse path filter"
#define FD_METRICS_COUNTER_NET_RX_RP_FILTER_CNT_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_NET_TOTAL (31UL)
