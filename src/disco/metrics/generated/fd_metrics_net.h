...
#define FD_METRICS_COUNTER_NET_TX_WAKEUP_TIMEOUT_CNT_OFF  (33UL)
#define FD_METRICS_COUNTER_NET_TX_WAKEUP_TIMEOUT_CNT_NAME "net_tx_wakeup_timeout_cnt"
#define FD_METRICS_COUNTER_NET_TX_WAKEUP_TIMEOUT_CNT_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_NET_TX_WAKEUP_TIMEOUT_CNT_DESC "Number of XSK sendto syscalls dispatched due to timeout."
#define FD_METRICS_COUNTER_NET_TX_WAKEUP_TIMEOUT_CNT_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_NET_TX_WAKEUP_LEVEL_CNT_OFF  (34UL)
#define FD_METRICS_COUNTER_NET_TX_WAKEUP_LEVEL_CNT_NAME "net_tx_wakeup_level_cnt"
#define FD_METRICS_COUNTER_NET_TX_WAKEUP_LEVEL_CNT_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_NET_TX_WAKEUP_LEVEL_CNT_DESC "Number of XSK sendto syscalls dispatched due to flush level."
#define FD_METRICS_COUNTER_NET_TX_WAKEUP_LEVEL_CNT_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_NET_TX_WAKEUP_TIMEOUT_AND_LEVEL_CNT_OFF  (35UL)
#define FD_METRICS_COUNTER_NET_TX_WAKEUP_TIMEOUT_AND_LEVEL_CNT_NAME "net_tx_wakeup_timeout_and_level_cnt"
#define FD_METRICS_COUNTER_NET_TX_WAKEUP_TIMEOUT_AND_LEVEL_CNT_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_NET_TX_WAKEUP_TIMEOUT_AND_LEVEL_CNT_DESC "Number of XSK sendto syscalls dispatched due to both timeout and flush level reached."
#define FD_METRICS_COUNTER_NET_TX_WAKEUP_TIMEOUT_AND_LEVEL_CNT_CVT  (FD_METRICS_CONVERTER_NONE)
