...
const fd_metrics_meta_t FD_METRICS_BANK[FD_METRICS_BANK_TOTAL] = {
    ...
    DECLARE_METRIC_COUNTER( BANK_TILE, PRECOMPILE_VERIFY_FAILURE ),
    ...
    DECLARE_METRIC_COUNTER( BANK_TILE, TRANSACTION_LOAD_PROGRAM_CACHE_HIT_MAX_LIMIT ),
    ...
    DECLARE_METRIC_COUNTER( BANK_TILE, TRANSACTION_EXECUTING_PROGRAM_CACHE_HIT_MAX_LIMIT ),
    ...
    DECLARE_METRIC_COUNTER( BANK_TILE, TRANSACTION_EXECUTED_PROGRAM_CACHE_HIT_MAX_LIMIT ),
    DECLARE_METRIC_COUNTER( BANK_TILE, COST_MODEL_UNDERCOUNT ),
};
