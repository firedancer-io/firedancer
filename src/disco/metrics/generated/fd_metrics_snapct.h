...
enum {
  ...
  FD_METRICS_COUNTER_SNAPCT_FULL_NUM_RETRIES_OFF,
  FD_METRICS_COUNTER_SNAPCT_INCREMENTAL_NUM_RETRIES_OFF,
  ...
  FD_METRICS_GAUGE_SNAPCT_FULL_DOWNLOAD_RETRIES_OFF,
  ...
  FD_METRICS_GAUGE_SNAPCT_INCREMENTAL_DOWNLOAD_RETRIES_OFF,
  FD_METRICS_GAUGE_SNAPCT_PREDICTED_SLOT_OFF,
  FD_METRICS_COUNTER_SNAPCT_SSL_ALLOC_ERRORS_OFF,
};
