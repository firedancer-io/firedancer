...
#define FD_METRICS_GAUGE_SNAPLS_STATE_OFF  (22UL)
...
#define FD_METRICS_GAUGE_SNAPLS_FULL_ACCOUNTS_HASHED_OFF  (23UL)
...
#define FD_METRICS_GAUGE_SNAPLS_INCREMENTAL_ACCOUNTS_HASHED_OFF  (24UL)
