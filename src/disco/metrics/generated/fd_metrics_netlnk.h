...
enum {
  FD_METRICS_COUNTER_NETLNK_DROP_EVENTS_OFF = FD_METRICS_TILE_OFF,
  FD_METRICS_COUNTER_NETLNK_LINK_FULL_SYNCS_OFF,
  FD_METRICS_COUNTER_NETLNK_ROUTE_FULL_SYNCS_OFF,
  FD_METRICS_COUNTER_NETLNK_UPDATES_OFF,
  FD_METRICS_COUNTER_NETLNK_UPDATES_LINK_OFF = FD_METRICS_COUNTER_NETLNK_UPDATES_OFF,
  FD_METRICS_COUNTER_NETLNK_UPDATES_NEIGH_OFF,
  FD_METRICS_COUNTER_NETLNK_UPDATES_IPV4_ROUTE_OFF,
  ...
  FD_METRICS_COUNTER_NETLNK_NEIGH_PROBE_SENT_OFF,
  FD_METRICS_COUNTER_NETLNK_NEIGH_PROBE_FAILS_OFF,
  FD_METRICS_COUNTER_NETLNK_NEIGH_PROBE_RATE_LIMIT_HOST_OFF,
  FD_METRICS_COUNTER_NETLNK_NEIGH_PROBE_RATE_LIMIT_GLOBAL_OFF,
};
