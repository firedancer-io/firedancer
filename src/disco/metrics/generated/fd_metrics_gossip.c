...
const fd_metrics_meta_t FD_METRICS_GOSSIP[FD_METRICS_GOSSIP_TOTAL] = {
    ...
    DECLARE_METRIC_ENUM( GOSSIP_IPV6_CONTACT_INFO, COUNTER, PEER_TYPES, VOTER ),
    ...
    DECLARE_METRIC_ENUM( GOSSIP_ZERO_IPV4_CONTACT_INFO, COUNTER, PEER_TYPES, VOTER ),
    ...
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS, COUNTER, CRDS_VALUE, CONTACT_INFO_V1 ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS, COUNTER, CRDS_VALUE, VOTE ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS, COUNTER, CRDS_VALUE, LOWEST_SLOT ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS, COUNTER, CRDS_VALUE, SNAPSHOT_HASHES ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS, COUNTER, CRDS_VALUE, ACCOUNTS_HASHES ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS, COUNTER, CRDS_VALUE, EPOCH_SLOTS ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS, COUNTER, CRDS_VALUE, VERSION_V1 ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS, COUNTER, CRDS_VALUE, VERSION_V2 ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS, COUNTER, CRDS_VALUE, NODE_INSTANCE ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS, COUNTER, CRDS_VALUE, DUPLICATE_SHRED ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS, COUNTER, CRDS_VALUE, INCREMENTAL_SNAPSHOT_HASHES ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS, COUNTER, CRDS_VALUE, CONTACT_INFO_V2 ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS, COUNTER, CRDS_VALUE, RESTART_LAST_VOTED_FORK_SLOTS ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS, COUNTER, CRDS_VALUE, RESTART_HEAVIEST_FORK ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS_DUPLICATE_MESSAGE, COUNTER, CRDS_VALUE, CONTACT_INFO_V1 ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS_DUPLICATE_MESSAGE, COUNTER, CRDS_VALUE, VOTE ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS_DUPLICATE_MESSAGE, COUNTER, CRDS_VALUE, LOWEST_SLOT ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS_DUPLICATE_MESSAGE, COUNTER, CRDS_VALUE, SNAPSHOT_HASHES ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS_DUPLICATE_MESSAGE, COUNTER, CRDS_VALUE, ACCOUNTS_HASHES ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS_DUPLICATE_MESSAGE, COUNTER, CRDS_VALUE, EPOCH_SLOTS ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS_DUPLICATE_MESSAGE, COUNTER, CRDS_VALUE, VERSION_V1 ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS_DUPLICATE_MESSAGE, COUNTER, CRDS_VALUE, VERSION_V2 ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS_DUPLICATE_MESSAGE, COUNTER, CRDS_VALUE, NODE_INSTANCE ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS_DUPLICATE_MESSAGE, COUNTER, CRDS_VALUE, DUPLICATE_SHRED ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS_DUPLICATE_MESSAGE, COUNTER, CRDS_VALUE, INCREMENTAL_SNAPSHOT_HASHES ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS_DUPLICATE_MESSAGE, COUNTER, CRDS_VALUE, CONTACT_INFO_V2 ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS_DUPLICATE_MESSAGE, COUNTER, CRDS_VALUE, RESTART_LAST_VOTED_FORK_SLOTS ),
    DECLARE_METRIC_ENUM( GOSSIP_RECEIVED_CRDS_DUPLICATE_MESSAGE, COUNTER, CRDS_VALUE, RESTART_HEAVIEST_FORK ),
