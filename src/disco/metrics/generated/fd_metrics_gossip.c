...
const fd_metrics_meta_t FD_METRICS_GOSSIP[FD_METRICS_GOSSIP_TOTAL] = {
    ...
    DECLARE_METRIC_ENUM( GOSSIP_FD_EPOCH_SLOT_FILTER, COUNTER, PULL_REQ_BLOOM_FILTER_RESULT, HIT ),
    DECLARE_METRIC_ENUM( GOSSIP_FD_EPOCH_SLOT_FILTER, COUNTER, PULL_REQ_BLOOM_FILTER_RESULT, MISS ),
    DECLARE_METRIC_ENUM( GOSSIP_AG_EPOCH_SLOT_FILTER, COUNTER, PULL_REQ_BLOOM_FILTER_RESULT, HIT ),
    DECLARE_METRIC_ENUM( GOSSIP_AG_EPOCH_SLOT_FILTER, COUNTER, PULL_REQ_BLOOM_FILTER_RESULT, MISS ),
