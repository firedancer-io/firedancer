...
#define FD_METRICS_COUNTER_SENDER_LEADER_CONTACT_NONROUTABLE_OFF  (20UL)
#define FD_METRICS_COUNTER_SENDER_LEADER_CONTACT_NONROUTABLE_NAME "sender_leader_contact_nonroutable"
#define FD_METRICS_COUNTER_SENDER_LEADER_CONTACT_NONROUTABLE_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_SENDER_LEADER_CONTACT_NONROUTABLE_DESC "Total count of times leader contact is nonroutable"
#define FD_METRICS_COUNTER_SENDER_LEADER_CONTACT_NONROUTABLE_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_SENDER_TOTAL (5UL)
