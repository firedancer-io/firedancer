...
const fd_metrics_meta_t FD_METRICS_PACK[FD_METRICS_PACK_TOTAL] = {
    ...
    DECLARE_METRIC( PACK_AVAILABLE_TRANSACTIONS, GAUGE ),
    DECLARE_METRIC( PACK_AVAILABLE_VOTE_TRANSACTIONS, GAUGE ),
    DECLARE_METRIC( PACK_PENDING_TRANSACTIONS_HEAP_SIZE, GAUGE ),
    DECLARE_METRIC( PACK_CONFLICTING_TRANSACTIONS, GAUGE ),
