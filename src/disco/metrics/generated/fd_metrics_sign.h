...
enum {
  FD_METRICS_HISTOGRAM_SIGN_SIGN_DURATION_SECONDS_OFF = FD_METRICS_TILE_OFF,
  FD_METRICS_HISTOGRAM_SIGN_SIGN_DURATION_SECONDS_OFF_END = FD_METRICS_HISTOGRAM_SIGN_SIGN_DURATION_SECONDS_OFF + 16,
};
