...
const fd_metrics_meta_t FD_METRICS_EXEC[FD_METRICS_EXEC_TOTAL] = {
    ...
    DECLARE_METRIC_ENUM( EXEC_TXN_ACCOUNT_CHANGES, COUNTER, ACCOUNT_CHANGE, UNCHANGED_NONEXIST ),
    DECLARE_METRIC_ENUM( EXEC_TXN_ACCOUNT_CHANGES, COUNTER, ACCOUNT_CHANGE, CREATED ),
    DECLARE_METRIC_ENUM( EXEC_TXN_ACCOUNT_CHANGES, COUNTER, ACCOUNT_CHANGE, DELETE ),
    DECLARE_METRIC_ENUM( EXEC_TXN_ACCOUNT_CHANGES, COUNTER, ACCOUNT_CHANGE, MODIFY ),
    DECLARE_METRIC_ENUM( EXEC_TXN_ACCOUNT_CHANGES, COUNTER, ACCOUNT_CHANGE, UNCHANGED ),
};
