...
enum {
  FD_METRICS_COUNTER_SOCK_SYSCALLS_SENDMMSG_OFF = FD_METRICS_TILE_OFF,
  FD_METRICS_COUNTER_SOCK_SYSCALLS_SENDMMSG_NO_ERROR_OFF = FD_METRICS_COUNTER_SOCK_SYSCALLS_SENDMMSG_OFF,
  FD_METRICS_COUNTER_SOCK_SYSCALLS_SENDMMSG_SLOW_OFF,
  FD_METRICS_COUNTER_SOCK_SYSCALLS_SENDMMSG_PERM_OFF,
  FD_METRICS_COUNTER_SOCK_SYSCALLS_SENDMMSG_UNREACH_OFF,
  FD_METRICS_COUNTER_SOCK_SYSCALLS_SENDMMSG_DOWN_OFF,
  FD_METRICS_COUNTER_SOCK_SYSCALLS_SENDMMSG_OTHER_OFF,
  FD_METRICS_COUNTER_SOCK_SYSCALLS_RECVMMSG_OFF,
  FD_METRICS_COUNTER_SOCK_RX_PKT_CNT_OFF,
  FD_METRICS_COUNTER_SOCK_TX_PKT_CNT_OFF,
  FD_METRICS_COUNTER_SOCK_TX_DROP_CNT_OFF,
  FD_METRICS_COUNTER_SOCK_TX_BYTES_TOTAL_OFF,
  FD_METRICS_COUNTER_SOCK_RX_BYTES_TOTAL_OFF,
};
