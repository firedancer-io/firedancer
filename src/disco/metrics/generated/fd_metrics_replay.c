...
const fd_metrics_meta_t FD_METRICS_REPLAY[FD_METRICS_REPLAY_TOTAL] = {
    ...
    DECLARE_METRIC( REPLAY_STORE_REMOVE_ACQUIRE, COUNTER ),
    DECLARE_METRIC( REPLAY_STORE_REMOVE_RELEASE, COUNTER ),
    DECLARE_METRIC_HISTOGRAM_SECONDS( REPLAY_STORE_REMOVE_WAIT ),
    DECLARE_METRIC_HISTOGRAM_SECONDS( REPLAY_STORE_REMOVE_WORK ),
    DECLARE_METRIC( REPLAY_STORE_REMOVE_CNT, COUNTER ),
    DECLARE_METRIC( REPLAY_STORE_REMOVE_MISSING_CNT, COUNTER ),
    DECLARE_METRIC( REPLAY_STORE_REMOVE_MR, GAUGE ),
    DECLARE_METRIC( REPLAY_STORE_REMOVE_MISSING_MR, GAUGE ),
