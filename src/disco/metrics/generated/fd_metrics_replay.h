...
#define FD_METRICS_COUNTER_REPLAY_SNAPSHOT_STATUS_OFF  (16UL)
#define FD_METRICS_COUNTER_REPLAY_SNAPSHOT_STATUS_CNT  (4UL)

#define FD_METRICS_COUNTER_REPLAY_SNAPSHOT_STATUS_SNAPSHOT_BEGIN_OFF  (16UL)
...
#define FD_METRICS_COUNTER_REPLAY_SNAPSHOT_STATUS_SNAPSHOT_BEGIN_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_REPLAY_SNAPSHOT_STATUS_SNAPSHOT_END_OFF  (17UL)
...
#define FD_METRICS_COUNTER_REPLAY_SNAPSHOT_STATUS_SNAPSHOT_END_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_REPLAY_SNAPSHOT_STATUS_INCREMENTAL_BEGIN_OFF  (18UL)
...
#define FD_METRICS_COUNTER_REPLAY_SNAPSHOT_STATUS_INCREMENTAL_BEGIN_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_REPLAY_SNAPSHOT_STATUS_INCREMENTAL_END_OFF  (19UL)
...
#define FD_METRICS_COUNTER_REPLAY_SNAPSHOT_STATUS_INCREMENTAL_END_CVT  (FD_METRICS_CONVERTER_NONE)
