...
const fd_metrics_meta_t FD_METRICS_QUIC[FD_METRICS_QUIC_TOTAL] = {
    ...
    DECLARE_METRIC_COUNTER( QUIC_TILE, REASSEMBLY_NOTIFY_ATTEMPTED ),
    DECLARE_METRIC_COUNTER( QUIC_TILE, REASSEMBLY_NOTIFY_CLOBBERED ),
    DECLARE_METRIC_COUNTER( QUIC_TILE, REASSEMBLY_NOTIFY_OKAY ),
    DECLARE_METRIC_COUNTER( QUIC_TILE, LEGACY_NOTIFY_ATTEMPTED ),
    DECLARE_METRIC_COUNTER( QUIC_TILE, LEGACY_NOTIFY_OKAY ),
