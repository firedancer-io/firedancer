...
enum {
  ...
  FD_METRICS_GAUGE_SNAPIN_WRITEBACK_STATE_OFF,
  FD_METRICS_COUNTER_SNAPIN_WRITEBACK_WAITS_OFF,
...
#define FD_METRICS_GAUGE_SNAPIN_WRITEBACK_STATE_NAME "snapin_writeback_state"
#define FD_METRICS_GAUGE_SNAPIN_WRITEBACK_STATE_TYPE (FD_METRICS_TYPE_GAUGE)
#define FD_METRICS_GAUGE_SNAPIN_WRITEBACK_STATE_DESC "Write-behind state: 0=off, 1=on, 2=off because sync_file_range is unsupported"
#define FD_METRICS_GAUGE_SNAPIN_WRITEBACK_STATE_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_SNAPIN_WRITEBACK_WAITS_NAME "snapin_writeback_waits"
#define FD_METRICS_COUNTER_SNAPIN_WRITEBACK_WAITS_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_SNAPIN_WRITEBACK_WAITS_DESC "Times this tile waited because its write-behind window was full"
#define FD_METRICS_COUNTER_SNAPIN_WRITEBACK_WAITS_CVT  (FD_METRICS_CONVERTER_NONE)
...
#define FD_METRICS_SNAPIN_TOTAL (11UL)
