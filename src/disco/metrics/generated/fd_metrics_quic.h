...
#define FD_METRICS_COUNTER_QUIC_TILE_QUIC_FRAGMENT_RECEIVE_OFF  (174UL)
#define FD_METRICS_COUNTER_QUIC_TILE_QUIC_FRAGMENT_RECEIVE_NAME "quic_tile_quic_fragment_receive"
#define FD_METRICS_COUNTER_QUIC_TILE_QUIC_FRAGMENT_RECEIVE_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_QUIC_TILE_QUIC_FRAGMENT_RECEIVE_DESC "Number of transaction fragments ingested via TPU/QUIC."

#define FD_METRICS_COUNTER_QUIC_TILE_QUIC_FRAGMENT_DROP_OFF  (175UL)
#define FD_METRICS_COUNTER_QUIC_TILE_QUIC_FRAGMENT_DROP_NAME "quic_tile_quic_fragment_drop"
#define FD_METRICS_COUNTER_QUIC_TILE_QUIC_FRAGMENT_DROP_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_QUIC_TILE_QUIC_FRAGMENT_DROP_DESC "Number of transaction fragments that failed reassembly via QUIC."

#define FD_METRICS_COUNTER_QUIC_TILE_QUIC_TRANSACTION_RECEIVE_OFF  (176UL)
#define FD_METRICS_COUNTER_QUIC_TILE_QUIC_TRANSACTION_RECEIVE_NAME "quic_tile_quic_transaction_receive"
#define FD_METRICS_COUNTER_QUIC_TILE_QUIC_TRANSACTION_RECEIVE_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_QUIC_TILE_QUIC_TRANSACTION_RECEIVE_DESC "Number of transactions reassembled via QUIC."

#define FD_METRICS_COUNTER_QUIC_TILE_QUIC_PACKET_TOO_SMALL_OFF  (177UL)
...
#define FD_METRICS_COUNTER_QUIC_TILE_NON_QUIC_PACKET_TOO_SMALL_OFF  (178UL)
...
#define FD_METRICS_COUNTER_QUIC_TILE_NON_QUIC_PACKET_TOO_LARGE_OFF  (179UL)
...
#define FD_METRICS_COUNTER_QUIC_TILE_NON_QUIC_TRANSACTION_RECEIVE_OFF  (180UL)
#define FD_METRICS_COUNTER_QUIC_TILE_NON_QUIC_TRANSACTION_RECEIVE_NAME "quic_tile_non_quic_transaction_receive"
#define FD_METRICS_COUNTER_QUIC_TILE_NON_QUIC_TRANSACTION_RECEIVE_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_QUIC_TILE_NON_QUIC_TRANSACTION_RECEIVE_DESC "Number of transactions received via TPU/UDP."

#define FD_METRICS_COUNTER_QUIC_RECEIVED_PACKETS_OFF  (181UL)
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_BYTES_OFF  (182UL)
...
#define FD_METRICS_COUNTER_QUIC_SENT_PACKETS_OFF  (183UL)
...
#define FD_METRICS_COUNTER_QUIC_SENT_BYTES_OFF  (184UL)
...
#define FD_METRICS_GAUGE_QUIC_CONNECTIONS_ACTIVE_OFF  (185UL)
...
#define FD_METRICS_COUNTER_QUIC_CONNECTIONS_CREATED_OFF  (186UL)
...
#define FD_METRICS_COUNTER_QUIC_CONNECTIONS_CLOSED_OFF  (187UL)
...
#define FD_METRICS_COUNTER_QUIC_CONNECTIONS_ABORTED_OFF  (188UL)
...
#define FD_METRICS_COUNTER_QUIC_CONNECTIONS_RETRIED_OFF  (189UL)
...
#define FD_METRICS_COUNTER_QUIC_CONNECTION_ERROR_NO_SLOTS_OFF  (190UL)
...
#define FD_METRICS_COUNTER_QUIC_CONNECTION_ERROR_TLS_FAIL_OFF  (191UL)
...
#define FD_METRICS_COUNTER_QUIC_CONNECTION_ERROR_RETRY_FAIL_OFF  (192UL)
...
#define FD_METRICS_COUNTER_QUIC_HANDSHAKES_CREATED_OFF  (193UL)
...
#define FD_METRICS_COUNTER_QUIC_HANDSHAKE_ERROR_ALLOC_FAIL_OFF  (194UL)
...
#define FD_METRICS_COUNTER_QUIC_STREAM_OPENED_OFF  (195UL)
#define FD_METRICS_COUNTER_QUIC_STREAM_OPENED_CNT  (4UL)

#define FD_METRICS_COUNTER_QUIC_STREAM_OPENED_BIDI_CLIENT_OFF  (195UL)
...
#define FD_METRICS_COUNTER_QUIC_STREAM_OPENED_BIDI_SERVER_OFF  (196UL)
...
#define FD_METRICS_COUNTER_QUIC_STREAM_OPENED_UNI_CLIENT_OFF  (197UL)
...
#define FD_METRICS_COUNTER_QUIC_STREAM_OPENED_UNI_SERVER_OFF  (198UL)
...
#define FD_METRICS_COUNTER_QUIC_STREAM_CLOSED_OFF  (199UL)
#define FD_METRICS_COUNTER_QUIC_STREAM_CLOSED_CNT  (4UL)

#define FD_METRICS_COUNTER_QUIC_STREAM_CLOSED_BIDI_CLIENT_OFF  (199UL)
...
#define FD_METRICS_COUNTER_QUIC_STREAM_CLOSED_BIDI_SERVER_OFF  (200UL)
...
#define FD_METRICS_COUNTER_QUIC_STREAM_CLOSED_UNI_CLIENT_OFF  (201UL)
...
#define FD_METRICS_COUNTER_QUIC_STREAM_CLOSED_UNI_SERVER_OFF  (202UL)
...
#define FD_METRICS_GAUGE_QUIC_STREAM_ACTIVE_OFF  (203UL)
#define FD_METRICS_GAUGE_QUIC_STREAM_ACTIVE_CNT  (4UL)

#define FD_METRICS_GAUGE_QUIC_STREAM_ACTIVE_BIDI_CLIENT_OFF  (203UL)
...
#define FD_METRICS_GAUGE_QUIC_STREAM_ACTIVE_BIDI_SERVER_OFF  (204UL)
...
#define FD_METRICS_GAUGE_QUIC_STREAM_ACTIVE_UNI_CLIENT_OFF  (205UL)
...
#define FD_METRICS_GAUGE_QUIC_STREAM_ACTIVE_UNI_SERVER_OFF  (206UL)
...
#define FD_METRICS_COUNTER_QUIC_STREAM_RECEIVED_EVENTS_OFF  (207UL)
...
#define FD_METRICS_COUNTER_QUIC_STREAM_RECEIVED_BYTES_OFF  (208UL)
...
#define FD_METRICS_QUIC_TOTAL (35UL)
