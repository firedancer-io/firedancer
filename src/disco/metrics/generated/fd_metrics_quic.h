...
#define FD_METRICS_COUNTER_QUIC_HANDSHAKE_EVICTED_OFF  (46UL)
...
#define FD_METRICS_COUNTER_QUIC_PKT_STATELESS_RESET_OFF  (125UL)
...
#define FD_METRICS_QUIC_TOTAL (78UL)
