...
#define FD_METRICS_COUNTER_QUIC_TILE_CRYPTO_MALLOC_FAILURE_OFF  (194UL)
#define FD_METRICS_COUNTER_QUIC_TILE_CRYPTO_MALLOC_FAILURE_NAME "quic_tile_crypto_malloc_failure"
#define FD_METRICS_COUNTER_QUIC_TILE_CRYPTO_MALLOC_FAILURE_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_QUIC_TILE_CRYPTO_MALLOC_FAILURE_DESC "Number of tiles crypto_malloc failed to allocate bytes for OpenSSL."
...
#define FD_METRICS_QUIC_TOTAL (53UL)
