...
#define FD_METRICS_COUNTER_QUIC_TXNS_RECEIVED_QUIC_FAST_NAME "quic_txns_received_quic_fast"
...
#define FD_METRICS_COUNTER_QUIC_TXNS_RECEIVED_QUIC_FRAG_NAME "quic_txns_received_quic_frag"
...
#define FD_METRICS_COUNTER_QUIC_PKT_CRYPTO_FAILED_INITIAL_NAME "quic_pkt_crypto_failed_initial"
#define FD_METRICS_COUNTER_QUIC_PKT_CRYPTO_FAILED_INITIAL_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_QUIC_PKT_CRYPTO_FAILED_INITIAL_DESC "Number of packets that failed decryption. (initial)"
#define FD_METRICS_COUNTER_QUIC_PKT_CRYPTO_FAILED_INITIAL_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_QUIC_PKT_CRYPTO_FAILED_EARLY_OFF  (112UL)
#define FD_METRICS_COUNTER_QUIC_PKT_CRYPTO_FAILED_EARLY_NAME "quic_pkt_crypto_failed_early"
#define FD_METRICS_COUNTER_QUIC_PKT_CRYPTO_FAILED_EARLY_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_QUIC_PKT_CRYPTO_FAILED_EARLY_DESC "Number of packets that failed decryption. (early data)"
#define FD_METRICS_COUNTER_QUIC_PKT_CRYPTO_FAILED_EARLY_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_QUIC_PKT_CRYPTO_FAILED_HANDSHAKE_OFF  (113UL)
#define FD_METRICS_COUNTER_QUIC_PKT_CRYPTO_FAILED_HANDSHAKE_NAME "quic_pkt_crypto_failed_handshake"
#define FD_METRICS_COUNTER_QUIC_PKT_CRYPTO_FAILED_HANDSHAKE_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_QUIC_PKT_CRYPTO_FAILED_HANDSHAKE_DESC "Number of packets that failed decryption. (handshake)"
#define FD_METRICS_COUNTER_QUIC_PKT_CRYPTO_FAILED_HANDSHAKE_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_QUIC_PKT_CRYPTO_FAILED_APP_OFF  (114UL)
#define FD_METRICS_COUNTER_QUIC_PKT_CRYPTO_FAILED_APP_NAME "quic_pkt_crypto_failed_app"
#define FD_METRICS_COUNTER_QUIC_PKT_CRYPTO_FAILED_APP_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_QUIC_PKT_CRYPTO_FAILED_APP_DESC "Number of packets that failed decryption. (app data)"
#define FD_METRICS_COUNTER_QUIC_PKT_CRYPTO_FAILED_APP_CVT  (FD_METRICS_CONVERTER_NONE)
...
#define FD_METRICS_COUNTER_QUIC_PKT_NO_KEY_INITIAL_NAME "quic_pkt_no_key_initial"
#define FD_METRICS_COUNTER_QUIC_PKT_NO_KEY_INITIAL_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_QUIC_PKT_NO_KEY_INITIAL_DESC "Number of packets that failed decryption due to missing key. (initial)"
#define FD_METRICS_COUNTER_QUIC_PKT_NO_KEY_INITIAL_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_QUIC_PKT_NO_KEY_EARLY_OFF  (116UL)
#define FD_METRICS_COUNTER_QUIC_PKT_NO_KEY_EARLY_NAME "quic_pkt_no_key_early"
#define FD_METRICS_COUNTER_QUIC_PKT_NO_KEY_EARLY_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_QUIC_PKT_NO_KEY_EARLY_DESC "Number of packets that failed decryption due to missing key. (early data)"
#define FD_METRICS_COUNTER_QUIC_PKT_NO_KEY_EARLY_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_QUIC_PKT_NO_KEY_HANDSHAKE_OFF  (117UL)
#define FD_METRICS_COUNTER_QUIC_PKT_NO_KEY_HANDSHAKE_NAME "quic_pkt_no_key_handshake"
#define FD_METRICS_COUNTER_QUIC_PKT_NO_KEY_HANDSHAKE_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_QUIC_PKT_NO_KEY_HANDSHAKE_DESC "Number of packets that failed decryption due to missing key. (handshake)"
#define FD_METRICS_COUNTER_QUIC_PKT_NO_KEY_HANDSHAKE_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_QUIC_PKT_NO_KEY_APP_OFF  (118UL)
#define FD_METRICS_COUNTER_QUIC_PKT_NO_KEY_APP_NAME "quic_pkt_no_key_app"
#define FD_METRICS_COUNTER_QUIC_PKT_NO_KEY_APP_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_QUIC_PKT_NO_KEY_APP_DESC "Number of packets that failed decryption due to missing key. (app data)"
#define FD_METRICS_COUNTER_QUIC_PKT_NO_KEY_APP_CVT  (FD_METRICS_CONVERTER_NONE)
