...
#define FD_METRICS_COUNTER_QUIC_TXNS_OVERRUN_OFF  (22UL)
...
#define FD_METRICS_COUNTER_QUIC_TXN_REASMS_STARTED_OFF  (23UL)
...
#define FD_METRICS_GAUGE_QUIC_TXN_REASMS_ACTIVE_OFF  (24UL)
...
#define FD_METRICS_COUNTER_QUIC_FRAGS_OK_OFF  (25UL)
...
#define FD_METRICS_COUNTER_QUIC_FRAGS_GAP_OFF  (26UL)
...
#define FD_METRICS_COUNTER_QUIC_FRAGS_DUP_OFF  (27UL)
...
#define FD_METRICS_COUNTER_QUIC_TXNS_RECEIVED_OFF  (28UL)
...
#define FD_METRICS_COUNTER_QUIC_TXNS_RECEIVED_UDP_OFF (28UL)
#define FD_METRICS_COUNTER_QUIC_TXNS_RECEIVED_QUIC_FAST_OFF (29UL)
#define FD_METRICS_COUNTER_QUIC_TXNS_RECEIVED_QUIC_FRAG_OFF (30UL)

#define FD_METRICS_COUNTER_QUIC_TXNS_ABANDONED_OFF  (31UL)
...
#define FD_METRICS_COUNTER_QUIC_TXN_UNDERSZ_OFF  (32UL)
...
#define FD_METRICS_COUNTER_QUIC_TXN_OVERSZ_OFF  (33UL)
...
#define FD_METRICS_COUNTER_QUIC_LEGACY_TXN_UNDERSZ_OFF  (34UL)
...
#define FD_METRICS_COUNTER_QUIC_LEGACY_TXN_OVERSZ_OFF  (35UL)
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_PACKETS_OFF  (36UL)
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_BYTES_OFF  (37UL)
...
#define FD_METRICS_COUNTER_QUIC_SENT_PACKETS_OFF  (38UL)
...
#define FD_METRICS_COUNTER_QUIC_SENT_BYTES_OFF  (39UL)
...
#define FD_METRICS_GAUGE_QUIC_CONNECTIONS_ALLOC_OFF  (40UL)
...
#define FD_METRICS_GAUGE_QUIC_CONNECTIONS_STATE_OFF  (41UL)
...
#define FD_METRICS_GAUGE_QUIC_CONNECTIONS_STATE_INVALID_OFF (41UL)
#define FD_METRICS_GAUGE_QUIC_CONNECTIONS_STATE_HANDSHAKE_OFF (42UL)
#define FD_METRICS_GAUGE_QUIC_CONNECTIONS_STATE_HANDSHAKE_COMPLETE_OFF (43UL)
#define FD_METRICS_GAUGE_QUIC_CONNECTIONS_STATE_ACTIVE_OFF (44UL)
#define FD_METRICS_GAUGE_QUIC_CONNECTIONS_STATE_PEER_CLOSE_OFF (45UL)
#define FD_METRICS_GAUGE_QUIC_CONNECTIONS_STATE_ABORT_OFF (46UL)
#define FD_METRICS_GAUGE_QUIC_CONNECTIONS_STATE_CLOSE_PENDING_OFF (47UL)
#define FD_METRICS_GAUGE_QUIC_CONNECTIONS_STATE_DEAD_OFF (48UL)

#define FD_METRICS_COUNTER_QUIC_CONNECTIONS_CREATED_OFF  (49UL)
...
#define FD_METRICS_COUNTER_QUIC_CONNECTIONS_CLOSED_OFF  (50UL)
...
#define FD_METRICS_COUNTER_QUIC_CONNECTIONS_ABORTED_OFF  (51UL)
...
#define FD_METRICS_COUNTER_QUIC_CONNECTIONS_TIMED_OUT_OFF  (52UL)
...
#define FD_METRICS_COUNTER_QUIC_CONNECTIONS_RETRIED_OFF  (53UL)
...
#define FD_METRICS_COUNTER_QUIC_CONNECTION_ERROR_NO_SLOTS_OFF  (54UL)
...
#define FD_METRICS_COUNTER_QUIC_CONNECTION_ERROR_RETRY_FAIL_OFF  (55UL)
...
#define FD_METRICS_COUNTER_QUIC_PKT_NO_CONN_OFF  (56UL)
...
#define FD_METRICS_COUNTER_QUIC_PKT_NO_CONN_INITIAL_OFF (56UL)
#define FD_METRICS_COUNTER_QUIC_PKT_NO_CONN_RETRY_OFF (57UL)
#define FD_METRICS_COUNTER_QUIC_PKT_NO_CONN_HANDSHAKE_OFF (58UL)
#define FD_METRICS_COUNTER_QUIC_PKT_NO_CONN_ONE_RTT_OFF (59UL)

#define FD_METRICS_COUNTER_QUIC_FRAME_TX_ALLOC_OFF  (60UL)
...
#define FD_METRICS_COUNTER_QUIC_FRAME_TX_ALLOC_SUCCESS_OFF (60UL)
#define FD_METRICS_COUNTER_QUIC_FRAME_TX_ALLOC_FAIL_EMPTY_POOL_OFF (61UL)
#define FD_METRICS_COUNTER_QUIC_FRAME_TX_ALLOC_FAIL_CONN_MAX_OFF (62UL)

#define FD_METRICS_COUNTER_QUIC_INITIAL_TOKEN_LEN_OFF  (63UL)
...
#define FD_METRICS_COUNTER_QUIC_INITIAL_TOKEN_LEN_ZERO_OFF (63UL)
#define FD_METRICS_COUNTER_QUIC_INITIAL_TOKEN_LEN_FD_QUIC_LEN_OFF (64UL)
#define FD_METRICS_COUNTER_QUIC_INITIAL_TOKEN_LEN_INVALID_LEN_OFF (65UL)

#define FD_METRICS_COUNTER_QUIC_HANDSHAKES_CREATED_OFF  (66UL)
...
#define FD_METRICS_COUNTER_QUIC_HANDSHAKE_ERROR_ALLOC_FAIL_OFF  (67UL)
...
#define FD_METRICS_COUNTER_QUIC_HANDSHAKE_EVICTED_OFF  (68UL)
...
#define FD_METRICS_COUNTER_QUIC_STREAM_RECEIVED_EVENTS_OFF  (69UL)
...
#define FD_METRICS_COUNTER_QUIC_STREAM_RECEIVED_BYTES_OFF  (70UL)
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_OFF  (71UL)
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_UNKNOWN_OFF (71UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_ACK_OFF (72UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_RESET_STREAM_OFF (73UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_STOP_SENDING_OFF (74UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_CRYPTO_OFF (75UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_NEW_TOKEN_OFF (76UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_STREAM_OFF (77UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_MAX_DATA_OFF (78UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_MAX_STREAM_DATA_OFF (79UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_MAX_STREAMS_OFF (80UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_DATA_BLOCKED_OFF (81UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_STREAM_DATA_BLOCKED_OFF (82UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_STREAMS_BLOCKED_OFF (83UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_NEW_CONN_ID_OFF (84UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_RETIRE_CONN_ID_OFF (85UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_PATH_CHALLENGE_OFF (86UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_PATH_RESPONSE_OFF (87UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_CONN_CLOSE_QUIC_OFF (88UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_CONN_CLOSE_APP_OFF (89UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_HANDSHAKE_DONE_OFF (90UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_PING_OFF (91UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_PADDING_OFF (92UL)

#define FD_METRICS_COUNTER_QUIC_ACK_TX_OFF  (93UL)
...
#define FD_METRICS_COUNTER_QUIC_ACK_TX_NOOP_OFF (93UL)
#define FD_METRICS_COUNTER_QUIC_ACK_TX_NEW_OFF (94UL)
#define FD_METRICS_COUNTER_QUIC_ACK_TX_MERGED_OFF (95UL)
#define FD_METRICS_COUNTER_QUIC_ACK_TX_DROP_OFF (96UL)
#define FD_METRICS_COUNTER_QUIC_ACK_TX_CANCEL_OFF (97UL)

#define FD_METRICS_HISTOGRAM_QUIC_SERVICE_DURATION_SECONDS_OFF  (98UL)
...
#define FD_METRICS_HISTOGRAM_QUIC_RECEIVE_DURATION_SECONDS_OFF  (115UL)
...
#define FD_METRICS_COUNTER_QUIC_FRAME_FAIL_PARSE_OFF  (132UL)
...
#define FD_METRICS_COUNTER_QUIC_PKT_CRYPTO_FAILED_OFF  (133UL)
...
#define FD_METRICS_COUNTER_QUIC_PKT_CRYPTO_FAILED_INITIAL_OFF (133UL)
#define FD_METRICS_COUNTER_QUIC_PKT_CRYPTO_FAILED_EARLY_OFF (134UL)
#define FD_METRICS_COUNTER_QUIC_PKT_CRYPTO_FAILED_HANDSHAKE_OFF (135UL)
#define FD_METRICS_COUNTER_QUIC_PKT_CRYPTO_FAILED_APP_OFF (136UL)

#define FD_METRICS_COUNTER_QUIC_PKT_NO_KEY_OFF  (137UL)
...
#define FD_METRICS_COUNTER_QUIC_PKT_NO_KEY_INITIAL_OFF (137UL)
#define FD_METRICS_COUNTER_QUIC_PKT_NO_KEY_EARLY_OFF (138UL)
#define FD_METRICS_COUNTER_QUIC_PKT_NO_KEY_HANDSHAKE_OFF (139UL)
#define FD_METRICS_COUNTER_QUIC_PKT_NO_KEY_APP_OFF (140UL)

#define FD_METRICS_COUNTER_QUIC_PKT_NET_HEADER_INVALID_OFF  (141UL)
...
#define FD_METRICS_COUNTER_QUIC_PKT_QUIC_HEADER_INVALID_OFF  (142UL)
...
#define FD_METRICS_COUNTER_QUIC_PKT_UNDERSZ_OFF  (143UL)
...
#define FD_METRICS_COUNTER_QUIC_PKT_OVERSZ_OFF  (144UL)
...
#define FD_METRICS_COUNTER_QUIC_PKT_VERNEG_OFF  (145UL)
...
#define FD_METRICS_COUNTER_QUIC_RETRY_SENT_OFF  (146UL)
...
#define FD_METRICS_COUNTER_QUIC_PKT_RETRANSMISSIONS_OFF  (147UL)
...
#define FD_METRICS_COUNTER_QUIC_PKT_RETRANSMISSIONS_INITIAL_OFF (147UL)
#define FD_METRICS_COUNTER_QUIC_PKT_RETRANSMISSIONS_EARLY_OFF (148UL)
#define FD_METRICS_COUNTER_QUIC_PKT_RETRANSMISSIONS_HANDSHAKE_OFF (149UL)
#define FD_METRICS_COUNTER_QUIC_PKT_RETRANSMISSIONS_APP_OFF (150UL)
