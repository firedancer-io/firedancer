...
#define FD_METRICS_COUNTER_QUIC_PKT_META_RETRY_OFF  (123UL)
#define FD_METRICS_COUNTER_QUIC_PKT_META_RETRY_NAME "quic_pkt_meta_retry"
#define FD_METRICS_COUNTER_QUIC_PKT_META_RETRY_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_QUIC_PKT_META_RETRY_DESC "Number of QUIC packets that retransmitted."
#define FD_METRICS_COUNTER_QUIC_PKT_META_RETRY_CVT  (FD_METRICS_CONVERTER_NONE)
