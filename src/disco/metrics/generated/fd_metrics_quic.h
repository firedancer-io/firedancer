...
#define FD_METRICS_COUNTER_QUIC_TXNS_RECEIVED_UDP_NAME "quic_txns_received_udp"
#define FD_METRICS_COUNTER_QUIC_TXNS_RECEIVED_UDP_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_QUIC_TXNS_RECEIVED_UDP_DESC "Count of txns received via TPU. (TPU/UDP)"
#define FD_METRICS_COUNTER_QUIC_TXNS_RECEIVED_UDP_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_QUIC_TXNS_RECEIVED_QUIC_FAST_OFF  (23UL)
#define FD_METRICS_COUNTER_QUIC_TXNS_RECEIVED_QUIC_FAST_NAME "quic_txns_received_quicfast"
#define FD_METRICS_COUNTER_QUIC_TXNS_RECEIVED_QUIC_FAST_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_QUIC_TXNS_RECEIVED_QUIC_FAST_DESC "Count of txns received via TPU. (TPU/QUIC unfragmented)"
#define FD_METRICS_COUNTER_QUIC_TXNS_RECEIVED_QUIC_FAST_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_QUIC_TXNS_RECEIVED_QUIC_FRAG_OFF  (24UL)
#define FD_METRICS_COUNTER_QUIC_TXNS_RECEIVED_QUIC_FRAG_NAME "quic_txns_received_quicfrag"
#define FD_METRICS_COUNTER_QUIC_TXNS_RECEIVED_QUIC_FRAG_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_QUIC_TXNS_RECEIVED_QUIC_FRAG_DESC "Count of txns received via TPU. (TPU/QUIC fragmented)"
#define FD_METRICS_COUNTER_QUIC_TXNS_RECEIVED_QUIC_FRAG_CVT  (FD_METRICS_CONVERTER_NONE)
...
#define FD_METRICS_COUNTER_QUIC_QUIC_PACKET_TOO_SMALL_OFF  (26UL)
#define FD_METRICS_COUNTER_QUIC_QUIC_PACKET_TOO_SMALL_NAME "quic_quic_packet_too_small"
#define FD_METRICS_COUNTER_QUIC_QUIC_PACKET_TOO_SMALL_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_QUIC_QUIC_PACKET_TOO_SMALL_DESC "Count of packets received on the QUIC port that were too small to be a valid IP packet."
#define FD_METRICS_COUNTER_QUIC_QUIC_PACKET_TOO_SMALL_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_QUIC_QUIC_TXN_TOO_SMALL_OFF  (27UL)
#define FD_METRICS_COUNTER_QUIC_QUIC_TXN_TOO_SMALL_NAME "quic_quic_txn_too_small"
#define FD_METRICS_COUNTER_QUIC_QUIC_TXN_TOO_SMALL_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_QUIC_QUIC_TXN_TOO_SMALL_DESC "Count of txns received via QUIC dropped because they were too small."
#define FD_METRICS_COUNTER_QUIC_QUIC_TXN_TOO_SMALL_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_QUIC_QUIC_TXN_TOO_LARGE_OFF  (28UL)
#define FD_METRICS_COUNTER_QUIC_QUIC_TXN_TOO_LARGE_NAME "quic_quic_txn_too_large"
#define FD_METRICS_COUNTER_QUIC_QUIC_TXN_TOO_LARGE_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_QUIC_QUIC_TXN_TOO_LARGE_DESC "Count of txns received via QUIC dropped because they were too large."
#define FD_METRICS_COUNTER_QUIC_QUIC_TXN_TOO_LARGE_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_QUIC_NON_QUIC_PACKET_TOO_SMALL_OFF  (29UL)
#define FD_METRICS_COUNTER_QUIC_NON_QUIC_PACKET_TOO_SMALL_NAME "quic_non_quic_packet_too_small"
#define FD_METRICS_COUNTER_QUIC_NON_QUIC_PACKET_TOO_SMALL_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_QUIC_NON_QUIC_PACKET_TOO_SMALL_DESC "Count of packets received on the non-QUIC port that were too small to be a valid IP packet."
#define FD_METRICS_COUNTER_QUIC_NON_QUIC_PACKET_TOO_SMALL_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_QUIC_NON_QUIC_PACKET_TOO_LARGE_OFF  (30UL)
#define FD_METRICS_COUNTER_QUIC_NON_QUIC_PACKET_TOO_LARGE_NAME "quic_non_quic_packet_too_large"
#define FD_METRICS_COUNTER_QUIC_NON_QUIC_PACKET_TOO_LARGE_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_QUIC_NON_QUIC_PACKET_TOO_LARGE_DESC "Count of packets received on the non-QUIC port that were too large to be a valid transaction."
#define FD_METRICS_COUNTER_QUIC_NON_QUIC_PACKET_TOO_LARGE_CVT  (FD_METRICS_CONVERTER_NONE)
...
#define FD_METRICS_GAUGE_QUIC_CONNECTIONS_ACTIVE_OFF  (35UL)
...
#define FD_METRICS_COUNTER_QUIC_CONNECTIONS_CREATED_OFF  (36UL)
...
#define FD_METRICS_COUNTER_QUIC_CONNECTIONS_CLOSED_OFF  (37UL)
...
#define FD_METRICS_COUNTER_QUIC_CONNECTIONS_ABORTED_OFF  (38UL)
...
#define FD_METRICS_COUNTER_QUIC_CONNECTIONS_TIMED_OUT_OFF  (39UL)
...
#define FD_METRICS_COUNTER_QUIC_CONNECTIONS_RETRIED_OFF  (40UL)
...
#define FD_METRICS_COUNTER_QUIC_CONNECTION_ERROR_NO_SLOTS_OFF  (41UL)
...
#define FD_METRICS_COUNTER_QUIC_CONNECTION_ERROR_RETRY_FAIL_OFF  (42UL)
...
#define FD_METRICS_COUNTER_QUIC_PKT_CRYPTO_FAILED_OFF  (43UL)
...
#define FD_METRICS_COUNTER_QUIC_PKT_NO_CONN_OFF  (44UL)
...
#define FD_METRICS_COUNTER_QUIC_PKT_TX_ALLOC_FAIL_OFF  (45UL)
...
#define FD_METRICS_COUNTER_QUIC_STREAM_RECEIVED_EVENTS_OFF  (48UL)
...
#define FD_METRICS_COUNTER_QUIC_STREAM_RECEIVED_BYTES_OFF  (49UL)
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_OFF  (50UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_CNT  (22UL)

#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_UNKNOWN_OFF  (50UL)
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_ACK_OFF  (51UL)
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_RESET_STREAM_OFF  (52UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_RESET_STREAM_NAME "quic_received_frames_resetstream"
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_STOP_SENDING_OFF  (53UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_STOP_SENDING_NAME "quic_received_frames_stopsending"
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_CRYPTO_OFF  (54UL)
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_NEW_TOKEN_OFF  (55UL)
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_STREAM_OFF  (56UL)
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_MAX_DATA_OFF  (57UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_MAX_DATA_NAME "quic_received_frames_maxdata"
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_MAX_STREAM_DATA_OFF  (58UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_MAX_STREAM_DATA_NAME "quic_received_frames_maxstreamdata"
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_MAX_STREAMS_OFF  (59UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_MAX_STREAMS_NAME "quic_received_frames_maxstreams"
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_DATA_BLOCKED_OFF  (60UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_DATA_BLOCKED_NAME "quic_received_frames_datablocked"
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_STREAM_DATA_BLOCKED_OFF  (61UL)
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_STREAMS_BLOCKED_OFF  (62UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_STREAMS_BLOCKED_NAME "quic_received_frames_streamsblocked"
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_NEW_CONN_ID_OFF  (63UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_NEW_CONN_ID_NAME "quic_received_frames_newconnid"
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_RETIRE_CONN_ID_OFF  (64UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_RETIRE_CONN_ID_NAME "quic_received_frames_retireconnid"
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_PATH_CHALLENGE_OFF  (65UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_PATH_CHALLENGE_NAME "quic_received_frames_pathchallenge"
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_PATH_RESPONSE_OFF  (66UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_PATH_RESPONSE_NAME "quic_received_frames_pathresponse"
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_CONN_CLOSE_QUIC_OFF  (67UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_CONN_CLOSE_QUIC_NAME "quic_received_frames_connclosequic"
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_CONN_CLOSE_APP_OFF  (68UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_CONN_CLOSE_APP_NAME "quic_received_frames_conncloseapp"
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_HANDSHAKE_DONE_OFF  (69UL)
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_HANDSHAKE_DONE_NAME "quic_received_frames_handshakedone"
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_PING_OFF  (70UL)
...
#define FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_PADDING_OFF  (71UL)
...
#define FD_METRICS_COUNTER_QUIC_ACK_TX_OFF  (72UL)
#define FD_METRICS_COUNTER_QUIC_ACK_TX_CNT  (5UL)

#define FD_METRICS_COUNTER_QUIC_ACK_TX_NOOP_OFF  (72UL)
...
#define FD_METRICS_COUNTER_QUIC_ACK_TX_NEW_OFF  (73UL)
...
#define FD_METRICS_COUNTER_QUIC_ACK_TX_MERGED_OFF  (74UL)
...
#define FD_METRICS_COUNTER_QUIC_ACK_TX_DROP_OFF  (75UL)
...
#define FD_METRICS_COUNTER_QUIC_ACK_TX_CANCEL_OFF  (76UL)
...
#define FD_METRICS_HISTOGRAM_QUIC_SERVICE_DURATION_SECONDS_OFF  (77UL)
...
#define FD_METRICS_HISTOGRAM_QUIC_RECEIVE_DURATION_SECONDS_OFF  (94UL)
...
#define FD_METRICS_COUNTER_QUIC_FRAME_FAIL_PARSE_OFF  (111UL)
...
#define FD_METRICS_QUIC_TOTAL (64UL)
