...
enum {
  FD_METRICS_COUNTER_QUIC_TXNS_OVERRUN_OFF = FD_METRICS_TILE_OFF,
  FD_METRICS_COUNTER_QUIC_TXN_REASMS_STARTED_OFF,
  FD_METRICS_GAUGE_QUIC_TXN_REASMS_ACTIVE_OFF,
  FD_METRICS_COUNTER_QUIC_FRAGS_OK_OFF,
  FD_METRICS_COUNTER_QUIC_FRAGS_GAP_OFF,
  FD_METRICS_COUNTER_QUIC_FRAGS_DUP_OFF,
  FD_METRICS_COUNTER_QUIC_TXNS_RECEIVED_OFF,
  FD_METRICS_COUNTER_QUIC_TXNS_RECEIVED_UDP_OFF = FD_METRICS_COUNTER_QUIC_TXNS_RECEIVED_OFF,
  FD_METRICS_COUNTER_QUIC_TXNS_RECEIVED_QUIC_FAST_OFF,
  FD_METRICS_COUNTER_QUIC_TXNS_RECEIVED_QUIC_FRAG_OFF,
  FD_METRICS_COUNTER_QUIC_TXNS_ABANDONED_OFF,
  FD_METRICS_COUNTER_QUIC_TXN_UNDERSZ_OFF,
  FD_METRICS_COUNTER_QUIC_TXN_OVERSZ_OFF,
  FD_METRICS_COUNTER_QUIC_LEGACY_TXN_UNDERSZ_OFF,
  FD_METRICS_COUNTER_QUIC_LEGACY_TXN_OVERSZ_OFF,
  FD_METRICS_COUNTER_QUIC_RECEIVED_PACKETS_OFF,
  FD_METRICS_COUNTER_QUIC_RECEIVED_BYTES_OFF,
  FD_METRICS_COUNTER_QUIC_SENT_PACKETS_OFF,
  FD_METRICS_COUNTER_QUIC_SENT_BYTES_OFF,
  FD_METRICS_GAUGE_QUIC_CONNECTIONS_ALLOC_OFF,
  FD_METRICS_GAUGE_QUIC_CONNECTIONS_STATE_OFF,
  FD_METRICS_GAUGE_QUIC_CONNECTIONS_STATE_INVALID_OFF = FD_METRICS_GAUGE_QUIC_CONNECTIONS_STATE_OFF,
  FD_METRICS_GAUGE_QUIC_CONNECTIONS_STATE_HANDSHAKE_OFF,
  FD_METRICS_GAUGE_QUIC_CONNECTIONS_STATE_HANDSHAKE_COMPLETE_OFF,
  FD_METRICS_GAUGE_QUIC_CONNECTIONS_STATE_ACTIVE_OFF,
  FD_METRICS_GAUGE_QUIC_CONNECTIONS_STATE_PEER_CLOSE_OFF,
  FD_METRICS_GAUGE_QUIC_CONNECTIONS_STATE_ABORT_OFF,
  FD_METRICS_GAUGE_QUIC_CONNECTIONS_STATE_CLOSE_PENDING_OFF,
  FD_METRICS_GAUGE_QUIC_CONNECTIONS_STATE_DEAD_OFF,
  FD_METRICS_COUNTER_QUIC_CONNECTIONS_CREATED_OFF,
  FD_METRICS_COUNTER_QUIC_CONNECTIONS_CLOSED_OFF,
  FD_METRICS_COUNTER_QUIC_CONNECTIONS_ABORTED_OFF,
  FD_METRICS_COUNTER_QUIC_CONNECTIONS_TIMED_OUT_OFF,
  FD_METRICS_COUNTER_QUIC_CONNECTIONS_RETRIED_OFF,
  FD_METRICS_COUNTER_QUIC_CONNECTION_ERROR_NO_SLOTS_OFF,
  FD_METRICS_COUNTER_QUIC_CONNECTION_ERROR_RETRY_FAIL_OFF,
  ...
  FD_METRICS_COUNTER_QUIC_PKT_WRONG_SRC_OFF,
  ...
  FD_METRICS_COUNTER_QUIC_FRAME_TX_ALLOC_FAIL_CONN_MAX_OFF,
  FD_METRICS_COUNTER_QUIC_INITIAL_TOKEN_LEN_OFF,
  FD_METRICS_COUNTER_QUIC_INITIAL_TOKEN_LEN_ZERO_OFF = FD_METRICS_COUNTER_QUIC_INITIAL_TOKEN_LEN_OFF,
  FD_METRICS_COUNTER_QUIC_INITIAL_TOKEN_LEN_FD_QUIC_LEN_OFF,
  FD_METRICS_COUNTER_QUIC_INITIAL_TOKEN_LEN_INVALID_LEN_OFF,
  FD_METRICS_COUNTER_QUIC_HANDSHAKES_CREATED_OFF,
  FD_METRICS_COUNTER_QUIC_HANDSHAKE_ERROR_ALLOC_FAIL_OFF,
  FD_METRICS_COUNTER_QUIC_HANDSHAKE_EVICTED_OFF,
  FD_METRICS_COUNTER_QUIC_STREAM_RECEIVED_EVENTS_OFF,
  FD_METRICS_COUNTER_QUIC_STREAM_RECEIVED_BYTES_OFF,
  FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_OFF,
  FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_UNKNOWN_OFF = FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_OFF,
  FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_ACK_OFF,
  FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_RESET_STREAM_OFF,
  FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_STOP_SENDING_OFF,
  FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_CRYPTO_OFF,
  FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_NEW_TOKEN_OFF,
  FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_STREAM_OFF,
  FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_MAX_DATA_OFF,
  FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_MAX_STREAM_DATA_OFF,
  FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_MAX_STREAMS_OFF,
  FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_DATA_BLOCKED_OFF,
  FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_STREAM_DATA_BLOCKED_OFF,
  FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_STREAMS_BLOCKED_OFF,
  FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_NEW_CONN_ID_OFF,
  FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_RETIRE_CONN_ID_OFF,
  FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_PATH_CHALLENGE_OFF,
  FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_PATH_RESPONSE_OFF,
  FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_CONN_CLOSE_QUIC_OFF,
  FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_CONN_CLOSE_APP_OFF,
  FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_HANDSHAKE_DONE_OFF,
  FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_PING_OFF,
  FD_METRICS_COUNTER_QUIC_RECEIVED_FRAMES_PADDING_OFF,
  ...
  FD_METRICS_COUNTER_QUIC_FRAME_FAIL_PARSE_OFF,
  ...
  FD_METRICS_COUNTER_QUIC_PKT_QUIC_HEADER_INVALID_OFF,
  FD_METRICS_COUNTER_QUIC_PKT_UNDERSZ_OFF,
  FD_METRICS_COUNTER_QUIC_PKT_OVERSZ_OFF,
  FD_METRICS_COUNTER_QUIC_PKT_VERNEG_OFF,
  FD_METRICS_COUNTER_QUIC_RETRY_SENT_OFF,
  FD_METRICS_COUNTER_QUIC_PKT_RETRANSMISSIONS_OFF,
  FD_METRICS_COUNTER_QUIC_PKT_RETRANSMISSIONS_INITIAL_OFF = FD_METRICS_COUNTER_QUIC_PKT_RETRANSMISSIONS_OFF,
  FD_METRICS_COUNTER_QUIC_PKT_RETRANSMISSIONS_EARLY_OFF,
  FD_METRICS_COUNTER_QUIC_PKT_RETRANSMISSIONS_HANDSHAKE_OFF,
  FD_METRICS_COUNTER_QUIC_PKT_RETRANSMISSIONS_APP_OFF,
};
...
#define FD_METRICS_COUNTER_QUIC_PKT_WRONG_SRC_NAME "quic_pkt_wrong_src"
#define FD_METRICS_COUNTER_QUIC_PKT_WRONG_SRC_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_QUIC_PKT_WRONG_SRC_DESC "Number of packets dropped due to a wrong source IP"
#define FD_METRICS_COUNTER_QUIC_PKT_WRONG_SRC_CVT  (FD_METRICS_CONVERTER_NONE)
