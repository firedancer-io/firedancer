...
#define FD_METRICS_GAUGE_SNAPLA_STATE_OFF  (22UL)
...
#define FD_METRICS_GAUGE_SNAPLA_FULL_ACCOUNTS_HASHED_OFF  (23UL)
...
#define FD_METRICS_GAUGE_SNAPLA_INCREMENTAL_ACCOUNTS_HASHED_OFF  (24UL)
