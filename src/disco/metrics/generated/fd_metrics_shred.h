...
#define FD_METRICS_HISTOGRAM_SHRED_CLUSTER_CONTACT_INFO_CNT_OFF  (23UL)
...
#define FD_METRICS_COUNTER_SHRED_MICROBLOCKS_ABANDONED_OFF  (40UL)
...
#define FD_METRICS_COUNTER_SHRED_INVALID_BLOCK_ID_OFF  (41UL)
...
#define FD_METRICS_HISTOGRAM_SHRED_BATCH_SZ_OFF  (42UL)
...
#define FD_METRICS_HISTOGRAM_SHRED_BATCH_MICROBLOCK_CNT_OFF  (59UL)
...
#define FD_METRICS_HISTOGRAM_SHRED_SHREDDING_DURATION_SECONDS_OFF  (76UL)
...
#define FD_METRICS_HISTOGRAM_SHRED_ADD_SHRED_DURATION_SECONDS_OFF  (93UL)
...
#define FD_METRICS_COUNTER_SHRED_SHRED_PROCESSED_OFF  (110UL)
...
#define FD_METRICS_COUNTER_SHRED_SHRED_PROCESSED_BAD_SLOT_OFF (110UL)
#define FD_METRICS_COUNTER_SHRED_SHRED_PROCESSED_PARSE_FAILED_OFF (111UL)
#define FD_METRICS_COUNTER_SHRED_SHRED_PROCESSED_REJECTED_OFF (112UL)
#define FD_METRICS_COUNTER_SHRED_SHRED_PROCESSED_IGNORED_OFF (113UL)
#define FD_METRICS_COUNTER_SHRED_SHRED_PROCESSED_OKAY_OFF (114UL)
#define FD_METRICS_COUNTER_SHRED_SHRED_PROCESSED_COMPLETES_OFF (115UL)

#define FD_METRICS_COUNTER_SHRED_FEC_SET_SPILLED_OFF  (116UL)
...
#define FD_METRICS_COUNTER_SHRED_SHRED_REJECTED_INITIAL_OFF  (117UL)
...
#define FD_METRICS_COUNTER_SHRED_SHRED_REJECTED_UNCHAINED_OFF  (118UL)
...
#define FD_METRICS_COUNTER_SHRED_FEC_REJECTED_FATAL_OFF  (119UL)
...
#define FD_METRICS_COUNTER_SHRED_BAD_NONCE_OFF  (120UL)
#define FD_METRICS_COUNTER_SHRED_BAD_NONCE_NAME "shred_bad_nonce"
#define FD_METRICS_COUNTER_SHRED_BAD_NONCE_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_SHRED_BAD_NONCE_DESC "The number of shreds we received that seemed to be repair responses but had an incorrect nonce"
#define FD_METRICS_COUNTER_SHRED_BAD_NONCE_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_SHRED_SHRED_REPAIR_RCV_OFF  (121UL)
...
#define FD_METRICS_COUNTER_SHRED_SHRED_REPAIR_RCV_BYTES_OFF  (122UL)
...
#define FD_METRICS_COUNTER_SHRED_SHRED_TURBINE_RCV_OFF  (123UL)
...
#define FD_METRICS_COUNTER_SHRED_SHRED_TURBINE_RCV_BYTES_OFF  (124UL)
...
#define FD_METRICS_COUNTER_SHRED_STORE_INSERT_ACQUIRE_OFF  (125UL)
#define FD_METRICS_COUNTER_SHRED_STORE_INSERT_ACQUIRE_NAME "shred_store_insert_acquire"
#define FD_METRICS_COUNTER_SHRED_STORE_INSERT_ACQUIRE_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_SHRED_STORE_INSERT_ACQUIRE_DESC "Count of slock acquires for insert"
#define FD_METRICS_COUNTER_SHRED_STORE_INSERT_ACQUIRE_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_SHRED_STORE_INSERT_RELEASE_OFF  (126UL)
#define FD_METRICS_COUNTER_SHRED_STORE_INSERT_RELEASE_NAME "shred_store_insert_release"
#define FD_METRICS_COUNTER_SHRED_STORE_INSERT_RELEASE_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_SHRED_STORE_INSERT_RELEASE_DESC "Count of slock releases for insert"
#define FD_METRICS_COUNTER_SHRED_STORE_INSERT_RELEASE_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_HISTOGRAM_SHRED_STORE_INSERT_WAIT_OFF  (127UL)
...
#define FD_METRICS_HISTOGRAM_SHRED_STORE_INSERT_WAIT_DESC "Time in seconds spent waiting to acquire the slock for insert"
...
#define FD_METRICS_HISTOGRAM_SHRED_STORE_INSERT_WORK_OFF  (144UL)
...
#define FD_METRICS_HISTOGRAM_SHRED_STORE_INSERT_WORK_DESC "Time in seconds spent working before releasing the slock for insert"
...
#define FD_METRICS_COUNTER_SHRED_STORE_INSERT_CNT_OFF  (161UL)
#define FD_METRICS_COUNTER_SHRED_STORE_INSERT_CNT_NAME "shred_store_insert_cnt"
#define FD_METRICS_COUNTER_SHRED_STORE_INSERT_CNT_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_SHRED_STORE_INSERT_CNT_DESC "Count of inserts"
#define FD_METRICS_COUNTER_SHRED_STORE_INSERT_CNT_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_SHRED_STORE_INSERT_FULL_CNT_OFF  (162UL)
#define FD_METRICS_COUNTER_SHRED_STORE_INSERT_FULL_CNT_NAME "shred_store_insert_full_cnt"
#define FD_METRICS_COUNTER_SHRED_STORE_INSERT_FULL_CNT_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_SHRED_STORE_INSERT_FULL_CNT_DESC "Count of inserts when store was full"
#define FD_METRICS_COUNTER_SHRED_STORE_INSERT_FULL_CNT_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_COUNTER_SHRED_STORE_INSERT_DUPLICATE_CNT_OFF  (163UL)
#define FD_METRICS_COUNTER_SHRED_STORE_INSERT_DUPLICATE_CNT_NAME "shred_store_insert_duplicate_cnt"
#define FD_METRICS_COUNTER_SHRED_STORE_INSERT_DUPLICATE_CNT_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_SHRED_STORE_INSERT_DUPLICATE_CNT_DESC "Count of duplicate inserts"
#define FD_METRICS_COUNTER_SHRED_STORE_INSERT_DUPLICATE_CNT_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_GAUGE_SHRED_STORE_INSERT_MR_OFF  (164UL)
#define FD_METRICS_GAUGE_SHRED_STORE_INSERT_MR_NAME "shred_store_insert_mr"
#define FD_METRICS_GAUGE_SHRED_STORE_INSERT_MR_TYPE (FD_METRICS_TYPE_GAUGE)
#define FD_METRICS_GAUGE_SHRED_STORE_INSERT_MR_DESC "First 8 bytes of most recently inserted merkle root"
#define FD_METRICS_GAUGE_SHRED_STORE_INSERT_MR_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_GAUGE_SHRED_STORE_INSERT_FULL_MR_OFF  (165UL)
#define FD_METRICS_GAUGE_SHRED_STORE_INSERT_FULL_MR_NAME "shred_store_insert_full_mr"
#define FD_METRICS_GAUGE_SHRED_STORE_INSERT_FULL_MR_TYPE (FD_METRICS_TYPE_GAUGE)
#define FD_METRICS_GAUGE_SHRED_STORE_INSERT_FULL_MR_DESC "First 8 bytes of most recently inserted merkle root when store was full"
#define FD_METRICS_GAUGE_SHRED_STORE_INSERT_FULL_MR_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_GAUGE_SHRED_STORE_INSERT_DUPLICATE_MR_OFF  (166UL)
#define FD_METRICS_GAUGE_SHRED_STORE_INSERT_DUPLICATE_MR_NAME "shred_store_insert_duplicate_mr"
#define FD_METRICS_GAUGE_SHRED_STORE_INSERT_DUPLICATE_MR_TYPE (FD_METRICS_TYPE_GAUGE)
#define FD_METRICS_GAUGE_SHRED_STORE_INSERT_DUPLICATE_MR_DESC "First 8 bytes of most recently inserted duplicate merkle root"
#define FD_METRICS_GAUGE_SHRED_STORE_INSERT_DUPLICATE_MR_CVT  (FD_METRICS_CONVERTER_NONE)

#define FD_METRICS_SHRED_TOTAL (32UL)
