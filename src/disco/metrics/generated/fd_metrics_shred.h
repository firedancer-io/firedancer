...
enum {
  FD_METRICS_HISTOGRAM_SHRED_CLUSTER_CONTACT_INFO_CNT_OFF = FD_METRICS_TILE_OFF,
  FD_METRICS_HISTOGRAM_SHRED_CLUSTER_CONTACT_INFO_CNT_OFF_END = FD_METRICS_HISTOGRAM_SHRED_CLUSTER_CONTACT_INFO_CNT_OFF + 16,
  FD_METRICS_COUNTER_SHRED_MICROBLOCKS_ABANDONED_OFF,
  FD_METRICS_COUNTER_SHRED_INVALID_BLOCK_ID_OFF,
  FD_METRICS_HISTOGRAM_SHRED_BATCH_SZ_OFF,
  FD_METRICS_HISTOGRAM_SHRED_BATCH_SZ_OFF_END = FD_METRICS_HISTOGRAM_SHRED_BATCH_SZ_OFF + 16,
  FD_METRICS_HISTOGRAM_SHRED_BATCH_MICROBLOCK_CNT_OFF,
  FD_METRICS_HISTOGRAM_SHRED_BATCH_MICROBLOCK_CNT_OFF_END = FD_METRICS_HISTOGRAM_SHRED_BATCH_MICROBLOCK_CNT_OFF + 16,
  ...
  FD_METRICS_COUNTER_SHRED_SHRED_PROCESSED_EQUIVOC_OFF,
  ...
  FD_METRICS_COUNTER_SHRED_BAD_NONCE_OFF,
  FD_METRICS_COUNTER_SHRED_SHRED_REPAIR_RCV_OFF,
  FD_METRICS_COUNTER_SHRED_SHRED_REPAIR_RCV_BYTES_OFF,
  FD_METRICS_COUNTER_SHRED_SHRED_TURBINE_RCV_OFF,
  FD_METRICS_COUNTER_SHRED_SHRED_TURBINE_RCV_BYTES_OFF,
};
...
#define FD_METRICS_HISTOGRAM_SHRED_CLUSTER_CONTACT_INFO_CNT_MAX  (108000UL)
