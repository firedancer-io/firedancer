...
#define FD_METRICS_GAUGE_SHRED_MAX_TURBINE_SLOT_OFF  (16UL)
#define FD_METRICS_GAUGE_SHRED_MAX_TURBINE_SLOT_NAME "shred_max_turbine_slot"
#define FD_METRICS_GAUGE_SHRED_MAX_TURBINE_SLOT_TYPE (FD_METRICS_TYPE_GAUGE)
#define FD_METRICS_GAUGE_SHRED_MAX_TURBINE_SLOT_DESC "The maximum seen slot in a recieved, resolved FEC set"
#define FD_METRICS_GAUGE_SHRED_MAX_TURBINE_SLOT_CVT  (FD_METRICS_CONVERTER_NONE)
...
#define FD_METRICS_HISTOGRAM_SHRED_STORE_INSERT_WAIT_OFF  (117UL)
...
#define FD_METRICS_HISTOGRAM_SHRED_STORE_INSERT_WORK_OFF  (134UL)
