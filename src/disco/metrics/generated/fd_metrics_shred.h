...
#define FD_METRICS_COUNTER_SHRED_FEC_DELIVERED_OFF  (111UL)
#define FD_METRICS_COUNTER_SHRED_FEC_DELIVERED_NAME "shred_fec_delivered"
#define FD_METRICS_COUNTER_SHRED_FEC_DELIVERED_TYPE (FD_METRICS_TYPE_COUNTER)
#define FD_METRICS_COUNTER_SHRED_FEC_DELIVERED_DESC "The number of FEC sets that were delivered to the store"
#define FD_METRICS_COUNTER_SHRED_FEC_DELIVERED_CVT  (FD_METRICS_CONVERTER_NONE)
