...
const fd_metrics_meta_t FD_METRICS_RESOLV[FD_METRICS_RESOLV_TOTAL] = {
    ...
    DECLARE_METRIC_COUNTER( RESOLV, STASH_OPERATION_INSERTED ),
    DECLARE_METRIC_COUNTER( RESOLV, STASH_OPERATION_OVERRUN ),
    DECLARE_METRIC_COUNTER( RESOLV, STASH_OPERATION_PUBLISHED ),
    DECLARE_METRIC_COUNTER( RESOLV, STASH_OPERATION_REMOVED ),
