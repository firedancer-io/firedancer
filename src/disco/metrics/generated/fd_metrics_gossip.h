...
#define FD_METRICS_GAUGE_GOSSIP_VALUE_MAP_SIZE_OFF  (28UL)
#define FD_METRICS_GAUGE_GOSSIP_VALUE_MAP_SIZE_NAME "gossip_value_map_size"
#define FD_METRICS_GAUGE_GOSSIP_VALUE_MAP_SIZE_TYPE (FD_METRICS_TYPE_GAUGE)
#define FD_METRICS_GAUGE_GOSSIP_VALUE_MAP_SIZE_DESC "Current size of the CRDS value map"
#define FD_METRICS_GAUGE_GOSSIP_VALUE_MAP_SIZE_CVT  (FD_METRICS_CONVERTER_NONE)
