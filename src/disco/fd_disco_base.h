...
#define FD_ESLOT_EQVOC_PER_BLOCK_CNT_LG_MAX (3)
#define FD_ESLOT_EQVOC_PER_BLOCK_CNT_MAX    (1UL<<FD_ESLOT_EQVOC_PER_BLOCK_CNT_LG_MAX)
#define FD_ESLOT_SLOT_LSB_MASK              ((1UL<<(64-FD_ESLOT_EQVOC_PER_BLOCK_CNT_LG_MAX))-1UL)
#define FD_ESLOT_PRIME_LSB_MASK             (FD_ESLOT_EQVOC_PER_BLOCK_CNT_MAX-1UL)

/* Equivocatable slot. */
union fd_eslot {
  struct {
    ulong slot:  64-FD_ESLOT_EQVOC_PER_BLOCK_CNT_LG_MAX;

    /* Prime counter, starting from 0, ++ for every equivocation on the
       slot. */
    ulong prime: FD_ESLOT_EQVOC_PER_BLOCK_CNT_LG_MAX;
  };
  ulong id;
};
