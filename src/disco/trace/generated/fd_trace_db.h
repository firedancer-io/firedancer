...
static inline void fd_trace_vinyl_acquire( void ) {
}
static inline void fd_trace_vinyl_release( void ) {
}
static inline void
fd_trace_vinyl_wait_enter( void ) {
  ulong const words[] = {
