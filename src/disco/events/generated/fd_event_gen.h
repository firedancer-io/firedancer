...
#define FD_EVENT_BLOCK_COMPLETED_DEAD_REASON_INVALID_LAST_TICK           (28) /* The block reached its max tick height, but the tick was not the last entry of the block. */
