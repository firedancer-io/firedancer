...
#define FD_EVENT_BLOCK_COMPLETED_DEAD_REASON_BAD_BLOCK_STRUCTURE         (28) /* An Alpenglow block's components did not follow the required shape: block header, optional genesis certificate, entries, optional update parent, entries, block footer, alpentick. */
