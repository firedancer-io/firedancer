...
#define FD_EVENT_ADMIN_COMMAND_TYPE_FAILOVER_STATUS              (6) /* Read failover pool status. */
#define FD_EVENT_ADMIN_COMMAND_TYPE_FAILOVER_CONTROL             (7) /* Apply a failover operator command. */
