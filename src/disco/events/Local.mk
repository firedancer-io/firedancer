ifdef FD_HAS_HOSTED
$(call add-hdrs,fd_circq.h fd_event_report.h fd_event_os.h)
...
$(call add-hdrs,fd_event_os.h)
$(call add-objs,fd_event_os,fd_disco)
$(call make-unit-test,test_event_os,test_event_os,fd_disco fd_util)
$(call run-unit-test,test_event_os)
endif
