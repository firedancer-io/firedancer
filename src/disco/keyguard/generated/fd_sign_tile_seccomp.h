...
#ifndef HEADER_fd_src_disco_keyguard_generated_fd_sign_tile_seccomp_h
#define HEADER_fd_src_disco_keyguard_generated_fd_sign_tile_seccomp_h
...
static const uint sock_filter_policy_fd_sign_tile_instr_cnt = 17;

static void populate_sock_filter_policy_fd_sign_tile( ulong out_cnt, struct sock_filter out[ static 17 ], uint logfile_fd ) {
  FD_TEST( out_cnt >= 17 );
...
#endif /* HEADER_fd_src_disco_keyguard_generated_fd_sign_tile_seccomp_h */
