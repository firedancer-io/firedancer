...
$(call make-unit-test,test_fec_resolver_proof_size_poc,test_fec_resolver_proof_size_poc,fd_flamenco fd_disco fd_ballet fd_util fd_tango fd_reedsol)
$(call run-unit-test,test_fec_resolver_proof_size_poc)
endif
