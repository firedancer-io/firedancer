...
$(call add-objs,fd_shred_dest_resolver fd_shred_tile,fd_disco)
$(call make-unit-test,test_fec_resolver,test_fec_resolver,fd_flamenco fd_disco fd_ballet fd_util_test fd_util fd_tango fd_reedsol)
