...
static const uint sock_filter_policy_fd_shred_tile_instr_cnt = 29;

static void populate_sock_filter_policy_fd_shred_tile( ulong out_cnt, struct sock_filter out[ static 29 ], uint logfile_fd, uint disk_fd ) {
  FD_TEST( out_cnt >= 29 );
