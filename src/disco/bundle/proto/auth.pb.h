...
typedef PB_BYTES_ARRAY_T(512) auth_Token_value_t;
...
typedef PB_BYTES_ARRAY_T(512) auth_RefreshAccessTokenRequest_refresh_token_t;
...
#define auth_GenerateAuthTokensResponse_size     1084
#define auth_RefreshAccessTokenRequest_size      515
#define auth_RefreshAccessTokenResponse_size     542
#define auth_Token_size                          539
