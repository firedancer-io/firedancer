...
#ifndef HEADER_fd_src_disco_bundle_generated_fd_bundle_tile_arm64_seccomp_h
#define HEADER_fd_src_disco_bundle_generated_fd_bundle_tile_arm64_seccomp_h
...
#endif
static const unsigned int sock_filter_policy_fd_bundle_tile_arm64_instr_cnt = 95;

static void populate_sock_filter_policy_fd_bundle_tile_arm64( ulong out_cnt, struct sock_filter * out, uint logfile_fd, uint keylog_fd, uint etc_hosts_fd, uint etc_resolv_conf ) {
  FD_TEST( out_cnt >= 95 );
