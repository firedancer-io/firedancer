...
$(call make-bin-rust,fddev,main,fd_fddev fd_fdctl fd_choreo fd_disco fd_flamenco fd_funk fd_quic fd_stl fd_tls fd_reedsol fd_ballet fd_waltz fd_tango fd_util external_functions, $(SECP256K1_LIBS))
endif
else
$(call make-bin-rust,fddev,main,fd_fddev fd_fdctl agave_validator firedancer_plugin_bundle fd_disco fd_flamenco fd_funk fd_quic fd_stl fd_tls fd_reedsol fd_ballet fd_waltz fd_tango fd_util)
endif
...
ifdef FD_HAS_NO_AGAVE
ifdef FD_HAS_SECP256K1
$(call make-integration-test,test_fddev,tests/test_fddev,fd_fddev fd_fdctl fd_choreo fd_disco fd_flamenco fd_funk fd_quic fd_stl fd_tls fd_reedsol fd_ballet fd_waltz fd_tango fd_util external_functions, $(SECP256K1_LIBS))
endif
else
$(call make-integration-test,test_fddev,tests/test_fddev,fd_fddev fd_fdctl fd_disco fd_flamenco fd_funk fd_quic fd_stl fd_tls fd_reedsol fd_ballet fd_waltz fd_tango fd_util agave_validator firedancer_plugin_bundle)
endif
