...
void bench_cmd_topo ( args_t * args, config_t * config );
void dev_cmd_topo   ( args_t * args, config_t * config );
void load_cmd_topo  ( args_t * args, config_t * config );
void pktgen_cmd_topo( args_t * args, config_t * config );

void dev_cmd_perm  ( args_t * args, fd_caps_ctx_t * caps, config_t * config );
void wksp_cmd_perm ( args_t * args, fd_caps_ctx_t * caps, config_t * config );
void txn_cmd_perm  ( args_t * args, fd_caps_ctx_t * caps, config_t * config );
void load_cmd_perm ( args_t * args, fd_caps_ctx_t * caps, config_t * config );
void flame_cmd_perm( args_t * args, fd_caps_ctx_t * caps, config_t * config );
