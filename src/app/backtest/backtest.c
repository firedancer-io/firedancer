...
apply_ledger_config( fd_ledger_config_t const * ledger_config, config_t * config ) {
  ...
  config->firedancer.snapshots.download = 0; /* Always false for backtest */
  config->firedancer.snapshots.minimum_download_speed_mib = 0;
  config->firedancer.snapshots.maximum_local_snapshot_age = 0;
  config->firedancer.snapshots.maximum_download_retry_abort = 0;
