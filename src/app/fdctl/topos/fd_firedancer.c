...
fd_topo_initialize( config_t * config ) {
  ...
  if( config->tiles.archiver.enabled ) {
    ...
    FOR(shred_tile_cnt) fd_topob_tile_in( topo, "arch_f", 0UL, "metric_in", "shred_storei", i, FD_TOPOB_UNRELIABLE, FD_TOPOB_POLLED );
    /**/ fd_topob_tile_in( topo, "arch_f", 0UL, "metric_in", "repair_store", 0UL, FD_TOPOB_UNRELIABLE, FD_TOPOB_POLLED );
    ...
    /**/ fd_topob_tile_in( topo, "arch_w", 0UL, "metric_in", "arch_f2w", 0UL, FD_TOPOB_UNRELIABLE, FD_TOPOB_POLLED );
  }
