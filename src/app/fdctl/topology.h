...
#define FD_TOPO_WKSP_KIND_GOSSIP       (19UL)
#define FD_TOPO_WKSP_KIND_MAX          ( FD_TOPO_WKSP_KIND_GOSSIP+1 ) /* Keep updated with maximum tile IDX */
...
#define FD_TOPO_TILE_KIND_GOSSIP ( 10UL)
#define FD_TOPO_TILE_KIND_MAX    ( FD_TOPO_TILE_KIND_GOSSIP+1 ) /* Keep updated with maximum tile IDX */
