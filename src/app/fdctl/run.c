...
tile_main( void * _args ) {
  ...
  fd_sandbox( frank_args.close_fd_start, frank_args.allow_syscalls_sz, frank_args.allow_syscalls );
...
main_pid_namespace( void * args ) {
  ...
  fd_sandbox( 3, sizeof(allow_syscalls)/sizeof(allow_syscalls[0]), allow_syscalls );
