...
static const unsigned int sock_filter_policy_quic_instr_cnt = 16;

static void populate_sock_filter_policy_quic(struct sock_filter (*out) [static 16]) {
  *out = {
    ...
    /* simply allow getpid */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, __NR_getpid, /* RET_ALLOW */ 9, 0 ),
    /* simply allow getrandom */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, __NR_getrandom, /* RET_ALLOW */ 8, 0 ),
