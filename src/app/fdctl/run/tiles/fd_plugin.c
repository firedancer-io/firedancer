...
after_frag( void *             _ctx,
  ...
  switch( *opt_sig ) {
    case 0:
      FD_LOG_WARNING(( "Got rooted slot %lu", *(ulong*)ctx->buf ));
      break;
    case 1:
      FD_LOG_WARNING(( "Got frozen slot %lu", *(ulong*)ctx->buf ));
      break;
    case 2:
      FD_LOG_WARNING(( "Got optimistically confirmed slot %lu", *(ulong*)ctx->buf ));
      break;
    default:
      FD_LOG_ERR(( "Unknown sig %lu", *opt_sig ));
  }
}
