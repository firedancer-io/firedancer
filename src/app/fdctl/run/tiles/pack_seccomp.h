#ifndef HEADER_fd_src_util_sandbox_pack_seccomp.h_h
#define HEADER_fd_src_util_sandbox_pack_seccomp.h_h
...
static void populate_sock_filter_policy_pack(struct sock_filter (*out) [static 14]) {
  *out = {
