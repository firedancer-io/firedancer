...
#ifndef HEADER_fd_src_app_fdctl_run_tiles_generated_replay_thread_seccomp_h
#define HEADER_fd_src_app_fdctl_run_tiles_generated_replay_thread_seccomp_h
...
#endif
static const unsigned int sock_filter_policy_replay_thread_instr_cnt = 15;

static void populate_sock_filter_policy_replay_thread( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd) {
  FD_TEST( out_cnt >= 15 );
  struct sock_filter filter[15] = {
    ...
    /* simply allow clock_gettime */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_clock_gettime, /* RET_ALLOW */ 8, 0 ),
