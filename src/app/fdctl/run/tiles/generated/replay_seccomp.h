...
#endif
static const unsigned int sock_filter_policy_replay_instr_cnt = 15;

static void populate_sock_filter_policy_replay( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd) {
  FD_TEST( out_cnt >= 15 );
