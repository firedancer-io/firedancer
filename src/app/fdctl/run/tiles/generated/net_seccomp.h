...
#endif
static const unsigned int sock_filter_policy_net_instr_cnt = 54;
...
static void populate_sock_filter_policy_net( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd, unsigned int xsk_fd, unsigned int lo_xsk_fd, unsigned int netlink_fd) {
  ...
  struct sock_filter filter[54] = {
    ...
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_recvfrom, /* check_recvfrom */ 36, 0 ),
    /* simply allow clock_gettime */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_clock_gettime, /* RET_ALLOW */ 44, 0 ),
