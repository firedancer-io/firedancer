...
unprivileged_init( fd_topo_t *      topo,
  ...
  if( FD_UNLIKELY( tile->in_cnt != 3UL ||
                   ...
                   strcmp( topo->links[ tile->in_link_id[ SENDER_IN_IDX  ] ].name,  "sender_gossip" ) ||
  ...
  if( FD_UNLIKELY( tile->out_cnt != 5 ||
                   ...
                   strcmp( topo->links[ tile->out_link_id[ SENDER_OUT_IDX ] ].name,  "gossip_sender" ) ) ) {
  ...
  /* Set up crds vote sender tile output  */
