...
send_packet( fd_gossip_tile_ctx_t * ctx,
  ...
  uchar mac[6] = {0};
  populate_packet_header_template( hdr, payload_sz, ctx->gossip_config.my_addr.addr, mac, ctx->gossip_listen_port );
...
unprivileged_init( fd_topo_t *      topo,
  ...
  ctx->net_out_mem    = topo->workspaces[ net_out->dcache_obj_id ].wksp;
