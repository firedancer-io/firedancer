...
fd_topo_tile_to_config( fd_topo_tile_t * tile ) {
  switch( tile->kind ) {
    ...
    case FD_TOPO_TILE_KIND_EXT_STORE:   return &fd_tile_ext_store;
    case FD_TOPO_TILE_KIND_SIGN:        return &fd_tile_sign;
    case FD_TOPO_TILE_KIND_METRIC:      return &fd_tile_metric;
    case FD_TOPO_TILE_KIND_GOSSIP:      return &fd_tile_gossip;
    ...
    case FD_TOPO_TILE_KIND_BLACKHOLE:   return &fd_tile_blackhole;
    case FD_TOPO_TILE_KIND_PACK_INT:    return &fd_tile_pack_int;
