...
fd_topo_firedancer( config_t * config ) {
  ...
  LINK( 1,                                FD_TOPO_LINK_KIND_VERIFY_TO_DEDUP,     FD_TOPO_WKSP_KIND_GOSSIP_VERIFY, config->tiles.net.send_buffer_size,       FD_NET_MTU,             1UL );
  ...
  TILE( 1,                                FD_TOPO_TILE_KIND_GOSSIP_VERIFY, FD_TOPO_WKSP_KIND_GOSSIP_VERIFY, fd_topo_find_link( topo, FD_TOPO_LINK_KIND_VERIFY_TO_DEDUP, i) );
  ...
  /**/                                                      TILE_IN(  FD_TOPO_TILE_KIND_VERIFY, 0UL, FD_TOPO_LINK_KIND_NETMUX_TO_OUT,     0UL, 0, 1 );
  /**/                                                      TILE_IN(  FD_TOPO_TILE_KIND_DEDUP,  0UL, FD_TOPO_LINK_KIND_VERIFY_TO_DEDUP,   0UL, 0, 1 );
