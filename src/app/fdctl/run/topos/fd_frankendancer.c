...
fd_topo_frankendancer( config_t * config ) { 
  ...
  /* Event notifications to event tile. */
  /**/                 fd_topob_link( topo, "replay_event", "plugin_in",    0,        128UL,                                    8UL,                    1UL );
  ...
  /**/                 fd_topob_tile( topo, "plugin",  "plugin",  "metric_in", "metric_in",  tile_to_cpu[ topo->tile_cnt ], 0,       NULL,           0UL );
  ...
  /**/                 fd_topob_tile_out( topo, "poh",    0UL,                        "replay_event", 0UL                                                  );

  /**/                 fd_topob_tile_in(  topo, "plugin", 0UL,           "metric_in", "replay_event", 0UL,          FD_TOPOB_RELIABLE,   FD_TOPOB_POLLED );
  /**/                 fd_topob_tile_in(  topo, "plugin", 0UL,           "metric_in", "crds_shred",   0UL,          FD_TOPOB_RELIABLE,   FD_TOPOB_POLLED );
