...
fd_topo_frankendancer( config_t * config ) {
  ...
  /**/                 fd_topob_tile_in(  topo, "plugin", 0UL,           "metric_in", "poh_pack",     0UL,          FD_TOPOB_RELIABLE,   FD_TOPOB_POLLED );
  /**/                 fd_topob_tile_in(  topo, "plugin", 0UL,           "metric_in", "pack_bank",    0UL,          FD_TOPOB_RELIABLE,   FD_TOPOB_POLLED );
