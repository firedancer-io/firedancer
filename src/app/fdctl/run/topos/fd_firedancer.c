...
fd_topo_initialize( config_t * config ) {
  ...
  FOR(gspvfy_tile_cnt) fd_topob_link( topo, "gspvfy_gossi", "gspvfy_gossi", 0,        128UL,                                    FD_TPU_DCACHE_MTU,             1UL );
  ...
  FOR(gspvfy_tile_cnt)             fd_topob_tile( topo, "gspvfy",  "gspvfy",  "metric_in", "metric_in",  tile_to_cpu[ topo->tile_cnt ], 0,       "gspvfy_gossi", i   );
