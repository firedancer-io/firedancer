...
fd_topo_initialize( config_t * config ) {
  ...
  ulong pending_shred_max = config->tiles.shred.max_pending_shred_sets * FD_REEDSOL_DATA_SHREDS_MAX;
  ...
  FOR(shred_tile_cnt)  fd_topob_link( topo, "shred_replay", "shred_replay", pending_shred_max,                        FD_SHRED_MAX_SZ,               config->tiles.shred.max_pending_shred_sets );
  ...
  /**/                 fd_topob_link( topo, "replay_repai", "replay_repai", pending_shred_max,                        FD_SHRED_MAX_SZ,               FD_REEDSOL_DATA_SHREDS_MAX );
  /**/                 fd_topob_link( topo, "repair_shred", "repair_shred", pending_shred_max,                        FD_SHRED_MAX_SZ,               FD_REEDSOL_DATA_SHREDS_MAX );
