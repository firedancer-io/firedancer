...
#endif
static const unsigned int sock_filter_policy_monitor_instr_cnt = 26;
...
static void populate_sock_filter_policy_monitor( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd, unsigned int drain_output_fd) {
  ...
  struct sock_filter filter[26] = {
    ...
    /* simply allow ioctl */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_ioctl, /* RET_ALLOW */ 15, 0 ),
    /* simply allow fcntl */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_fcntl, /* RET_ALLOW */ 14, 0 ),
