...
FIREDANCER_VERSION_PATCH_BASE := $(shell printf "%d%02d00" $(AGAVE_VERSION_MAJOR) $(AGAVE_VERSION_MINOR))
FIREDANCER_VERSION_CSTR := $(FIREDANCER_VERSION_MAJOR).$(FIREDANCER_VERSION_MINOR_ACTUAL).$(FIREDANCER_VERSION_PATCH_BASE)-$(AGAVE_PRERELEASE_STRING).$(AGAVE_VERSION_PATCH)
else
