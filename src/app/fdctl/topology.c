...
fd_topo_initialize( config_t * config ) {
  ...
  FOR(verify_tile_cnt) fd_topob_link( topo, "verify_dedup", "verify_dedup", config->tiles.verify.receive_buffer_size, FD_TPU_PARSED_MTU,      FD_VERIFY_BATCH_TXN_MAX+1UL );
