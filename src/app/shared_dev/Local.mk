...
$(call add-objs,commands/minimal_bench,fddev_shared)
$(call add-objs,commands/pktgen/pktgen,fddev_shared)
$(call add-objs,commands/producer_consumer/prodcons,fddev_shared)
...
$(call add-objs,commands/producer_consumer/fd_produc_tile,fddev_shared)
$(call add-objs,commands/producer_consumer/fd_consum_tile,fddev_shared)
