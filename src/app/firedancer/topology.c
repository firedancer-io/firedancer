...
//  FOR(resolv_tile_cnt) fd_topob_tile_in(  topo, "resolv",  i,            "metric_in", "replay_resol", 0UL,          FD_TOPOB_RELIABLE,   FD_TOPOB_POLLED );
  ...
  if( FD_LIKELY( plugins_enabled ) ) {
    ...
    /**/                 fd_topob_link( topo, "tower_plugin", "plugin_in",    128UL,                                    sizeof(fd_plugin_msg_slot_reset_t),   1UL );
    ...
    /**/                 fd_topob_tile_out( topo, "tower",  0UL,                        "tower_plugin", 0UL                                                  );
    ...
    /**/                 fd_topob_tile_in(  topo, "plugin", 0UL,           "metric_in", "tower_plugin", 0UL,          FD_TOPOB_RELIABLE,   FD_TOPOB_POLLED );
  ...
  if( FD_LIKELY( config->tiles.gui.enabled ) ) {
    ...
    FOR(shred_tile_cnt)  fd_topob_tile_in(  topo, "gui",    0UL,       "metric_in",  "gossip_net",  i,             FD_TOPOB_RELIABLE,   FD_TOPOB_POLLED );
    FOR(shred_tile_cnt)  fd_topob_tile_in(  topo, "gui",    0UL,       "metric_in",  "net_gossvf",  i,             FD_TOPOB_RELIABLE,   FD_TOPOB_POLLED );
    FOR(shred_tile_cnt)  fd_topob_tile_in(  topo, "gui",    0UL,       "metric_in",  "gossip_out",  i,             FD_TOPOB_RELIABLE,   FD_TOPOB_POLLED );
  }
