...
fd_topo_initialize( config_t * config ) {
  ...
  if(leader_enabled)  {fd_topob_link( topo, "executed_txn",  "executed_txn",  16384UL,                                  64UL,                          1UL );} /* TODO: Rename this ... */
  ...
  if(leader_enabled)  {fd_topob_tile_out(   topo, "replay",  0UL,                       "executed_txn",  0UL                                                );}
