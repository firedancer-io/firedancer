...
setup_topo_banks( fd_topo_t *  topo,
  ...
  FD_TEST( fd_pod_insertf_ulong( topo->props, stake_max_records, "obj.%lu.stake_max_records", obj->id ) );
  FD_TEST( fd_pod_insertf_ulong( topo->props, stake_cache_bytes, "obj.%lu.stake_cache_bytes", obj->id ) );
  ulong seed;
