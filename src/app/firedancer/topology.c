...
setup_snapshots( config_t *       config,
  ...
  tile->snaprd.max_full_snapshots_to_keep        = config->firedancer.snapshots.archive.max_full_snapshots_to_keep;
  tile->snaprd.max_incremental_snapshots_to_keep = config->firedancer.snapshots.archive.max_incremental_snapshots_to_keep;
