...
FD_IMPORT_BINARY( firedancer_testnet_jito_config, "src/app/firedancer/config/testnet-jito.toml" );
FD_IMPORT_BINARY( firedancer_mainnet_jito_config, "src/app/firedancer/config/mainnet-jito.toml" );
