...
#ifndef HEADER_fd_src_app_firedancer_commands_generated_exit_seccomp_h
#define HEADER_fd_src_app_firedancer_commands_generated_exit_seccomp_h
...
static const uint sock_filter_policy_exit_instr_cnt = 36;

static void populate_sock_filter_policy_exit( ulong out_cnt, struct sock_filter out[ static 36 ], uint logfile_fd, uint pidfd ) {
  FD_TEST( out_cnt >= 36 );
  struct sock_filter filter[36] = {
    ...
    /* allow nanosleep */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_nanosleep, /* RET_ALLOW */ 7, 0 ),
    /* allow sched_yield */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_sched_yield, /* RET_ALLOW */ 6, 0 ),
    /* allow rt_sigaction */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_rt_sigaction, /* RET_ALLOW */ 5, 0 ),
    /* allow rt_sigreturn */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_rt_sigreturn, /* RET_ALLOW */ 4, 0 ),
    /* check ppoll */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_ppoll, /* check_ppoll */ 16, 0 ),
    /* check pidfd_send_signal */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_pidfd_send_signal, /* check_pidfd_send_signal */ 19, 0 ),
    /* allow exit_group */
...
//  ppoll_ALLOW:
    BPF_STMT( BPF_RET | BPF_K, SECCOMP_RET_ALLOW ),
//  check_pidfd_send_signal:
    /* arg 0 low 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_LO_OFFSET(0)),
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, ((uint)(pidfd)), /* and_3 */ 0, /* pidfd_send_signal_KILL */ 2 ),
//  and_3:
    /* arg 1 low 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_LO_OFFSET(1)),
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, FD_SECCOMP_ARG_LO(SIGTERM), /* pidfd_send_signal_ALLOW */ 1, /* pidfd_send_signal_KILL */ 0 ),
//  pidfd_send_signal_KILL:
    BPF_STMT( BPF_RET | BPF_K, SECCOMP_RET_KILL_PROCESS ),
//  pidfd_send_signal_ALLOW:
    BPF_STMT( BPF_RET | BPF_K, SECCOMP_RET_ALLOW ),
  };
...
#endif /* HEADER_fd_src_app_firedancer_commands_generated_exit_seccomp_h */
