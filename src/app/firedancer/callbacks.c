...
banks_footprint( fd_topo_t const *     topo,
  ...
  return fd_banks_footprint( VAL("max_live_slots"), VAL("max_fork_width"), VAL("max_stake_accounts"), FD_RUNTIME_MAX_VAT_VOTE_ACCOUNTS );
}
...
banks_new( fd_topo_t const *     topo,
  ...
  FD_TEST( fd_banks_new( fd_topo_obj_laddr( topo, obj->id ), FD_STAKE_DELEGATIONS_FD, VAL("max_live_slots"), VAL("max_fork_width"), VAL("max_stake_accounts"), VAL("max_stake_accounts_fallback"), FD_RUNTIME_MAX_VAT_VOTE_ACCOUNTS, VAL("bench_max_cost_per_block"), seed ) );
}
