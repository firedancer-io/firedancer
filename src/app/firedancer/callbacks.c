...
banks_footprint( fd_topo_t const *     topo,
  ...
  return fd_banks_footprint( VAL("max_live_slots"), VAL("max_fork_width"), FD_RUNTIME_MAX_STAKE_ACCOUNTS, FD_RUNTIME_MAX_VAT_VOTE_ACCOUNTS, VAL("stake_max_records"), VAL("stake_cache_bytes") );
}
...
banks_new( fd_topo_t const *     topo,
  ...
  FD_TEST( fd_banks_new( fd_topo_obj_laddr( topo, obj->id ), FD_STAKE_DELEGATIONS_FD, VAL("max_live_slots"), VAL("max_fork_width"), FD_RUNTIME_MAX_STAKE_ACCOUNTS, VAL("stake_max_records"), FD_RUNTIME_MAX_VAT_VOTE_ACCOUNTS, VAL("bench_max_cost_per_block"), seed, VAL("stake_cache_bytes") ) );
}
