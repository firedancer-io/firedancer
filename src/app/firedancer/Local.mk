...
$(call make-bin,firedancer,main,fd_firedancer fdctl_shared fdctl_platform fd_discof fd_alpenglow fd_disco fd_choreo fd_flamenco fd_quic fd_tls fd_reedsol fd_waltz fd_tango fd_ballet fd_util,$(OPENSSL_LIBS))
endif
# endif
endif
