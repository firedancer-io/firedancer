...
#undef DIFFX
    ...
    printf( " Prune Finder Rx from Pruned Path Count: %s (%s)\n\n", fmt_count( buf1, gossip_metrics[ MIDX( COUNTER, GOSSIP, PRUNE_FINDER_DEBUG_RX_FROM_PRUNED_PATH_COUNT ) ] ), DIFFC( buf2, PRUNE_FINDER_DEBUG_RX_FROM_PRUNED_PATH_COUNT ) );
