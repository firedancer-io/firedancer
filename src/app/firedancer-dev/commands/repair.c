...
static const char * CATCHUP_HELP =
  "usage: repair catchup [-h] manifest-path [--iptable-path IPTABLE_PATH] [--sort-by-slot]"
  ""
  "positional arguments:"
...
repair_cmd_args( int *    pargc,
  ...
  char const * manifest_path = !strcmp( args->repair.pos_arg, "catchup" ) ? (*pargv)[1] : NULL; (*pargc)--; if( FD_LIKELY( manifest_path ) ) (*pargc)--;
