...
backtest_topo( config_t * config ) {
  ...
  fd_topo_obj_t * store_obj = setup_topo_store( topo, "store", config->firedancer.runtime.max_live_slots * FD_SHRED_BLK_MAX, store_fec_data_max, 0UL, config->tiles.rserve.shred_cache_size_gib, 0UL, config->paths.shredb );
