...
backtest_topo( config_t * config ) {
  ...
  FD_LOG_NOTICE(( "Using store %lu", config->firedancer.store.max_completed_shred_sets ));
  ...
  fd_topob_tile_uses( topo, backtest_tile, banks_obj, FD_SHMEM_JOIN_MODE_READ_WRITE );
