...
$(call add-objs,commands/dump_blocks,fd_firedancer_dev)

ifdef FD_HAS_SSE
# ifdef FD_HAS_BLST -- will be a required dependency soon
ifdef FD_HAS_S2NBIGNUM
$(call make-bin,firedancer-dev,main,fd_firedancer_dev fd_firedancer fddev_shared fdctl_shared fdctl_platform fd_discof fd_disco fd_choreo fd_flamenco fd_funk fd_quic fd_tls fd_reedsol fd_waltz fd_tango fd_ballet fd_util firedancer_version,$(ROCKSDB_LIBS) $(OPENSSL_LIBS))
endif
# endif
endif
