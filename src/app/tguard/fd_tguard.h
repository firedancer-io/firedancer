...
#define FD_TGUARD_CNC_DIAG_FILT_CNT       (4UL)
#define FD_TGUARD_CNC_DIAG_FILT_SIZ       (5UL)
#define FD_TGUARD_CNC_DIAG_PRODUCE_CNT    (6UL)
#define FD_TGUARD_CNC_DIAG_PRODUCE_SIZ    (7UL)
#define FD_TGUARD_CNC_DIAG_CONSUME_CNT    (8UL)
#define FD_TGUARD_CNC_DIAG_CONSUME_SIZ    (9UL)
#define FD_TGUARD_CNC_DIAG_INGRESS_CNT    (10UL)
#define FD_TGUARD_CNC_DIAG_INGRESS_SIZ    (11UL)
#define FD_TGUARD_CNC_DIAG_EGRESS_CNT     (12UL)
#define FD_TGUARD_CNC_DIAG_EGRESS_SIZ     (13UL)
