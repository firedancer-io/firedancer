...
fib4_footprint( fd_topo_t const *     topo,
                fd_topo_obj_t const * obj ) {
  return fd_fib4_footprint( VAL("route_max"), VAL("route_peer_max"), VAL("route_peer_lock_cnt") );
}
...
fib4_new( fd_topo_t const *     topo,
           fd_topo_obj_t const * obj ) {
  FD_TEST( fd_fib4_new( fd_topo_obj_laddr( topo, obj->id ), VAL("route_max"), VAL("route_peer_max"), VAL("route_peer_lock_cnt"), VAL("route_peer_seed") ) );
}
