...
neigh4_hmap_footprint( fd_topo_t const * topo,
                   fd_topo_obj_t const * obj ) {
  int lg_slot_cnt = fd_neigh4_hmap_est_lg_slot_cnt( VAL("ele_max") );
  FD_TEST( lg_slot_cnt > 0 );
  return fd_neigh4_hmap_footprint( lg_slot_cnt );
}
...
neigh4_hmap_new( fd_topo_t const *     topo,
  ...
  int lg_slot_cnt = fd_neigh4_hmap_est_lg_slot_cnt( VAL("ele_max") );
  FD_TEST( lg_slot_cnt > 0 );
  FD_TEST( fd_neigh4_hmap_new( fd_topo_obj_laddr( topo, obj->id ), lg_slot_cnt, VAL("seed") ) );
}
