...
fd_config_to_json( fd_config_t const * config,
  ...
  jw_obj_open( &w, "runtime" );
    ...
    jw_ulong( &w, "stake_delegations_cache_mib",   f->runtime.stake_delegations_cache_mib );
    jw_ulong( &w, "stake_delegations_max_records", f->runtime.stake_delegations_max_records );
  jw_obj_close( &w );
