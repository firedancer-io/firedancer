...
$(call make-unit-test,test_configure_iavf,commands/configure/test_iavf,fd_fdctl fdctl_shared fdctl_platform fd_disco fd_waltz fd_ballet fd_tango fd_util)
$(call run-unit-test,test_configure_iavf)
...
$(call add-objs,commands/configure/iavf,fdctl_shared)
