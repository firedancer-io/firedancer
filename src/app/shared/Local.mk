...
$(call add-hdrs,fd_config_private.h)

$(call add-objs,fd_obj_callbacks,fdctl_shared)
$(call make-unit-test,test_config_parse,test_config_parse,fd_fdctl fd_configutil fdctl_shared fd_configutil fd_disco fd_ballet fd_tango fd_util)
$(call run-unit-test,test_config_parse)
$(call make-fuzz-test,fuzz_fdctl_config,fuzz_fdctl_config,fd_fdctl fdctl_shared fd_configutil fd_disco fd_ballet fd_tango fd_util)
...
$(call add-objs,fd_config,fdctl_shared)
$(call add-objs,fd_config_private,fdctl_shared)
