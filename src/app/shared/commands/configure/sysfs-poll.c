...
#define NAPI_DEFER_HARD_IRQS 100000U
...
check( config_t const * config,
  ...
  if( fd_file_util_read_uint( path, &value ) || value != NAPI_DEFER_HARD_IRQS ) {
  ...
  if( fd_file_util_read_uint( path, &value ) || value != GRO_FLUSH_TIMEOUT ) {
