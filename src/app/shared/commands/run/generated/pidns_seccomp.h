...
static const uint sock_filter_policy_pidns_instr_cnt = 32;

static void populate_sock_filter_policy_pidns( ulong out_cnt, struct sock_filter out[ static 32 ], uint logfile_fd ) {
  FD_TEST( out_cnt >= 32 );
  struct sock_filter filter[32] = {
    ...
    /* check poll */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_poll, /* check_poll */ 13, 0 ),
    /* check wait4 */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_wait4, /* check_wait4 */ 16, 0 ),
    /* allow exit_group */
