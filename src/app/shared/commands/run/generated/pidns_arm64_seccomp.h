...
static const uint sock_filter_policy_pidns_arm64_instr_cnt = 28;

static void populate_sock_filter_policy_pidns_arm64( ulong out_cnt, struct sock_filter out[ static 28 ], uint logfile_fd ) {
  FD_TEST( out_cnt >= 28 );
  struct sock_filter filter[28] = {
    ...
    /* check wait4 */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_wait4, /* check_wait4 */ 12, 0 ),
    /* allow exit_group */
...
//  check_wait4:
    ...
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, FD_SECCOMP_ARG_LO((int)__WALL | (int)WNOHANG), /* and_2 */ 1, /* or_eq_next_lo_3 */ 0 ),
//  or_eq_next_lo_3:
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, FD_SECCOMP_ARG_LO((int)__WALL), /* and_2 */ 0, /* wait4_KILL */ 4 ),
//  and_2:
    /* arg 3 high 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_HI_OFFSET(3)),
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, 0x00000000U, /* arg_hi_eq_4 */ 0, /* wait4_KILL */ 2 ),
//  arg_hi_eq_4:
    /* arg 3 low 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_LO_OFFSET(3)),
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, 0x00000000U, /* wait4_ALLOW */ 1, /* wait4_KILL */ 0 ),
//  wait4_KILL:
    BPF_STMT( BPF_RET | BPF_K, SECCOMP_RET_KILL_PROCESS ),
//  wait4_ALLOW:
    BPF_STMT( BPF_RET | BPF_K, SECCOMP_RET_ALLOW ),
...
#endif /* HEADER_fd_src_app_shared_commands_run_generated_pidns_arm64_seccomp_h */
