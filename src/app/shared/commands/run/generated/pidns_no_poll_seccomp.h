...
#ifndef HEADER_fd_src_app_shared_commands_run_generated_pidns_no_poll_seccomp_h
#define HEADER_fd_src_app_shared_commands_run_generated_pidns_no_poll_seccomp_h
...
static const uint sock_filter_policy_pidns_no_poll_instr_cnt = 30;

static void populate_sock_filter_policy_pidns_no_poll( ulong out_cnt, struct sock_filter out[ static 30 ], uint logfile_fd ) {
  FD_TEST( out_cnt >= 30 );
...
#endif /* HEADER_fd_src_app_shared_commands_run_generated_pidns_no_poll_seccomp_h */
