...
build_expected( void ) {
  for( int dial_peer=0; dial_peer<2; dial_peer++ ) {
    ...
    expected[ dial_peer ][ FD_FAILOVER_SESSION_HELLO     ][ FD_FAILOVER_EV_HELLO_FATAL    ] = dial_peer ? FD_FAILOVER_SESSION_BACKOFF : FD_FAILOVER_SESSION_LISTENING;
  ...
  expected[ 0 ][ FD_FAILOVER_SESSION_REJECTED ][ FD_FAILOVER_EV_RETRY ] = FD_FAILOVER_SESSION_LISTENING;
  expected[ 1 ][ FD_FAILOVER_SESSION_REJECTED ][ FD_FAILOVER_EV_RETRY ] = FD_FAILOVER_SESSION_DIALING;
