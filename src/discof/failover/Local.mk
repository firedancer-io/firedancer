$(call add-hdrs,fd_failover_proto.h fd_failover_wire.h fd_failover_channel.h fd_failover_stream.h fd_failover_bus.h fd_failover_role.h)
...
$(call add-objs,fd_failover_role,fd_discof)
...
$(call make-unit-test,test_failover_role,test_failover_role,fd_discof fd_ballet fd_util)
