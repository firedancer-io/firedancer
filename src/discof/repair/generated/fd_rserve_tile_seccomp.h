...
#endif
static const unsigned int sock_filter_policy_fd_rserve_tile_instr_cnt = 14;

static void populate_sock_filter_policy_fd_rserve_tile( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd ) {
  FD_TEST( out_cnt >= 14 );
