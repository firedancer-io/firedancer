...
#endif
static const unsigned int sock_filter_policy_fd_repair_tile_instr_cnt = 14;

static void populate_sock_filter_policy_fd_repair_tile( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd ) {
  FD_TEST( out_cnt >= 14 );
...
#endif /* HEADER_fd_src_discof_repair_generated_fd_repair_tile_seccomp_h */
