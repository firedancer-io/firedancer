...
test_regular_fec( fd_wksp_t * wksp ){
  ...
  void * mem = fd_wksp_alloc_laddr( wksp, fd_fec_repair_align(), fd_fec_repair_footprint( fec_max ), 1UL );
  FD_TEST( mem );
  fd_fec_repair_t * fec_repair = fd_fec_repair_join( fd_fec_repair_new( mem, fec_max, 0UL ) );
  FD_TEST( fec_repair );
  ...
  */
  fd_fec_repair_ele_insert( fec_repair, 1, 5, 5, 0, 0 );
  ...
  FD_TEST( !check_blind_fec_completed( fec_repair, 1, 5 ) );

  fd_fec_repair_ele_insert( fec_repair, 1, 0, 4, 0, 0 );
  FD_TEST( fd_fec_intra_map_ele_query( fec_repair->intra_map, &key0, NULL, fec_repair->intra_pool ) );
  FD_TEST( !check_blind_fec_completed( fec_repair, 1, 0 ) );

  fd_fec_repair_ele_insert( fec_repair, 1, 0, 3, 0, 0 );
  FD_TEST( !check_blind_fec_completed( fec_repair, 1, 0 ) );
  fd_fec_repair_ele_insert( fec_repair, 1, 0, 2, 0, 0 );
  FD_TEST( !check_blind_fec_completed( fec_repair, 1, 0 ) );
  fd_fec_repair_ele_insert( fec_repair, 1, 0, 1, 0, 0 );
  FD_TEST( !check_blind_fec_completed( fec_repair, 1, 0 ) );
  fd_fec_repair_ele_insert( fec_repair, 1, 0, 0, 0, 0 );
  FD_TEST( check_blind_fec_completed( fec_repair, 1, 0 ) );
...
test_completing_fec( fd_wksp_t * wksp ) {
    ...
    */
    ...
    fd_fec_repair_ele_insert( fec_repair, 1, 0, 2, 0, 0 );
    FD_TEST( !check_blind_fec_completed( fec_repair, 1, 0 ) );
    fd_fec_repair_ele_insert( fec_repair, 1, 0, 4, 1, 0 );
...
test_fec_insert( fd_wksp_t * wksp ){
  ...
  fd_fec_repair_ele_insert( fec_repair, 1, 48, 48, 0, 0 );
  fd_fec_repair_ele_insert( fec_repair, 1, 48, 54, 1, 0 );

  fd_fec_repair_ele_insert( fec_repair, 1, 48, 7, 0, 1 );
  fd_fec_repair_ele_insert( fec_repair, 1, 48,  49, 0, 0 );
  fd_fec_repair_ele_insert( fec_repair, 1, 48, 50, 0, 0 );
