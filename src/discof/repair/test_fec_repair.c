...
test_regular_fec( fd_wksp_t * wksp ){
  ...
  */
  fd_fec_repair_ele_insert( fec_repair, 1, 5, 5, 0 );
  ...
  fd_fec_repair_ele_insert( fec_repair, 1, 0, 4, 0 );
  ...
  fd_fec_repair_ele_insert( fec_repair, 1, 0, 3, 0 );
  FD_TEST( !check_blind_fec_completed( fec_repair, 1, 0 ) );
  fd_fec_repair_ele_insert( fec_repair, 1, 0, 2, 0 );
  FD_TEST( !check_blind_fec_completed( fec_repair, 1, 0 ) );
  fd_fec_repair_ele_insert( fec_repair, 1, 0, 1, 0 );
  FD_TEST( !check_blind_fec_completed( fec_repair, 1, 0 ) );
  fd_fec_repair_ele_insert( fec_repair, 1, 0, 0, 0 );
  FD_TEST( check_blind_fec_completed( fec_repair, 1, 0 ) );
...
test_completing_fec( fd_wksp_t * wksp ) {
    ...
    */
    ...
    fd_fec_repair_ele_insert( fec_repair, 1, 0, 2, 0 );
    FD_TEST( !check_blind_fec_completed( fec_repair, 1, 0 ) );
    fd_fec_repair_ele_insert( fec_repair, 1, 0, 4, 1 );
