...
test_print_tree( fd_wksp_t *wksp ){
  ...
  fd_blk_repair_data_shred_insert( blk_repair, 1568377, 1, 0, 0, 1);
  fd_blk_repair_data_shred_insert( blk_repair, 1568378, 1, 0, 0, 1 );
  fd_blk_repair_data_shred_insert( blk_repair, 1568379, 1, 0, 0, 1 );
  fd_blk_repair_data_shred_insert( blk_repair, 1568380, 1, 0, 0, 1 );
  fd_blk_repair_data_shred_insert( blk_repair, 1568381, 2, 0, 0, 1 );
  fd_blk_repair_data_shred_insert( blk_repair, 1568382, 1, 0, 0, 1 );
  fd_blk_repair_data_shred_insert( blk_repair, 1568383, 4, 0, 0, 1 );
  fd_blk_repair_data_shred_insert( blk_repair, 1568384, 5, 0, 0, 1 );
  fd_blk_repair_data_shred_insert( blk_repair, 1568385, 5, 0, 0, 1 );
  fd_blk_repair_data_shred_insert( blk_repair, 1568386, 6, 0, 0, 1 );

  for( ulong i = 1568387; i < 1568400; i++ ){
    FD_TEST( fd_blk_repair_data_shred_insert( blk_repair, i, 1, 0, 0, 1 ) );
