...
static const uint sock_filter_policy_fd_tower_tile_instr_cnt = 62;

static void populate_sock_filter_policy_fd_tower_tile( ulong out_cnt, struct sock_filter out[ static 62 ], uint logfile_fd, uint checkpt_fd, uint restore_fd, uint accounts_fd, uint lockos_fd, uint eqvoc_fd ) {
  FD_TEST( out_cnt >= 62 );
  struct sock_filter filter[62] = {
    ...
    /* check pwrite64 */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_pwrite64, /* check_pwrite64 */ 39, 0 ),
    /* check pread64 */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_pread64, /* check_pread64 */ 44, 0 ),
//  RET_KILL_PROCESS:
    /* default deny */
...
//  check_pwrite64:
    /* arg 0 low 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_LO_OFFSET(0)),
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, ((uint)(lockos_fd)), /* pwrite64_ALLOW */ 3, /* or_5 */ 0 ),
//  or_5:
    /* arg 0 low 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_LO_OFFSET(0)),
...
//  check_pread64:
    /* arg 0 low 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_LO_OFFSET(0)),
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, ((uint)(lockos_fd)), /* pread64_ALLOW */ 3, /* or_6 */ 0 ),
//  or_6:
    /* arg 0 low 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_LO_OFFSET(0)),
