...
static const uint sock_filter_policy_fd_tower_tile_instr_cnt = 28;

static void populate_sock_filter_policy_fd_tower_tile( ulong out_cnt, struct sock_filter out[ static 28 ], uint logfile_fd, uint checkpt_fd, uint restore_fd ) {
  FD_TEST( out_cnt >= 28 );
