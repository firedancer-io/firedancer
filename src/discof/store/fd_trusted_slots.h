#ifndef HEADER_fd_src_discof_store_fd_trusted_slots_h
#define HEADER_fd_src_discof_store_fd_trusted_slots_h
...
#endif /* HEADER_fd_src_discof_store_fd_trusted_slots_h */
