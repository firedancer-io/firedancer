...
#ifndef HEADER_fd_src_discof_execrp_generated_fd_execrp_tile_seccomp_h
#define HEADER_fd_src_discof_execrp_generated_fd_execrp_tile_seccomp_h
...
static const uint sock_filter_policy_fd_execrp_tile_instr_cnt = 62;

static void populate_sock_filter_policy_fd_execrp_tile( ulong out_cnt, struct sock_filter out[ static 62 ], uint logfile_fd, uint accounts_fd, uint stake_spill_fd, uint accdb_ring_fd ) {
  FD_TEST( out_cnt >= 62 );
