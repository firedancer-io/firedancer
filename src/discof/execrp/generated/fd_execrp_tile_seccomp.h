...
static const uint sock_filter_policy_fd_execrp_tile_instr_cnt = 57;

static void populate_sock_filter_policy_fd_execrp_tile( ulong out_cnt, struct sock_filter out[ static 57 ], uint logfile_fd, uint accounts_fd, uint stake_spill_fd, uint cost_tracker_fd, uint collector_overrides_fd ) {
  FD_TEST( out_cnt >= 57 );
