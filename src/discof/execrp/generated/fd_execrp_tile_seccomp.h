...
#endif
static const unsigned int sock_filter_policy_fd_execrp_tile_instr_cnt = 20;
...
static void populate_sock_filter_policy_fd_execrp_tile( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd, unsigned int accounts_fd ) {
  ...
  struct sock_filter filter[20] = {
    ...
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_pwritev2, /* check_pwritev2 */ 8, 0 ),
    /* allow pread64 based on expression */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_pread64, /* check_pread64 */ 9, 0 ),
