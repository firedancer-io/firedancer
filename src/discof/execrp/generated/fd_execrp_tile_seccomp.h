...
static const uint sock_filter_policy_fd_execrp_tile_instr_cnt = 47;

static void populate_sock_filter_policy_fd_execrp_tile( ulong out_cnt, struct sock_filter out[ static 47 ], uint logfile_fd, uint accounts_fd ) {
  FD_TEST( out_cnt >= 47 );
