...
static const uint sock_filter_policy_fd_execrp_tile_instr_cnt = 55;

static void populate_sock_filter_policy_fd_execrp_tile( ulong out_cnt, struct sock_filter out[ static 55 ], uint logfile_fd, uint accounts_fd, uint stake_spill_fd, uint txncache_fd, uint accdb_idx_fd ) {
  FD_TEST( out_cnt >= 55 );
