...
#ifndef HEADER_fd_src_discof_motor_generated_fd_motor_tile_seccomp_h
#define HEADER_fd_src_discof_motor_generated_fd_motor_tile_seccomp_h
...
static const uint sock_filter_policy_fd_motor_tile_instr_cnt = 30;

static void populate_sock_filter_policy_fd_motor_tile( ulong out_cnt, struct sock_filter out[ static 30 ], uint logfile_fd ) {
  FD_TEST( out_cnt >= 30 );
...
#endif /* HEADER_fd_src_discof_motor_generated_fd_motor_tile_seccomp_h */
