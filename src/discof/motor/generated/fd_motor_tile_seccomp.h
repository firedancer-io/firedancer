...
static const uint sock_filter_policy_fd_motor_tile_instr_cnt = 22;

static void populate_sock_filter_policy_fd_motor_tile( ulong out_cnt, struct sock_filter out[ static 22 ], uint logfile_fd ) {
  FD_TEST( out_cnt >= 22 );
