...
static const uint sock_filter_policy_fd_execle_tile_instr_cnt = 38;

static void populate_sock_filter_policy_fd_execle_tile( ulong out_cnt, struct sock_filter out[ static 38 ], uint logfile_fd, uint accounts_fd ) {
  FD_TEST( out_cnt >= 38 );
