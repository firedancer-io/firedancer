...
static const uint sock_filter_policy_fd_execle_tile_instr_cnt = 55;

static void populate_sock_filter_policy_fd_execle_tile( ulong out_cnt, struct sock_filter out[ static 55 ], uint logfile_fd, uint accounts_fd, uint stake_spill_fd, uint txncache_fd, uint accdb_idx_fd ) {
  FD_TEST( out_cnt >= 55 );
...
//  check_pread64:
    /* arg 0 low 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_LO_OFFSET(0)),
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, ((uint)(stake_spill_fd)), /* pread64_ALLOW */ 3, /* or_4 */ 0 ),
//  or_4:
    /* arg 0 low 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_LO_OFFSET(0)),
...
//  check_pwrite64:
    /* arg 0 low 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_LO_OFFSET(0)),
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, ((uint)(stake_spill_fd)), /* pwrite64_ALLOW */ 3, /* or_5 */ 0 ),
//  or_5:
    /* arg 0 low 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_LO_OFFSET(0)),
