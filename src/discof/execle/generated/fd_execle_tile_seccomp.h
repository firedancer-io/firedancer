...
static const uint sock_filter_policy_fd_execle_tile_instr_cnt = 21;

static void populate_sock_filter_policy_fd_execle_tile( ulong out_cnt, struct sock_filter out[ static 21 ], uint logfile_fd ) {
  FD_TEST( out_cnt >= 21 );
