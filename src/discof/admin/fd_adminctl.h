...
#define FD_ADMINCTL_CMD_SNAP_CREATE    (2UL)
...
#define FD_SNAPSHOT_CREATE_RESULT_BUSY                             (8UL)
#define FD_SNAPSHOT_CREATE_RESULT_UNSUPPORTED                      (9UL)
#define FD_SNAPSHOT_CREATE_RESULT_NOT_READY                        (10UL)
#define FD_SNAPSHOT_CREATE_RESULT_UNEXPECTED_PAYLOAD_SIZE          (11UL)
#define FD_SNAPSHOT_CREATE_RESULT_UNEXPECTED_RESPONSE              (12UL)
