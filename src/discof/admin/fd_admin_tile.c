...
metrics_write( fd_admin_tile_ctx_t * ctx ) {
  ...
  FD_MCNT_SET  ( ADMIN, FAILOVER_MAC_FAILURES,          status.mac_failures );
  ...
  FD_MCNT_SET  ( ADMIN, FAILOVER_CONNECTIONS,           status.connections );
}
