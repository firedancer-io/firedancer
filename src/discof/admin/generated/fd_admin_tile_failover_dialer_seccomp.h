...
#ifndef HEADER_fd_src_discof_admin_generated_fd_admin_tile_failover_dialer_seccomp_h
#define HEADER_fd_src_discof_admin_generated_fd_admin_tile_failover_dialer_seccomp_h
...
static const uint sock_filter_policy_fd_admin_tile_failover_dialer_instr_cnt = 36;

static void populate_sock_filter_policy_fd_admin_tile_failover_dialer( ulong out_cnt, struct sock_filter out[ static 36 ], uint logfile_fd ) {
  FD_TEST( out_cnt >= 36 );
  struct sock_filter filter[36] = {
    ...
    /* allow connect */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_connect, /* RET_ALLOW */ 4, 0 ),
    /* allow recvfrom */
...
//  check_close:
    /* arg 0 low 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_LO_OFFSET(0)),
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, 0x00000002U, /* close_KILL */ 2, /* or_4 */ 0 ),
//  or_4:
    /* arg 0 low 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_LO_OFFSET(0)),
...
#endif /* HEADER_fd_src_discof_admin_generated_fd_admin_tile_failover_dialer_seccomp_h */
