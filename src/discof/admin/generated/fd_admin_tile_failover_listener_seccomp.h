...
#ifndef HEADER_fd_src_discof_admin_generated_fd_admin_tile_failover_listener_seccomp_h
#define HEADER_fd_src_discof_admin_generated_fd_admin_tile_failover_listener_seccomp_h
...
static const uint sock_filter_policy_fd_admin_tile_failover_listener_instr_cnt = 35;

static void populate_sock_filter_policy_fd_admin_tile_failover_listener( ulong out_cnt, struct sock_filter out[ static 35 ], uint logfile_fd, uint listen_fd ) {
  FD_TEST( out_cnt >= 35 );
  struct sock_filter filter[35] = {
    ...
    /* check close */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_close, /* check_close */ 18, 0 ),
//  RET_KILL_PROCESS:
    /* default deny */
...
//  check_accept4:
    /* arg 0 low 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_LO_OFFSET(0)),
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, ((uint)(listen_fd)), /* and_2 */ 0, /* accept4_KILL */ 2 ),
//  and_2:
    /* arg 3 low 32 bits */
...
//  check_close:
    /* arg 0 low 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_LO_OFFSET(0)),
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, 0x00000002U, /* close_KILL */ 4, /* or_3 */ 0 ),
//  or_3:
    /* arg 0 low 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_LO_OFFSET(0)),
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, ((uint)(logfile_fd)), /* close_KILL */ 2, /* or_4 */ 0 ),
//  or_4:
    /* arg 0 low 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_LO_OFFSET(0)),
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, ((uint)(listen_fd)), /* close_KILL */ 0, /* close_ALLOW */ 1 ),
//  close_KILL:
    BPF_STMT( BPF_RET | BPF_K, SECCOMP_RET_KILL_PROCESS ),
//  close_ALLOW:
    BPF_STMT( BPF_RET | BPF_K, SECCOMP_RET_ALLOW ),
...
#endif /* HEADER_fd_src_discof_admin_generated_fd_admin_tile_failover_listener_seccomp_h */
