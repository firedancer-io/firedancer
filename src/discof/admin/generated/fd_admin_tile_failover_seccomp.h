...
static const uint sock_filter_policy_fd_admin_tile_failover_instr_cnt = 24;

static void populate_sock_filter_policy_fd_admin_tile_failover( ulong out_cnt, struct sock_filter out[ static 24 ], uint logfile_fd, uint junk_key_fd, uint staked_key_fd ) {
  FD_TEST( out_cnt >= 24 );
...
//  check_pread64:
    /* arg 0 low 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_LO_OFFSET(0)),
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, ((uint)(junk_key_fd)), /* pread64_ALLOW */ 3, /* or_2 */ 0 ),
//  or_2:
    /* arg 0 low 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_LO_OFFSET(0)),
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, ((uint)(staked_key_fd)), /* pread64_ALLOW */ 1, /* pread64_KILL */ 0 ),
//  pread64_KILL:
    BPF_STMT( BPF_RET | BPF_K, SECCOMP_RET_KILL_PROCESS ),
//  pread64_ALLOW:
    BPF_STMT( BPF_RET | BPF_K, SECCOMP_RET_ALLOW ),
