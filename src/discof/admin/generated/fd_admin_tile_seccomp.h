...
static const uint sock_filter_policy_fd_admin_tile_instr_cnt = 17;

static void populate_sock_filter_policy_fd_admin_tile( ulong out_cnt, struct sock_filter out[ static 17 ], uint logfile_fd ) {
  FD_TEST( out_cnt >= 17 );
