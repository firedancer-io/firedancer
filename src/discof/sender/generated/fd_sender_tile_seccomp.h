...
#ifndef HEADER_fd_src_discof_sender_generated_fd_sender_tile_seccomp_h
#define HEADER_fd_src_discof_sender_generated_fd_sender_tile_seccomp_h
...
#endif
static const unsigned int sock_filter_policy_fd_sender_tile_instr_cnt = 14;

static void populate_sock_filter_policy_fd_sender_tile( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd) {
  FD_TEST( out_cnt >= 14 );
