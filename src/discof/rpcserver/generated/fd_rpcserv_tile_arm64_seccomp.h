...
#ifndef HEADER_fd_src_discof_rpcserver_generated_fd_rpcserv_tile_arm64_seccomp_h
#define HEADER_fd_src_discof_rpcserver_generated_fd_rpcserv_tile_arm64_seccomp_h
...
#endif
static const unsigned int sock_filter_policy_fd_rpcserv_tile_arm64_instr_cnt = 45;

static void populate_sock_filter_policy_fd_rpcserv_tile_arm64( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd, unsigned int rpcserv_socket_fd, unsigned int blockstore_fd ) {
  FD_TEST( out_cnt >= 45 );
