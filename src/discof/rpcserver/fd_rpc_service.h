...
void fd_rpc_replay_during_frag( fd_rpc_ctx_t * ctx, void const * msg, ulong sig, ulong sz, ulong ctl );

void fd_rpc_replay_after_frag(fd_rpc_ctx_t * ctx, ulong sig );

void fd_rpc_stake_during_frag(fd_rpc_ctx_t * ctx, void const * msg, ulong sz);

void fd_rpc_stake_after_frag(fd_rpc_ctx_t * ctx);

void fd_rpc_repair_during_frag(fd_rpc_ctx_t * ctx, void const * msg, ulong sz);
