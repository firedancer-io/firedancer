...
#ifndef HEADER_fd_src_discof_eqvoc_generated_fd_eqvoc_tile_seccomp_h
#define HEADER_fd_src_discof_eqvoc_generated_fd_eqvoc_tile_seccomp_h
...
#endif
static const unsigned int sock_filter_policy_fd_eqvoc_tile_instr_cnt = 14;

static void populate_sock_filter_policy_fd_eqvoc_tile( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd) {
  FD_TEST( out_cnt >= 14 );
