...
static const uint sock_filter_policy_fd_snapzp_tile_instr_cnt = 29;

static void populate_sock_filter_policy_fd_snapzp_tile( ulong out_cnt, struct sock_filter out[ static 29 ], uint logfile_fd, uint pool_min_fd, uint pool_max_fd ) {
  FD_TEST( out_cnt >= 29 );
