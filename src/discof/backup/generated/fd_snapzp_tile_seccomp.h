...
static const uint sock_filter_policy_fd_snapzp_tile_instr_cnt = 34;

static void populate_sock_filter_policy_fd_snapzp_tile( ulong out_cnt, struct sock_filter out[ static 34 ], uint logfile_fd, uint pool_min_fd, uint pool_max_fd ) {
  FD_TEST( out_cnt >= 34 );
  struct sock_filter filter[34] = {
    ...
    /* check pwrite64 */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_pwrite64, /* check_pwrite64 */ 14, 0 ),
