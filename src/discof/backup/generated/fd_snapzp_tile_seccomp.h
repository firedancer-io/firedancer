...
static const uint sock_filter_policy_fd_snapzp_tile_instr_cnt = 47;

static void populate_sock_filter_policy_fd_snapzp_tile( ulong out_cnt, struct sock_filter out[ static 47 ], uint logfile_fd, uint pool_min_fd, uint pool_max_fd, uint accdb_ro_fd ) {
  FD_TEST( out_cnt >= 47 );
