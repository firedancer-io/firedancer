...
#ifndef HEADER_fd_src_discof_backup_generated_fd_snapzp_tile_seccomp_h
#define HEADER_fd_src_discof_backup_generated_fd_snapzp_tile_seccomp_h
...
static const uint sock_filter_policy_fd_snapzp_tile_instr_cnt = 52;

static void populate_sock_filter_policy_fd_snapzp_tile( ulong out_cnt, struct sock_filter out[ static 52 ], uint logfile_fd, uint pool_min_fd, uint pool_max_fd, uint accdb_ro_fd, uint accdb_ring_fd ) {
  FD_TEST( out_cnt >= 52 );
  struct sock_filter filter[52] = {
    ...
    /* check pwrite64 */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_pwrite64, /* check_pwrite64 */ 18, 0 ),
    /* check preadv2 */
    ...
    /* check exit */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_exit, /* check_exit */ 29, 0 ),
    /* check futex */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_futex, /* check_futex */ 32, 0 ),
    /* allow restart_syscall */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_restart_syscall, /* RET_ALLOW */ 2, 0 ),
    /* check io_uring_enter */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_io_uring_enter, /* check_io_uring_enter */ 36, 0 ),
//  RET_KILL_PROCESS:
    /* default deny */
...
//  check_pwrite64:
    /* arg 0 low 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_LO_OFFSET(0)),
    BPF_JUMP( BPF_JMP | BPF_JGE | BPF_K, ((uint)(pool_min_fd)), /* and_2 */ 0, /* pwrite64_KILL */ 2 ),
//  and_2:
    /* arg 0 low 32 bits */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, FD_SECCOMP_ARG_LO_OFFSET(0)),
...
#endif /* HEADER_fd_src_discof_backup_generated_fd_snapzp_tile_seccomp_h */
