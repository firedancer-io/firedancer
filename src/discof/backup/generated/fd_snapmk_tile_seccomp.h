...
static const uint sock_filter_policy_fd_snapmk_tile_instr_cnt = 103;

static void populate_sock_filter_policy_fd_snapmk_tile( ulong out_cnt, struct sock_filter out[ static 103 ], uint logfile_fd, uint dir_fd, uint pool_min_fd, uint pool_max_fd, uint txncache_fd ) {
  FD_TEST( out_cnt >= 103 );
  struct sock_filter filter[103] = {
    ...
    /* check pread64 */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_pread64, /* check_pread64 */ 82, 0 ),
//  RET_KILL_PROCESS:
    /* default deny */
