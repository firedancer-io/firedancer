...
static void populate_sock_filter_policy_fd_snapmk_tile( ulong out_cnt, struct sock_filter out[ static 108 ], uint logfile_fd, uint dir_fd, uint pool_min_fd, uint pool_max_fd, uint txncache_fd ) {
  FD_TEST( out_cnt >= 108 );
