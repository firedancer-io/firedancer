...
#ifndef HEADER_fd_src_discof_backup_generated_fd_snaprd_tile_seccomp_h
#define HEADER_fd_src_discof_backup_generated_fd_snaprd_tile_seccomp_h
...
static const uint sock_filter_policy_fd_snaprd_tile_instr_cnt = 40;

static void populate_sock_filter_policy_fd_snaprd_tile( ulong out_cnt, struct sock_filter out[ static 40 ], uint logfile_fd, uint accounts_fd ) {
  FD_TEST( out_cnt >= 40 );
  struct sock_filter filter[40] = {
    ...
    /* check exit */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_exit, /* check_exit */ 22, 0 ),
    /* check futex */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_futex, /* check_futex */ 25, 0 ),
...
#endif /* HEADER_fd_src_discof_backup_generated_fd_snaprd_tile_seccomp_h */
