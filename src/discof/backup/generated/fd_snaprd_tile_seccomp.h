...
static const uint sock_filter_policy_fd_snaprd_tile_instr_cnt = 32;

static void populate_sock_filter_policy_fd_snaprd_tile( ulong out_cnt, struct sock_filter out[ static 32 ], uint logfile_fd, uint accounts_fd ) {
  FD_TEST( out_cnt >= 32 );
  struct sock_filter filter[32] = {
    ...
    /* check exit */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_exit, /* check_exit */ 20, 0 ),
//  RET_KILL_PROCESS:
    /* default deny */
