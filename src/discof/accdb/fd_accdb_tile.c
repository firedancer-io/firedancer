...
scratch_footprint( fd_topo_tile_t const * tile ) {
  ...
  l = FD_LAYOUT_APPEND( l, fd_accdb_align(),               fd_accdb_footprint( tile->accdb.max_accounts, tile->accdb.max_unrooted_slots, tile->accdb.max_txn_per_slot, tile->accdb.partition_cnt ) );
...
unprivileged_init( fd_topo_t *      topo,
  ...
  FD_SCRATCH_ALLOC_INIT( l, scratch );
  fd_accdb_tile_ctx_t * ctx = FD_SCRATCH_ALLOC_APPEND( l, alignof( fd_accdb_tile_ctx_t ), sizeof( fd_accdb_tile_ctx_t ) );
  ctx->accdb = fd_accdb_join( fd_accdb_new( FD_SCRATCH_ALLOC_APPEND( l, fd_accdb_align(), fd_accdb_footprint( tile->accdb.max_accounts, tile->accdb.max_unrooted_slots, tile->accdb.max_txn_per_slot, tile->accdb.partition_cnt ) ), tile->accdb.max_accounts, tile->accdb.max_unrooted_slots, tile->accdb.max_txn_per_slot, tile->accdb.partition_cnt, tile->accdb.partition_sz, ctx->seed ), ctx->fd );
  FD_TEST( ctx->accdb );
