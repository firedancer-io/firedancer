...
#endif
static const unsigned int sock_filter_policy_fd_accdb_tile_instr_cnt = 31;

static void populate_sock_filter_policy_fd_accdb_tile( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd, unsigned int bstream_fd, unsigned int ring_fd ) {
  FD_TEST( out_cnt >= 31 );
