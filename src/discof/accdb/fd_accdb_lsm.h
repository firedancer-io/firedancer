#ifndef HEADER_fd_src_accdb_fd_accdb_lsm_h
#define HEADER_fd_src_accdb_fd_accdb_lsm_h
...
#define FD_ACCDB_LSM_ALIGN (4096UL)

#define FD_ACCDB_LSM_MAGIC (0xf17eda2ce7acc150UL) /* FIREDANCE ACCDB LSM V0 */

struct fd_accdb_lsm_private;
typedef struct fd_accdb_lsm_private fd_accdb_lsm_t;
...
fd_accdb_lsm_t *
fd_accdb_lsm_join( void * ljoin,
                   int    fd );

/* fd_accdb_lsm_read retrieves the account information for a given
...
/* fd_accdb_lsm_write writes the account information for a given pubkey
...
/* fd_accdb_lsm_compact compacts the accounts database, removing any
...
/* fd_accdb_lsm_metrics returns a pointer to the metrics structure for
...
#endif /* HEADER_fd_src_accdb_fd_accdb_lsm_h */
