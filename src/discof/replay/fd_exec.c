...
fd_slice_exec_txn_parse( fd_slice_exec_t * slice_exec_ctx,
  ...
  ulong pay_sz = 0UL;
  ulong txn_sz = fd_txn_parse_core( slice_exec_ctx->mbatch + slice_exec_ctx->wmark,
  ...
  fd_memcpy( txn_p_out->payload, slice_exec_ctx->mbatch + slice_exec_ctx->wmark, pay_sz );
...
fd_slice_exec_microblock_parse( fd_slice_exec_t * slice_exec_ctx ) {
  fd_microblock_hdr_t * hdr = (fd_microblock_hdr_t *)fd_type_pun( slice_exec_ctx->mbatch + slice_exec_ctx->wmark );
...
fd_slice_exec_begin( fd_slice_exec_t * slice_exec_ctx,
  ...
  slice_exec_ctx->txns_rem   = 0;
  slice_exec_ctx->mblks_rem  = FD_LOAD( ulong, slice_exec_ctx->mbatch );
