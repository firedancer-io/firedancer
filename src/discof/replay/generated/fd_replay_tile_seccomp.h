...
static void populate_sock_filter_policy_fd_replay_tile( ulong out_cnt, struct sock_filter out[ static 57 ], uint logfile_fd, uint accounts_fd, uint store_fd, uint stake_spill_fd, uint epoch_credits_fd ) {
  FD_TEST( out_cnt >= 57 );
