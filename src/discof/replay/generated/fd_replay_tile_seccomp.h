...
static const uint sock_filter_policy_fd_replay_tile_instr_cnt = 51;

static void populate_sock_filter_policy_fd_replay_tile( ulong out_cnt, struct sock_filter out[ static 51 ], uint logfile_fd, uint accounts_fd, uint store_fd ) {
  FD_TEST( out_cnt >= 51 );
  struct sock_filter filter[51] = {
    ...
    /* check pread64 */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_pread64, /* check_pread64 */ 36, 0 ),
//  RET_KILL_PROCESS:
    /* default deny */
