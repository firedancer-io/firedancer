...
static void populate_sock_filter_policy_fd_replay_tile( ulong out_cnt, struct sock_filter out[ static 53 ], uint logfile_fd, uint accounts_fd, uint store_fd, uint rewards_spill_fd ) {
  FD_TEST( out_cnt >= 53 );
