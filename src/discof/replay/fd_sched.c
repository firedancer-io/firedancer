...
/* max size of an Alpenglow footer finalization cert: slot (8) +
   block_id (32) + two aggregates (96B compressed BLS sig + 2B bitmap
   length + up to 259B base2 bitmap for 2048 signers) + 1 option
   byte. */
