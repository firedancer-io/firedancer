...
test_sched_footprint( void ) {
  ...
  FD_TEST( fd_sched_footprint( 65536UL, 2048UL, FD_SHRED_BLK_MAX, FD_MAX_TXN_PER_SLOT )==1118207360UL );
  /* Only the shred length array scales with the shred limit. */
  FD_TEST( fd_sched_footprint( 65536UL, 2048UL, 4UL*FD_SHRED_BLK_MAX, FD_MAX_TXN_PER_SLOT )==1118207360UL+2048UL*3UL*FD_SHRED_BLK_MAX*sizeof(ushort) );
  FD_TEST( fd_sched_footprint( 65536UL, 2048UL, FD_SHRED_BLK_MAX, 5UL*FD_MAX_TXN_PER_SLOT )==1118207360UL );
