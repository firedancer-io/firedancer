...
/* Add the data in the FEC set to the scheduler.  If is_last_fec is 1,
   ...
   Returns 1 if the last FEC set in the block has just been ingested,
   and there are no more transactions queued for the block in the
   scheduler.  Returns 0 otherwise. */
FD_WARN_UNUSED int
