...
publish_txn_executed( fd_replay_tile_t *  ctx,
  ...
  *txn_executed->txn = *fd_sched_get_txn( ctx->sched, txn_idx );
  ...
  txn_executed->runtime_is_committable = txn_info->runtime_is_committable;
  txn_executed->runtime_is_fees_only = txn_info->runtime_is_fees_only;
  txn_executed->runtime_is_simple_vote = txn_info->runtime_is_simple_vote;
...
process_exec_task_done( fd_replay_tile_t *          ctx,
  ...
  switch( sig>>32 ) {
    case FD_EXECRP_TT_TXN_EXEC: {
      ...
      txn_info->runtime_is_committable = msg->txn_exec->runtime_is_committable;
      txn_info->runtime_is_fees_only   = msg->txn_exec->runtime_is_fees_only;
      txn_info->runtime_is_simple_vote = msg->txn_exec->runtime_is_simple_vote;
