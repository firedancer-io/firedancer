...
/* advance_accdb_root moves account records from the unrooted to the
   rooted database. */
...
static void
advance_accdb_root( fd_replay_tile_t * ctx,
                    ulong              slot,
                    ulong              bank_idx ) {
...
advance_published_root( fd_replay_tile_t * ctx ) {
  ...
  advance_accdb_root( ctx, advanceable_root_slot, bank->data->idx );
