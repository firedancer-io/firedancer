...
#ifndef HEADER_fd_src_discof_vinyl_generated_fd_vinyl_tile_seccomp_h
#define HEADER_fd_src_discof_vinyl_generated_fd_vinyl_tile_seccomp_h
...
#endif
static const unsigned int sock_filter_policy_fd_vinyl_tile_instr_cnt = 31;

static void populate_sock_filter_policy_fd_vinyl_tile( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd, unsigned int bstream_fd, unsigned int ring_fd ) {
  FD_TEST( out_cnt >= 31 );
  struct sock_filter filter[31] = {
    ...
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_io_uring_enter, /* check_io_uring_enter */ 12, 0 ),
...
#endif /* HEADER_fd_src_discof_vinyl_generated_fd_vinyl_tile_seccomp_h */
