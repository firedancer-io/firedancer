...
handle_new_contact_info( fd_capture_tile_ctx_t * ctx,
  ...
  fd_ip4_port_t tvu    = fd_contact_info_get_socket( &msg->contact_info, FD_CONTACT_INFO_SOCKET_TVU );
  fd_ip4_port_t repair = fd_contact_info_get_socket( &msg->contact_info, FD_CONTACT_INFO_SOCKET_SERVE_REPAIR );
