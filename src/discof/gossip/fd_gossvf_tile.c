...
handle_net( fd_gossvf_tile_ctx_t * ctx,
  ...
  if( FD_UNLIKELY( !fd_ip4_udp_hdr_strip( ctx->payload, sz, &payload, &payload_sz, NULL, &ip4_hdr, &udp_hdr ) ) )
    return FD_METRICS_ENUM_GOSSVF_MESSAGE_OUTCOME_V_DROPPED_UNPARSEABLE_IDX;
