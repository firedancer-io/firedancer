...
static const uint sock_filter_policy_fd_gossip_tile_instr_cnt = 25;

static void populate_sock_filter_policy_fd_gossip_tile( ulong out_cnt, struct sock_filter out[ static 25 ], uint logfile_fd ) {
  FD_TEST( out_cnt >= 25 );
