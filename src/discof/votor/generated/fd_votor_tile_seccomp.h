...
static const uint sock_filter_policy_fd_votor_tile_instr_cnt = 18;

static void populate_sock_filter_policy_fd_votor_tile( ulong out_cnt, struct sock_filter out[ static 18 ], uint logfile_fd ) {
  FD_TEST( out_cnt >= 18 );
