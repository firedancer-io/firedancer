...
#ifndef HEADER_fd_src_discof_solcap_generated_fd_solcap_tile_seccomp_h
#define HEADER_fd_src_discof_solcap_generated_fd_solcap_tile_seccomp_h
...
#endif
static const unsigned int sock_filter_policy_fd_solcap_tile_instr_cnt = 16;

static void populate_sock_filter_policy_fd_solcap_tile( ulong out_cnt, struct sock_filter * out, uint logfile_fd, uint solcap_fd ) {
  FD_TEST( out_cnt >= 16 );
...
#endif /* HEADER_fd_src_discof_solcap_generated_fd_solcap_tile_seccomp_h */
