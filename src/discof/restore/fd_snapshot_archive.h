#ifndef HEADER_fd_src_discof_restore_fd_snapshot_archive_h
#define HEADER_fd_src_discof_restore_fd_snapshot_archive_h
...
#endif /* HEADER_fd_src_discof_restore_fd_snapshot_archive_h */
