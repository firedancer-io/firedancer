...
ifdef FD_HAS_INT128
$(call make-unit-test,test_ssmanifest_parser,utils/test_ssmanifest_parser,fd_discof fd_flamenco fd_funk fd_ballet fd_util) # lint-no-run-unit-test, requires CLI arg
endif
