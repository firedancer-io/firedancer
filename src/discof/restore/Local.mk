...
$(call make-unit-test,test_snapin_tile,test_snapin_tile,fd_discof fd_disco fd_flamenco fd_choreo fd_ballet fd_tango fd_util)
$(call run-unit-test,test_snapin_tile)
$(call add-objs,fd_snapwr_tile,fd_discof)
$(call make-unit-test,test_snapwr_tile,test_snapwr_tile,fd_discof fd_disco fd_flamenco fd_choreo fd_ballet fd_tango fd_util)
...
$(call make-unit-test,test_ssmanifest_parser,utils/test_ssmanifest_parser,fd_discof fd_flamenco fd_choreo fd_ballet fd_util)
...
$(call make-unit-test,test_ssload,utils/test_ssload,fd_discof fd_disco fd_flamenco fd_choreo fd_ballet fd_tango fd_util)
...
$(call make-fuzz-test,fuzz_ssmanifest_parser,utils/fuzz_ssmanifest_parser,fd_discof fd_flamenco fd_choreo fd_ballet fd_util)
