...
$(call make-unit-test,test_ssresolve,utils/test_ssresolve,fd_discof fd_waltz fd_flamenco fd_ballet fd_util,$(OPENSSL_LIBS))
...
$(call run-unit-test,test_ssresolve)
