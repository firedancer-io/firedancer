...
#endif
static const unsigned int sock_filter_policy_fd_snaplts_tile_instr_cnt = 17;

static void populate_sock_filter_policy_fd_snaplts_tile( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd ) {
  FD_TEST( out_cnt >= 17 );
