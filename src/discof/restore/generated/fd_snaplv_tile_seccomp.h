...
#ifndef HEADER_fd_src_discof_restore_generated_fd_snaplv_tile_seccomp_h
#define HEADER_fd_src_discof_restore_generated_fd_snaplv_tile_seccomp_h
...
#endif
static const unsigned int sock_filter_policy_fd_snaplv_tile_instr_cnt = 22;

static void populate_sock_filter_policy_fd_snaplv_tile( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd ) {
  FD_TEST( out_cnt >= 22 );
  struct sock_filter filter[22] = {
    ...
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_exit, /* check_exit */ 10, 0 ),
    /* allow sched_yield based on expression */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_sched_yield, /* check_sched_yield */ 11, 0 ),
    ...
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_nanosleep, /* check_nanosleep */ 11, 0 ),
...
#endif /* HEADER_fd_src_discof_restore_generated_fd_snaplv_tile_seccomp_h */
