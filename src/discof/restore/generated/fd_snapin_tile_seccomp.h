...
static const uint sock_filter_policy_fd_snapin_tile_instr_cnt = 44;

static void populate_sock_filter_policy_fd_snapin_tile( ulong out_cnt, struct sock_filter out[ static 44 ], uint logfile_fd, uint accounts_fd, uint stake_spill_fd ) {
  FD_TEST( out_cnt >= 44 );
