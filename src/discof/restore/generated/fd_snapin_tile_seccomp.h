...
static const uint sock_filter_policy_fd_snapin_tile_instr_cnt = 37;

static void populate_sock_filter_policy_fd_snapin_tile( ulong out_cnt, struct sock_filter out[ static 37 ], uint logfile_fd, uint accounts_fd ) {
  FD_TEST( out_cnt >= 37 );
