...
static void populate_sock_filter_policy_fd_snapin_tile( ulong out_cnt, struct sock_filter out[ static 39 ], uint logfile_fd, uint accounts_fd ) {
  FD_TEST( out_cnt >= 39 );
  struct sock_filter filter[39] = {
    ...
    /* check pwrite64 */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_pwrite64, /* check_pwrite64 */ 23, 0 ),
    /* check pread64 */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_pread64, /* check_pread64 */ 26, 0 ),
//  RET_KILL_PROCESS:
    /* default deny */
