...
static const uint sock_filter_policy_fd_snapdc_tile_instr_cnt = 30;

static void populate_sock_filter_policy_fd_snapdc_tile( ulong out_cnt, struct sock_filter out[ static 30 ], uint logfile_fd ) {
  FD_TEST( out_cnt >= 30 );
