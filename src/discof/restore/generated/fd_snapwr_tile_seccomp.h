...
static const uint sock_filter_policy_fd_snapwr_tile_instr_cnt = 35;

static void populate_sock_filter_policy_fd_snapwr_tile( ulong out_cnt, struct sock_filter out[ static 35 ], uint logfile_fd, uint accounts_fd ) {
  FD_TEST( out_cnt >= 35 );
