...
#endif
static const unsigned int sock_filter_policy_fd_snapwm_tile_vinyl_instr_cnt = 23;

static void populate_sock_filter_policy_fd_snapwm_tile_vinyl( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd ) {
  FD_TEST( out_cnt >= 23 );
...
#endif /* HEADER_fd_src_discof_restore_generated_fd_snapwm_tile_vinyl_seccomp_h */
