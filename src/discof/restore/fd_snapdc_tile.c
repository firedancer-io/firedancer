...
metrics_write( void * _ctx ) {
  ...
  FD_MGAUGE_SET( SNAPDC,
                 FULL_COMPRESSED_BYTES_READ,
                 ctx->metrics.full.compressed_bytes_read );
  FD_MGAUGE_SET( SNAPDC,
                 FULL_DECOMPRESSED_BYTES_READ,
                 ctx->metrics.full.decompressed_bytes_read );
  FD_MGAUGE_SET( SNAPDC,
                 FULL_DECOMPRESSED_BYTES_TOTAL,
                 ctx->metrics.full.decompressed_bytes_total );

  FD_MGAUGE_SET( SNAPDC,
                 INCREMENTAL_COMPRESSED_BYTES_READ,
                 ctx->metrics.incremental.compressed_bytes_read );
  FD_MGAUGE_SET( SNAPDC,
                 INCREMENTAL_DECOMPRESSED_BYTES_READ,
                 ctx->metrics.incremental.decompressed_bytes_read );
  FD_MGAUGE_SET( SNAPDC,
                 INCREMENTAL_DECOMPRESSED_BYTES_TOTAL,
                 ctx->metrics.incremental.decompressed_bytes_total );
}
