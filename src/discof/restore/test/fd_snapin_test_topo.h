...
struct fd_snapin_test_topo {
  ...
  /* out link handles for tile unit test */
  fd_restore_link_out_t in_dc_out;

  /* in link view handles for tile unit test */
  fd_restore_link_in_t out_manif_in_view;
  fd_restore_link_in_t out_ct_in_view;
