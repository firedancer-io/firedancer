...
#define FD_FULL_SNAPSHOT_MANIFEST_MESSAGE_ID                 (0)
#define FD_INCREMENTAL_SNAPSHOT_MANIFEST_MESSAGE_ID          (1)
#define FD_FULL_SNAPSHOT_MANIFEST_EXTERNAL_MESSAGE_ID        (2)
#define FD_INCREMENTAL_SNAPSHOT_MANIFEST_EXTERNAL_MESSAGE_ID (3)
...
struct fd_snapshot_manifest_epoch_stakes {
  ulong                                   stakes_len;
  fd_snapshot_manifest_stake_delegation_t stakes[ 1024 * 1024UL ]; /* TODO: Bound correctly */
};
