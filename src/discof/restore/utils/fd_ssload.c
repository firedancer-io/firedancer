...
fd_ssload_recover( fd_snapshot_manifest_t * manifest,
  ...
  /* Seed new_votes with zero-stake vote accounts from the manifest.
     These represent vote accounts that exist but have no delegated
     stake, which need to be tracked for vote seeding on boot. */
