#ifndef HEADER_fd_src_discof_restore_fd_sspeer_selector_h
#define HEADER_fd_src_discof_restore_fd_sspeer_selector_h
...
/* Add a peer to the selector.  If the peer already exists,
   fd_sspeer_selector_add updates the existing peer's snapshot info. */
void
...
/* Remove a peer from the selector.  Peers are removed when they are
   not reachable or serving corrupted/malformed snapshots. */
void
...
#endif /* HEADER_fd_src_discof_restore_fd_sspeer_selector_h */
