...
/* fd_ssload_recover_epoch_stakes_e1_entry processes a single t-1
...
/* fd_ssload_recover_epoch_stakes_t_3 processes E-1 vote_stakes entries
   (three epochs ago / T-3 delayed commission).  Overwrites
   vote_rewards_map commission with the T-3 commission for each entry
   that already exists in the map.  Must be called after
   fd_ssload_recover_epoch_stakes_t_2. */
void
