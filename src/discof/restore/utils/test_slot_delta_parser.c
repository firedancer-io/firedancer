...
test_one_entry( fd_slot_delta_parser_t * parser ) {
  uchar input[ 97UL ];
  fd_slot_delta_parser_init( parser, entry_cb_no_err, NULL, 1000UL );
...
static void
test_one_entry_slot_greater_than_bank_slot( fd_slot_delta_parser_t * parser ) {
  uchar input[ 97UL ];
  /* Test slot greater than bank slot */
  fd_slot_delta_parser_init( parser, entry_cb_no_err, NULL, 999UL );
  FD_TEST( fd_slot_delta_parser_consume( parser, input, sizeof(input) )==FD_SLOT_DELTA_PARSER_ERROR_SLOT_GREATER_THAN_MAX_ROOT );
}
...
test_one_entry_with_txn_error( fd_slot_delta_parser_t * parser ) {
  uchar input[ 101UL ];
  fd_slot_delta_parser_init( parser, entry_cb_with_txn_err, NULL, 1000UL );
...
test_one_entry_with_txn_custom_error( fd_slot_delta_parser_t * parser ) {
  uchar input[ 102UL ];
  fd_slot_delta_parser_init( parser, entry_cb_with_txn_custom_err, NULL, ULONG_MAX );
...
test_one_entry_with_instr_error( fd_slot_delta_parser_t * parser ) {
  uchar input[ 106UL ];
  fd_slot_delta_parser_init( parser, entry_cb_with_instr_err, NULL, ULONG_MAX );
...
test_one_entry_with_instr_custom_error( fd_slot_delta_parser_t * parser ) {
  uchar input[ 110UL ];
  fd_slot_delta_parser_init( parser, entry_cb_with_instr_custom_err, NULL, ULONG_MAX );
...
test_one_entry_with_instr_borsh_io_error( fd_slot_delta_parser_t * parser ) {
  uchar input[ 122UL ];
  fd_slot_delta_parser_init( parser, entry_cb_with_instr_borsh_io_err, NULL, ULONG_MAX );
...
test_multiple_entries( fd_slot_delta_parser_t * parser ) {
  ...
  fd_slot_delta_parser_init( parser, entry_cb_multiple, NULL, 1002UL );
  /* consume all at once */
  FD_TEST( fd_slot_delta_parser_consume( parser, input, sizeof(input) )==0 );
...
test_multiple_entries_v2( fd_slot_delta_parser_t * parser ) {
  ...
  fd_slot_delta_parser_init( parser, entry_cb_multiple_v2, NULL, 1002UL );
  /* consume all at once */
  FD_TEST( fd_slot_delta_parser_consume( parser, input, sizeof(input) )==0 );
...
test_multiple_slot_deltas_no_entries( fd_slot_delta_parser_t * parser ) {
  ...
  fd_slot_delta_parser_init( parser, entry_cb_noop, NULL, 1002UL );
  /* consume all at once */
  FD_TEST( fd_slot_delta_parser_consume( parser, input, sizeof(input) )==0 );
...
test_duplicate_slots( fd_slot_delta_parser_t * parser ) {
  ...
  fd_slot_delta_parser_init( parser, NULL, NULL, 1002UL );
  /* consume all at once */
...
int main( int     argc,
  ...
  test_one_entry_slot_greater_than_bank_slot( slot_delta_parser );
