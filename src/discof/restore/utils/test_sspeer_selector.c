...
test_basic_peer_selection( fd_sspeer_selector_t * selector ) {
  ...
  fd_ip4_port_t addr = { .addr = FD_IP4_ADDR( 35 , 214, 172, 227 ), .port = 8899 };
  ...
  /* Add a peer with better latency at the same slot and it should be
     the best peer */
  fd_ip4_port_t addr2 = { .addr = FD_IP4_ADDR( 35 , 214, 172, 228 ), .port = 8899 };
  ...
  fd_ip4_port_t addr3 = { .addr = FD_IP4_ADDR( 35 , 214, 172, 229 ), .port = 8899 };
  ...
  fd_ip4_port_t addr4 = { .addr = FD_IP4_ADDR( 35 , 214, 172, 230 ), .port = 8899 };
  ...
  fd_ip4_port_t addr5 = { .addr = FD_IP4_ADDR( 35 , 214, 172, 231 ), .port = 8899 };
  ...
  fd_ip4_port_t addr6 = { .addr = FD_IP4_ADDR( 35 , 214, 172, 232 ), .port = 8899 };
  ...
  fd_ip4_port_t addr7 = { .addr = FD_IP4_ADDR( 35 , 214, 172, 233 ), .port = 8899 };
