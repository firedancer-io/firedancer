...
fd_snapshot_parser_reset( fd_snapshot_parser_t * self,
  ...
  /* TODO: get the predicted slot from snaprd */
  fd_slot_delta_parser_init( self->slot_delta_parser, self->status_cache_cb, self->cb_arg, ULONG_MAX );

  self->process_status_cache = process_status_cache;
