...
test_insert( fd_wksp_t * wksp ) {
  ...
  fd_reasm_insert( reasm, mr0_64, NULL, 0, 0, 0, 0, 0, 0, 0, NULL );
  fd_reasm_fec_t * f0_64 = fd_reasm_query( reasm, mr0_64 );
  FD_TEST( f0_64 );
  FD_TEST( frontier_ele_query( frontier, &f0_64->key, NULL, pool ) == f0_64 );

  fd_reasm_fec_t * f1_32 = fd_reasm_insert( reasm, mr1_32, mr1_00, 1, 32, 1, 32, 1, 1, 0, NULL );
  FD_TEST( subtrees_ele_query( subtrees, &f1_32->key, NULL, pool ) == f1_32 );

  fd_reasm_fec_t * f1_00 = fd_reasm_insert( reasm, mr1_00, mr0_64, 1, 0, 1, 32, 0, 0, 0, NULL );
  ...
  fd_reasm_fec_t * f3_64a     = fd_reasm_insert( reasm, mr3_64a, mr3_32, 3, 64, 2, 32, 1, 1, 0, NULL );
  ...
  fd_reasm_fec_t * f3_0a     = fd_reasm_insert( reasm, mr3_0a, mr2_32, 3, 0, 1, 32, 0, 0, 0, NULL );
...
test_publish( fd_wksp_t * wksp ) {
  ...
  */
  ...
  fd_reasm_insert( reasm, mr4, mr2, 4, 0, 2, 0, 1, 1, 0, NULL );
  fd_reasm_insert( reasm, mr6, mr5, 6, 0, 1, 0, 1, 1, 0, NULL );

  /* Repairing backwards, interleaved. */

  fd_reasm_insert( reasm, mr5, mr3, 5, 0, 2, 0, 1, 1, 0, NULL );
  fd_reasm_insert( reasm, mr2, mr1, 2, 0, 1, 0, 1, 1, 0, NULL );
  fd_reasm_insert( reasm, mr3, mr1, 3, 0, 2, 0, 1, 1, 0, NULL );
  fd_reasm_insert( reasm, mr1, mr0, 1, 0, 1, 0, 1, 1, 0, NULL );
...
test_slot_mr( fd_wksp_t * wksp ) {
  ...
  fd_reasm_insert( reasm, mr1, NULL, 1, 0, 0, 0, 0, 1, 0, NULL ); /* set root */
  fd_reasm_fec_t * fec1 = fd_reasm_query( reasm, mr1 );
  FD_TEST( fec1 );
  FD_TEST( frontier_ele_query( frontier, &fec1->key, NULL, pool ) == fec1 );

  fd_reasm_fec_t * fec2 = fd_reasm_insert( reasm, mr2, mr0, 2, 0, 1, 32, 0, 1, 0, NULL ); /* insert with bad mr0 should be mr1 */
  ...
  fd_reasm_fec_t * fec4 = fd_reasm_insert( reasm, mr4, mr0, 4, 0, 1, 32, 0, 1, 0 , NULL ); /* insert with bad mr0 should be mr3 */
  FD_TEST( subtrees_ele_query( subtrees, &fec4->key, NULL, pool ) );                /* orphaned */

  fd_reasm_fec_t * fec3 = fd_reasm_insert( reasm, mr3, mr2, 3, 0, 1, 32, 0, 1, 0, NULL );
...
test_eqvoc( fd_wksp_t * wksp ) {
  ...
  fd_reasm_insert( reasm, mr1, NULL, 1, 0, 1, 32, 0, 0, 0, NULL );

  /* Slot 1 equivocates. */

  fd_reasm_insert( reasm, mr1a, mr1, /* slot */ 1, /* fec_set_idx */ 32, 1, 32, 0, 0, 0, NULL );
  fd_reasm_insert( reasm, mr1b, mr1, /* slot */ 1, /* fec_set_idx */ 32, 1, 32, 0, 0, 0, NULL );
  ...
  fd_reasm_insert( reasm, mr1ba, mr1b,  /* slot */ 1, 64, /* parent_off */ 1, /* data_cnt */ 32, /* data_complete */ 1, /* slot_complete */ 1, /* is_leader */ 0, NULL );
  fd_reasm_insert( reasm, mr1bb, mr1b,  /* slot */ 1, 64, /* parent_off */ 1, /* data_cnt */ 32, /* data_complete */ 1, /* slot_complete */ 1, /* is_leader */ 0, NULL );
  fd_reasm_insert( reasm, mr2,   mr1bb, /* slot */ 2, 0,  /* parent_off */ 1, /* data_cnt */ 32, /* data_complete */ 0, /* slot_complete */ 0, /* is_leader */ 0, NULL );
...
test_eqvoc_xidbid( fd_wksp_t * wksp ) {
  ...
  fd_reasm_fec_t * fec3 = fd_reasm_insert( reasm, mr3, mr2,  1, 64, 1, 32, 0, 1, 0, NULL );
  ...
  fd_reasm_fec_t * fec4 = fd_reasm_insert( reasm, mr4, mr2,  1, 64, 1, 32, 0, 1, 0, NULL ); /* equivocate on last fec set idx */
  ...
  fd_hash_t mr5[1] = {{{ 1, 5 }}};
  fd_reasm_insert( reasm, mr5, mr4,  2, 0, 1, 32, 0, 1, 0, NULL );
...
test_eqvoc_transitive( fd_wksp_t * wksp ) {
  ...
  fd_reasm_insert( reasm, mr1,  NULL,  /* slot */ 1, /* fec_set_idx */ 0,  1, 32, 0, 0, 0, NULL );
  fd_reasm_insert( reasm, mr2a, mr1,   /* slot */ 2, /* fec_set_idx */ 32, 1, 32, 0, 0, 0, NULL );
  fd_reasm_insert( reasm, mr3,  mr2aa, /* slot */ 3, /* fec_set_idx */ 0,  1, 32, 0, 0, 0, NULL );
  fd_reasm_insert( reasm, mr4,  mr2aa, /* slot */ 4, /* fec_set_idx */ 0,  1, 32, 0, 0, 0, NULL );

  /* Introduce 2b (which equivocates with 2a). */

  fd_reasm_insert( reasm, mr2b, mr1, /* slot */ 2, /* fec_set_idx */ 32, 1, 32, 0, 0, 0, NULL );
  ...
  fd_reasm_insert( reasm, mr2aa, mr2a, /* slot */ 2, /* fec_set_idx */ 64, 1, 32, 0, 1, 0, NULL );
  ...
  fd_reasm_insert( reasm, mr5, mr4, /* slot */ 5, /* fec_set_idx */ 0, 1, 32, 0, 0, 0, NULL );
...
test_evict( fd_wksp_t * wksp ) {
  ...
  FD_TEST( evicted_empty( reasm->evicted ));

                               /*  mr    cmr   slot fec_idx  p_off  data_cnt -  slot_cmpl - - */
  FD_TEST( fd_reasm_insert( reasm, mr0,  NULL, 1,   0,       1,     32,      0, 1,        0, NULL ) );
  FD_TEST( fd_reasm_insert( reasm, mr1,  mr0,  2,   0,       1,     32,      0, 1,        0, NULL ) );
  FD_TEST( fd_reasm_insert( reasm, mr2,  mr1,  3,   0,       1,     32,      0, 1,        0, NULL ) );
  /* fork 4 and 5 off 3*/
  FD_TEST( fd_reasm_insert( reasm, mr3,  mr2,  4,   0,       1,     32,      0, 0,        0, NULL ) );
  FD_TEST( fd_reasm_insert( reasm, mr4,  mr2,  5,   0,       1,     32,      0, 0,        0, NULL ) );
  FD_TEST( fd_reasm_insert( reasm, mr5,  mr4,  5,   32,      1,     32,      0, 1,        0, NULL ) );
  ...
  /* now for orphans */
  FD_TEST( fd_reasm_insert( reasm, mr8,  mr7,  8,    0,       1,     32,     0, 0,        0, NULL ) );
  FD_TEST( fd_reasm_insert( reasm, mr9,  mr8,  8,    0,       1,     32,     0, 1,        0, NULL ) ); /* By the way maybe this should be rejected? agave will reject it. But lowkeys we would replay it.... */
  ...
  FD_TEST( fd_reasm_insert( reasm, mr9,  mr8,  8,    32,       1,     32,     0, 1,        0, NULL ) );
  FD_TEST( !fd_reasm_query( reasm, mr6 )); /* evicts unconfirmed leaf */
  FD_TEST( evicted_cnt( reasm->evicted ) == 1 );
  evicted = evicted_pop_head( reasm->evicted );
  FD_TEST( evicted.slot == 6 && evicted.fec_set_idx == 0 );

  FD_TEST( fd_reasm_insert( reasm, mr10, mr9,  10,    0,       1,     32,     0, 0,        0, NULL ) );
  FD_TEST( !fd_reasm_query( reasm, mr5 ) ); /* evicts chain of bank idxs */
  FD_TEST( !fd_reasm_query( reasm, mr4 ) );
  FD_TEST( evicted_cnt( reasm->evicted ) == 2 );
  evicted = evicted_pop_head( reasm->evicted );
  FD_TEST( evicted.slot == 5 && evicted.fec_set_idx == 0 );
  evicted = evicted_pop_head( reasm->evicted );
