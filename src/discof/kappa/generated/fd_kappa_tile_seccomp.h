...
#endif
static const unsigned int sock_filter_policy_fd_kappa_tile_instr_cnt = 20;

static void populate_sock_filter_policy_fd_kappa_tile( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd, uint shreds_fd, uint requests_fd, uint fec_fd) {
  FD_TEST( out_cnt >= 20 );
