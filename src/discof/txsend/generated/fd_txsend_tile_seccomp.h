...
static const uint sock_filter_policy_fd_txsend_tile_instr_cnt = 23;

static void populate_sock_filter_policy_fd_txsend_tile( ulong out_cnt, struct sock_filter out[ static 23 ], uint logfile_fd ) {
  FD_TEST( out_cnt >= 23 );
