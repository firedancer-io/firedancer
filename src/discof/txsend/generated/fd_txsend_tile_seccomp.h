...
#ifndef HEADER_fd_src_discof_txsend_generated_fd_txsend_tile_seccomp_h
#define HEADER_fd_src_discof_txsend_generated_fd_txsend_tile_seccomp_h
...
static const uint sock_filter_policy_fd_txsend_tile_instr_cnt = 22;

static void populate_sock_filter_policy_fd_txsend_tile( ulong out_cnt, struct sock_filter out[ static 22 ], uint logfile_fd ) {
  FD_TEST( out_cnt >= 22 );
  struct sock_filter filter[22] = {
    ...
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_clock_nanosleep, /* check_clock_nanosleep */ 11, 0 ),
//  RET_KILL_PROCESS:
    /* default deny */
...
#endif /* HEADER_fd_src_discof_txsend_generated_fd_txsend_tile_seccomp_h */
