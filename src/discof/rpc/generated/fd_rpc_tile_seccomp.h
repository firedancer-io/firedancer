...
#endif
static const unsigned int sock_filter_policy_fd_rpc_tile_instr_cnt = 48;

static void populate_sock_filter_policy_fd_rpc_tile( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd, unsigned int rpc_socket_fd, unsigned int accdb_ro_fd ) {
  FD_TEST( out_cnt >= 48 );
  struct sock_filter filter[48] = {
    ...
    /* simply allow ppoll */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_ppoll, /* RET_ALLOW */ 37, 0 ),
    /* allow preadv2 based on expression */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_preadv2, /* check_preadv2 */ 33, 0 ),
...
//  check_accept4:
    /* load syscall argument 0 in accumulator */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, offsetof(struct seccomp_data, args[0])),
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, rpc_socket_fd, /* lbl_2 */ 0, /* RET_KILL_PROCESS */ 26 ),
//  lbl_2:
...
//  lbl_6:
    /* load syscall argument 0 in accumulator */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, offsetof(struct seccomp_data, args[0])),
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, rpc_socket_fd, /* RET_KILL_PROCESS */ 14, /* RET_ALLOW */ 15 ),
//  check_sendto:
    /* load syscall argument 0 in accumulator */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, offsetof(struct seccomp_data, args[0])),
...
//  lbl_8:
    /* load syscall argument 0 in accumulator */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, offsetof(struct seccomp_data, args[0])),
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, rpc_socket_fd, /* RET_KILL_PROCESS */ 8, /* RET_ALLOW */ 9 ),
//  check_close:
    /* load syscall argument 0 in accumulator */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, offsetof(struct seccomp_data, args[0])),
...
//  lbl_10:
    /* load syscall argument 0 in accumulator */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, offsetof(struct seccomp_data, args[0])),
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, rpc_socket_fd, /* RET_KILL_PROCESS */ 2, /* RET_ALLOW */ 3 ),
//  check_preadv2:
    /* load syscall argument 0 in accumulator */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, offsetof(struct seccomp_data, args[0])),
