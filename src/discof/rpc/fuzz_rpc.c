...
#include "../../flamenco/accdb/fd_accdb_impl_v1.c"
...
LLVMFuzzerInitialize( int  *   argc,
  ...
  funk_obj = fd_topob_obj( topo, "funk", "wksp" );
...
#define FETCH_TYPE(__type) (FD_LOAD( __type, FETCH_REF( sizeof(__type) ) ))
  ...
  FD_TEST( fd_accdb_user_v1_init( ctx->accdb, fd_topo_obj_laddr( topo, funk_obj->id ) ) );
