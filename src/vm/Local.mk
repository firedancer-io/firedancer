$(call make-lib,fd_vm)
$(call add-hdrs,fd_instr.h fd_invocation_context.h fd_log_collector.h fd_opcodes.h fd_mem_map.h fd_sbpf_interp.h fd_syscalls.h fd_base64.h fd_sbpf_disasm.h)
