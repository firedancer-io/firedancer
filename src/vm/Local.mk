...
$(call add-objs,fd_vm_context fd_vm_disasm fd_vm_interp fd_vm_log_collector fd_vm_stack fd_vm_syscalls,fd_vm)

$(call make-bin,fd_vm_tool,fd_vm_tool,fd_vm fd_ballet fd_util)
