...
/* 0x3d */ JT_CASE(0x3d) // FD_SBPF_OP_JGE_REG
  pc += (register_file[dst_reg] >= register_file[src_reg]) ? instr.offset : 0;
JT_CASE_END
/* 0x3f */ JT_CASE(0x3f) // FD_SBPF_OP_DIV64_REG
  register_file[dst_reg] = register_file[src_reg] == 0 ? 0 : (register_file[dst_reg] / register_file[src_reg]);
JT_CASE_END

/* 0x40 - 0x4f */
/* 0x44 */ JT_CASE(0x44) // FD_SBPF_OP_OR_IMM
  register_file[dst_reg] = (uint)((uint)register_file[dst_reg] | (uint)imm);
JT_CASE_END
/* 0x45 */ JT_CASE(0x45) // FD_SBPF_OP_JSET_IMM
  pc += (register_file[dst_reg] & imm) ? instr.offset : 0;
JT_CASE_END
/* 0x47 */ JT_CASE(0x47) // FD_SBPF_OP_OR64_IMM
  register_file[dst_reg] |= imm;
JT_CASE_END
/* 0x4c */ JT_CASE(0x4c) // FD_SBPF_OP_OR_REG
  register_file[dst_reg] = (uint)((uint)register_file[dst_reg] | (uint)register_file[src_reg]);
JT_CASE_END
/* 0x4d */ JT_CASE(0x4d) // FD_SBPF_OP_JSET_REG
  pc += (register_file[dst_reg] & register_file[src_reg]) ? instr.offset : 0;
JT_CASE_END
/* 0x4f */ JT_CASE(0x4f) // FD_SBPF_OP_OR64_REG
  register_file[dst_reg] |= register_file[src_reg];
JT_CASE_END

/* 0x50 - 0x5f */
/* 0x54 */ JT_CASE(0x54) // FD_SBPF_OP_AND_IMM
  register_file[dst_reg] = (uint)((uint)register_file[dst_reg] & (uint)imm);
JT_CASE_END
/* 0x55 */ JT_CASE(0x55) // FD_SBPF_OP_JNE_IMM
  pc += (register_file[dst_reg] != imm) ? instr.offset : 0;
JT_CASE_END
/* 0x57 */ JT_CASE(0x57) // FD_SBPF_OP_AND64_IMM
  register_file[dst_reg] &= imm;
JT_CASE_END
/* 0x5c */ JT_CASE(0x5c) // FD_SBPF_OP_AND_REG
  register_file[dst_reg] = (uint)((uint)register_file[dst_reg] & (uint)register_file[src_reg]);
JT_CASE_END
/* 0x5d */ JT_CASE(0x5d) // FD_SBPF_OP_JNE_REG
  pc += (register_file[dst_reg] != register_file[src_reg]) ? instr.offset : 0;
JT_CASE_END
/* 0x5f */ JT_CASE(0x5f) // FD_SBPF_OP_AND64_REG
  register_file[dst_reg] &= register_file[src_reg];
JT_CASE_END

/* 0x60 - 0x6f */
/* 0x61 */ JT_CASE(0x61) // FD_SBPF_OP_LDXW
...
fallthrough_0x61:
JT_CASE_END
/* 0x62 */ JT_CASE(0x62) // FD_SBPF_OP_STW
...
fallthrough_0x62:
JT_CASE_END
/* 0x63 */ JT_CASE(0x63) // FD_SBPF_OP_STXW
...
fallthrough_0x63:
JT_CASE_END
/* 0x64 */ JT_CASE(0x64) // FD_SBPF_OP_LSH_IMM
  register_file[dst_reg] = (uint)((uint)register_file[dst_reg] << (uint)imm);
JT_CASE_END
/* 0x65 */ JT_CASE(0x65) // FD_SBPF_OP_JSGT_IMM
  pc += ((long)register_file[dst_reg] > (long)imm) ? instr.offset : 0;
JT_CASE_END
/* 0x67 */ JT_CASE(0x67) // FD_SBPF_OP_LSH64_IMM
  register_file[dst_reg] <<= imm;
JT_CASE_END
/* 0x69 */ JT_CASE(0x69) // FD_SBPF_OP_LDXH
...
fallthrough_0x69:
JT_CASE_END
/* 0x6a */ JT_CASE(0x6a) // FD_SBPF_OP_STH
...
fallthrough_0x6a:
JT_CASE_END
/* 0x6b */ JT_CASE(0x6b) // FD_SBPF_OP_STXH
...
fallthrough_0x71:
JT_CASE_END
/* 0x72 */ JT_CASE(0x72) // FD_SBPF_OP_STB
...
fallthrough_0x72:
JT_CASE_END
/* 0x73 */ JT_CASE(0x73) // FD_SBPF_OP_STXB
...
fallthrough_0x73:
JT_CASE_END
/* 0x74 */ JT_CASE(0x74) // FD_SBPF_OP_RSH_IMM
  register_file[dst_reg] = (uint)((uint)register_file[dst_reg] >> (uint)imm);
JT_CASE_END
/* 0x75 */ JT_CASE(0x75) // FD_SBPF_OP_JSGE_IMM
  pc += ((long)register_file[dst_reg] >= (long)imm) ? instr.offset : 0;
JT_CASE_END
/* 0x77 */ JT_CASE(0x77) // FD_SBPF_OP_RSH64_IMM
  register_file[dst_reg] >>= imm;
JT_CASE_END
/* 0x79 */ JT_CASE(0x79) // FD_SBPF_OP_LDXQ
...
fallthrough_0x79:
JT_CASE_END
/* 0x7a */ JT_CASE(0x7a) // FD_SBPF_OP_STQ
...
fallthrough_0x7a:
JT_CASE_END
/* 0x7b */ JT_CASE(0x7b) // FD_SBPF_OP_STXQ
...
fallthrough_0x7b:
JT_CASE_END
/* 0x7c */ JT_CASE(0x7c) // FD_SBPF_OP_RSH_REG
  register_file[dst_reg] = (uint)((uint)register_file[dst_reg] >> (uint)register_file[src_reg]);
JT_CASE_END
/* 0x7d */ JT_CASE(0x7d) // FD_SBPF_OP_JSGE_REG
  pc += ((long)register_file[dst_reg] > (long)register_file[src_reg]) ? instr.offset : 0;
JT_CASE_END
/* 0x7f */ JT_CASE(0x7f) // FD_SBPF_OP_RSH64_REG
  register_file[dst_reg] >>= register_file[src_reg];
JT_CASE_END

/* 0x80 - 0x8f */
/* 0x84 */ JT_CASE(0x84) // FD_SBPF_OP_NEG
...
fallthrough_0x85:
JT_CASE_END
/* 0x87 */ JT_CASE(0x87) // FD_SBPF_OP_NEG64
...
/* 0x90 - 0x9f */
/* 0x94 */ JT_CASE(0x94) // FD_SBPF_OP_MOD_IMM
...
JT_CASE_END
/* 0x9f */ JT_CASE(0x9f) // FD_SBPF_OP_MOD64_REG
...
/* 0xa0 - 0xaf */
/* 0xa4 */ JT_CASE(0xa4) // FD_SBPF_OP_XOR_IMM
  register_file[dst_reg] = (uint)((uint)register_file[dst_reg] ^ (uint)imm);
JT_CASE_END
/* 0xa5 */ JT_CASE(0xa5) // FD_SBPF_OP_JLT_IMM
  pc += (register_file[dst_reg] < imm) ? instr.offset : 0;
JT_CASE_END
/* 0xa7 */ JT_CASE(0xa7) // FD_SBPF_OP_XOR64_IMM
  register_file[dst_reg] ^= imm;
JT_CASE_END
