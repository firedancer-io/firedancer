...
/* 0x61 */ AJT_CASE(0x61) // FD_BPF_OP_LDXW
  ulong * reg_ptr0 = &register_file[instr.dst_reg];
  cond_fault = fd_vm_mem_map_read_uint( &ctx->mem_map, (ulong)((long)register_file[instr.src_reg] + instr.offset), (uint *)reg_ptr0 );
/* 0x62 */ AJT_CASE(0x62) // FD_BPF_OP_STW
  cond_fault = fd_vm_mem_map_write_uint( &ctx->mem_map, (ulong)((long)register_file[instr.dst_reg] + instr.offset), (uint)instr.imm );
/* 0x63 */ AJT_CASE(0x63) // FD_BPF_OP_STXW
  cond_fault = fd_vm_mem_map_write_uint( &ctx->mem_map, (ulong)((long)register_file[instr.dst_reg] + instr.offset), (uint)register_file[instr.src_reg]);
...
/* 0x69 */ AJT_CASE(0x69) // FD_BPF_OP_LDXH
  ulong * reg_ptr1 = &register_file[instr.dst_reg];
  cond_fault = fd_vm_mem_map_read_ushort( &ctx->mem_map, (ulong)((long)register_file[instr.src_reg] + instr.offset), (ushort *)reg_ptr1 );
/* 0x6a */ AJT_CASE(0x6a) // FD_BPF_OP_STH
  cond_fault = fd_vm_mem_map_write_ushort( &ctx->mem_map, (ulong)((long)register_file[instr.dst_reg] + instr.offset), (ushort)instr.imm );
/* 0x6b */ AJT_CASE(0x6b) // FD_BPF_OP_STXH
  cond_fault = fd_vm_mem_map_write_ushort( &ctx->mem_map, (ulong)((long)register_file[instr.dst_reg] + instr.offset), (ushort)register_file[instr.src_reg] );
...
/* 0x71 */ AJT_CASE(0x71) // FD_BPF_OP_LDXB
  cond_fault = fd_vm_mem_map_read_uchar( &ctx->mem_map, (ulong)((long)register_file[instr.src_reg] + instr.offset), (uchar *)&register_file[instr.dst_reg] );
/* 0x72 */ AJT_CASE(0x72) // FD_BPF_OP_STB
  cond_fault = fd_vm_mem_map_write_uchar( &ctx->mem_map, (ulong)((long)register_file[instr.dst_reg] + instr.offset), (uchar)instr.imm );
/* 0x73 */ AJT_CASE(0x73) // FD_BPF_OP_STXB
  cond_fault = fd_vm_mem_map_write_uchar( &ctx->mem_map, (ulong)((long)register_file[instr.dst_reg] + instr.offset), (uchar)register_file[instr.src_reg] );
...
/* 0x79 */ AJT_CASE(0x79) // FD_BPF_OP_LDXQ
  cond_fault = fd_vm_mem_map_read_ulong( &ctx->mem_map, (ulong)((long)register_file[instr.src_reg] + instr.offset), (ulong *)&register_file[instr.dst_reg] );
/* 0x7a */ AJT_CASE(0x7a) // FD_BPF_OP_STQ
  cond_fault = fd_vm_mem_map_write_ulong( &ctx->mem_map, (ulong)((long)register_file[instr.dst_reg] + instr.offset), (ulong)instr.imm );
/* 0x7b */ AJT_CASE(0x7b) // FD_BPF_OP_STXQ
  cond_fault = fd_vm_mem_map_write_ulong( &ctx->mem_map, (ulong)((long)register_file[instr.dst_reg] + instr.offset), (ulong)register_file[instr.src_reg] );
...
/* 0x84 */ AJT_CASE(0x84) // FD_BPF_OP_NEG
  register_file[instr.dst_reg] = (uint)(~((uint)register_file[instr.dst_reg])); 
/* 0x85 */ AJT_CASE(0x85);
/* 0x86 */ AJT_CASE(0x86);
...
/* 0xdc */ AJT_CASE(0xdc) // FD_BPF_OP_BE 
  switch (instr.imm) {
    case 16:
      uchar tmp = ((uchar *)&register_file[instr.dst_reg])[0];
      ((uchar *)&register_file[instr.dst_reg])[0] = ((uchar *)&register_file[instr.dst_reg])[1];
      ((uchar *)&register_file[instr.dst_reg])[1] = tmp;
      
      break;
    case 32:
      register_file[instr.dst_reg] = (uint)_bswap((int)register_file[instr.dst_reg]);
      break;
    case 64:
      register_file[instr.dst_reg] = (ulong)_bswap64((long)register_file[instr.dst_reg]);
      break;
  }
