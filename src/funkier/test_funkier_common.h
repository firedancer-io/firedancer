#ifndef HEADER_fd_src_funkier_test_funkier_common_h
#define HEADER_fd_src_funkier_test_funkier_common_h
...
xid_set( fd_funkier_txn_xid_t * xid,
         ulong               _xid ) {
...
xid_eq( fd_funkier_txn_xid_t const * xid,
         ulong                    _xid ) {
  fd_funkier_txn_xid_t tmp[1];
  return fd_funkier_txn_xid_eq( xid, xid_set( tmp, _xid ) );
}

static inline fd_funkier_rec_key_t *
key_set( fd_funkier_rec_key_t * key,
         ulong               _key ) {
