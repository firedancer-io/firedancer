...
#include "../../util/tpool/fd_tpool.h"

#define FD_VINYL_DATA_VOL_FOOTPRINT (41944192UL) /* autogenerated */
#define FD_VINYL_DATA_SZC_CNT       (83UL) /* autogenerated */
#define FD_VINYL_DATA_SZC_ITER_MAX  (7UL) /* autogenerated */
...
fd_vinyl_data_szc( ulong val_max ) {
  ...
  for( ulong rem=FD_VINYL_DATA_SZC_ITER_MAX; rem; rem-- ) {
