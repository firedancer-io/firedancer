#ifndef HEADER_fd_src_tango_quic_tests_fd_quic_stream_spam_h
#define HEADER_fd_src_tango_quic_tests_fd_quic_stream_spam_h
...
#endif /* HEADER_fd_src_tango_quic_tests_test_stream_spam_h */
