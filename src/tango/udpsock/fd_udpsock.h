...
/* fd_udpsock_new prepares a new memory region suitable for storing an
   fd_udpsock_t object with the given footprint parameters.  Returns
   shmem on success and NULL on failure.  The caller is not joined on
   return. */
