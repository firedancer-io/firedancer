...
FD_STATIC_ASSERT( alignof(fd_dcache_private_hdr_t)==FD_DCACHE_ALIGN, unit_test );
FD_STATIC_ASSERT( sizeof (fd_dcache_private_hdr_t)==FD_DCACHE_ALIGN, unit_test );
...
FD_STATIC_ASSERT( FD_DCACHE_ALIGN                   == 4096UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(   0UL,   0UL)== 4096UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(   0UL,   1UL)== 8192UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(   0UL,4096UL)== 8192UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(   0UL,4097UL)==12288UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(   1UL,   0UL)== 8192UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(   1UL,   1UL)==12288UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(   1UL,4096UL)==12288UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(   1UL,4097UL)==16384UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(4096UL,   0UL)== 8192UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(4096UL,   1UL)==12288UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(4096UL,4096UL)==12288UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(4096UL,4097UL)==16384UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(4097UL,   0UL)==12288UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(4097UL,   1UL)==16384UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(4097UL,4096UL)==16384UL, unit_test );
FD_STATIC_ASSERT( FD_DCACHE_FOOTPRINT(4097UL,4097UL)==20480UL, unit_test );

FD_STATIC_ASSERT( FD_DCACHE_GUARD_FOOTPRINT==3968UL, unit_test );
