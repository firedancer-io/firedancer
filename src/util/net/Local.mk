...
$(call add-objs,fd_ip4 fd_ip6,fd_util)
$(call add-objs,fd_pcap fd_pcapng fd_pcapng_iter,fd_util_extra)
$(call add-objs,fd_eth,fd_util_test)
$(call make-unit-test,test_eth,test_eth,fd_util_test fd_util)
...
$(call make-fuzz-test,fuzz_pcap,fuzz_pcap,fd_util_extra fd_util)
$(call make-fuzz-test,fuzz_pcapng,fuzz_pcapng,fd_util_extra fd_util)
$(call make-fuzz-test,fuzz_ip6,fuzz_ip6,fd_util)
endif
