...
ifdef FD_HAS_HOSTED
$(call add-objs,fd_wksp_io fd_wksp_checkpt_v1 fd_wksp_restore_v1 fd_wksp_checkpt_v2 fd_wksp_restore_v2,fd_util_test)
endif
$(call make-bin,fd_wksp_ctl,fd_wksp_ctl,fd_util_test fd_util) # Just a stub if not HAS_HOSTED
...
$(call make-unit-test,test_wksp_tpool,test_wksp_tpool,fd_util_test fd_util)
