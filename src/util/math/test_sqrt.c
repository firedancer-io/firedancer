...
#   define TEST(UINT,INT,w) do {                                                  \
      ...
      if( FD_UNLIKELY( (y>=(((UINT)1)<<(w/2))) | (r>(y<<1)) ) ) {                 \
        FD_LOG_WARNING(( "FAIL: iter %i op sqrt_uint" #w " x %lx y %lx r %lx)",   \
      ...
      if( u>=((INT)0) ) {                                                         \
        ...
        if( FD_UNLIKELY( !((((INT)0)<=s) & (s<=(v<<1))) ) ) {                     \
          FD_LOG_WARNING(( "FAIL: iter %i op sqrt_int" #w " u %li v %li s %li",   \
      ...
      if( !( FD_UNLIKELY( ((u>=((INT)0)) & (((INT)0)<=s) & (s<=(v<<1))) |         \
                          ((u< ((INT)0)) & (v==((INT)0))              ) ) ) ) {   \
        FD_LOG_WARNING(( "FAIL: iter %i op sqrt_re_int" #w " u %li v %li s %li",  \
                         i, (long)u, (long)v, (long)s ));                         \
        return 1;                                                                 \
      }                                                                           \
      ...
      if( FD_UNLIKELY( v!=s ) ) {                                                 \
        FD_LOG_WARNING(( "FAIL: iter %i op sqrt_abs_int" #w " u %li v %li s %li", \
                         i, (long)u, (long)v, (long)s ));                         \
        return 1;                                                                 \
      }                                                                           \
    } while(0)
