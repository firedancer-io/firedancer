...
#define FD_ENV_CMDLINE_IMPL( T, what )                                         \
T                                                                              \
...
FD_ENV_CMDLINE_IMPL( char const *, cstr   )
FD_ENV_CMDLINE_IMPL( char,         char   )
FD_ENV_CMDLINE_IMPL( schar,        schar  )
FD_ENV_CMDLINE_IMPL( short,        short  )
FD_ENV_CMDLINE_IMPL( int,          int    )
FD_ENV_CMDLINE_IMPL( long,         long   )
FD_ENV_CMDLINE_IMPL( uchar,        uchar  )
FD_ENV_CMDLINE_IMPL( ushort,       ushort )
FD_ENV_CMDLINE_IMPL( uint,         uint   )
FD_ENV_CMDLINE_IMPL( ulong,        ulong  )
FD_ENV_CMDLINE_IMPL( float,        float  )
#if FD_HAS_DOUBLE
FD_ENV_CMDLINE_IMPL( double,       double )
#endif

#undef FD_ENV_CMDLINE_IMPL
