...
FD_FN_CONST static inline SET_(t) SET_(null)( void ) {
  return (SET_(t)) 0;
}

FD_FN_CONST static inline SET_(t) SET_(full)( void ) {
  return (SET_(t))((((SET_(t)) ~((SET_(t)) 0))) >> SET_(PRIVATE_ZP_CNT));
}
...
FD_FN_CONST static inline SET_(t) SET_(ele)   (        SET_IDX_T i ) {
  return (SET_(t))(((SET_(t))  1) << i);
}
FD_FN_CONST static inline SET_(t) SET_(ele_if)( int c, SET_IDX_T i ) {
  return (SET_(t))(((SET_(t)) !!c) << i);
}

FD_FN_CONST static inline SET_IDX_T SET_(max)  ( void      ) {
  return (SET_IDX_T)SET_(MAX);
}
FD_FN_CONST static inline SET_IDX_T SET_(cnt)  ( SET_(t) x ) {
  return (SET_IDX_T)SET_POPCNT(x);
}
FD_FN_CONST static inline SET_IDX_T SET_(first)( SET_(t) x ) {
  return (SET_IDX_T)SET_FIND_LSB(x);
}

/* Handles >=0 for negative types too */
FD_FN_CONST static inline int SET_(valid_idx)( SET_IDX_T i              ) {
  return ((ulong)(long)i)<((ulong)SET_(MAX));
}

FD_FN_CONST static inline int SET_(valid)    ( SET_(t)   x              ) {
  return !(x & ~SET_(full)());
}
FD_FN_CONST static inline int SET_(is_null)  ( SET_(t)   x              ) {
  return !x;
}
FD_FN_CONST static inline int SET_(is_full)  ( SET_(t)   x              ) {
  return x==SET_(full)();
}
FD_FN_CONST static inline int SET_(test)     ( SET_(t)   x, SET_IDX_T i ) {
  return (int)((x>>i) & ((SET_(t)) 1));
}
FD_FN_CONST static inline int SET_(eq)       ( SET_(t)   x, SET_(t)   y ) {
  return x==y;
}
FD_FN_CONST static inline int SET_(subset)   ( SET_(t)   x, SET_(t)   y ) {
  return x==(x & y);
}

FD_FN_CONST static inline SET_(t) SET_(copy)      ( SET_(t) x ) {
  return x;
}
FD_FN_CONST static inline SET_(t) SET_(complement)( SET_(t) x ) {
  return x ^ SET_(full)();
}

FD_FN_CONST static inline SET_(t) SET_(union)    ( SET_(t) x, SET_(t) y ) {
  return x | y;
}
FD_FN_CONST static inline SET_(t) SET_(intersect)( SET_(t) x, SET_(t) y ) {
  return x & y;
}
FD_FN_CONST static inline SET_(t) SET_(subtract) ( SET_(t) x, SET_(t) y ) {
  return (SET_(t))(x & ~y);
}
FD_FN_CONST static inline SET_(t) SET_(xor)      ( SET_(t) x, SET_(t) y ) {
  return x ^  y;
}
...
FD_FN_CONST static inline SET_(iter_t) SET_(iter_done)( SET_(iter_t) iter ) {
  return !iter;
}
FD_FN_CONST static inline SET_(iter_t) SET_(iter_next)( SET_(iter_t) iter ) {
  return SET_POP_LSB(  iter );
}
FD_FN_CONST static inline SET_IDX_T    SET_(iter_idx) ( SET_(iter_t) iter ) {
  return (SET_IDX_T)SET_FIND_LSB( iter );
}

FD_FN_CONST static inline SET_(t) SET_(insert)( SET_(t) x, SET_IDX_T i ) {
  return x | SET_(ele)(i);
}
FD_FN_CONST static inline SET_(t) SET_(remove)( SET_(t) x, SET_IDX_T i ) {
  return (SET_(t))(x & ~SET_(ele)(i));
}

FD_FN_CONST static inline SET_(t) SET_(insert_if)( int c, SET_(t) x, SET_IDX_T i ) {
  return x | SET_(ele_if)(c,i);
}
FD_FN_CONST static inline SET_(t) SET_(remove_if)( int c, SET_(t) x, SET_IDX_T i ) {
