...
main( int     argc,
  ...
  FD_EXPECT_LOG_ERR( test_deque_new( NULL ) );
  FD_EXPECT_LOG_ERR( test_deque_new( (void*)((char*)scratch+1) ) );
  FD_EXPECT_LOG_ERR( test_deque_delete( NULL ) );
  FD_EXPECT_LOG_ERR( test_deque_delete( scratch+1 ) );
  ...
  FD_EXPECT_LOG_ERR( test_deque_pop_idx_tail( deque, 1 ) );
