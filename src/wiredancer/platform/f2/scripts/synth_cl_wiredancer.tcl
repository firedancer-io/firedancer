...
read_verilog $HDK_SHELL_DESIGN_DIR/interfaces/unused_flr_template.inc
read_verilog $HDK_SHELL_DESIGN_DIR/interfaces/unused_cl_sda_template.inc
read_verilog $HDK_SHELL_DESIGN_DIR/interfaces/unused_apppf_irq_template.inc
