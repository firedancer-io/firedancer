...
FD_TEMPL_DEF_STRUCT_BEGIN(common_frag)
  FD_TEMPL_MBR_ELEM_VARINT(type,uint64)
...
FD_TEMPL_DEF_STRUCT_BEGIN(ack_frame)
  ...
  //FD_TEMPL_MBR_ELEM(type,uint8)
  FD_TEMPL_MBR_ELEM_VARINT(largest_ack,uint64)
  FD_TEMPL_MBR_ELEM_VARINT(ack_delay,uint64)
  FD_TEMPL_MBR_ELEM_VARINT(ack_range_count,uint64)
  FD_TEMPL_MBR_ELEM_VARINT(first_ack_range,uint64)
...
FD_TEMPL_DEF_STRUCT_BEGIN(ack_range_frag)
  FD_TEMPL_MBR_ELEM_VARINT(gap,uint64)
  FD_TEMPL_MBR_ELEM_VARINT(length,uint64)
...
FD_TEMPL_DEF_STRUCT_BEGIN(ecn_counts_frag)
  FD_TEMPL_MBR_ELEM_VARINT(ect0_count,uint64)
  FD_TEMPL_MBR_ELEM_VARINT(ect1_count,uint64)
  FD_TEMPL_MBR_ELEM_VARINT(ecn_ce_count,uint64)
...
FD_TEMPL_DEF_STRUCT_BEGIN(reset_stream_frame)
  ...
  FD_TEMPL_MBR_ELEM_VARINT(stream_id,uint64)
  FD_TEMPL_MBR_ELEM_VARINT(app_proto_err_code,uint64)
  FD_TEMPL_MBR_ELEM_VARINT(final_size,uint64)
...
FD_TEMPL_DEF_STRUCT_BEGIN(crypto_frame)
  ...
  FD_TEMPL_MBR_ELEM_VARINT(offset,uint64)
  FD_TEMPL_MBR_ELEM_VARINT(length,uint64)
...
FD_TEMPL_DEF_STRUCT_BEGIN(new_token_frame)
  ...
  FD_TEMPL_MBR_ELEM_VARINT(token_len,uint32)
...
FD_TEMPL_DEF_STRUCT_BEGIN(max_data_frame)
  ...
  FD_TEMPL_MBR_ELEM_VARINT(max_data,uint64)
...
FD_TEMPL_DEF_STRUCT_BEGIN(max_stream_data)
  ...
  FD_TEMPL_MBR_ELEM_VARINT(stream_id,uint64)
  FD_TEMPL_MBR_ELEM_VARINT(max_stream_data,uint64)
...
FD_TEMPL_DEF_STRUCT_BEGIN(max_streams_frame)
  ...
  FD_TEMPL_MBR_ELEM_VARINT(max_streams,uint64)
...
FD_TEMPL_DEF_STRUCT_BEGIN(new_conn_id_frame)
  ...
  FD_TEMPL_MBR_ELEM_VARINT(seq_nbr,uint64)
  FD_TEMPL_MBR_ELEM_VARINT(retire_prior_to,uint64)
  FD_TEMPL_MBR_ELEM(conn_id_len,uint8)
  FD_TEMPL_MBR_ELEM_VAR_RAW(conn_id,0,160,conn_id_len)
  FD_TEMPL_MBR_ELEM_FIXED(stateless_reset_token,uint8,16)
...
FD_TEMPL_DEF_STRUCT_BEGIN(path_challenge_frame)
  ...
  FD_TEMPL_MBR_ELEM_VARINT(data,uint64)
...
FD_TEMPL_DEF_STRUCT_BEGIN(conn_close_frame)
  ...
  FD_TEMPL_MBR_ELEM_VARINT(error_code,uint64)
  FD_TEMPL_MBR_OPT(type,frame_type,0x01,
    FD_TEMPL_MBR_ELEM_VARINT(frame_type,uint64)
    )
  FD_TEMPL_MBR_ELEM_VARINT(reason_phrase_length,uint64)
  /* phrase follows */
