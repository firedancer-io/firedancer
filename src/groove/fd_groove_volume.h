...
/* Groove data objects are stored in groove volumes.  A volume has a
   ...
   (Note that 50B data objects at a worst case 10 MiB per object
...
#define FD_GROOVE_VOLUME_INFO_MAX  (FD_GROOVE_DATA_BLOCK_FOOTPRINT-24UL)
#define FD_GROOVE_VOLUME_DATA_MAX  (FD_GROOVE_VOLUME_FOOTPRINT-FD_GROOVE_DATA_BLOCK_FOOTPRINT)

struct __attribute__((aligned(FD_GROOVE_VOLUME_ALIGN))) fd_groove_volume {
  ulong magic; /* == FD_GROOVE_VOLUME_MAGIC */
  ...
  uchar info[ FD_GROOVE_VOLUME_INFO_MAX ]; /* User info */

  /* This point is aligned FD_GROOVE_DATA_BLOCK_ALIGN */
