...
/* fd_groove_data_block API *******************************************/

/* Groove data objects FD_GROOVE_DATA_BLOCK_ALIGN aligned
   FD_GROOVE_DATA_BLOCK_FOOTPRINT byte blocks.  ALIGN==FOOTPRINT and are
   a power of 2.  512 is used for tight coupling to typical HPC I/O API,
   operating system, driver and hardware limits. */

#define FD_GROOVE_DATA_BLOCK_ALIGN     (512UL)
#define FD_GROOVE_DATA_BLOCK_FOOTPRINT (512UL)
