...
fd_quic_service_sampled( fd_quic_t  * quic,
  ...
  long delta_ns = fd_clock_now( clock ) - now;
  fd_histf_sample( quic->metrics.service_duration, (ulong)delta_ns );
...
fd_quic_process_packet_sampled( fd_quic_t  *  quic,
  ...
  fd_quic_process_packet( quic, data, data_sz, now );

  long dt  = fd_clock_now( clock ) - now;
