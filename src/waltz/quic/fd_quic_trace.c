...
ulong
fd_quic_trace_v1_frames( char **           out_buf,
                         ulong *           out_buf_sz,
                         uchar const *     buf,
                         ulong             buf_sz );
...
ulong
fd_quic_trace_v1_quic_hdr_initial( char **        out_buf,
                                   ulong *        out_buf_sz,
...
ulong
fd_quic_trace_v1_quic_hdr_handshake( char **        out_buf,
                                     ulong *        out_buf_sz,
                                     uchar const ** frame_ptr,
                                     ulong *        frame_sz,
                                     uchar const *  buf,
...
ulong
fd_quic_trace_v1_quic_hdr_one_rtt( char **        out_buf,
                                   ulong *        out_buf_sz,
                                   uchar const ** frame_ptr,
                                   ulong *        frame_sz,
                                   uchar const *  buf,
...
ulong
fd_quic_trace_v1_quic_hdr( char **        out_buf,
                           ulong *        out_buf_sz,
                           uchar const ** frame_ptr,
                           ulong *        frame_sz,
                           uchar const *  buf,
  ...
  if( !is_long ) {
      return fd_quic_trace_v1_quic_hdr_one_rtt( out_buf, out_buf_sz, frame_ptr, frame_sz, buf, buf_sz );
  }
  ...
  switch( long_type ) {
    case 0x00: /* initial */
      return fd_quic_trace_v1_quic_hdr_initial( out_buf, out_buf_sz, frame_ptr, frame_sz, buf, buf_sz );
    case 0x01: /* 0-rtt - unused */
      ...
      *out_buf_sz -= sz;
      return FD_QUIC_PARSE_FAIL;
    case 0x02: /* handshake */
      return fd_quic_trace_v1_quic_hdr_handshake( out_buf, out_buf_sz, frame_ptr, frame_sz, buf, buf_sz );
    case 0x03:
...
fd_quic_trace_v1_quic_pkt( fd_quic_trace_t * trace,
  ...
  ulong hdr_rc = fd_quic_trace_v1_quic_hdr( &out_buf,
                                            &out_buf_sz,
                                            &frame_ptr,
                                            &frame_sz,
                                            buf,
  ...
  ulong rc = fd_quic_trace_v1_frames( &out_buf,
                                      &out_buf_sz,
                                      frame_ptr,
                                      frame_sz );
  if( rc == FD_QUIC_PARSE_FAIL ) {
