...
bench_retry_create( void ) {
  ...
  fd_quic_retry_create( retry, &pkt, rng, aes_key, aes_iv, &orig_dst_conn_id, &new_conn_id, 1UL );
...
bench_retry_server_verify( void ) {
  ...
  static uchar const token[] = {
    0xa5, 0xda, 0x08, 0x08, 0xb6, 0xf9, 0x36, 0xa0, 0xaa, 0xc1, 0x13, 0x73, 0xa5, 0x4e, 0x0a, 0x11,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00,
    0xcb, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x3f, 0x84, 0x11, 0x89, 0x90, 0xdb, 0x6d, 0xc3, 0x4a, 0xb6, 0x73, 0x07, 0xa5, 0x27,
    0xc2, 0x98
  };
...
test_retry_token_time( void ) {
  ...
  static uchar const token[] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x6c, 0xd6, 0x54, 0xf8, 0x96, 0x46, 0x60, 0xcb, 0xa3, 0x14, 0xc5, 0x12, 0x3f, 0x0d,
    0xaa, 0xad
  };
  fd_quic_initial_t initial = { .dst_conn_id_len = 8 };
  initial.token_len = sizeof(token);
