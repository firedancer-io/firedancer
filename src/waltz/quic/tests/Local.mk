...
$(call make-lib,fd_waltz_test)
$(call add-objs,fd_quic_test_helpers,fd_waltz_test)

QUIC_TEST_LIBS:=fd_waltz_test fd_quic fd_tls fd_tango fd_ballet fd_waltz fd_util_extra fd_util
...
$(call make-unit-test,test_quic_streams,    test_quic_streams fd_quic_stream_spam,$(QUIC_TEST_LIBS))
...
$(call make-unit-test,test_quic_conformance,test_quic_conformance fd_quic_sandbox,$(QUIC_TEST_LIBS) fd_util)
$(call make-unit-test,test_quic_ack_tx,     test_quic_ack_tx,     $(QUIC_TEST_LIBS))
$(call make-unit-test,test_quic_concurrency,test_quic_concurrency fd_quic_sandbox,$(QUIC_TEST_LIBS))
...
$(call make-unit-test,test_quic_pkt_meta_lifecycle,test_quic_pkt_meta_lifecycle fd_quic_sandbox,$(QUIC_TEST_LIBS))
...
$(call make-unit-test,test_quic_client_flood,test_quic_client_flood,fd_util_test $(QUIC_TEST_LIBS))
