...
/* fd_dns_cache_put inserts or replaces a cache record.  fqdn points to
   a fully-qualified domain name of fqdn_len characters.
   resolve_time_nanos is the wallclock timestamp when the server
   returned the query.  ip6_addr_tbl points to a contiguous table
