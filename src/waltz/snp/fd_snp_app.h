...
#define FD_SNP_META_PROTO_UDP    (0x0100000000000000UL)
#define FD_SNP_META_PROTO_V1_TLV (0x0200000000000000UL)
#define FD_SNP_META_PROTO_V1_RAW (0x0400000000000000UL)
...
#define FD_SNP_APP_SUCCESS ( 0)
#define FD_SNP_APP_FAILURE (-1)
...
typedef ulong fd_snp_app_peer_t;

/* fd_snp_app_meta_t is a type to represent connection metadata. */
typedef ulong fd_snp_app_meta_t;
...
typedef int
( * fd_snp_app_cb_tx_t )( uchar const *        packet,       /* packet to send */
...
typedef int
( * fd_snp_app_cb_rx_t )( fd_snp_app_peer_t    peer,         /* source peer */
                          void const *         data,         /* app data received from peer */
...
fd_snp_app_meta_t
fd_snp_app_into_meta( ulong snp_proto, uint ip4, ushort port );
