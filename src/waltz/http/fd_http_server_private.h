...
struct __attribute__((aligned(FD_HTTP_SERVER_ALIGN))) fd_http_server_private {
  ...
  compressed, one uncompressed), since a broadcast message may need to
  send compressed data to some clients and uncompressed data to others.
  The server will only compress outgoing messages after they have been
  fully staged. The memory layout will look like this:
