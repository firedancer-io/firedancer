...
main( int     argc,
  ...
  ulong  seed        = 42UL;
  int    lg_slot_cnt = fd_neigh4_hmap_est_lg_slot_cnt( ele_max );
  void * hmap_mem    = fd_wksp_alloc_laddr( wksp, fd_neigh4_hmap_align(), fd_neigh4_hmap_footprint( lg_slot_cnt ), 1UL );
  FD_TEST( hmap_mem );
  fd_neigh4_hmap_t * map = fd_neigh4_hmap_join( fd_neigh4_hmap_new( hmap_mem, lg_slot_cnt, seed ) );
  FD_TEST( map );
