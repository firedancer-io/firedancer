...
test_client_hello_decode( void ) {
  ...
  fd_tls_client_hello_t client_hello_expected = {
    ...
    .signature_algorithms = {
      .ed25519 = 1, .ecdsa_secp256r1_sha256 = 1, .ecdsa_secp384r1_sha384 = 1,
      .rsa_pkcs1_sha256 = 1, .rsa_pkcs1_sha384 = 1, .rsa_pkcs1_sha512 = 1,
      .rsa_pss_rsae_sha256 = 1, .rsa_pss_rsae_sha384 = 1, .rsa_pss_rsae_sha512 = 1
    },
    .key_share = {
      .has_x25519 = 1,
      .x25519 = {
...
test_tls_client_hello_sigalgs( fd_rng_t * rng ) {
  ...
  for( uint quic=0U; quic<2U; quic++ ) {
    ...
    FD_TEST( ch.signature_algorithms.rsa_pss_rsae_sha256 == ( !quic && FD_HAS_INT128 ) );
    FD_TEST( ch.signature_algorithms.rsa_pss_rsae_sha384 == ( !quic && FD_HAS_INT128 ) );
    FD_TEST( ch.signature_algorithms.rsa_pss_rsae_sha512 == ( !quic && FD_HAS_INT128 ) );
    FD_TEST( !ch.signature_algorithms.rsa_pkcs1_sha256 );
    FD_TEST( !ch.signature_algorithms.rsa_pkcs1_sha384 );
    FD_TEST( !ch.signature_algorithms.rsa_pkcs1_sha512 );
    ...
    FD_TEST( ch.signature_algorithms_cert.rsa_pkcs1_sha256 == ( !quic && FD_HAS_INT128 ) );
    FD_TEST( ch.signature_algorithms_cert.rsa_pkcs1_sha384 == ( !quic && FD_HAS_INT128 ) );
    FD_TEST( ch.signature_algorithms_cert.rsa_pkcs1_sha512 == ( !quic && FD_HAS_INT128 ) );
    FD_TEST( !ch.signature_algorithms_cert.rsa_pss_rsae_sha256 );
    FD_TEST( !ch.signature_algorithms_cert.rsa_pss_rsae_sha384 );
    FD_TEST( !ch.signature_algorithms_cert.rsa_pss_rsae_sha512 );
...
#if FD_HAS_INT128
/* A TCP client accepts an RSA leaf and an rsa_pss_rsae_sha{256,384,
   512} CertificateVerify.  The handshake state is set up so that the
   signed transcript hash is SHA-256(""), which the fixture signatures
   (generated with Python cryptography) cover. */

static void
test_tls_client_rsa_cert_verify( fd_rng_t * rng ) {
  static uchar const k2048_rsapub[ 270 ] = {
    
  };
  static uchar const k2048_cv_sha256[ 256 ] = {
    
  };
  static uchar const k2048_cv_sha384[ 256 ] = {
    
  };
  static uchar const k2048_cv_sha512[ 256 ] = {
    
  };
  static uchar const k4096_rsapub[ 526 ] = {
    
  };
  static uchar const k4096_cv_sha256[ 512 ] = {
    
  };
  static uchar const k4096_cv_sha384[ 512 ] = {
    
  };
  static uchar const k4096_cv_sha512[ 512 ] = {
    
  };

  struct { uchar const * pubkey; ulong pubkey_len; uchar const * sig; ulong sig_len; ushort alg; } const vec[] = {
    { k2048_rsapub, sizeof(k2048_rsapub), k2048_cv_sha256, sizeof(k2048_cv_sha256), FD_TLS_SIGNATURE_RSA_PSS_RSAE_SHA256 },
    { k2048_rsapub, sizeof(k2048_rsapub), k2048_cv_sha384, sizeof(k2048_cv_sha384), FD_TLS_SIGNATURE_RSA_PSS_RSAE_SHA384 },
    { k2048_rsapub, sizeof(k2048_rsapub), k2048_cv_sha512, sizeof(k2048_cv_sha512), FD_TLS_SIGNATURE_RSA_PSS_RSAE_SHA512 },
    { k4096_rsapub, sizeof(k4096_rsapub), k4096_cv_sha256, sizeof(k4096_cv_sha256), FD_TLS_SIGNATURE_RSA_PSS_RSAE_SHA256 },
    { k4096_rsapub, sizeof(k4096_rsapub), k4096_cv_sha384, sizeof(k4096_cv_sha384), FD_TLS_SIGNATURE_RSA_PSS_RSAE_SHA384 },
    { k4096_rsapub, sizeof(k4096_rsapub), k4096_cv_sha512, sizeof(k4096_cv_sha512), FD_TLS_SIGNATURE_RSA_PSS_RSAE_SHA512 },
  };
  ...
  for( ulong i=0UL; i<sizeof(vec)/sizeof(vec[0]); i++ ) {
    /* CertificateVerify: msg hdr || alg || sig len || sig */
    uchar msg[ 4+4+FD_TLS_CV_SIG_SZ_MAX ];
    ulong msg_sz = 4UL+vec[i].sig_len;
    msg[0] = FD_TLS_MSG_CERT_VERIFY;
    msg[1] = 0; msg[2] = (uchar)( msg_sz>>8 ); msg[3] = (uchar)msg_sz;
    FD_STORE( ushort, msg+4, fd_ushort_bswap( vec[i].alg ) );
    FD_STORE( ushort, msg+6, fd_ushort_bswap( (ushort)vec[i].sig_len ) );
    fd_memcpy( msg+8, vec[i].sig, vec[i].sig_len );
    ulong rec_sz = 4UL+msg_sz;

    for( int variant=0; variant<5; variant++ ) {
      fd_tls_estate_cli_t hs[1];
      FD_TEST( fd_tls_estate_cli_new( hs ) );
      hs->base.state = FD_TLS_HS_WAIT_CV;
      fd_sha256_init( &hs->transcript );
      fd_memcpy( hs->server_pubkey, vec[i].pubkey, vec[i].pubkey_len );
      hs->server_pubkey_len = vec[i].pubkey_len;
      hs->server_key_type   = FD_TLS_KEY_RSA;

      uchar rec[ sizeof(msg) ];
      fd_memcpy( rec, msg, rec_sz );
      long res;
      switch( variant ) {
      case 0:  /* valid */
        res = fd_tls_client_handshake( client, hs, rec, rec_sz, FD_TLS_LEVEL_HANDSHAKE );
        FD_TEST( res==(long)rec_sz );
        FD_TEST( hs->base.state==FD_TLS_HS_WAIT_FINISHED );
        break;
      case 1:  /* bit flip in signature */
        rec[ rec_sz-1UL ] ^= 0x01;
        res = fd_tls_client_handshake( client, hs, rec, rec_sz, FD_TLS_LEVEL_HANDSHAKE );
        FD_TEST( res==-(long)FD_TLS_ALERT_DECRYPT_ERROR );
        FD_TEST( hs->base.reason==FD_TLS_REASON_RSA_FAIL );
        break;
      case 2:  /* wrong hash in scheme */
        FD_STORE( ushort, rec+4, fd_ushort_bswap( (ushort)( vec[i].alg==FD_TLS_SIGNATURE_RSA_PSS_RSAE_SHA256
                                                             ? FD_TLS_SIGNATURE_RSA_PSS_RSAE_SHA384
                                                             : FD_TLS_SIGNATURE_RSA_PSS_RSAE_SHA256 ) ) );
        res = fd_tls_client_handshake( client, hs, rec, rec_sz, FD_TLS_LEVEL_HANDSHAKE );
        FD_TEST( res==-(long)FD_TLS_ALERT_DECRYPT_ERROR );
        FD_TEST( hs->base.reason==FD_TLS_REASON_RSA_FAIL );
        break;
      case 3:  /* RSA scheme, but the cert key is not RSA */
        hs->server_key_type = FD_TLS_KEY_ECDSA_P256;
        res = fd_tls_client_handshake( client, hs, rec, rec_sz, FD_TLS_LEVEL_HANDSHAKE );
        FD_TEST( res==-(long)FD_TLS_ALERT_HANDSHAKE_FAILURE );
        FD_TEST( hs->base.reason==FD_TLS_REASON_CV_SIGALG );
        break;
      default: /* signature shorter than the modulus */
        FD_STORE( ushort, rec+6, fd_ushort_bswap( (ushort)( vec[i].sig_len-1UL ) ) );
        rec[3]--;
        res = fd_tls_client_handshake( client, hs, rec, rec_sz-1UL, FD_TLS_LEVEL_HANDSHAKE );
        FD_TEST( res<0L );
        FD_TEST( hs->base.state==FD_TLS_HS_WAIT_CV || hs->base.state==FD_TLS_HS_FAIL );
        break;
      }
      fd_tls_estate_cli_delete( hs );
    }
...
/* An RSA server certificate is accepted by the TCP client and rejected
   in QUIC mode. */

static void
test_tls_client_rsa_cert( fd_rng_t * rng ) {
  /* Self-signed RSA-2048 cert, CN=RSA Loader Root (also used by
     test_x509_verify) */
  static char const rsa_cert_hex[] =
  "308203253082020da00302010202147ae7e054097c8133bf03b9e2aa2c76cae8b7f840300d06092a864886f70d01010b0500"
    ...
    "e8e4165a7cba25715b";
  uchar rsa_cert[ 809 ];
  fd_hex_decode( rsa_cert, rsa_cert_hex, sizeof(rsa_cert) );

  uchar cert_msg[ 1024 ];
  long cert_msg_sz = fd_tls_encode_cert_x509( rsa_cert, sizeof(rsa_cert), cert_msg, sizeof(cert_msg) );
  FD_TEST( cert_msg_sz>0L );
  ...
  for( int quic=0; quic<2; quic++ ) {
    ...
    long res = fd_tls_client_handshake( client, hs, cert_msg, (ulong)cert_msg_sz, FD_TLS_LEVEL_HANDSHAKE );
    if( quic ) {
      FD_TEST( res==-(long)FD_TLS_ALERT_UNSUPPORTED_CERTIFICATE );
      FD_TEST( hs->base.reason==FD_TLS_REASON_CERT_KEY_TYPE );
    } else {
      FD_TEST( res==cert_msg_sz );
      FD_TEST( hs->base.state==FD_TLS_HS_WAIT_CV );
      FD_TEST( hs->server_key_type==FD_TLS_KEY_RSA );
      FD_TEST( hs->server_pubkey_len==270UL );
      fd_rsa_pubkey_t key[1];
      FD_TEST( !fd_x509_decode_rsa_pubkey( hs->server_pubkey, hs->server_pubkey_len, key ) );
      FD_TEST( key->mod_bits==2048UL );
    }
    fd_tls_estate_cli_delete( hs );
  }
...
#if FD_HAS_INT128
  test_tls_client_rsa_cert_verify( rng );
  test_tls_client_rsa_cert( rng );
#endif
