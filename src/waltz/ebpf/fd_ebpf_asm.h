...
#define FD_EBPF_ASM_jeq32_imm( dst, imm, off ) FD_EBPF_ASM_JUMP_COND_IMM( 0x16, dst, imm, off )
#define FD_EBPF_ASM_jne32_imm( dst, imm, off ) FD_EBPF_ASM_JUMP_COND_IMM( 0x56, dst, imm, off )
