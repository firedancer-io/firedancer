...
fd_ext_poh_reset( ulong         completed_bank_slot, /* The slot that successfully produced a block */
  ...
  memcpy( ctx->features_activation->slots, features_activation, FD_SHRED_FEATURES_ACTIVATION_SLOT_CNT*FD_SHRED_FEATURES_ACTIVATION_SLOT_SZ);
...
publish_features_activation(  fd_poh_ctx_t *      ctx,
  ...
  memcpy( act_data, ctx->features_activation, FD_SHRED_FEATURES_ACTIVATION_SLOT_CNT*FD_SHRED_FEATURES_ACTIVATION_SLOT_SZ );
