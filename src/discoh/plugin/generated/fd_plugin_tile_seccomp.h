...
static const uint sock_filter_policy_fd_plugin_tile_instr_cnt = 16;

static void populate_sock_filter_policy_fd_plugin_tile( ulong out_cnt, struct sock_filter out[ static 16 ], uint logfile_fd ) {
  FD_TEST( out_cnt >= 16 );
