...
[Implementation](https://github.com/firedancer-io/firedancer/tree/main/src/ballet/bn254) handwritten over the BN254 scalar field.
...
- TLS 1.3 server authentication (`ecdsa_secp256r1_sha256`) outside of QUIC.
...
SHA-512 is used by Ed25519 and RSA signatures. SHA-384 is used by P-384
ECDSA and RSA signatures in X.509/TLS.

Implementations of [SHA-256](https://github.com/firedancer-io/firedancer/tree/89ed44b4c521e314487b8f0145532dc1aa43953e/src/ballet/sha256)
and [SHA-384/SHA-512](https://github.com/firedancer-io/firedancer/tree/main/src/ballet/sha512)
provide scalar and SIMD batched variants written by hand. SHA-256 also
uses SHA-NI. The SHA-512 AVX2 core is generated from OpenSSL's
`sha512-x86_64.pl`.
...
written by hand, using the [core Keccak-256](#keccak-256) permutation
described above.
