...
| tips            | `number\|null`     | Total amount of tips that this slot collects in lamports, across all build builders, after any commission to the block builder is subtracted |
