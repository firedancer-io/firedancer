...
| transactions        | `Transactions\|null`      | If the slot is not `mine`, will be `null`. Otherwise, a metrics for the transactions in this slot, all ordered by the execution order of their corresponding transaction |
