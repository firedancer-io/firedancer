...
| compute_unit_timestamps_nanos | `number[]`    | An array of UNIX timestamps, in nanoseconds. Each timestamp represents the time of when we started executing a microblock. Timestamps are sorted, and will never decrease |
