...
| Metric | Type | Description |
|--------|------|-------------|
| <span class="metrics-name">admin_&#8203;failover_&#8203;link</span> | gauge | Failover pair channel state (0=listener, including pending candidates: 1=dialing, 2=dialer TLS or HELLO, 3=paired, 4=reserved, 5=backoff) |
