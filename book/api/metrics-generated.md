...
| <span class="metrics-name">replay_&#8203;is_&#8203;voting</span> | gauge | Whether the current identity is eligible to vote. Zero before eligibility is known or re-evaluated after an identity switch |
...
| <span class="metrics-name">diag_&#8203;vote_&#8203;status</span> | gauge | Precise status of the vote subsystem: 0=disabled (non-voting or no consensus tile), 1=not started (replay or consensus tile not running or no votes yet), 2=delinquent (vote distance exceeds threshold or vote stalled), 3=voting (voting normally) |
