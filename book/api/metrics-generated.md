...
| <span class="metrics-name">votor_&#8203;footer_&#8203;cert</span><br/>{footer_&#8203;cert_&#8203;result="<span class="metrics-enum">success</span>"} | counter | Result of processing a finalization cert from a replayed block footer (per cert) (Cert was handed to the pool and accepted) |
