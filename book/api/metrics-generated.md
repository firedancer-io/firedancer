...
| <span class="metrics-name">execle_&#8203;txn_&#8203;result</span><br/>{transaction_&#8203;result="<span class="metrics-enum">unsupported_&#8203;version</span>"} | counter | Result of loading and executing a transaction (The transaction uses a version that is not supported by the current feature set (v1 before enable_tx_v1 is active)) |
...
| <span class="metrics-name">execrp_&#8203;txn_&#8203;result</span><br/>{transaction_&#8203;result="<span class="metrics-enum">unsupported_&#8203;version</span>"} | counter | Result of loading and executing a transaction (The transaction uses a version that is not supported by the current feature set (v1 before enable_tx_v1 is active)) |
