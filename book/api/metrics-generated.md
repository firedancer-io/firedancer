...
| <span class="metrics-name">rpc_&#8203;websocket_&#8203;event_&#8203;unique_&#8203;sent</span><br/>{rpc_&#8203;event_&#8203;type="<span class="metrics-enum">vote</span>"} | counter | Number of unique WebSocket events sent by the RPC service, before fanout to subscribed connections (vote) |
| <span class="metrics-name">rpc_&#8203;websocket_&#8203;event_&#8203;sent</span><br/>{rpc_&#8203;event_&#8203;type="<span class="metrics-enum">vote</span>"} | counter | Number of WebSocket events sent by the RPC service across all subscribed connections (vote) |
