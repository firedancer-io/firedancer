...
| shred_&#8203;shred_&#8203;processed_&#8203;bad_&#8203;slot | `counter` | The result of processing a shred from the network (Shred was for a slot for which we don't know the leader) |
| shred_&#8203;shred_&#8203;processed_&#8203;parse_&#8203;failed | `counter` | The result of processing a shred from the network (Shred parsing failed) |
| shred_&#8203;shred_&#8203;processed_&#8203;rejected | `counter` | The result of processing a shred from the network (Shred was invalid for one of many reasons) |
| shred_&#8203;shred_&#8203;processed_&#8203;ignored | `counter` | The result of processing a shred from the network (Shred was ignored because we had already received or reconstructed it) |
| shred_&#8203;shred_&#8203;processed_&#8203;okay | `counter` | The result of processing a shred from the network (Shred accepted to an incomplete FEC set) |
| shred_&#8203;shred_&#8203;processed_&#8203;completes | `counter` | The result of processing a shred from the network (Shred accepted and resulted in a valid, complete FEC set) |
...
| Metric | Type | Description |
|--------|------|-------------|
| gossip_&#8203;shred_&#8203;version | `gauge` |  |
| gossip_&#8203;table_&#8203;capacity | `gauge` |  |
| gossip_&#8203;table_&#8203;size | `gauge` |  |
| gossip_&#8203;table_&#8203;expired | `gauge` |  |
| gossip_&#8203;table_&#8203;evicted | `gauge` |  |
| gossip_&#8203;purged_&#8203;capacity | `gauge` |  |
| gossip_&#8203;purged_&#8203;size | `gauge` |  |
| gossip_&#8203;failed_&#8203;capacity | `gauge` |  |
| gossip_&#8203;failed_&#8203;size | `gauge` |  |
| gossip_&#8203;message_&#8203;received_&#8203;pull_&#8203;request | `counter` | Number of gossip messages received (Pull Request) |
| gossip_&#8203;message_&#8203;received_&#8203;pull_&#8203;response | `counter` | Number of gossip messages received (Pull Response) |
| gossip_&#8203;message_&#8203;received_&#8203;push | `counter` | Number of gossip messages received (Push) |
| gossip_&#8203;message_&#8203;received_&#8203;prune | `counter` | Number of gossip messages received (Prune) |
| gossip_&#8203;message_&#8203;received_&#8203;ping | `counter` | Number of gossip messages received (Ping) |
| gossip_&#8203;message_&#8203;received_&#8203;pong | `counter` | Number of gossip messages received (Pong) |
| gossip_&#8203;message_&#8203;sent_&#8203;pull_&#8203;request | `counter` | Number of gossip messages sent (Pull Request) |
| gossip_&#8203;message_&#8203;sent_&#8203;pull_&#8203;response | `counter` | Number of gossip messages sent (Pull Response) |
| gossip_&#8203;message_&#8203;sent_&#8203;push | `counter` | Number of gossip messages sent (Push) |
| gossip_&#8203;message_&#8203;sent_&#8203;prune | `counter` | Number of gossip messages sent (Prune) |
| gossip_&#8203;message_&#8203;sent_&#8203;ping | `counter` | Number of gossip messages sent (Ping) |
| gossip_&#8203;message_&#8203;sent_&#8203;pong | `counter` | Number of gossip messages sent (Pong) |
| gossip_&#8203;crds_&#8203;received_&#8203;contact_&#8203;info_&#8203;v1 | `counter` | Number of CRDS values received (Contact Info V1) |
| gossip_&#8203;crds_&#8203;received_&#8203;vote | `counter` | Number of CRDS values received (Vote) |
| gossip_&#8203;crds_&#8203;received_&#8203;lowest_&#8203;slot | `counter` | Number of CRDS values received (Lowest Slot) |
| gossip_&#8203;crds_&#8203;received_&#8203;snapshot_&#8203;hashes | `counter` | Number of CRDS values received (Snapshot Hashes) |
| gossip_&#8203;crds_&#8203;received_&#8203;accounts_&#8203;hashes | `counter` | Number of CRDS values received (Accounts Hashes) |
| gossip_&#8203;crds_&#8203;received_&#8203;epoch_&#8203;slots | `counter` | Number of CRDS values received (Epoch Slots) |
| gossip_&#8203;crds_&#8203;received_&#8203;version_&#8203;v1 | `counter` | Number of CRDS values received (Version V1) |
| gossip_&#8203;crds_&#8203;received_&#8203;version_&#8203;v2 | `counter` | Number of CRDS values received (Version V2) |
| gossip_&#8203;crds_&#8203;received_&#8203;node_&#8203;instance | `counter` | Number of CRDS values received (Node Instance) |
| gossip_&#8203;crds_&#8203;received_&#8203;duplicate_&#8203;shred | `counter` | Number of CRDS values received (Duplicate Shred) |
| gossip_&#8203;crds_&#8203;received_&#8203;incremental_&#8203;snapshot_&#8203;hashes | `counter` | Number of CRDS values received (Incremental Snapshot Hashes) |
| gossip_&#8203;crds_&#8203;received_&#8203;contact_&#8203;info_&#8203;v2 | `counter` | Number of CRDS values received (Contact Info V2) |
| gossip_&#8203;crds_&#8203;received_&#8203;restart_&#8203;last_&#8203;voted_&#8203;fork_&#8203;slots | `counter` | Number of CRDS values received (Restart Last Voted Fork Slots) |
| gossip_&#8203;crds_&#8203;received_&#8203;restart_&#8203;heaviest_&#8203;fork | `counter` | Number of CRDS values received (Restart Heaviest Fork) |
| gossip_&#8203;crds_&#8203;sent_&#8203;contact_&#8203;info_&#8203;v1 | `counter` | Number of CRDS values sent (Contact Info V1) |
| gossip_&#8203;crds_&#8203;sent_&#8203;vote | `counter` | Number of CRDS values sent (Vote) |
| gossip_&#8203;crds_&#8203;sent_&#8203;lowest_&#8203;slot | `counter` | Number of CRDS values sent (Lowest Slot) |
| gossip_&#8203;crds_&#8203;sent_&#8203;snapshot_&#8203;hashes | `counter` | Number of CRDS values sent (Snapshot Hashes) |
| gossip_&#8203;crds_&#8203;sent_&#8203;accounts_&#8203;hashes | `counter` | Number of CRDS values sent (Accounts Hashes) |
| gossip_&#8203;crds_&#8203;sent_&#8203;epoch_&#8203;slots | `counter` | Number of CRDS values sent (Epoch Slots) |
| gossip_&#8203;crds_&#8203;sent_&#8203;version_&#8203;v1 | `counter` | Number of CRDS values sent (Version V1) |
| gossip_&#8203;crds_&#8203;sent_&#8203;version_&#8203;v2 | `counter` | Number of CRDS values sent (Version V2) |
| gossip_&#8203;crds_&#8203;sent_&#8203;node_&#8203;instance | `counter` | Number of CRDS values sent (Node Instance) |
| gossip_&#8203;crds_&#8203;sent_&#8203;duplicate_&#8203;shred | `counter` | Number of CRDS values sent (Duplicate Shred) |
| gossip_&#8203;crds_&#8203;sent_&#8203;incremental_&#8203;snapshot_&#8203;hashes | `counter` | Number of CRDS values sent (Incremental Snapshot Hashes) |
| gossip_&#8203;crds_&#8203;sent_&#8203;contact_&#8203;info_&#8203;v2 | `counter` | Number of CRDS values sent (Contact Info V2) |
| gossip_&#8203;crds_&#8203;sent_&#8203;restart_&#8203;last_&#8203;voted_&#8203;fork_&#8203;slots | `counter` | Number of CRDS values sent (Restart Last Voted Fork Slots) |
| gossip_&#8203;crds_&#8203;sent_&#8203;restart_&#8203;heaviest_&#8203;fork | `counter` | Number of CRDS values sent (Restart Heaviest Fork) |
