...
| <span class="metrics-name">link_&#8203;consumer_&#8203;slow</span> | counter | Times the consumer was detected as rate limiting by the producer |
</div>
...
| <span class="metrics-name">tile_&#8203;heartbeat_&#8203;nanos</span> | gauge | Last UNIX timestamp the tile heartbeated, in nanoseconds |
...
| <span class="metrics-name">ipecho_&#8203;conn_&#8203;closed_&#8203;ok</span> | counter | Connections to the ipecho service made and closed normally |
| <span class="metrics-name">ipecho_&#8203;conn_&#8203;closed_&#8203;error</span> | counter | Connections to the ipecho service made and closed abnormally |
...
| <span class="metrics-name">snapct_&#8203;full_&#8203;retry</span> | counter | Times we aborted and retried full snapshot download because the peer was too slow |
| <span class="metrics-name">snapct_&#8203;incremental_&#8203;retry</span> | counter | Times we aborted and retried incremental snapshot download because the peer was too slow |
...
| <span class="metrics-name">snapct_&#8203;full_&#8203;download_&#8203;retry</span> | gauge | Times we retried the full snapshot download because the peer was too slow |
...
| <span class="metrics-name">snapct_&#8203;incremental_&#8203;download_&#8203;retry</span> | gauge | Times we retried the incremental snapshot download because the peer was too slow |
...
| <span class="metrics-name">net_&#8203;pkt_&#8203;rx_&#8203;fill_&#8203;blocked</span> | counter | Incoming packets dropped due to fill ring being full |
...
| <span class="metrics-name">net_&#8203;pkt_&#8203;tx_&#8203;route_&#8203;failed</span> | counter | Packet transmit jobs dropped due to route failure |
| <span class="metrics-name">net_&#8203;pkt_&#8203;tx_&#8203;neighbor_&#8203;failed</span> | counter | Packet transmit jobs dropped due to unresolved neighbor |
| <span class="metrics-name">net_&#8203;pkt_&#8203;tx_&#8203;ring_&#8203;full_&#8203;failed</span> | counter | Packet transmit jobs dropped due to XDP TX ring full or missing completions |
...
| <span class="metrics-name">net_&#8203;xsk_&#8203;tx_&#8203;wakeup</span> | counter | XSK sendto syscalls dispatched |
| <span class="metrics-name">net_&#8203;xsk_&#8203;rx_&#8203;wakeup</span> | counter | XSK recvmsg syscalls dispatched |
...
| <span class="metrics-name">net_&#8203;gre_&#8203;pkt_&#8203;tx_&#8203;route_&#8203;failed</span> | counter | GRE packet transmit jobs dropped due to route failure |
...
| <span class="metrics-name">sock_&#8203;pkt_&#8203;tx_&#8203;dropped</span> | counter | Packets that failed to send |
...
| <span class="metrics-name">quic_&#8203;conn_&#8203;allocated</span> | gauge | QUIC connections currently allocated |
...
| <span class="metrics-name">quic_&#8203;frame_&#8203;tx_&#8203;alloc</span><br/>{frame_&#8203;tx_&#8203;alloc_&#8203;result="<span class="metrics-enum">success</span>"} | counter | Attempts to acquire QUIC frame metadata (Success) |
| <span class="metrics-name">quic_&#8203;frame_&#8203;tx_&#8203;alloc</span><br/>{frame_&#8203;tx_&#8203;alloc_&#8203;result="<span class="metrics-enum">fail_&#8203;empty_&#8203;pool</span>"} | counter | Attempts to acquire QUIC frame metadata (PktMetaPoolEmpty) |
| <span class="metrics-name">quic_&#8203;frame_&#8203;tx_&#8203;alloc</span><br/>{frame_&#8203;tx_&#8203;alloc_&#8203;result="<span class="metrics-enum">fail_&#8203;connection_&#8203;max</span>"} | counter | Attempts to acquire QUIC frame metadata (ConnMaxedInflightFrames) |
| <span class="metrics-name">quic_&#8203;initial_&#8203;token_&#8203;length</span><br/>{quic_&#8203;initial_&#8203;token_&#8203;length="<span class="metrics-enum">zero</span>"} | counter | Initial packets grouped by token length (No token) |
| <span class="metrics-name">quic_&#8203;initial_&#8203;token_&#8203;length</span><br/>{quic_&#8203;initial_&#8203;token_&#8203;length="<span class="metrics-enum">fd_&#8203;quic_&#8203;length</span>"} | counter | Initial packets grouped by token length (fd_quic retry token length) |
| <span class="metrics-name">quic_&#8203;initial_&#8203;token_&#8203;length</span><br/>{quic_&#8203;initial_&#8203;token_&#8203;length="<span class="metrics-enum">invalid_&#8203;length</span>"} | counter | Initial packets grouped by token length (Invalid token length) |
...
| <span class="metrics-name">quic_&#8203;pkt_&#8203;retransmitted</span><br/>{quic_&#8203;encryption_&#8203;level="<span class="metrics-enum">initial</span>"} | counter | QUIC packets retransmitted (Initial) |
| <span class="metrics-name">quic_&#8203;pkt_&#8203;retransmitted</span><br/>{quic_&#8203;encryption_&#8203;level="<span class="metrics-enum">early</span>"} | counter | QUIC packets retransmitted (Early data) |
| <span class="metrics-name">quic_&#8203;pkt_&#8203;retransmitted</span><br/>{quic_&#8203;encryption_&#8203;level="<span class="metrics-enum">handshake</span>"} | counter | QUIC packets retransmitted (Handshake) |
| <span class="metrics-name">quic_&#8203;pkt_&#8203;retransmitted</span><br/>{quic_&#8203;encryption_&#8203;level="<span class="metrics-enum">app</span>"} | counter | QUIC packets retransmitted (App data) |
...
| <span class="metrics-name">bundle_&#8203;proto_&#8203;rx_&#8203;bytes</span> | counter | Bytes from received gRPC protobuf payloads |
| <span class="metrics-name">bundle_&#8203;bundle_&#8203;rx</span> | counter | Bundles received |
| <span class="metrics-name">bundle_&#8203;error</span><br/>{bundle_&#8203;error="<span class="metrics-enum">protobuf</span>"} | counter | gRPC errors encountered (Protobuf decode/encode error) |
| <span class="metrics-name">bundle_&#8203;error</span><br/>{bundle_&#8203;error="<span class="metrics-enum">transport</span>"} | counter | gRPC errors encountered (Transport error) |
| <span class="metrics-name">bundle_&#8203;error</span><br/>{bundle_&#8203;error="<span class="metrics-enum">timeout</span>"} | counter | gRPC errors encountered (I/O timeout) |
| <span class="metrics-name">bundle_&#8203;error</span><br/>{bundle_&#8203;error="<span class="metrics-enum">no_&#8203;fee_&#8203;info</span>"} | counter | gRPC errors encountered (Bundle dropped due to missing fee info) |
| <span class="metrics-name">bundle_&#8203;error</span><br/>{bundle_&#8203;error="<span class="metrics-enum">ssl_&#8203;alloc</span>"} | counter | gRPC errors encountered (OpenSSL alloc fail) |
...
| <span class="metrics-name">bundle_&#8203;keepalive_&#8203;acked</span> | counter | HTTP/2 PINGs acknowledged by server |
...
| <span class="metrics-name">bundle_&#8203;txn_&#8203;backpressure</span> | counter | Transactions dropped because the pending transaction buffer was full (should never happen) |
...
| <span class="metrics-name">verify_&#8203;vote_&#8203;rx_&#8203;gossip</span> | counter | Simple vote transactions received over gossip instead of via the normal TPU path |
...
| <span class="metrics-name">dedup_&#8203;vote_&#8203;rx_&#8203;gossip</span> | counter | Simple vote transactions received over gossip instead of via the normal TPU path |
...
| Metric | Type | Description |
|--------|------|-------------|
| <span class="metrics-name">resolv_&#8203;no_&#8203;bank_&#8203;dropped</span> | counter | Transactions dropped because the bank was not available |
...
| <span class="metrics-name">pack_&#8203;normal_&#8203;txn_&#8203;rx</span> | counter | Transactions received via the normal TPU path |
...
| <span class="metrics-name">pack_&#8203;txn_&#8203;inserted</span><br/>{pack_&#8203;txn_&#8203;insert_&#8203;return="<span class="metrics-enum">bundle_&#8203;blacklist</span>"} | counter | Result of inserting a transaction into the pack object (Transaction uses an account on the bundle blacklist) |
...
| <span class="metrics-name">pack_&#8203;state_&#8203;duration_&#8203;nanos</span><br/>{pack_&#8203;timing_&#8203;state="<span class="metrics-enum">no_&#8203;txn_&#8203;no_&#8203;execle_&#8203;no_&#8203;leader_&#8203;no_&#8203;microblock</span>"} | counter | Time spent in each state, in nanoseconds (Pack had no transactions available, and wasn't leader) |
| <span class="metrics-name">pack_&#8203;state_&#8203;duration_&#8203;nanos</span><br/>{pack_&#8203;timing_&#8203;state="<span class="metrics-enum">txn_&#8203;no_&#8203;execle_&#8203;no_&#8203;leader_&#8203;no_&#8203;microblock</span>"} | counter | Time spent in each state, in nanoseconds (Pack had transactions available, but wasn't leader or had hit a limit) |
| <span class="metrics-name">pack_&#8203;state_&#8203;duration_&#8203;nanos</span><br/>{pack_&#8203;timing_&#8203;state="<span class="metrics-enum">no_&#8203;txn_&#8203;execle_&#8203;no_&#8203;leader_&#8203;no_&#8203;microblock</span>"} | counter | Time spent in each state, in nanoseconds (Pack had no transactions available, had execle but wasn't leader) |
| <span class="metrics-name">pack_&#8203;state_&#8203;duration_&#8203;nanos</span><br/>{pack_&#8203;timing_&#8203;state="<span class="metrics-enum">txn_&#8203;execle_&#8203;no_&#8203;leader_&#8203;no_&#8203;microblock</span>"} | counter | Time spent in each state, in nanoseconds (Pack had transactions available, had execle but wasn't leader) |
| <span class="metrics-name">pack_&#8203;state_&#8203;duration_&#8203;nanos</span><br/>{pack_&#8203;timing_&#8203;state="<span class="metrics-enum">no_&#8203;txn_&#8203;no_&#8203;execle_&#8203;leader_&#8203;no_&#8203;microblock</span>"} | counter | Time spent in each state, in nanoseconds (Pack had no transactions available, and was leader but had no available execle) |
| <span class="metrics-name">pack_&#8203;state_&#8203;duration_&#8203;nanos</span><br/>{pack_&#8203;timing_&#8203;state="<span class="metrics-enum">txn_&#8203;no_&#8203;execle_&#8203;leader_&#8203;no_&#8203;microblock</span>"} | counter | Time spent in each state, in nanoseconds (Pack had transactions available, was leader, but had no available execle) |
| <span class="metrics-name">pack_&#8203;state_&#8203;duration_&#8203;nanos</span><br/>{pack_&#8203;timing_&#8203;state="<span class="metrics-enum">no_&#8203;txn_&#8203;execle_&#8203;leader_&#8203;no_&#8203;microblock</span>"} | counter | Time spent in each state, in nanoseconds (Pack had available execle but no transactions) |
| <span class="metrics-name">pack_&#8203;state_&#8203;duration_&#8203;nanos</span><br/>{pack_&#8203;timing_&#8203;state="<span class="metrics-enum">txn_&#8203;execle_&#8203;leader_&#8203;no_&#8203;microblock</span>"} | counter | Time spent in each state, in nanoseconds (Pack had execle and transactions available but couldn't schedule anything non-conflicting) |
| <span class="metrics-name">pack_&#8203;state_&#8203;duration_&#8203;nanos</span><br/>{pack_&#8203;timing_&#8203;state="<span class="metrics-enum">no_&#8203;txn_&#8203;no_&#8203;execle_&#8203;no_&#8203;leader_&#8203;microblock</span>"} | counter | Time spent in each state, in nanoseconds (Pack scheduled a non-empty microblock while not leader) |
| <span class="metrics-name">pack_&#8203;state_&#8203;duration_&#8203;nanos</span><br/>{pack_&#8203;timing_&#8203;state="<span class="metrics-enum">txn_&#8203;no_&#8203;execle_&#8203;no_&#8203;leader_&#8203;microblock</span>"} | counter | Time spent in each state, in nanoseconds (Pack scheduled a non-empty microblock while not leader) |
| <span class="metrics-name">pack_&#8203;state_&#8203;duration_&#8203;nanos</span><br/>{pack_&#8203;timing_&#8203;state="<span class="metrics-enum">no_&#8203;txn_&#8203;execle_&#8203;no_&#8203;leader_&#8203;microblock</span>"} | counter | Time spent in each state, in nanoseconds (Pack scheduled a non-empty microblock while not leader) |
| <span class="metrics-name">pack_&#8203;state_&#8203;duration_&#8203;nanos</span><br/>{pack_&#8203;timing_&#8203;state="<span class="metrics-enum">txn_&#8203;execle_&#8203;no_&#8203;leader_&#8203;microblock</span>"} | counter | Time spent in each state, in nanoseconds (Pack scheduled a non-empty microblock while not leader) |
| <span class="metrics-name">pack_&#8203;state_&#8203;duration_&#8203;nanos</span><br/>{pack_&#8203;timing_&#8203;state="<span class="metrics-enum">no_&#8203;txn_&#8203;no_&#8203;execle_&#8203;leader_&#8203;microblock</span>"} | counter | Time spent in each state, in nanoseconds (Pack scheduled a non-empty microblock but all execle were busy) |
| <span class="metrics-name">pack_&#8203;state_&#8203;duration_&#8203;nanos</span><br/>{pack_&#8203;timing_&#8203;state="<span class="metrics-enum">txn_&#8203;no_&#8203;execle_&#8203;leader_&#8203;microblock</span>"} | counter | Time spent in each state, in nanoseconds (Pack scheduled a non-empty microblock but all execle were busy) |
| <span class="metrics-name">pack_&#8203;state_&#8203;duration_&#8203;nanos</span><br/>{pack_&#8203;timing_&#8203;state="<span class="metrics-enum">no_&#8203;txn_&#8203;execle_&#8203;leader_&#8203;microblock</span>"} | counter | Time spent in each state, in nanoseconds (Pack scheduled a non-empty microblock and now has no transactions) |
| <span class="metrics-name">pack_&#8203;state_&#8203;duration_&#8203;nanos</span><br/>{pack_&#8203;timing_&#8203;state="<span class="metrics-enum">txn_&#8203;execle_&#8203;leader_&#8203;microblock</span>"} | counter | Time spent in each state, in nanoseconds (Pack scheduled a non-empty microblock) |
...
| <span class="metrics-name">pack_&#8203;txn_&#8203;already_&#8203;executed_&#8203;dropped</span> | counter | Transactions dropped from pack because they were already executed (in either the replay or leader pipeline) |
| <span class="metrics-name">pack_&#8203;txn_&#8203;partial_&#8203;bundle_&#8203;dropped</span> | counter | Transactions dropped from pack because they were part of a partial bundle |
...
| <span class="metrics-name">pack_&#8203;txn_&#8203;pending_&#8203;heap_&#8203;size</span> | gauge | Maximum number of pending transactions that pack can consider. Fixed at Firedancer startup but a useful reference for TxnAvailable |
| <span class="metrics-name">pack_&#8203;txn_&#8203;pending_&#8203;smallest</span> | gauge | Lower bound on the smallest non-vote transaction (in cost units) that is immediately available for scheduling |
| <span class="metrics-name">pack_&#8203;microblock_&#8203;per_&#8203;block_&#8203;limit</span> | counter | Times pack did not pack a microblock because the microblocks-per-block limit had been reached |
| <span class="metrics-name">pack_&#8203;data_&#8203;per_&#8203;block_&#8203;limit</span> | counter | Times pack did not pack a microblock because it reached the data per block limit at the start of trying to schedule a microblock |
| <span class="metrics-name">pack_&#8203;txn_&#8203;schedule</span><br/>{pack_&#8203;txn_&#8203;schedule="<span class="metrics-enum">taken</span>"} | counter | Result of trying to consider a transaction for scheduling (Pack included the transaction in the microblock) |
| <span class="metrics-name">pack_&#8203;txn_&#8203;schedule</span><br/>{pack_&#8203;txn_&#8203;schedule="<span class="metrics-enum">cu_&#8203;limit</span>"} | counter | Result of trying to consider a transaction for scheduling (Pack skipped the transaction because it would have exceeded the block CU limit) |
| <span class="metrics-name">pack_&#8203;txn_&#8203;schedule</span><br/>{pack_&#8203;txn_&#8203;schedule="<span class="metrics-enum">fast_&#8203;path</span>"} | counter | Result of trying to consider a transaction for scheduling (Pack skipped the transaction because of account conflicts using the fast bitvector check) |
| <span class="metrics-name">pack_&#8203;txn_&#8203;schedule</span><br/>{pack_&#8203;txn_&#8203;schedule="<span class="metrics-enum">byte_&#8203;limit</span>"} | counter | Result of trying to consider a transaction for scheduling (Pack skipped the transaction because it would have exceeded the block data size limit) |
| <span class="metrics-name">pack_&#8203;txn_&#8203;schedule</span><br/>{pack_&#8203;txn_&#8203;schedule="<span class="metrics-enum">alloc_&#8203;limit</span>"} | counter | Result of trying to consider a transaction for scheduling (Pack skipped the transaction because it would have exceeded the data allocation limit) |
| <span class="metrics-name">pack_&#8203;txn_&#8203;schedule</span><br/>{pack_&#8203;txn_&#8203;schedule="<span class="metrics-enum">write_&#8203;cost</span>"} | counter | Result of trying to consider a transaction for scheduling (Pack skipped the transaction because it would have caused a writable account to exceed the per-account block write cost limit) |
| <span class="metrics-name">pack_&#8203;txn_&#8203;schedule</span><br/>{pack_&#8203;txn_&#8203;schedule="<span class="metrics-enum">slow_&#8203;path</span>"} | counter | Result of trying to consider a transaction for scheduling (Pack skipped the transaction because of account conflicts using the full slow check) |
| <span class="metrics-name">pack_&#8203;txn_&#8203;schedule</span><br/>{pack_&#8203;txn_&#8203;schedule="<span class="metrics-enum">defer_&#8203;skip</span>"} | counter | Result of trying to consider a transaction for scheduling (Pack skipped the transaction it previously exceeded the per-account block write cost limit too many times) |
...
| <span class="metrics-name">pack_&#8203;cu_&#8203;consumed_&#8203;in_&#8203;block</span> | gauge | Cost units consumed in the current block, or 0 if pack is not currently packing a block |
...
| <span class="metrics-name">pack_&#8203;delete_&#8203;missed</span> | counter | Attempts to delete a transaction that wasn't found |
| <span class="metrics-name">pack_&#8203;delete_&#8203;hit</span> | counter | Attempts to delete a transaction that was found and deleted |
...
| <span class="metrics-name">shred_&#8203;invalid_&#8203;block_&#8203;id</span> | counter | Times a block was created with unknown parent block_id |
...
| <span class="metrics-name">shred_&#8203;fec_&#8203;set_&#8203;spilled</span> | counter | FEC sets spilled because they didn't complete in time and we needed space |
| <span class="metrics-name">shred_&#8203;shred_&#8203;rejected_&#8203;initial</span> | counter | Shreds rejected before any resources were allocated for the FEC set |
| <span class="metrics-name">shred_&#8203;shred_&#8203;rejected_&#8203;unchained</span> | counter | Shreds rejected because they're not chained merkle shreds |
| <span class="metrics-name">shred_&#8203;fec_&#8203;rejected_&#8203;fatal</span> | counter | FEC sets rejected for reasons that cause the whole FEC set to become invalid |
...
| <span class="metrics-name">gossip_&#8203;crds_&#8203;peer_&#8203;stake_&#8203;total</span> | gauge | Total visible stake in the data store, in lamports |
...
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push</span><br/>{crds_&#8203;value="<span class="metrics-enum">contact_&#8203;info_&#8203;v1</span>"} | counter | CRDS values sent in push messages (Contact Info V1) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push</span><br/>{crds_&#8203;value="<span class="metrics-enum">vote</span>"} | counter | CRDS values sent in push messages (Vote) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push</span><br/>{crds_&#8203;value="<span class="metrics-enum">lowest_&#8203;slot</span>"} | counter | CRDS values sent in push messages (Lowest Slot) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push</span><br/>{crds_&#8203;value="<span class="metrics-enum">snapshot_&#8203;hashes</span>"} | counter | CRDS values sent in push messages (Snapshot Hashes) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push</span><br/>{crds_&#8203;value="<span class="metrics-enum">accounts_&#8203;hashes</span>"} | counter | CRDS values sent in push messages (Accounts Hashes) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push</span><br/>{crds_&#8203;value="<span class="metrics-enum">epoch_&#8203;slots</span>"} | counter | CRDS values sent in push messages (Epoch Slots) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push</span><br/>{crds_&#8203;value="<span class="metrics-enum">version_&#8203;v1</span>"} | counter | CRDS values sent in push messages (Version V1) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push</span><br/>{crds_&#8203;value="<span class="metrics-enum">version_&#8203;v2</span>"} | counter | CRDS values sent in push messages (Version V2) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push</span><br/>{crds_&#8203;value="<span class="metrics-enum">node_&#8203;instance</span>"} | counter | CRDS values sent in push messages (Node Instance) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push</span><br/>{crds_&#8203;value="<span class="metrics-enum">duplicate_&#8203;shred</span>"} | counter | CRDS values sent in push messages (Duplicate Shred) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push</span><br/>{crds_&#8203;value="<span class="metrics-enum">incremental_&#8203;snapshot_&#8203;hashes</span>"} | counter | CRDS values sent in push messages (Incremental Snapshot Hashes) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push</span><br/>{crds_&#8203;value="<span class="metrics-enum">contact_&#8203;info_&#8203;v2</span>"} | counter | CRDS values sent in push messages (Contact Info V2) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push</span><br/>{crds_&#8203;value="<span class="metrics-enum">restart_&#8203;last_&#8203;voted_&#8203;fork_&#8203;slots</span>"} | counter | CRDS values sent in push messages (Restart Last Voted Fork Slots) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push</span><br/>{crds_&#8203;value="<span class="metrics-enum">restart_&#8203;heaviest_&#8203;fork</span>"} | counter | CRDS values sent in push messages (Restart Heaviest Fork) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">contact_&#8203;info_&#8203;v1</span>"} | counter | Wire bytes of CRDS sent in push messages (Contact Info V1) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">vote</span>"} | counter | Wire bytes of CRDS sent in push messages (Vote) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">lowest_&#8203;slot</span>"} | counter | Wire bytes of CRDS sent in push messages (Lowest Slot) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">snapshot_&#8203;hashes</span>"} | counter | Wire bytes of CRDS sent in push messages (Snapshot Hashes) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">accounts_&#8203;hashes</span>"} | counter | Wire bytes of CRDS sent in push messages (Accounts Hashes) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">epoch_&#8203;slots</span>"} | counter | Wire bytes of CRDS sent in push messages (Epoch Slots) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">version_&#8203;v1</span>"} | counter | Wire bytes of CRDS sent in push messages (Version V1) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">version_&#8203;v2</span>"} | counter | Wire bytes of CRDS sent in push messages (Version V2) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">node_&#8203;instance</span>"} | counter | Wire bytes of CRDS sent in push messages (Node Instance) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">duplicate_&#8203;shred</span>"} | counter | Wire bytes of CRDS sent in push messages (Duplicate Shred) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">incremental_&#8203;snapshot_&#8203;hashes</span>"} | counter | Wire bytes of CRDS sent in push messages (Incremental Snapshot Hashes) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">contact_&#8203;info_&#8203;v2</span>"} | counter | Wire bytes of CRDS sent in push messages (Contact Info V2) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">restart_&#8203;last_&#8203;voted_&#8203;fork_&#8203;slots</span>"} | counter | Wire bytes of CRDS sent in push messages (Restart Last Voted Fork Slots) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;push_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">restart_&#8203;heaviest_&#8203;fork</span>"} | counter | Wire bytes of CRDS sent in push messages (Restart Heaviest Fork) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response</span><br/>{crds_&#8203;value="<span class="metrics-enum">contact_&#8203;info_&#8203;v1</span>"} | counter | CRDS values sent in pull response messages (Contact Info V1) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response</span><br/>{crds_&#8203;value="<span class="metrics-enum">vote</span>"} | counter | CRDS values sent in pull response messages (Vote) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response</span><br/>{crds_&#8203;value="<span class="metrics-enum">lowest_&#8203;slot</span>"} | counter | CRDS values sent in pull response messages (Lowest Slot) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response</span><br/>{crds_&#8203;value="<span class="metrics-enum">snapshot_&#8203;hashes</span>"} | counter | CRDS values sent in pull response messages (Snapshot Hashes) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response</span><br/>{crds_&#8203;value="<span class="metrics-enum">accounts_&#8203;hashes</span>"} | counter | CRDS values sent in pull response messages (Accounts Hashes) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response</span><br/>{crds_&#8203;value="<span class="metrics-enum">epoch_&#8203;slots</span>"} | counter | CRDS values sent in pull response messages (Epoch Slots) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response</span><br/>{crds_&#8203;value="<span class="metrics-enum">version_&#8203;v1</span>"} | counter | CRDS values sent in pull response messages (Version V1) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response</span><br/>{crds_&#8203;value="<span class="metrics-enum">version_&#8203;v2</span>"} | counter | CRDS values sent in pull response messages (Version V2) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response</span><br/>{crds_&#8203;value="<span class="metrics-enum">node_&#8203;instance</span>"} | counter | CRDS values sent in pull response messages (Node Instance) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response</span><br/>{crds_&#8203;value="<span class="metrics-enum">duplicate_&#8203;shred</span>"} | counter | CRDS values sent in pull response messages (Duplicate Shred) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response</span><br/>{crds_&#8203;value="<span class="metrics-enum">incremental_&#8203;snapshot_&#8203;hashes</span>"} | counter | CRDS values sent in pull response messages (Incremental Snapshot Hashes) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response</span><br/>{crds_&#8203;value="<span class="metrics-enum">contact_&#8203;info_&#8203;v2</span>"} | counter | CRDS values sent in pull response messages (Contact Info V2) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response</span><br/>{crds_&#8203;value="<span class="metrics-enum">restart_&#8203;last_&#8203;voted_&#8203;fork_&#8203;slots</span>"} | counter | CRDS values sent in pull response messages (Restart Last Voted Fork Slots) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response</span><br/>{crds_&#8203;value="<span class="metrics-enum">restart_&#8203;heaviest_&#8203;fork</span>"} | counter | CRDS values sent in pull response messages (Restart Heaviest Fork) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">contact_&#8203;info_&#8203;v1</span>"} | counter | Wire bytes of CRDS sent in pull response messages (Contact Info V1) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">vote</span>"} | counter | Wire bytes of CRDS sent in pull response messages (Vote) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">lowest_&#8203;slot</span>"} | counter | Wire bytes of CRDS sent in pull response messages (Lowest Slot) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">snapshot_&#8203;hashes</span>"} | counter | Wire bytes of CRDS sent in pull response messages (Snapshot Hashes) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">accounts_&#8203;hashes</span>"} | counter | Wire bytes of CRDS sent in pull response messages (Accounts Hashes) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">epoch_&#8203;slots</span>"} | counter | Wire bytes of CRDS sent in pull response messages (Epoch Slots) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">version_&#8203;v1</span>"} | counter | Wire bytes of CRDS sent in pull response messages (Version V1) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">version_&#8203;v2</span>"} | counter | Wire bytes of CRDS sent in pull response messages (Version V2) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">node_&#8203;instance</span>"} | counter | Wire bytes of CRDS sent in pull response messages (Node Instance) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">duplicate_&#8203;shred</span>"} | counter | Wire bytes of CRDS sent in pull response messages (Duplicate Shred) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">incremental_&#8203;snapshot_&#8203;hashes</span>"} | counter | Wire bytes of CRDS sent in pull response messages (Incremental Snapshot Hashes) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">contact_&#8203;info_&#8203;v2</span>"} | counter | Wire bytes of CRDS sent in pull response messages (Contact Info V2) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">restart_&#8203;last_&#8203;voted_&#8203;fork_&#8203;slots</span>"} | counter | Wire bytes of CRDS sent in pull response messages (Restart Last Voted Fork Slots) |
| <span class="metrics-name">gossip_&#8203;crds_&#8203;tx_&#8203;pull_&#8203;response_&#8203;bytes</span><br/>{crds_&#8203;value="<span class="metrics-enum">restart_&#8203;heaviest_&#8203;fork</span>"} | counter | Wire bytes of CRDS sent in pull response messages (Restart Heaviest Fork) |
...
| <span class="metrics-name">repair_&#8203;pkt_&#8203;tx_&#8203;type</span><br/>{repair_&#8203;sent_&#8203;request_&#8203;type="<span class="metrics-enum">needed_&#8203;window</span>"} | counter | Client messages sent, by type (Need Window) |
| <span class="metrics-name">repair_&#8203;pkt_&#8203;tx_&#8203;type</span><br/>{repair_&#8203;sent_&#8203;request_&#8203;type="<span class="metrics-enum">needed_&#8203;highest_&#8203;window</span>"} | counter | Client messages sent, by type (Need Highest Window) |
| <span class="metrics-name">repair_&#8203;pkt_&#8203;tx_&#8203;type</span><br/>{repair_&#8203;sent_&#8203;request_&#8203;type="<span class="metrics-enum">needed_&#8203;orphan</span>"} | counter | Client messages sent, by type (Need Orphans) |
| <span class="metrics-name">repair_&#8203;pkt_&#8203;tx_&#8203;type</span><br/>{repair_&#8203;sent_&#8203;request_&#8203;type="<span class="metrics-enum">pong</span>"} | counter | Client messages sent, by type (Pong) |
...
| <span class="metrics-name">repair_&#8203;eager_&#8203;repair_&#8203;threshold_&#8203;exceeded</span> | counter | Times we passed the eager repair threshold |
...
| <span class="metrics-name">repair_&#8203;ping_&#8203;sigverify_&#8203;failed</span> | counter | Pings whose signature we failed to verify |
...
| Metric | Type | Description |
|--------|------|-------------|
| <span class="metrics-name">replay_&#8203;store_&#8203;query_&#8203;acquire</span> | counter | Store slock acquires for query |
| <span class="metrics-name">replay_&#8203;store_&#8203;query_&#8203;release</span> | counter | Store slock releases for query |
...
| <span class="metrics-name">replay_&#8203;store_&#8203;query</span> | counter | Queries |
| <span class="metrics-name">replay_&#8203;store_&#8203;query_&#8203;missing</span> | counter | Queries where merkle root was missing |
| <span class="metrics-name">replay_&#8203;store_&#8203;query_&#8203;merkle_&#8203;root</span> | gauge | First 8 bytes of most recently queried merkle root |
| <span class="metrics-name">replay_&#8203;store_&#8203;query_&#8203;missing_&#8203;merkle_&#8203;root</span> | gauge | First 8 bytes of most recently queried missing merkle root |
...
| <span class="metrics-name">replay_&#8203;sched_&#8203;last_&#8203;dispatch_&#8203;time_&#8203;nanos</span> | gauge | Timestamp when the replay scheduler last dispatched work, in nanoseconds |
...
| <span class="metrics-name">replay_&#8203;sched_&#8203;staging_&#8203;lane_&#8203;head_&#8203;bank_&#8203;index0</span> | gauge | Bank at the head of staging lane 0 of the replay dispatcher |
| <span class="metrics-name">replay_&#8203;sched_&#8203;staging_&#8203;lane_&#8203;head_&#8203;bank_&#8203;index1</span> | gauge | Bank at the head of staging lane 1 of the replay dispatcher |
| <span class="metrics-name">replay_&#8203;sched_&#8203;staging_&#8203;lane_&#8203;head_&#8203;bank_&#8203;index2</span> | gauge | Bank at the head of staging lane 2 of the replay dispatcher |
| <span class="metrics-name">replay_&#8203;sched_&#8203;staging_&#8203;lane_&#8203;head_&#8203;bank_&#8203;index3</span> | gauge | Bank at the head of staging lane 3 of the replay dispatcher |
...
| <span class="metrics-name">replay_&#8203;sched_&#8203;block_&#8203;bad</span> | counter | Blocks the replay scheduler considers bad |
...
| <span class="metrics-name">replay_&#8203;sched_&#8203;deactivate_&#8203;no_&#8203;child</span> | counter | Times the replay scheduler stopped dispatching because a block fully replayed and there was no child block available yet |
| <span class="metrics-name">replay_&#8203;sched_&#8203;deactivate_&#8203;no_&#8203;work</span> | counter | Times the replay scheduler stopped dispatching because a partially replayed block ran out of work to dispatch |
| <span class="metrics-name">replay_&#8203;sched_&#8203;deactivate_&#8203;abandoned</span> | counter | Times the replay scheduler stopped dispatching because a block got abandoned for any reason |
| <span class="metrics-name">replay_&#8203;sched_&#8203;deactivate_&#8203;minority</span> | counter | Times the replay scheduler stopped dispatching because a block got abandoned for being on a minority fork |
| <span class="metrics-name">replay_&#8203;sched_&#8203;lane_&#8203;switch</span> | counter | Times the replay scheduler switched the lane it is dispatching from |
| <span class="metrics-name">replay_&#8203;sched_&#8203;lane_&#8203;promote</span> | counter | Times the replay scheduler promoted one or more blocks onto a staging lane |
| <span class="metrics-name">replay_&#8203;sched_&#8203;lane_&#8203;demote</span> | counter | Times the replay scheduler demoted one or more blocks from a staging lane |
| <span class="metrics-name">replay_&#8203;sched_&#8203;fork_&#8203;observed</span> | counter | Forks the replay scheduler has observed |
| <span class="metrics-name">replay_&#8203;sched_&#8203;alut_&#8203;success</span> | counter | Transactions with address lookup tables that the replay scheduler successfully expanded |
| <span class="metrics-name">replay_&#8203;sched_&#8203;alut_&#8203;failed</span> | counter | Transactions with address lookup tables that the replay scheduler failed to expand |
| <span class="metrics-name">replay_&#8203;sched_&#8203;txn_&#8203;abandoned_&#8203;parsed</span> | counter | Transactions that were parsed but ended up being in abandoned blocks |
| <span class="metrics-name">replay_&#8203;sched_&#8203;txn_&#8203;abandoned_&#8203;exec</span> | counter | Transactions that were executed but ended up being in abandoned blocks |
| <span class="metrics-name">replay_&#8203;sched_&#8203;txn_&#8203;abandoned_&#8203;done</span> | counter | Transactions that were fully replayed but ended up being in abandoned blocks |
...
| <span class="metrics-name">replay_&#8203;sched_&#8203;txn_&#8203;exec</span> | counter | Transactions the replay pipeline has executed |
| <span class="metrics-name">replay_&#8203;sched_&#8203;txn_&#8203;sigverify</span> | counter | Transactions the replay pipeline has sigverified |
| <span class="metrics-name">replay_&#8203;sched_&#8203;txn_&#8203;mixin</span> | counter | Transactions the replay pipeline has performed PoH mixin on |
...
| <span class="metrics-name">replay_&#8203;sched_&#8203;fec</span> | counter | FEC sets the replay scheduler has been given |
...
| <span class="metrics-name">replay_&#8203;sched_&#8203;full</span> | counter | Times sched is full and a FEC set can't be processed |
| <span class="metrics-name">replay_&#8203;reassembly_&#8203;empty</span> | counter | Times reassembly is empty and a FEC set can't be processed |
| <span class="metrics-name">replay_&#8203;leader_&#8203;bid_&#8203;wait</span> | counter | Times replay is blocked by the PoH tile not sending an end of leader message |
| <span class="metrics-name">replay_&#8203;bank_&#8203;full</span> | counter | Times banks are full and a FEC set can't be processed |
...
| <span class="metrics-name">replay_&#8203;accdb_&#8203;created</span> | counter | Account database records created |
| <span class="metrics-name">replay_&#8203;accdb_&#8203;reverted</span> | counter | Account database records reverted |
| <span class="metrics-name">replay_&#8203;accdb_&#8203;rooted</span> | counter | Account database entries rooted |
| <span class="metrics-name">replay_&#8203;accdb_&#8203;rooted_&#8203;bytes</span> | counter | Bytes in account database entries rooted (including overhead) |
| <span class="metrics-name">replay_&#8203;accdb_&#8203;garbage_&#8203;collected</span> | counter | Account database entries garbage collected |
| <span class="metrics-name">replay_&#8203;accdb_&#8203;reclaimed</span> | counter | Account database entries reclaimed (deletion rooted) |
| <span class="metrics-name">replay_&#8203;root_&#8203;slot_&#8203;duration_&#8203;seconds</span> | histogram | Time spent updating the rooted account store (one sample per block) |
...
| <span class="metrics-name">replay_&#8203;accdb_&#8203;cache_&#8203;free_&#8203;partition</span> | gauge | Free account database cache heap partitions (indicates fragmentation) |
| <span class="metrics-name">replay_&#8203;accdb_&#8203;cache_&#8203;free_&#8203;bytes</span> | gauge | Free bytes in the account database cache heap |
| <span class="metrics-name">replay_&#8203;accdb_&#8203;cache_&#8203;size_&#8203;bytes</span> | gauge | Total size of the account database cache heap |
| <span class="metrics-name">replay_&#8203;accdb_&#8203;cache_&#8203;free_&#8203;partition_&#8203;max_&#8203;bytes</span> | gauge | Largest free heap partition in account database cache |
| <span class="metrics-name">replay_&#8203;accdb_&#8203;cache_&#8203;used_&#8203;partition_&#8203;median_&#8203;bytes</span> | gauge | Median used heap partition size in account database cache |
| <span class="metrics-name">replay_&#8203;accdb_&#8203;cache_&#8203;used_&#8203;partition_&#8203;mean_&#8203;bytes</span> | gauge | Mean used heap partition size in account database cache |
...
| <span class="metrics-name">execrp_&#8203;sigverify</span> | counter | Ed25519 signature verification jobs executed |
| <span class="metrics-name">execrp_&#8203;poh_&#8203;hash</span> | counter | PoH SHA-256 calls executed |
| <span class="metrics-name">execrp_&#8203;accdb_&#8203;created</span> | counter | Account database records created |
...
| <span class="metrics-name">execrp_&#8203;txn_&#8203;account_&#8203;change</span><br/>{account_&#8203;change="<span class="metrics-enum">unchanged_&#8203;nonexistent</span>"} | counter | Transaction account change events (Account did not exist before and still does not) |
| <span class="metrics-name">execrp_&#8203;txn_&#8203;account_&#8203;change</span><br/>{account_&#8203;change="<span class="metrics-enum">created</span>"} | counter | Transaction account change events (Account created) |
| <span class="metrics-name">execrp_&#8203;txn_&#8203;account_&#8203;change</span><br/>{account_&#8203;change="<span class="metrics-enum">deleted</span>"} | counter | Transaction account change events (Account deleted) |
| <span class="metrics-name">execrp_&#8203;txn_&#8203;account_&#8203;change</span><br/>{account_&#8203;change="<span class="metrics-enum">modified</span>"} | counter | Transaction account change events (Account modified) |
| <span class="metrics-name">execrp_&#8203;txn_&#8203;account_&#8203;change</span><br/>{account_&#8203;change="<span class="metrics-enum">unchanged</span>"} | counter | Transaction account change events (Account unchanged) |
...
| <span class="metrics-name">tower_&#8203;txn_&#8203;deserialize_&#8203;failed</span> | counter | Vote txns that failed to deserialize |
| <span class="metrics-name">tower_&#8203;txn_&#8203;tower_&#8203;invalid</span> | counter | Vote txns that deserialized but whose tower was invalid |
| <span class="metrics-name">tower_&#8203;txn_&#8203;not_&#8203;tower_&#8203;sync</span> | counter | Vote txns that were not a TowerSync instruction |
| <span class="metrics-name">tower_&#8203;txn_&#8203;tower_&#8203;empty</span> | counter | Vote txns that had an empty tower (validator hasn't voted) |
| <span class="metrics-name">tower_&#8203;proof_&#8203;checked</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">conflict_&#8203;merkle</span>"} | counter | Result of checking a pair of shreds for equivocation (Merkle root conflict) |
| <span class="metrics-name">tower_&#8203;proof_&#8203;checked</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">conflict_&#8203;meta</span>"} | counter | Result of checking a pair of shreds for equivocation (Coding metadata conflict) |
| <span class="metrics-name">tower_&#8203;proof_&#8203;checked</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">conflict_&#8203;last</span>"} | counter | Result of checking a pair of shreds for equivocation (Last shred index conflict) |
| <span class="metrics-name">tower_&#8203;proof_&#8203;checked</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">conflict_&#8203;overlap</span>"} | counter | Result of checking a pair of shreds for equivocation (Overlapping FEC set conflict) |
| <span class="metrics-name">tower_&#8203;proof_&#8203;checked</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">conflict_&#8203;chained</span>"} | counter | Result of checking a pair of shreds for equivocation (Chained merkle root conflict) |
| <span class="metrics-name">tower_&#8203;proof_&#8203;checked</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">error_&#8203;serde</span>"} | counter | Result of checking a pair of shreds for equivocation (Invalid serialization) |
| <span class="metrics-name">tower_&#8203;proof_&#8203;checked</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">error_&#8203;slot</span>"} | counter | Result of checking a pair of shreds for equivocation (Shreds were for different slots) |
| <span class="metrics-name">tower_&#8203;proof_&#8203;checked</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">error_&#8203;version</span>"} | counter | Result of checking a pair of shreds for equivocation (Either shred had wrong shred version) |
| <span class="metrics-name">tower_&#8203;proof_&#8203;checked</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">error_&#8203;type</span>"} | counter | Result of checking a pair of shreds for equivocation (Wrong shred type (must be chained merkle)) |
| <span class="metrics-name">tower_&#8203;proof_&#8203;checked</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">error_&#8203;merkle</span>"} | counter | Result of checking a pair of shreds for equivocation (Failed to derive merkle root) |
| <span class="metrics-name">tower_&#8203;proof_&#8203;checked</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">error_&#8203;signature</span>"} | counter | Result of checking a pair of shreds for equivocation (Failed to sig verify) |
| <span class="metrics-name">tower_&#8203;proof_&#8203;checked</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">error_&#8203;chunk_&#8203;count</span>"} | counter | Result of checking a pair of shreds for equivocation (Unexpected number of chunks (num_chunks != FD_EQVOC_CHUNK_CNT)) |
| <span class="metrics-name">tower_&#8203;proof_&#8203;checked</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">error_&#8203;chunk_&#8203;index</span>"} | counter | Result of checking a pair of shreds for equivocation (Chunk index out of range (chunk_index >= FD_EQVOC_CHUNK_CNT)) |
| <span class="metrics-name">tower_&#8203;proof_&#8203;checked</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">error_&#8203;chunk_&#8203;length</span>"} | counter | Result of checking a pair of shreds for equivocation (Chunk length did not match expected length for chunk index (chunk_len)) |
| <span class="metrics-name">tower_&#8203;proof_&#8203;checked</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">error_&#8203;chunk_&#8203;from</span>"} | counter | Result of checking a pair of shreds for equivocation (Unrecognized from address) |
| <span class="metrics-name">tower_&#8203;proof_&#8203;checked</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">error_&#8203;chunk_&#8203;slot</span>"} | counter | Result of checking a pair of shreds for equivocation (Slot older than root or unable to derive leader schedule) |
| <span class="metrics-name">tower_&#8203;proof_&#8203;checked</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">error_&#8203;shred_&#8203;slot</span>"} | counter | Result of checking a pair of shreds for equivocation (Slot older than root) |
| <span class="metrics-name">tower_&#8203;proof_&#8203;checked</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">error_&#8203;shred_&#8203;index</span>"} | counter | Result of checking a pair of shreds for equivocation (Shred index out of range (shred index >= FD_SHRED_BLK_MAX)) |
| <span class="metrics-name">tower_&#8203;proof_&#8203;constructed</span> | counter | Duplicate proofs we constructed from shreds |
| <span class="metrics-name">tower_&#8203;proof_&#8203;verified</span> | counter | Duplicate proofs we verified from gossip |
| <span class="metrics-name">tower_&#8203;ghost_&#8203;vote_&#8203;dropped</span><br/>{ghost_&#8203;vote_&#8203;result="<span class="metrics-enum">not_&#8203;voted</span>"} | counter | Ghost votes dropped, by reason (Skipped because voter hasn't voted) |
| <span class="metrics-name">tower_&#8203;ghost_&#8203;vote_&#8203;dropped</span><br/>{ghost_&#8203;vote_&#8203;result="<span class="metrics-enum">too_&#8203;old</span>"} | counter | Ghost votes dropped, by reason (Slot was behind the root) |
| <span class="metrics-name">tower_&#8203;ghost_&#8203;vote_&#8203;dropped</span><br/>{ghost_&#8203;vote_&#8203;result="<span class="metrics-enum">already_&#8203;voted</span>"} | counter | Ghost votes dropped, by reason (Slot was not newer than previous vote) |
| <span class="metrics-name">tower_&#8203;hard_&#8203;fork_&#8203;vote_&#8203;dropped</span><br/>{hard_&#8203;fork_&#8203;vote_&#8203;result="<span class="metrics-enum">unknown_&#8203;voter</span>"} | counter | Hard fork votes dropped, by reason (Voter not in voter set) |
| <span class="metrics-name">tower_&#8203;hard_&#8203;fork_&#8203;vote_&#8203;dropped</span><br/>{hard_&#8203;fork_&#8203;vote_&#8203;result="<span class="metrics-enum">already_&#8203;voted</span>"} | counter | Hard fork votes dropped, by reason (Voter already voted for this block_id) |
| <span class="metrics-name">tower_&#8203;hard_&#8203;fork_&#8203;vote_&#8203;dropped</span><br/>{hard_&#8203;fork_&#8203;vote_&#8203;result="<span class="metrics-enum">too_&#8203;old</span>"} | counter | Hard fork votes dropped, by reason (Slot not newer than previous) |
...
| <span class="metrics-name">tower_&#8203;vote_&#8203;considered</span><br/>{tower_&#8203;vote_&#8203;decision="<span class="metrics-enum">same_&#8203;fork</span>"} | counter | Result of deciding whether we can vote on a fork (Same fork as prev vote (can vote)) |
| <span class="metrics-name">tower_&#8203;vote_&#8203;considered</span><br/>{tower_&#8203;vote_&#8203;decision="<span class="metrics-enum">switch_&#8203;allowed</span>"} | counter | Result of deciding whether we can vote on a fork (Prev vote was on a different fork, but we are allowed to switch (can vote)) |
| <span class="metrics-name">tower_&#8203;vote_&#8203;considered</span><br/>{tower_&#8203;vote_&#8203;decision="<span class="metrics-enum">switch_&#8203;denied</span>"} | counter | Result of deciding whether we can vote on a fork (Prev vote was on a different fork, and we are not allowed to switch (can't vote)) |
| <span class="metrics-name">tower_&#8203;vote_&#8203;considered</span><br/>{tower_&#8203;vote_&#8203;decision="<span class="metrics-enum">ancestor_&#8203;rollback</span>"} | counter | Result of deciding whether we can vote on a fork (Rollback to an ancestor of our prev vote (can't vote)) |
| <span class="metrics-name">tower_&#8203;vote_&#8203;considered</span><br/>{tower_&#8203;vote_&#8203;decision="<span class="metrics-enum">sibling_&#8203;confirmed</span>"} | counter | Result of deciding whether we can vote on a fork (Duplicate sibling got confirmed (can't vote)) |
| <span class="metrics-name">tower_&#8203;vote_&#8203;considered</span><br/>{tower_&#8203;vote_&#8203;decision="<span class="metrics-enum">lockout</span>"} | counter | Result of deciding whether we can vote on a fork (Locked out (can't vote)) |
| <span class="metrics-name">tower_&#8203;vote_&#8203;considered</span><br/>{tower_&#8203;vote_&#8203;decision="<span class="metrics-enum">threshold</span>"} | counter | Result of deciding whether we can vote on a fork (Did not pass threshold check (can't vote)) |
| <span class="metrics-name">tower_&#8203;vote_&#8203;considered</span><br/>{tower_&#8203;vote_&#8203;decision="<span class="metrics-enum">not_&#8203;propagated</span>"} | counter | Result of deciding whether we can vote on a fork (Prev leader block did not propagate (can't vote)) |
| <span class="metrics-name">tower_&#8203;vote_&#8203;txn_&#8203;dropped</span><br/>{vote_&#8203;txn_&#8203;result="<span class="metrics-enum">too_&#8203;old</span>"} | counter | Vote txns dropped, by reason (Vote slot was behind the votes root) |
| <span class="metrics-name">tower_&#8203;vote_&#8203;txn_&#8203;dropped</span><br/>{vote_&#8203;txn_&#8203;result="<span class="metrics-enum">too_&#8203;new</span>"} | counter | Vote txns dropped, by reason (Vote slot was too far ahead of the votes root) |
| <span class="metrics-name">tower_&#8203;vote_&#8203;txn_&#8203;dropped</span><br/>{vote_&#8203;txn_&#8203;result="<span class="metrics-enum">unknown_&#8203;voter</span>"} | counter | Vote txns dropped, by reason (Vote account was not in the voter set) |
| <span class="metrics-name">tower_&#8203;vote_&#8203;txn_&#8203;dropped</span><br/>{vote_&#8203;txn_&#8203;result="<span class="metrics-enum">already_&#8203;voted</span>"} | counter | Vote txns dropped, by reason (Voter already voted for this slot) |
| <span class="metrics-name">tower_&#8203;vote_&#8203;txn_&#8203;dropped</span><br/>{vote_&#8203;txn_&#8203;result="<span class="metrics-enum">unknown_&#8203;slot</span>"} | counter | Vote txns dropped, by reason (Vote txn was for a slot we haven't replayed) |
| <span class="metrics-name">tower_&#8203;vote_&#8203;txn_&#8203;dropped</span><br/>{vote_&#8203;txn_&#8203;result="<span class="metrics-enum">unknown_&#8203;block_&#8203;id</span>"} | counter | Vote txns dropped, by reason (Vote txn was for a block id we don't recognize) |
...
| <span class="metrics-name">txsend_&#8203;conn_&#8203;allocated</span> | gauge | QUIC connections currently allocated |
...
| <span class="metrics-name">txsend_&#8203;pkt_&#8203;retransmitted</span><br/>{quic_&#8203;encryption_&#8203;level="<span class="metrics-enum">initial</span>"} | counter | QUIC packets retransmitted (Initial) |
| <span class="metrics-name">txsend_&#8203;pkt_&#8203;retransmitted</span><br/>{quic_&#8203;encryption_&#8203;level="<span class="metrics-enum">early</span>"} | counter | QUIC packets retransmitted (Early data) |
| <span class="metrics-name">txsend_&#8203;pkt_&#8203;retransmitted</span><br/>{quic_&#8203;encryption_&#8203;level="<span class="metrics-enum">handshake</span>"} | counter | QUIC packets retransmitted (Handshake) |
| <span class="metrics-name">txsend_&#8203;pkt_&#8203;retransmitted</span><br/>{quic_&#8203;encryption_&#8203;level="<span class="metrics-enum">app</span>"} | counter | QUIC packets retransmitted (App data) |
...
| <span class="metrics-name">txsend_&#8203;frame_&#8203;tx_&#8203;alloc</span><br/>{frame_&#8203;tx_&#8203;alloc_&#8203;result="<span class="metrics-enum">success</span>"} | counter | Attempts to acquire QUIC frame metadata (Success) |
| <span class="metrics-name">txsend_&#8203;frame_&#8203;tx_&#8203;alloc</span><br/>{frame_&#8203;tx_&#8203;alloc_&#8203;result="<span class="metrics-enum">fail_&#8203;empty_&#8203;pool</span>"} | counter | Attempts to acquire QUIC frame metadata (PktMetaPoolEmpty) |
| <span class="metrics-name">txsend_&#8203;frame_&#8203;tx_&#8203;alloc</span><br/>{frame_&#8203;tx_&#8203;alloc_&#8203;result="<span class="metrics-enum">fail_&#8203;connection_&#8203;max</span>"} | counter | Attempts to acquire QUIC frame metadata (ConnMaxedInflightFrames) |
...
| <span class="metrics-name">event_&#8203;event_&#8203;queue_&#8203;depth</span> | gauge | Events in the event queue waiting to be sent to the event service |
| <span class="metrics-name">event_&#8203;event_&#8203;queue_&#8203;dropped</span> | counter | Events dropped because the event queue was full |
| <span class="metrics-name">event_&#8203;event_&#8203;queue_&#8203;bytes_&#8203;used</span> | gauge | Bytes used in the event queue |
| <span class="metrics-name">event_&#8203;event_&#8203;queue_&#8203;bytes_&#8203;capacity</span> | gauge | Total capacity of the event queue, in bytes |
| <span class="metrics-name">event_&#8203;event_&#8203;sent</span> | counter | Events sent to the event service |
| <span class="metrics-name">event_&#8203;event_&#8203;acked</span> | counter | Events acknowledged by the event service |
...
| Metric | Type | Description |
|--------|------|-------------|
| <span class="metrics-name">resolh_&#8203;no_&#8203;bank_&#8203;dropped</span> | counter | Transactions dropped because the bank was not available |
...
| <span class="metrics-name">bank_&#8203;txn_&#8203;executed_&#8203;failed</span> | counter | Transactions that execute on chain but failed |
| <span class="metrics-name">bank_&#8203;txn_&#8203;executed_&#8203;success</span> | counter | Transactions that execute on chain and succeed |
