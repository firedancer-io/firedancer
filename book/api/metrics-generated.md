...
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;shred</span><br/>{eqvoc_&#8203;shred_&#8203;result="<span class="metrics-enum">no_&#8203;conflict</span>"} | counter | Result of checking one of our own incoming shreds for equivocation (per shred) (Shred does not equivocate) |
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;shred</span><br/>{eqvoc_&#8203;shred_&#8203;result="<span class="metrics-enum">success_&#8203;merkle</span>"} | counter | Result of checking one of our own incoming shreds for equivocation (per shred) (Merkle root conflict) |
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;shred</span><br/>{eqvoc_&#8203;shred_&#8203;result="<span class="metrics-enum">success_&#8203;last</span>"} | counter | Result of checking one of our own incoming shreds for equivocation (per shred) (Last shred index conflict) |
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;shred</span><br/>{eqvoc_&#8203;shred_&#8203;result="<span class="metrics-enum">success_&#8203;chained</span>"} | counter | Result of checking one of our own incoming shreds for equivocation (per shred) (Chained merkle root conflict) |
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;shred</span><br/>{eqvoc_&#8203;shred_&#8203;result="<span class="metrics-enum">err_&#8203;slot</span>"} | counter | Result of checking one of our own incoming shreds for equivocation (per shred) (Shreds were for different slots) |
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;shred</span><br/>{eqvoc_&#8203;shred_&#8203;result="<span class="metrics-enum">err_&#8203;version</span>"} | counter | Result of checking one of our own incoming shreds for equivocation (per shred) (Either shred had wrong shred version) |
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;shred</span><br/>{eqvoc_&#8203;shred_&#8203;result="<span class="metrics-enum">err_&#8203;type</span>"} | counter | Result of checking one of our own incoming shreds for equivocation (per shred) (Wrong shred type (must be chained merkle)) |
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;shred</span><br/>{eqvoc_&#8203;shred_&#8203;result="<span class="metrics-enum">err_&#8203;merkle</span>"} | counter | Result of checking one of our own incoming shreds for equivocation (per shred) (Failed to derive merkle root) |
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;shred</span><br/>{eqvoc_&#8203;shred_&#8203;result="<span class="metrics-enum">err_&#8203;signature</span>"} | counter | Result of checking one of our own incoming shreds for equivocation (per shred) (Failed to sig verify) |
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;shred</span><br/>{eqvoc_&#8203;shred_&#8203;result="<span class="metrics-enum">err_&#8203;shred_&#8203;slot</span>"} | counter | Result of checking one of our own incoming shreds for equivocation (per shred) (Slot older than root) |
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;shred</span><br/>{eqvoc_&#8203;shred_&#8203;result="<span class="metrics-enum">err_&#8203;shred_&#8203;idx</span>"} | counter | Result of checking one of our own incoming shreds for equivocation (per shred) (Shred index >= FD_SHRED_BLK_MAX) |
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;proof</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">in_&#8203;progress</span>"} | counter | Result of inserting one chunk of a DuplicateShred gossip proof (per chunk) (Chunk accepted, proof not yet complete) |
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;proof</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">success_&#8203;merkle</span>"} | counter | Result of inserting one chunk of a DuplicateShred gossip proof (per chunk) (Merkle root conflict) |
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;proof</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">success_&#8203;last</span>"} | counter | Result of inserting one chunk of a DuplicateShred gossip proof (per chunk) (Last shred index conflict) |
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;proof</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">success_&#8203;chained</span>"} | counter | Result of inserting one chunk of a DuplicateShred gossip proof (per chunk) (Chained merkle root conflict) |
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;proof</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">err_&#8203;chunk_&#8203;slot</span>"} | counter | Result of inserting one chunk of a DuplicateShred gossip proof (per chunk) (Slot older than root or unable to derive leader schedule) |
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;proof</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">err_&#8203;chunk_&#8203;from</span>"} | counter | Result of inserting one chunk of a DuplicateShred gossip proof (per chunk) (Unrecognized from address) |
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;proof</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">err_&#8203;chunk_&#8203;cnt</span>"} | counter | Result of inserting one chunk of a DuplicateShred gossip proof (per chunk) (num_chunks != FD_EQVOC_CHUNK_CNT) |
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;proof</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">err_&#8203;chunk_&#8203;idx</span>"} | counter | Result of inserting one chunk of a DuplicateShred gossip proof (per chunk) (chunk_index >= FD_EQVOC_CHUNK_CNT) |
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;proof</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">err_&#8203;chunk_&#8203;len</span>"} | counter | Result of inserting one chunk of a DuplicateShred gossip proof (per chunk) (chunk_len does not match expected length for chunk_index) |
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;proof</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">err_&#8203;serde</span>"} | counter | Result of inserting one chunk of a DuplicateShred gossip proof (per chunk) (Invalid serialization of reassembled shreds) |
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;proof</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">err_&#8203;slot</span>"} | counter | Result of inserting one chunk of a DuplicateShred gossip proof (per chunk) (Reassembled shreds were for different slots) |
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;proof</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">err_&#8203;version</span>"} | counter | Result of inserting one chunk of a DuplicateShred gossip proof (per chunk) (Either reassembled shred had wrong shred version) |
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;proof</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">err_&#8203;type</span>"} | counter | Result of inserting one chunk of a DuplicateShred gossip proof (per chunk) (Wrong shred type (must be chained merkle)) |
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;proof</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">err_&#8203;merkle</span>"} | counter | Result of inserting one chunk of a DuplicateShred gossip proof (per chunk) (Failed to derive merkle root) |
| <span class="metrics-name">tower_&#8203;eqvoc_&#8203;proof</span><br/>{eqvoc_&#8203;proof_&#8203;result="<span class="metrics-enum">err_&#8203;signature</span>"} | counter | Result of inserting one chunk of a DuplicateShred gossip proof (per chunk) (Failed to sig verify) |
