...
/* TurboSHAKE12 + 8-way parallel-squeeze hash-to-point (defined in
 * falcon_ref_turbopar.c, requires AVX-512).  Same input convention as
 * the avx512 verifiers' parsing: pass the contiguous nonce||msg slice
 * (sm + 2, NONCELEN + msg_len). */
void fa512_hash_to_point_turbopar( uint16_t * out,
