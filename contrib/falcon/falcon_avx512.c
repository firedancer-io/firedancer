 ...
 * standard and turbopar variants share parse + finish via local
...
int
falcon_avx512_turbopar_crypto_sign_open( uint8_t       * m,  size_t * mlen,
                                          uint8_t const * sm, size_t   smlen,
                                          uint8_t const * pk ) {
  falcon_pubkey_t    pubk[1];
  falcon_signature_t sig [1];
  ...
  /* See falcon_avx512_barrett_turbopar_crypto_sign_open for the rationale on
