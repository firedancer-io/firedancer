 ...
 *   - falcon_ref_turbopar : non-standard TurboSHAKE12 + 8-way parallel-squeeze
 ...
 *   - falcon_x86_turbopar : auto-vec C + parallel-squeeze hash.
 ...
 *   - falcon_avx512_barrett_turbopar : Barrett AVX-512 + parallel-squeeze hash.
 *   - falcon_avx512_turbopar         : Shoup AVX-512 + parallel-squeeze hash.
 */
...
/* The four turbopar variants share a non-standard hash-to-point and
...
test_turbopar_runs( void ) {
  ...
  struct { char const * name; verify_fn fn; } v[] = {
    { "falcon_ref_turbopar",            falcon_ref_turbopar_crypto_sign_open            },
    { "falcon_x86_turbopar",            falcon_x86_turbopar_crypto_sign_open            },
    { "falcon_avx512_barrett_turbopar", falcon_avx512_barrett_turbopar_crypto_sign_open },
    { "falcon_avx512_turbopar",         falcon_avx512_turbopar_crypto_sign_open         },
  };
